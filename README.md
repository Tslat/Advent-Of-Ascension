...
此branch的所有内容均来自本mod1.12.2的最新版本。

## 免责声明
Github中的源码仅供查看。根据许可，你允许修改这些代码，但这些代码仅供个人使用。
分发这些代码将违反许可协议。

这里提供的代码将无法更改。所有可见的源代码都仅来自于公开发布的最新版本。
因此，所有非翻译的编辑均会被立即删除。如果有需要修复的漏洞或者更改游戏内容，请提交漏洞报告或者建议。
