...
public final class ClientConfig {
	...
	protected ClientConfig(ForgeConfigSpec.Builder specBuilder) {
		...
		showVanityLevels = specBuilder
				...
				.translation("config.aoa3.showVanityLevels")
		...
		showXpParticles = specBuilder
				...
				.translation("config.aoa3.showXpParticles")
		...
		showWelcomeMessage = specBuilder
				...
				.translation("config.aoa3.showWelcomeMessage")
		...
		showPlayerHalos = specBuilder
				...
				.translation("config.aoa3.showPlayerHalos")
		...
		personalHaloPreference = specBuilder
				...
				.translation("config.aoa3.personalHaloPreference")
		...
		adventGuiTheme = specBuilder
				...
				.translation("config.aoa3.adventGuiTheme")
		...
		adventGuiPausesGame = specBuilder
				...
				.translation("config.aoa3.adventGuiPausesGame")
		...
		thirdPartyBestiary = specBuilder
				...
				.translation("config.aoa3.thirdPartyBestiary")
		...
		hudResourcesPosition = specBuilder
				...
				.translation("config.aoa3.hudResourcesPosition")
		...
		hudResourcesHorizontal = specBuilder
				...
				.translation("config.aoa3.hudResourcesHorizontal")
		...
		disableHudPotionOffset = specBuilder
				...
				.translation("config.aoa3.disableHudPotionOffset")
		...
		useToasts = specBuilder
				...
				.translation("config.aoa3.useToasts")
		...
		rotatingTrophies = specBuilder
				...
				.translation("config.aoa3.rotatingTrophies")
