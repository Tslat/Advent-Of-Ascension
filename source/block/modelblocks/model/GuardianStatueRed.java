...
public class GuardianStatueRed extends ModelBase implements ModelEternalBlock {
	ModelRenderer head;
	...
	public GuardianStatueRed() {
		...
		setRotation(rightarm1, 0.0f, 0.0f, 0.240525f);
		...
		setRotation(leftarm1, 0.0f, 0.0f, -0.3346075f);
		...
		setRotation(rightarm2, 0.0f, 0.0f, 0.240525f);
		...
		setRotation(leftarm2, 0.0f, 0.0f, -0.3346075f);
		...
		setRotation(rightarm3, 0.0f, 0.0f, 0.240525f);
		...
		setRotation(leftarm3, 0.0f, 0.0f, -0.3346075f);
		...
		setRotation(rightarm4, 0.0f, 0.0f, 0.240525f);
		...
		setRotation(leftarm4, 0.0f, 0.0f, -0.3346075f);
		...
		setRotation(rightarm5, 0.0f, 0.0f, 0.240525f);
		...
		setRotation(leftarm5, 0.0f, 0.0f, -0.3346075f);
	}
