...
public class GuardianStatueYellow extends ModelBase implements ModelEternalBlock {
	ModelRenderer head;
	...
	public GuardianStatueYellow() {
		...
		setRotation(rightarm1, 0.181349f, 0.6320364f, 0.240525f);
		...
		setRotation(leftarm1, -2.714039f, -0.1684398f, -0.3346075f);
		...
		setRotation(rightarm2, 0.181349f, 0.6320364f, 0.240525f);
		...
		setRotation(leftarm2, -2.714039f, -0.1684398f, -0.3346075f);
		...
		setRotation(rightarm3, 0.181349f, 0.6320364f, 0.240525f);
		...
		setRotation(leftarm3, -2.714039f, -0.1684398f, -0.3346075f);
		...
		setRotation(rightarm4, 0.181349f, 0.6320364f, 0.240525f);
		...
		setRotation(leftarm4, -2.714039f, -0.1684398f, -0.3346075f);
		...
		setRotation(rightarm5, 0.181349f, 0.6320364f, 0.240525f);
		...
		setRotation(leftarm5, -2.714039f, -0.1684398f, -0.3346075f);
	}
