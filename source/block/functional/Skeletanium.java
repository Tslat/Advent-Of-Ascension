...
public class Skeletanium extends Block {
	public Skeletanium(final Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	public void onEntityCollidedWithBlock(final World w, final int x, final int y, final int z, final Entity e) {
		if (!(e instanceof EntityItem) && w.getBlock(x, y, z) == Blockizer.Skeletanium) {
			e.attackEntityFrom(DamageSource.cactus, 5.0f);
		}
	}
}
