...
public class GrassCrystal extends Block implements IGrowable {
	...
	public GrassCrystal(Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	public void registerBlockIcons(IIconRegister icon) {
		top = icon.registerIcon("nevermine:grassCrystal_top");
		side = icon.registerIcon("nevermine:grassCrystal_side");
		bottom = icon.registerIcon("nevermine:dirtCandyland");
		blockIcon = icon.registerIcon("nevermine:grassCrystal_side");
	}
