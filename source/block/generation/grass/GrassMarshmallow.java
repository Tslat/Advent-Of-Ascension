...
public class GrassMarshmallow extends Block implements IGrowable {
	...
	public GrassMarshmallow(Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	public void registerBlockIcons(IIconRegister icon) {
		this.top = icon.registerIcon("nevermine:grassMarshmallow_top");
		this.side = icon.registerIcon("nevermine:grassMarshmallow_side");
		this.bottom = icon.registerIcon("nevermine:dirtCandyland");
		this.blockIcon = icon.registerIcon("nevermine:grassMarshmallow_side");
	}
