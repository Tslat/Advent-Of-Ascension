...
public class GrassLelyetiaUp extends Block implements IGrowable {
	...
	public GrassLelyetiaUp(final Material p_i45394_1_) {
		super(p_i45394_1_);
		setCreativeTab(Itemizer.GenerationTab);
		setHardness(1.5f);
		setResistance(0.2f);
		setStepSound(GrassLelyetiaUp.grass);
	...
	public void registerBlockIcons(final IIconRegister icon) {
		top = icon.registerIcon("nevermine:grassLelyetia_end");
		side = icon.registerIcon("nevermine:grassLelyetiaUp_side");
		bottom = icon.registerIcon("nevermine:stoneLelyetia");
		blockIcon = icon.registerIcon("nevermine:grassLelyetiaUp_side");
	}

	static {
		GrassLelyetiaUp.grass = Block.soundTypeGrass;
	}
}
