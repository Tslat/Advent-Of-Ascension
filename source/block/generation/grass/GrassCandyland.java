...
public class GrassCandyland extends Block implements IGrowable {
	...
	public GrassCandyland(final Material p_i45394_1_) {
		super(p_i45394_1_);
		setCreativeTab(Itemizer.GenerationTab);
		setHardness(1.5f);
		setResistance(0.2f);
		setStepSound(GrassCandyland.grass);
	...
	public void registerBlockIcons(final IIconRegister icon) {
		top = icon.registerIcon("nevermine:grassCandyland_top");
		side = icon.registerIcon("nevermine:grassCandyland_side");
		bottom = icon.registerIcon("nevermine:dirtCandyland");
		blockIcon = icon.registerIcon("nevermine:grassCandyland_side");
	}
}
