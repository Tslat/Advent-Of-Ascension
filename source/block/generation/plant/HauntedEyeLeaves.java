...
public class HauntedEyeLeaves extends BlockDirectional {
	...
	public HauntedEyeLeaves(final Material p_i45394_1_, final String strname) {
		super(p_i45394_1_);
	...
	public void registerBlockIcons(final IIconRegister icon) {
		top = icon.registerIcon("nevermine:leavesHaunted");
		bottom = top;
		if (name != "TentacleBlock") {
			...
			side = icon.registerIcon("nevermine:leavesHaunted");
			blockIcon = icon.registerIcon("nevermine:leavesHaunted");
		}
	}
}
