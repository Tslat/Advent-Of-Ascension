...
public class BlockGenLunarPlant extends Block implements IShearable {
	private String name;

	public BlockGenLunarPlant(final Material Rck) {
		super(Rck);
		setCreativeTab(Itemizer.GenerationTab);
		setHardness(0.4f);
		setResistance(0.5f);
		setStepSound(BlockGenLunarPlant.soundTypeGrass);
	}
	...
	public void onEntityCollidedWithBlock(final World p_149670_1_, final int p_149670_2_, final int p_149670_3_, final int p_149670_4_, final Entity p_149670_5_) {
		if (p_149670_5_ instanceof EntityPlayer) {
			((EntityLivingBase)p_149670_5_).addPotionEffect(new PotionEffect(Potion.invisibility.id, 30, 0));
		}
	}
