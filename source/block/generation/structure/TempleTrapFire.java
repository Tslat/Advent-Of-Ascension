...
public class TempleTrapFire extends Block {
	public TempleTrapFire(final Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	public void onEntityCollidedWithBlock(final World w, final int x, final int y, final int z, final Entity e) {
		if (w.getBlock(x, y, z) == Blockizer.TempleTrapFire && e instanceof EntityPlayer && !((EntityPlayer)e).capabilities.isCreativeMode) {
			e.worldObj.playSoundAtEntity(e, "nevermine:TempleLaugh", 1.3f, 1.0f);
			((EntityLivingBase)e).addPotionEffect(new PotionEffect(Potion.blindness.id, 70, 3));
			e.setFire(5);
		}
	}
}
