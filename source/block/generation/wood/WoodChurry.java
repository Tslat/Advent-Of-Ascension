...
public class WoodChurry extends BlockLog {
	...
	public WoodChurry(final Material p_i45394_1_) {
	...
	public void registerBlockIcons(final IIconRegister icon) {
		top = icon.registerIcon("nevermine:woodChurryTop");
		bottom = top;
		side = icon.registerIcon("nevermine:woodChurry");
		blockIcon = icon.registerIcon("nevermine:woodChurry");
	}
}
