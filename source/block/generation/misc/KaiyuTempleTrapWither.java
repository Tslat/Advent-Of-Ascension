...
public class KaiyuTempleTrapWither extends Block {
	...
	public void entityInside(BlockState state, World world, BlockPos pos, Entity entity) {
		if (entity instanceof PlayerEntity && !((PlayerEntity)entity).isCreative())
			EntityUtil.applyPotions(entity, new PotionUtil.EffectBuilder(Effects.WITHER, 40).level(4).isAmbient(), new PotionUtil.EffectBuilder(Effects.MOVEMENT_SLOWDOWN, 40).level(4).isAmbient());
	}
}
