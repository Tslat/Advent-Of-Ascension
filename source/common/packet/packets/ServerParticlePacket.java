...
public class ServerParticlePacket implements AoAPacket {
	...
	public ServerParticlePacket particle(ParticleOptions particle, Entity entity, boolean randomPosInBB) {
		if (randomPosInBB) {
			return particle(particle, entity.getX() + RandomUtil.randomScaledGaussianValue(entity.getBbWidth()), entity.getY() + RandomUtil.randomValueUpTo(entity.getBbHeight()), entity.getZ() + RandomUtil.randomValueUpTo(entity.getBbWidth()));
		}
		else {
