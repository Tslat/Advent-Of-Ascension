...
import net.tslat.aoa3.entity.animal.*;
import net.tslat.aoa3.entity.boss.*;
import net.tslat.aoa3.entity.minion.*;
import net.tslat.aoa3.entity.misc.*;
import net.tslat.aoa3.entity.misc.pixon.*;
import net.tslat.aoa3.entity.mob.abyss.*;
import net.tslat.aoa3.entity.mob.barathos.*;
import net.tslat.aoa3.entity.mob.candyland.*;
import net.tslat.aoa3.entity.mob.celeve.*;
import net.tslat.aoa3.entity.mob.creeponia.*;
import net.tslat.aoa3.entity.mob.crystevia.*;
import net.tslat.aoa3.entity.mob.deeplands.*;
import net.tslat.aoa3.entity.mob.dustopia.*;
...
import net.tslat.aoa3.entity.mob.lunalus.*;
import net.tslat.aoa3.entity.mob.misc.*;
import net.tslat.aoa3.entity.mob.mysterium.*;
import net.tslat.aoa3.entity.mob.nether.*;
import net.tslat.aoa3.entity.mob.overworld.*;
import net.tslat.aoa3.entity.mob.overworld.bigday.*;
import net.tslat.aoa3.entity.mob.overworld.bloodhunt.AnemiaEntity;
import net.tslat.aoa3.entity.mob.overworld.bloodhunt.BloodmistEntity;
import net.tslat.aoa3.entity.mob.overworld.bloodhunt.LingerEntity;
import net.tslat.aoa3.entity.mob.overworld.creepday.HostEntity;
import net.tslat.aoa3.entity.mob.overworld.deathday.DeathHunterEntity;
import net.tslat.aoa3.entity.mob.overworld.deathday.HeadlessDestroyerEntity;
import net.tslat.aoa3.entity.mob.overworld.deathday.ReaperTwinsEntity;
import net.tslat.aoa3.entity.mob.overworld.deathday.TriclopsEntity;
import net.tslat.aoa3.entity.mob.overworld.fullmoon.*;
import net.tslat.aoa3.entity.mob.overworld.lunarinvasion.*;
import net.tslat.aoa3.entity.mob.overworld.soulscurry.*;
import net.tslat.aoa3.entity.mob.precasia.*;
import net.tslat.aoa3.entity.mob.runandor.*;
import net.tslat.aoa3.entity.mob.runandor.templars.*;
import net.tslat.aoa3.entity.mob.shyrelands.*;
import net.tslat.aoa3.entity.mob.voxponds.*;
import net.tslat.aoa3.entity.npc.ambient.*;
import net.tslat.aoa3.entity.npc.banker.*;
import net.tslat.aoa3.entity.npc.lottoman.*;
import net.tslat.aoa3.entity.npc.skillmaster.*;
import net.tslat.aoa3.entity.npc.trader.*;
...
import net.tslat.aoa3.entity.projectile.misc.*;
...
import net.tslat.aoa3.entity.tablet.*;
...
public final class AoAEntities {
	...
	public static void initializeAllRegisters(IEventBus bus) {
		SPAWN_EGGS.register(bus);
		Mobs.MOBS.register(bus);
		Animals.ANIMALS.register(bus);
		NPCs.NPCS.register(bus);
		Misc.MISC.register(bus);
		Minions.MINIONS.register(bus);
		Projectiles.PROJECTILES.register(bus);
	}
	...
	public static class Mobs {
		...
		public static final RegistryObject<EntityType<MonsterEntity>> AMPHIBIOR = registerMob("amphibior", AmphibiorEntity::new, 0.625f, 2.1875f, 6026738, 16757504);
		public static final RegistryObject<EntityType<MonsterEntity>> AMPHIBIYTE = registerMob("amphibiyte", AmphibiyteEntity::new, 0.95f, 1.25f, 5140613, 16744695);
		...
		public static final RegistryObject<EntityType<FlyingEntity>> ANGELICA = registerMob("angelica", AngelicaEntity::new, 0.6f, 2f, 3579029, 13290663);
		public static final RegistryObject<EntityType<MonsterEntity>> ANGLER = registerMob("angler", AnglerEntity::new, 0.75f, 1.1875f, 5667476, 8604807);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> ARCBEAST = registerMob("arcbeast", ArcbeastEntity::new, 0.75f, 1.375f, 13886315, 14869466);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> AUTOMATON = registerMob("automaton", AutomatonEntity::new, 1.125f, 2.125f, 0, 16777215);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> BLACK_URSA = registerMob("black_ursa", BlackUrsaEntity::new, 1.3f, 1.6f, 4341560, 8026227);
		public static final RegistryObject<EntityType<MonsterEntity>> BLOODMIST = registerMob("bloodmist", BloodmistEntity::new, 0.8f, 1.2f, 11740453, 14577519);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> BONE_CREATURE = registerMob("bone_creature", BoneCreatureEntity::new, 1.0f, 1.6f, 15132390, 13617352);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> BONEBACK = registerMob("boneback", BonebackEntity::new, 0.5625f, 1f, 6182726, 3052700);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> BRUTE = registerMob("brute", BruteEntity::new, 0.75f, 2.2f, 6904102, 8420984);
		public static final RegistryObject<EntityType<MonsterEntity>> BUGEYE = registerMob("bugeye", BugeyeEntity::new, 0.95f, 1.125f, 992269, 7243115);
		public static final RegistryObject<EntityType<MonsterEntity>> BUSH_BABY = registerMob("bush_baby", BushBabyEntity::new, 0.85f, 0.9f, 7243115, 5721387);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> CHERRY_BARRAGER = registerMob("cherry_barrager", CherryBarragerEntity::new, 1f, 1.4375f, 14032414, 7374678);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> CHOMPER = registerMob("chomper", ChomperEntity::new, 0.8f, 1.375f, 4479279, 2043409);
		public static final RegistryObject<EntityType<MonsterEntity>> CLOWN = registerMob("clown", ClownEntity::new, 0.5f, 2f, 5376265, 14597565);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> CONIFERON = registerMob("coniferon", ConiferonEntity::new, 1.5f, 6.375f, 2694151, 1452309);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> CORALON = registerMob("coralon", CoralonEntity::new, 0.75f, 1.375f, 32221, 16120064);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> DICER = registerMob("dicer", DicerEntity::new, 1.5f, 2.375f, 2500408, 16529978);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> EEO = registerMob("eeo", EeoEntity::new, 0.375f, 1.25f, 15921906, 5155053);
		public static final RegistryObject<EntityType<MonsterEntity>> EILOSAPIEN = registerMob("eilosapien", EilosapienEntity::new, 0.5f, 1.875f, 1810557, 13706193);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> EXOID = registerMob("exoid", ExoidEntity::new, 0.5625f, 2.3125f, 1184278, 10370108);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> EYE_CREATURE = registerMob("eye_creature", EyeCreatureEntity::new, 1.2f, 1.9375f, 4486586, 4172457);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> FACELESS_RUNNER = registerMob("faceless_runner", FacelessRunnerEntity::new, 1.0f, 1.315f, 5322600, 8210052);
		public static final RegistryObject<EntityType<MonsterEntity>> FAKE_ZOMBIE_PIGMAN = registerMob("fake_zombie_pigman", FakeZombiePigmanEntity::new, true, 0.6f, 1.95f, 10174865, 2911049);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> FISCHER = registerMob("fischer", FischerEntity::new, 0.75f, 1.0f, 3156005, 11349293);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> GHOSTINE_ANCIENT = registerMob("ghostine_ancient", GhostineAncientEntity::new, 0.9f, 2.1f, 11719412, 10340338);
		public static final RegistryObject<EntityType<MonsterEntity>> GHOSTLY_BUGEYE = registerMob("ghostly_bugeye", GhostlyBugeyeEntity::new, 0.9f, 1.125f, 12572655, 9213871);
		public static final RegistryObject<EntityType<MonsterEntity>> GHOSTLY_CHARGER = registerMob("ghostly_charger", GhostlyChargerEntity::new, 0.625f, 1.5f, 12572655, 8556461);
		public static final RegistryObject<EntityType<MonsterEntity>> GHOSTLY_CYCLOPS = registerMob("ghostly_cyclops", GhostlyCyclopsEntity::new, 0.6f, 2.25f, 12572655, 8227493);
		public static final RegistryObject<EntityType<MonsterEntity>> GHOSTLY_GOBLIN = registerMob("ghostly_goblin", GhostlyGoblinEntity::new, 0.6f, 1.8f, 12572655, 9149111);
		public static final RegistryObject<EntityType<MonsterEntity>> GHOSTLY_NIGHT_REAPER = registerMob("ghostly_night_reaper", GhostlyNightReaperEntity::new, 1f, 2.375f, 12572655, 7312324);
		public static final RegistryObject<EntityType<MonsterEntity>> GHOSTLY_SASQUATCH = registerMob("ghostly_sasquatch", GhostlySasquatchEntity::new, 0.6f, 2f, 12572655, 8757185);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> GOLDORTH = registerMob("goldorth", GoldorthEntity::new, 2f, 3f, 5657109, 8659233);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> GROCCULATE = registerMob("grocculate", GrocculateEntity::new, 1.5f, 3.5f, 1124377, 1845268);
		public static final RegistryObject<EntityType<MonsterEntity>> GRUNT = registerMob("grunt", GruntEntity::new, 1.0f, 1.375f, 2638869, 4009744);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> HEADLESS_DESTROYER = registerMob("headless_destroyer", HeadlessDestroyerEntity::new, 1.2f, 1.9f, 7341574, 8681335);
		public static final RegistryObject<EntityType<MonsterEntity>> HEADLESS_HUNTER = registerMob("headless_hunter", HeadlessHunterEntity::new, 1.2f, 1.9f, 7168353, 1644568);
		public static final RegistryObject<EntityType<MonsterEntity>> HELLCAT = registerMob("hellcat", HellcatEntity::new, true, 1.7f, 2.1875f, 11690766, 2824195);
		public static final RegistryObject<EntityType<MonsterEntity>> HELLSPOT = registerMob("hellspot", HellspotEntity::new, true, 0.97f, 1.2f, 13832204, 3676183);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> HORON = registerMob("horon", HoronEntity::new, 1.5f, 2.6875f, 9865773, 12039325);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> HUNCH = registerMob("hunch", HunchEntity::new, 0.6f, 1.4375f, 7370943, 1710883);
		...
		public static final RegistryObject<EntityType<HydroliskEntity>> HYDROLISK = registerMob("hydrolisk", HydroliskEntity::new, 1.9f, 3f, 2956372, 5315355);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> IRKLING = registerMob("irkling", IrklingEntity::new, 0.8f, 1.6875f, 5935451, 12175801);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> KROR = registerMob("kror", KrorEntity::new, 2.2f, 4f, 8488834, 13620176);
		public static final RegistryObject<EntityType<MonsterEntity>> LEAFY_GIANT = registerMob("leafy_giant", LeafyGiantEntity::new, 1.125f, 6.5f, 149780, 3153154);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> LINGER = registerMob("linger", LingerEntity::new, 1.2f, 1.0625f, 12325394, 4791324);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> MAGICKE = registerMob("magicke", MagickeEntity::new, 0.6f, 2.1875f, 1765349, 12112335);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> MERMAGE = registerMob("mermage", MermageEntity::new, 0.6f, 2.125f, 262786, 1756891);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> MUCKOPEDE = registerMob("muckopede", MuckopedeEntity::new, 1.3f, 0.85f, 9338466, 6709851);
		public static final RegistryObject<EntityType<MonsterEntity>> MUNCHER = registerMob("muncher", MuncherEntity::new, 1.0f, 2.0625f, 660405, 10430127);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> NATURA = registerMob("natura", NaturaEntity::new, 0.8f, 1.6875f, 288273, 946815);
		public static final RegistryObject<EntityType<MonsterEntity>> NEPTUNO = registerMob("neptuno", NeptunoEntity::new, 0.75f, 2f, 533611, 1582407);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> NIGHT_REAPER = registerMob("night_reaper", NightReaperEntity::new, 0.9f, 2.4f, 1117453, 11975851);
		public static final RegistryObject<EntityType<MonsterEntity>> NIGHT_WATCHER = registerMob("night_watcher", NightWatcherEntity::new, 0.6f, 2.7f, 723977, 592898);
		public static final RegistryObject<EntityType<FlyingEntity>> NIGHTFLY = registerMob("nightfly", NightflyEntity::new, 1.0f, 1.0f, 1315859, 12566398);
		...
		public static final RegistryObject<EntityType<FlyingEntity>> OMNILIGHT = registerMob("omnilight", OmnilightEntity::new, 0.9f, 0.9f, 14540080, 12566365);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> ORBITER = registerMob("orbiter", OrbiterEntity::new, 0.5625f, 2.5f, 973549, 16776960);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> PENUMBRA = registerMob("penumbra", PenumbraEntity::new, 0.9f, 3.1875f, 5317906, 11473937);
		public static final RegistryObject<EntityType<MonsterEntity>> PHANTOM = registerMob("phantom", PhantomEntity::new, 0.6f, 2.0f, 4786795, 6048870);
		public static final RegistryObject<EntityType<MonsterEntity>> PIGOTRON = registerMob("pigotron", PigotronEntity::new, true, 0.875f, 2.25f, 12850616, 1195290);
		public static final RegistryObject<EntityType<MonsterEntity>> PINCHER = registerMob("pincher", PincherEntity::new, 1f, 0.75f, 467791, 1296854);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> POLAR_URSA = registerMob("polar_ursa", PolarUrsaEntity::new, 1.4f, 1.5f, 14346986, 10998483);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> QUICKPOCKET = registerMob("quickpocket", QuickpocketEntity::new, 0.375f, 1.25f, 1580567, 4130567);
		public static final RegistryObject<EntityType<MonsterEntity>> RAINICORN = registerMob("rainicorn", RainicornEntity::new, 1.4f, 1.3125f, 15066083, 7836541);
		public static final RegistryObject<EntityType<MonsterEntity>> RAMMERHEAD = registerMob("rammerhead", RammerheadEntity::new, 1.5f, 1.875f, 4473924, 15921135);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> REAPER_TWINS = registerMob("reaper_twins", ReaperTwinsEntity::new, 1.2f, 2.375f, 8024365, 1447440);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> ROLOSCOPE = registerMob("roloscope", RoloscopeEntity::new, 1.2f, 1.0625f, 4478340, 12041417);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> SAND_GIANT = registerMob("sand_giant", SandGiantEntity::new, 1.125f, 6.5f, 12695722, 16246218);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> SEA_SKELETON = registerMob("sea_skeleton", SeaSkeletonEntity::new, 0.55f, 2.03125f, 1612512, 552828);
		public static final RegistryObject<EntityType<MonsterEntity>> SEA_SPIDER = registerMob("sea_spider", SeaSpiderEntity::new, 1.4f, 0.8125f, 1115030, 4272621);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> SEA_VIPER = registerMob("sea_viper", SeaViperEntity::new, 1.2f, 0.6875f, 1357029, 7710903);
		public static final RegistryObject<EntityType<FlyingEntity>> SEEKER = registerMob("seeker", SeekerEntity::new, 0.75f, 1.25f, 14738782, 15461809);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> SHYRE_TROLL = registerMob("shyre_troll", ShyreTrollEntity::new, 0.6f, 1.8f, 15263760, 408936);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> SILVERFOOT = registerMob("silverfoot", SilverfootEntity::new, 1.1f, 2.5f, 2301720, 12235169);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> SKELLOX = registerMob("skellox", SkelloxEntity::new, 1.0f, 2.25f, 2958092, 11183773);
		public static final RegistryObject<EntityType<MonsterEntity>> SKIPPER = registerMob("skipper", SkipperEntity::new, 1.0f, 0.4375f, 9742445, 13168000);
		public static final RegistryObject<EntityType<MonsterEntity>> SKOLLE = registerMob("skolle", SkolleEntity::new, 1.0f, 1.4375f, 3680010, 13873788);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> SPINUX = registerMob("spinux", SpinuxEntity::new, 0.6f, 2f, 3239057, 6592954);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> STALKER_PRIME = registerMob("stalker_prime", StalkerPrimeEntity::new, 0.6f, 2.5f, 131329, 2499877);
		...
		public static final RegistryObject<EntityType<FlyingEntity>> STINGER = registerMob("stinger", StingerEntity::new, 0.8f, 0.8f, 2825223, 3526170);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> STONE_GIANT = registerMob("stone_giant", StoneGiantEntity::new, 1.125f, 6.5f, 10181528, 10185496);
		...
		public static final RegistryObject<EntityType<FlyingEntity>> SURVEYOR = registerMob("surveyor", SurveyorEntity::new, 1.375f, 2.3f, 1366801, 1448214);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> SYSKER = registerMob("sysker", SyskerEntity::new, 0.6f, 1.40625f, 14941189, 653789);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> URKA = registerMob("urka", UrkaEntity::new, 1.2f, 1.5f, 1644569, 15987444);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> VERTEBRON = registerMob("vertebron", VertebronEntity::new, 0.6f, 2.1875f, 4485706, 979500);
		...
		public static final RegistryObject<EntityType<FlyingEntity>> VISULAR = registerMob("visular", VisularEntity::new, 0.625f, 1.75f, 15994093, 12655548);
		public static final RegistryObject<EntityType<FlyingEntity>> VISULON = registerMob("visulon", VisulonEntity::new, 1.5f, 2.625f, 15863530, 15351009);
		...
		public static final RegistryObject<EntityType<FlyingEntity>> VOLAR = registerMob("volar", VolarEntity::new, 0.75f, 0.9375f, 1477341, 4096951);
		public static final RegistryObject<EntityType<FlyingEntity>> VOLIANT = registerMob("voliant", VoliantEntity::new, 3.5f, 4.75f, 811936, 4096951);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> WALKER = registerMob("walker", WalkerEntity::new, true, 0.6f, 1.9375f, 14839305, 6251357);
		public static final RegistryObject<EntityType<MonsterEntity>> WARCLOPS = registerMob("warclops", WarclopsEntity::new, 0.6f, 2.125f, 1977608, 3290412);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> WICKETT = registerMob("wickett", WickettEntity::new, 1.0f, 1.125f, 2170398, 3815480);
		...
		public static final RegistryObject<EntityType<MonsterEntity>> WITHER_WIZARD = registerMob("wither_wizard", WitherWizardEntity::new, 0.6f, 2.5f, 659209, 4145726);
		public static final RegistryObject<EntityType<MonsterEntity>> WOOD_GIANT = registerMob("wood_giant", WoodGiantEntity::new, 1.125f, 6.5f, 2957061, 731907);
		...
		private static <T extends Entity> RegistryObject<EntityType<T>> registerMob(String registryName, EntityType.IFactory<T> factory, boolean fireImmune, float width, float height, int primaryEggColour, int secondaryEggColour) {
			EntityType.Builder<T> typeBuilder = EntityType.Builder.create(factory, EntityClassification.MONSTER).size(width, height);

			if (fireImmune)
				typeBuilder.immuneToFire();

			EntityType<T> entityType = typeBuilder.build(registryName);

			if (primaryEggColour != -1)
				SPAWN_EGGS.register(registryName + "_spawn_egg", () -> new SpawnEggItem(entityType, primaryEggColour, secondaryEggColour, new Item.Properties().group(ItemGroup.MISC)));

			return MOBS.register(registryName, () -> entityType);
		}
	}
	...
	public static class Animals {
		...
		public static final RegistryObject<EntityType<AnimalEntity>> CORATEE = registerAnimal("coratee", CorateeEntity::new, 1.2f, 1.375f, 40623, 7236);
		...
		private static <T extends Entity> RegistryObject<EntityType<T>> registerAnimal(String registryName, EntityType.IFactory<T> factory, float width, float height, int primaryEggColour, int secondaryEggColour) {
			return registerAnimal(registryName, factory, EntityClassification.CREATURE, false, width, height, primaryEggColour, secondaryEggColour);
		}
		...
		private static <T extends Entity> RegistryObject<EntityType<T>> registerAnimal(String registryName, EntityType.IFactory<T> factory, EntityClassification classification, float width, float height, int primaryEggColour, int secondaryEggColour) {
			return registerAnimal(registryName, factory, classification, false, width, height, primaryEggColour, secondaryEggColour);
		}

		private static <T extends Entity> RegistryObject<EntityType<T>> registerAnimal(String registryName, EntityType.IFactory<T> factory, EntityClassification classification, boolean fireImmune, float width, float height, int primaryEggColour, int secondaryEggColour) {
			EntityType.Builder<T> typeBuilder = EntityType.Builder.create(factory, classification).size(width, height);
			...
			return ANIMALS.register(registryName, () -> entityType);
		}
	}
	...
	public static class NPCs {
		...
		public static final RegistryObject<EntityType<CreatureEntity>> ABYSSAL_LOTTOMAN = registerNPC("abyssal_lottoman", AbyssalLottomanEntity::new, 0.5625f, 2.0f, 15994121, 15917022);
		public static final RegistryObject<EntityType<CreatureEntity>> BARON_LOTTOMAN = registerNPC("baron_lottoman", BaronLottomanEntity::new, 0.5625f, 2.0f, 15394263, 12029839);
		public static final RegistryObject<EntityType<CreatureEntity>> BOREIC_LOTTOMAN = registerNPC("boreic_lottoman", BoreicLottomanEntity::new, 0.5625f, 2.0f, 1103858, 14017509);
		public static final RegistryObject<EntityType<CreatureEntity>> CANDIED_LOTTOMAN = registerNPC("candied_lottoman", CandiedLottomanEntity::new, 0.5625f, 2.0f, 11538661, 15062506);
		public static final RegistryObject<EntityType<CreatureEntity>> CELEVIAN_LOTTOMAN = registerNPC("celevian_lottoman", CelevianLottomanEntity::new, 0.5625f, 2.0f, 14807784, 10671799);
		public static final RegistryObject<EntityType<CreatureEntity>> CREEPONIA_LOTTOMAN = registerNPC("creeponia_lottoman", CreeponiaLottomanEntity::new, 0.5625f, 2.0f, 668938, 855821);
		public static final RegistryObject<EntityType<CreatureEntity>> CRYSTAL_LOTTOMAN = registerNPC("crystal_lottoman", CrystalLottomanEntity::new, 0.5625f, 2.0f, 13097927, 1814501);
		public static final RegistryObject<EntityType<CreatureEntity>> DUSTOPIAN_LOTTOMAN = registerNPC("dustopian_lottoman", DustopianLottomanEntity::new, 0.5625f, 2.0f, 15065045, 4012857);
		public static final RegistryObject<EntityType<CreatureEntity>> FLORO_LOTTOMAN = registerNPC("floro_lottoman", FloroLottomanEntity::new, 0.5625f, 2.0f, 16250098, 862212);
		public static final RegistryObject<EntityType<CreatureEntity>> GOLDEN_LOTTOMAN = registerNPC("golden_lottoman", GoldenLottomanEntity::new, 0.5625f, 2.0f, 16051179, 986638);
		public static final RegistryObject<EntityType<CreatureEntity>> HAUNTED_LOTTOMAN = registerNPC("haunted_lottoman", HauntedLottomanEntity::new, 0.5625f, 2.0f, 6430178, 16052983);
		public static final RegistryObject<EntityType<CreatureEntity>> LELYETIAN_LOTTOMAN = registerNPC("lelyetian_lottoman", LelyetianLottomanEntity::new, 0.5625f, 2.0f, 16052459, 10509836);
		public static final RegistryObject<EntityType<CreatureEntity>> LOTTOMAN = registerNPC("lottoman", LottomanEntity::new, 0.5625f, 2.0f, 15723491, 789515);
		public static final RegistryObject<EntityType<CreatureEntity>> LUNAR_LOTTOMAN = registerNPC("lunar_lottoman", LunarLottomanEntity::new, 0.5625f, 2.0f, 11034029, 12169914);
		public static final RegistryObject<EntityType<CreatureEntity>> MYSTIC_LOTTOMAN = registerNPC("mystic_lottoman", MysticLottomanEntity::new, 0.5625f, 2.0f, 15722738, 1238360);
		public static final RegistryObject<EntityType<CreatureEntity>> PRECASIAN_LOTTOMAN = registerNPC("precasian_lottoman", PrecasianLottomanEntity::new, 0.5625f, 2.0f, 1330186, 15528682);
		public static final RegistryObject<EntityType<CreatureEntity>> ROCKY_LOTTOMAN = registerNPC("rocky_lottoman", RockyLottomanEntity::new, 0.5625f, 2.0f, 15131631, 2763053);
		public static final RegistryObject<EntityType<CreatureEntity>> RUNIC_LOTTOMAN = registerNPC("runic_lottoman", RunicLottomanEntity::new, 0.5625f, 2.0f, 1007835, 14804717);
		public static final RegistryObject<EntityType<CreatureEntity>> SHYRELANDS_LOTTOMAN = registerNPC("shyrelands_lottoman", ShyrelandsLottomanEntity::new, 0.5625f, 2.0f, 14871822, 15395550);
		public static final RegistryObject<EntityType<CreatureEntity>> TOXIC_LOTTOMAN = registerNPC("toxic_lottoman", ToxicLottomanEntity::new, 0.5625f, 2.0f, 479494, 9081226);
		public static final RegistryObject<EntityType<CreatureEntity>> TWINKLING_LOTTOMAN = registerNPC("twinkling_lottoman", TwinklingLottomanEntity::new, 0.5625f, 2.0f, 839991, 13360079);
		public static final RegistryObject<EntityType<CreatureEntity>> WITHERING_LOTTOMAN = registerNPC("withering_lottoman", WitheringLottomanEntity::new, 0.5625f, 2.0f, 15594735, 2698026);

		public static final RegistryObject<EntityType<CreatureEntity>> ANIMA_MASTER = registerNPC("anima_master", AnimaMasterEntity::new, 0.5625f, 2.0f, 639471, 8445943);
		public static final RegistryObject<EntityType<CreatureEntity>> AUGURY_MASTER = registerNPC("augury_master", AuguryMasterEntity::new, 0.5625f, 2.0f, 13882169, 4470027);
		public static final RegistryObject<EntityType<CreatureEntity>> BUTCHERY_MASTER = registerNPC("butchery_master", ButcheryMasterEntity::new, 0.5625f, 2.0f, 15667987, 7014151);
		public static final RegistryObject<EntityType<CreatureEntity>> CREATION_MASTER = registerNPC("creation_master", CreationMasterEntity::new, 0.5625f, 2.0f, 2360660, 5724933);
		public static final RegistryObject<EntityType<CreatureEntity>> EXPEDITION_MASTER = registerNPC("expedition_master", ExpeditionMasterEntity::new, 0.5625f, 2.0f, 1164512, 15134962);
		public static final RegistryObject<EntityType<CreatureEntity>> EXTRACTION_MASTER = registerNPC("extraction_master", ExtractionMasterEntity::new, 0.5625f, 2.0f, 16031758, 2499876);
		public static final RegistryObject<EntityType<CreatureEntity>> FORAGING_MASTER = registerNPC("foraging_master", ForagingMasterEntity::new, 0.5625f, 2.0f, 16053260, 1842202);
		public static final RegistryObject<EntityType<CreatureEntity>> HAULING_MASTER = registerNPC("hauling_master", HaulingMasterEntity::new, 0.5625f, 2.0f, 979188, 8346895);
		public static final RegistryObject<EntityType<CreatureEntity>> HUNTER_MASTER = registerNPC("hunter_master", HunterMasterEntity::new, 0.5625f, 2.0f, 15864334, 848943);
		public static final RegistryObject<EntityType<CreatureEntity>> INFUSION_MASTER = registerNPC("infusion_master", InfusionMasterEntity::new, 0.5625f, 2.0f, 782319, 9442287);
		public static final RegistryObject<EntityType<CreatureEntity>> INNERVATION_MASTER = registerNPC("innervation_master", InnervationMasterEntity::new, 0.5625f, 2.0f, 15537429, 5523514);
		public static final RegistryObject<EntityType<CreatureEntity>> LOGGING_MASTER = registerNPC("logging_master", LoggingMasterEntity::new, 0.5625f, 2.0f, 2879253, 7364669);
		public static final RegistryObject<EntityType<CreatureEntity>> RUNATION_MASTER = registerNPC("runation_master", RunationMasterEntity::new, 0.5625f, 2.0f, 1108561, 5195834);

		public static final RegistryObject<EntityType<CreatureEntity>> ASSASSIN = registerNPC("assassin", AssassinEntity::new, 0.5625f, 2.0f, 5638000, 5393748);
		...
		public static final RegistryObject<EntityType<CreatureEntity>> CRYSTAL_TRADER = registerNPC("crystal_trader", CrystalTraderEntity::new, 0.5625f, 2.0f, 14150368, 1369392);
		public static final RegistryObject<EntityType<CreatureEntity>> DUNGEON_KEEPER = registerNPC("dungeon_keeper", DungeonKeeperEntity::new, 0.5625f, 2.0f, 3157507, 2825476);
		public static final RegistryObject<EntityType<CreatureEntity>> EXPLOSIVES_EXPERT = registerNPC("explosives_expert", ExplosivesExpertEntity::new, 0.5625f, 2.0f, 15864595, 16250871);
		public static final RegistryObject<EntityType<CreatureEntity>> GORB_ARMS_DEALER = registerNPC("gorb_arms_dealer", GorbArmsDealerEntity::new, 0.5625f, 1.6875f, 4990482, 14195479);
		public static final RegistryObject<EntityType<CreatureEntity>> GORB_ENGINEER = registerNPC("gorb_engineer", GorbEngineerEntity::new, 0.5625f, 1.6875f, 10032659, 14389134);
		public static final RegistryObject<EntityType<CreatureEntity>> LELYETIAN_TRADER = registerNPC("lelyetian_trader", LelyetianTraderEntity::new, 0.5625f, 2.0f, 14705940, 2955779);
		public static final RegistryObject<EntityType<CreatureEntity>> METALLOID = registerNPC("metalloid", MetalloidEntity::new, 0.5625f, 2.0f, 3677189, 7555455);
		public static final RegistryObject<EntityType<CreatureEntity>> NATURALIST = registerNPC("naturalist", NaturalistEntity::new, 0.5625f, 2.0f, 4927582, 10193420);
		public static final RegistryObject<EntityType<CreatureEntity>> PRIMORDIAL_MERCHANT = registerNPC("primordial_merchant", PrimordialMerchantEntity::new, 0.5625f, 2.0f, 909869, 1250835);
		public static final RegistryObject<EntityType<CreatureEntity>> PRIMORDIAL_SPELLBINDER = registerNPC("primordial_spellbinder", PrimordialSpellbinderEntity::new, 0.5625f, 2.0f, 1059237, 8097765);
		public static final RegistryObject<EntityType<CreatureEntity>> PRIMORDIAL_WIZARD = registerNPC("primordial_wizard", PrimordialWizardEntity::new, 0.5625f, 2.0f, 4000119, 13023446);
		public static final RegistryObject<EntityType<CreatureEntity>> PROFESSOR = registerNPC("professor", ProfessorEntity::new, 0.5625f, 2.0f, 13493531, 1644822);
		public static final RegistryObject<EntityType<CreatureEntity>> REALMSHIFTER = registerNPC("realmshifter", RealmshifterEntity::new, 0.5625f, 2.0f, 2953404, 1776158);
		public static final RegistryObject<EntityType<CreatureEntity>> SHYRE_ARCHER = registerNPC("shyre_archer", ShyreArcherEntity::new, 0.5625f, 2.0f, 14393873, 15397397);
		public static final RegistryObject<EntityType<CreatureEntity>> STORE_KEEPER = registerNPC("store_keeper", StoreKeeperEntity::new, 0.5625f, 2.0f, 2824965, 10530735);
		public static final RegistryObject<EntityType<CreatureEntity>> TOKEN_COLLECTOR = registerNPC("token_collector", TokenCollectorEntity::new, 0.5625f, 2.0f, 6840842, 13878796);
		public static final RegistryObject<EntityType<CreatureEntity>> TOY_MERCHANT = registerNPC("toy_merchant", ToyMerchantEntity::new, 0.5625f, 2.0f, 7821066, 14068552);
		public static final RegistryObject<EntityType<CreatureEntity>> TROLL_TRADER = registerNPC("troll_trader", TrollTraderEntity::new, 0.5625f, 1.8125f, 779757, 415293);
		public static final RegistryObject<EntityType<CreatureEntity>> UNDEAD_HERALD = registerNPC("undead_herald", UndeadHeraldEntity::new, 0.5625f, 2.0f, 592394, 1302514);
		public static final RegistryObject<EntityType<CreatureEntity>> ZAL_GROCER = registerNPC("zal_grocer", ZalGrocerEntity::new, 0.5625f, 1.875f, 2956551, 6315353);
		public static final RegistryObject<EntityType<CreatureEntity>> ZAL_HERBALIST = registerNPC("zal_herbalist", ZalHerbalistEntity::new, 0.5625f, 1.875f, 997382, 6315353);
		public static final RegistryObject<EntityType<CreatureEntity>> ZAL_SPELLBINDER = registerNPC("zal_spellbinder", ZalSpellbinderEntity::new, 0.5625f, 1.875f, 3475048, 6315353);
		public static final RegistryObject<EntityType<CreatureEntity>> ZAL_VENDOR = registerNPC("zal_vendor", ZalVendorEntity::new, 0.5625f, 1.875f, 4144703, 9933723);
		...
		private static <T extends Entity> RegistryObject<EntityType<T>> registerNPC(String registryName, EntityType.IFactory<T> factory, boolean fireImmune, float width, float height, int primaryEggColour, int secondaryEggColour) {
			...
			return NPCS.register(registryName, () -> entityType);
		}
	}
	...
	public static class Misc {
		...
		public static final RegistryObject<EntityType<AnimaStoneEntity>> ANIMA_STONE = registerMiscEntity("anima_stone", AnimaStoneEntity::new, true, 0.3f, 0.45f);
		public static final RegistryObject<EntityType<BloodlustEntity>> BLOODLUST = registerMiscEntity("bloodlust", BloodlustEntity::new, true, 0.5f, 0.5f);
		public static final RegistryObject<EntityType<GyrocopterEntity>> GYROCOPTER = registerMiscEntity("gyrocopter", GyrocopterEntity::new, 1.375f, 1.625f);
		public static final RegistryObject<EntityType<HeartStoneEntity>> HEART_STONE = registerMiscEntity("heart_stone", HeartStoneEntity::new, true, 0.3f, 0.45f);
		public static final RegistryObject<EntityType<ItemEntity>> BOSS_ITEM = registerMiscEntity("boss_item", BossItemEntity::new, 0.25f, 0.25f);
		public static final RegistryObject<EntityType<LottoTotemEntity>> LOTTO_TOTEM = registerMiscEntity("lotto_totem", LottoTotemEntity::new, true, 0.75f, 0.95f);
		public static final RegistryObject<EntityType<OccultBlockEntity>> OCCULT_BLOCK = registerMiscEntity("occult_block", OccultBlockEntity::new, true, 0.99f, 0.99f);
		public static final RegistryObject<EntityType<TNTEntity>> FAKE_TNT = registerMiscEntity("fake_tnt", FakeTntEntity::new, 1f, 1f);
		public static final RegistryObject<EntityType<BaronBombEntity>> BARON_BOMB = registerMiscEntity("baron_bomb", BaronBombEntity::new, 1f, 0.8125f);

		public static final RegistryObject<EntityType<MonsterEntity>> BANE_CLONE = registerMiscEntity("bane_clone", BaneCloneEntity::new, 0.75f, 2f);
		public static final RegistryObject<EntityType<MonsterEntity>> BIG_BANE_CLONE = registerMiscEntity("big_bane_clone", BigBaneCloneEntity::new, 1.2f, 3.9375f);
		...
		private static <T extends Entity> RegistryObject<EntityType<T>> registerMiscEntity(String registryName, EntityType.IFactory<T> factory, float width, float height) {
			return registerMiscEntity(registryName, factory, false, width, height);
		}

		private static <T extends Entity> RegistryObject<EntityType<T>> registerMiscEntity(String registryName, EntityType.IFactory<T> factory, boolean fireImmune, float width, float height) {
			EntityType.Builder<T> typeBuilder = EntityType.Builder.create(factory, EntityClassification.MISC).size(width, height).setTrackingRange(40).setUpdateInterval(1);

			if (fireImmune)
				typeBuilder.immuneToFire();

			return MISC.register(registryName, () -> typeBuilder.build(registryName));
		}
	}

	public static class Minions {
		public static final DeferredRegister<EntityType<?>> MINIONS = DeferredRegister.create(ForgeRegistries.ENTITIES, AdventOfAscension.MOD_ID);

		public static final RegistryObject<EntityType<TameableEntity>> ALLURICORN = registerMinion("alluricorn", AlluricornEntity::new, 1.1f, 2.0f, 14737517, 8684555);
		public static final RegistryObject<EntityType<TameableEntity>> BLISSARD = registerMinion("blissard", BlissardEntity::new, 0.6f, 1, 6662606, 15462900);
		public static final RegistryObject<EntityType<TameableEntity>> COMPEER = registerMinion("compeer", CompeerEntity::new, 0.65625f, 1.1875f, 1250582, 13424605);
		public static final RegistryObject<EntityType<TameableEntity>> CONSTRUCT_OF_SERVILITY = registerMinion("construct_of_servility", ConstructOfServilityEntity::new, 0.75f, 1.75f, 278281, 2371621);
		public static final RegistryObject<EntityType<TameableEntity>> CORBY = registerMinion("corby", CorbyEntity::new, 0.8f, 1.0625f, 630253, 14486998);
		public static final RegistryObject<EntityType<TameableEntity>> CRAGGY = registerMinion("craggy", CraggyEntity::new, 0.9f, 0.9375f, 15013009, 15563787);
		public static final RegistryObject<EntityType<TameableEntity>> DRAGGY = registerMinion("draggy", DraggyEntity::new, 0.9f, 0.9375f, 11605487, 14663917);
		public static final RegistryObject<EntityType<TameableEntity>> ENDER_CARRIER = registerMinion("ender_carrier", EnderCarrierEntity::new, 1.1f, 1.375f, 1447445, 8393957);
		public static final RegistryObject<EntityType<TameableEntity>> FRIENDLY_CREEPER = registerMinion("friendly_creeper", FriendlyCreeperEntity::new, 0.6f, 1.7f, 894731, 0);
		public static final RegistryObject<EntityType<TameableEntity>> GNAWER = registerMinion("gnawer", GnawerEntity::new, 0.625f, 2.5f, 3160086, 3882796);
		public static final RegistryObject<EntityType<TameableEntity>> GOOFER = registerMinion("goofer", GooferEntity::new, 1.25f, 1.375f, 15996691, 15053232);
		public static final RegistryObject<EntityType<TameableEntity>> HEALING_GOLEM = registerMinion("healing_golem", HealingGolemEntity::new, 1.25f, 2.125f, 5328976, 15665931);
		public static final RegistryObject<EntityType<TameableEntity>> HELLQUIN = registerMinion("hellquin", HellquinEntity::new, 0.5f, 1.25f, 1315603, 15337737);
		public static final RegistryObject<EntityType<TameableEntity>> HIVE_SOLDIER = registerMinion("hive_soldier", HiveSoldierEntity::new, 0.5625f, 1.75f, 12350388, 15259109);
		public static final RegistryObject<EntityType<TameableEntity>> HORNTAIL = registerMinion("horntail", HorntailEntity::new, 0.75f, 1.875f, 15063708, 15720333);
		public static final RegistryObject<EntityType<TameableEntity>> MECHA_CYCLOPS = registerMinion("mecha_cyclops", MechaCyclopsEntity::new, 0.5f, 2.25f, 11710995, 2500128);
		public static final RegistryObject<EntityType<TameableEntity>> MECHA_SKELLOX = registerMinion("mecha_skellox", MechaSkelloxEntity::new, 0.8f, 2.375f, 2500128, 11710995);
		public static final RegistryObject<EntityType<TameableEntity>> ORBLING = registerMinion("orbling", OrblingEntity::new, 1.0f, 1.0f, 16189423, 15582443);
		public static final RegistryObject<EntityType<TameableEntity>> PENGUIN = registerMinion("penguin", PenguinEntity::new, 0.5f, 1.25f, 857102, 16248822);
		public static final RegistryObject<EntityType<TameableEntity>> PLATEOSAUR = registerMinion("plateosaur", PlateosaurEntity::new, 1.0f, 1.25f, 5077436, 6649230);
		public static final RegistryObject<EntityType<TameableEntity>> RAMMERHORN = registerMinion("rammerhorn", RammerhornEntity::new, 0.95f, 1.0625f, 12281066, 4143128);
		public static final RegistryObject<EntityType<TameableEntity>> ROSID = registerMinion("rosid", RosidEntity::new, 0.5f, 0.875f, 14161122, 519461);
		public static final RegistryObject<EntityType<TameableEntity>> SHADDY = registerMinion("shaddy", ShaddyEntity::new, 0.9f, 0.9375f, 5987931, 14610398);
		public static final RegistryObject<EntityType<TameableEntity>> SHADOW_STALKER = registerMinion("shadow_stalker", ShadowStalkerEntity::new, 1.125f, 1.59375f, 2171681, 14807777);
		public static final RegistryObject<EntityType<TameableEntity>> SPIKEBACK = registerMinion("spikeback", SpikebackEntity::new, 1.0f, 1.0f, 2958082, 13881282);
		public static final RegistryObject<EntityType<TameableEntity>> SPRAGGY = registerMinion("spraggy", SpraggyEntity::new, 0.9f, 0.9375f, 5817443, 12509378);
		public static final RegistryObject<EntityType<TameableEntity>> WAGGY = registerMinion("waggy", WaggyEntity::new, 0.9f, 0.9375f, 6396660, 340855);


		private static <T extends Entity> RegistryObject<EntityType<T>> registerMinion(String registryName, EntityType.IFactory<T> factory, float width, float height, int primaryEggColour, int secondaryEggColour) {
			return registerMinion(registryName, factory, false, width, height, primaryEggColour, secondaryEggColour);
		}

		private static <T extends Entity> RegistryObject<EntityType<T>> registerMinion(String registryName, EntityType.IFactory<T> factory, boolean fireImmune, float width, float height, int primaryEggColour, int secondaryEggColour) {
			EntityType.Builder<T> typeBuilder = EntityType.Builder.create(factory, EntityClassification.CREATURE).size(width, height);
			...
			return MINIONS.register(registryName, () -> entityType);
		}
	}
	...
	public static class Projectiles {
		...
		public static final RegistryObject<EntityType<MagickeShotEntity>> MAGICKE_SHOT = registerProjectile("magicke_shot", MagickeShotEntity::new);
		...
		public static final RegistryObject<EntityType<PenumbraShotEntity>> PENUMBRA_SHOT = registerProjectile("penumbra_shot", PenumbraShotEntity::new);
		...
		public static final RegistryObject<EntityType<VolarShotEntity>> VOLAR_SHOT = registerProjectile("volar_shot", VolarShotEntity::new);
		...
		private static <T extends Entity> RegistryObject<EntityType<T>> registerProjectile(String registryName, EntityType.IFactory<T> factory, float width, float height) {
			EntityType.Builder<T> typeBuilder = EntityType.Builder.create(factory, EntityClassification.MISC).size(width, height).setTrackingRange(120).setUpdateInterval(20);

			return PROJECTILES.register(registryName, () -> typeBuilder.build(registryName));
		}
	}
}
