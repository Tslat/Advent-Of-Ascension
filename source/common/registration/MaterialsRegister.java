...
public class MaterialsRegister {
	...
	public static final ItemArmor.ArmorMaterial ARMOUR_CREATION 				= EnumHelper.addArmorMaterial("AOAARMOURCREATION", 			"aoa3:creation", 				65, new int[] {6, 7, 9, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 7); // Creation Master
