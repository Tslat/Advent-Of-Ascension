...
public class MaterialsRegister {
	...
	public static final Item.ToolMaterial SWORD_BLOODSTONE 		= EnumHelper.addToolMaterial("AOABLOODSTONE", 		4, 1800, 	4.0f, 	14.0f, 	16);
	...
	public static final Item.ToolMaterial SWORD_CRYSTALLITE 	= EnumHelper.addToolMaterial("AOACRYSTALLITE", 		4, 1700, 	4.0f, 	14.0f, 	10).setRepairItem(new ItemStack(ItemRegister.getUnmappedItem("crystallite")));
	...
	public static final Item.ToolMaterial TOOL_AMETHYST 		= EnumHelper.addToolMaterial("AOAAMETHYSTTOOL", 		3, 1200, 	8.0f, 		4.5f, 	14).setRepairItem(new ItemStack(ItemRegister.getUnmappedItem("amethyst")));
	public static final Item.ToolMaterial TOOL_CHAINSAW 		= EnumHelper.addToolMaterial("AOACHAINSAWTOOL", 		2, 2500, 	18.0f, 	4.0f, 	0);
	public static final Item.ToolMaterial TOOL_EMBERSTONE 		= EnumHelper.addToolMaterial("AOAEMBERSTONETOOL", 	5, 2000, 	10.0f, 	5.5f, 	10).setRepairItem(new ItemStack(ItemRegister.getUnmappedItem("emberstone_ingot")));
	...
	public static final Item.ToolMaterial TOOL_ORNAMYTE 		= EnumHelper.addToolMaterial("AOAORNAMYTETOOL", 		5, 2750, 	10.0f, 	6.0f, 	14);
	...
	public static final Item.ToolMaterial TOOL_SAPPHIRE 		= EnumHelper.addToolMaterial("AOASAPPHIRETOOL", 		4, 2500, 	9.0f, 		5.0f, 	19).setRepairItem(new ItemStack(ItemRegister.getUnmappedItem("sapphire")));
	public static final Item.ToolMaterial TOOL_SKELETAL 		= EnumHelper.addToolMaterial("AOASKELETALTOOL", 		5, 2000, 	10.0f, 	6.0f, 	10).setRepairItem(new ItemStack(ItemRegister.getUnmappedItem("skeletal_ingot")));
	...
	public static final ItemArmor.ArmorMaterial ARMOUR_CREATION 				= EnumHelper.addArmorMaterial("AOAARMOURCREATION", 			"aoa3:creation", 				65, new int[] {4, 9, 7, 6}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 7); // Creation Master
	...
	public static final ItemArmor.ArmorMaterial ARMOUR_ENGINEERING 				= EnumHelper.addArmorMaterial("AOAARMOURENGINEERING", 		"aoa3:engineering", 				65, new int[] {6, 7, 9, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 7); // Engineering Master
	...
	public static final ItemArmor.ArmorMaterial ARMOUR_NIGHT_VISION_GOGGLES 	= EnumHelper.addArmorMaterial("AOAARMOURNIGHTVISIONGOGGLES",	"aoa3:night_vision_goggles", 	27, new int[] {2, 2, 2, 2}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1); // Overworld | Crafting Recipe
