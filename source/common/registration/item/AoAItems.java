...
public final class AoAItems {
	...
	public static final RegistryObject<Item> EYE_BULB = registerItem("eye_bulb", () -> new ItemNameBlockItem(AoABlocks.EYE_BULB_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.4f).build())));
	...
	public static final RegistryObject<Item> MAGIC_MENDING_COMPOUND = registerItem("magic_mending_compound", () -> new TooltipItem(1, new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> MAGIC_REPAIR_DUST = registerItem("magic_repair_dust", () -> new TooltipItem(1, new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> TORN_PAGES = registerItem("torn_pages", TornPages::new);
	...
	public static final RegistryObject<Item> BALLOON = registerItem("balloon", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.AMMUNITION)));
	public static final RegistryObject<Item> CANNONBALL = registerItem("cannonball", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.AMMUNITION)));
	public static final RegistryObject<Item> DISCHARGE_CAPSULE = registerItem("discharge_capsule", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.AMMUNITION)));
	public static final RegistryObject<Item> LIMONITE_BULLET = registerItem("limonite_bullet", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.AMMUNITION)));
	public static final RegistryObject<Item> METAL_SLUG = registerItem("metal_slug", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.AMMUNITION)));
	public static final RegistryObject<Item> POP_SHOT = registerItem("pop_shot", () -> new ArrowItem(new Item.Properties().tab(AoACreativeModeTabs.AMMUNITION)));
	public static final RegistryObject<Item> SPREADSHOT = registerItem("spreadshot", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.AMMUNITION)));
	...
	public static final RegistryObject<Item> ANCIENT_RING = registerItem("ancient_ring", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> BONE_HORN = registerItem("bone_horn", miscItem()); // TODO
	public static final RegistryObject<Item> BOOK_OF_SHADOWS = registerItem("book_of_shadows", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> BOULDER_DASH = registerItem("boulder_dash", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> CALL_OF_THE_DRAKE = registerItem("call_of_the_drake", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> EXPLOSIVE_GEMS = registerItem("explosive_gems", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> EXPLOSIVE_IDOL = registerItem("explosive_idol", miscItem()); // TODO
	public static final RegistryObject<Item> GIANT_CRYSTAL = registerItem("giant_crystal", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> GOLD_SPRING = registerItem("gold_spring", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> GUARDIANS_EYE = registerItem("guardians_eye", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> APOCO_UPGRADE_KIT = registerItem("apoco_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> CLOWN_UPGRADE_KIT = registerItem("clown_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> DARKLY_UPGRADE_KIT = registerItem("darkly_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> FLORO_UPGRADE_KIT = registerItem("floro_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> FUNGAL_UPGRADE_KIT = registerItem("fungal_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> GOLDEN_UPGRADE_KIT = registerItem("golden_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> HAUNTED_UPGRADE_KIT = registerItem("haunted_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> LELYETIAN_UPGRADE_KIT = registerItem("lelyetian_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> LIGHT_UPGRADE_KIT = registerItem("light_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> LUNAR_UPGRADE_KIT = registerItem("lunar_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> NETHER_UPGRADE_KIT = registerItem("nether_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> PRECASIAN_UPGRADE_KIT = registerItem("precasian_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> PREDATOR_UPGRADE_KIT = registerItem("predator_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> ROCKY_UPGRADE_KIT = registerItem("rocky_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> SEASIDE_UPGRADE_KIT = registerItem("seaside_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> SMILEY_UPGRADE_KIT = registerItem("smiley_upgrade_kit", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS).rarity(Rarity.RARE)));

	public static final RegistryObject<Item> WATERLOGGED_AQUA_CANNON = registerItem("waterlogged_aqua_cannon", () -> new WaterloggedItem(AoAWeapons.AQUA_CANNON, new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> WATERLOGGED_CORAL_CANNON = registerItem("waterlogged_coral_cannon", () -> new WaterloggedItem(AoAWeapons.CORAL_CANNON, new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> WATERLOGGED_CORAL_CLOGGER = registerItem("waterlogged_coral_clogger", () -> new WaterloggedItem(AoAWeapons.CORAL_CLOGGER, new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> WATERLOGGED_CORAL_CROSSBOW = registerItem("waterlogged_coral_crossbow", () -> new WaterloggedItem(AoAWeapons.CORAL_CROSSBOW, new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> WATERLOGGED_REEFER = registerItem("waterlogged_reefer", () -> new WaterloggedItem(AoAWeapons.REEFER, new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> BLUE_GEMTRAP = registerItem("blue_gemtrap", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> CANDLEFISH = registerItem("candlefish", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> CHARRED_CHAR = registerItem("charred_char", CharredChar::new);
	public static final RegistryObject<Item> CHOCAW = registerItem("chocaw", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(6).saturationMod(0.65f).build())));
	public static final RegistryObject<Item> CRIMSON_SKIPPER = registerItem("crimson_skipper", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> CRIMSON_STRIPEFISH = registerItem("crimson_stripefish", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> DARK_HATCHETFISH = registerItem("dark_hatchetfish", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> GREEN_GEMTRAP = registerItem("green_gemtrap", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> HYDRONE = registerItem("hydrone", miscItem());
	public static final RegistryObject<Item> IRONBACK = registerItem("ironback", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> JAMFISH = registerItem("jamfish", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(5).saturationMod(0.5f).effect(() -> new EffectBuilder(MobEffects.MOVEMENT_SPEED, 600).build(), 1f).build())));
	public static final RegistryObject<Item> PARAPIRANHA = registerItem("parapiranha", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> PEARL_STRIPEFISH = registerItem("pearl_stripefish", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> PURPLE_GEMTRAP = registerItem("purple_gemtrap", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> RAZORFISH = registerItem("razorfish", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> RED_GEMTRAP = registerItem("red_gemtrap", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> REEFTOOTH = registerItem("reeftooth", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> ROCKETFISH = registerItem("rocketfish", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> SAILBACK = registerItem("sailback", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> SAPPHIRE_STRIDER = registerItem("sapphire_strider", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> SKELECANTH = registerItem("skelecanth", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(1).saturationMod(0.1f).build())));
	public static final RegistryObject<Item> WHITE_GEMTRAP = registerItem("white_gemtrap", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> YELLOW_GEMTRAP = registerItem("yellow_gemtrap", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> TURQUOISE_STRIPEFISH = registerItem("turquoise_stripefish", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> VIOLET_SKIPPER = registerItem("violet_skipper", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));

	public static final RegistryObject<Item> RAW_RAINBOWFISH = registerItem("raw_rainbowfish", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(3).saturationMod(0.85f).build())));
	public static final RegistryObject<Item> COOKED_RAINBOWFISH = registerItem("cooked_rainbowfish", () -> new HealingFood(5.0f, new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(6).saturationMod(0.85f).effect(() -> new EffectBuilder(MobEffects.LUCK, 600).build(), 1f).build())));

	public static final RegistryObject<Item> BUBBLE_BERRIES = registerItem("bubble_berries", BubbleBerries::new);
	public static final RegistryObject<Item> CANDY_CANE = registerItem("candy_cane", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(1).saturationMod(0.1f).build())));
	public static final RegistryObject<Item> CANDY_CORN = registerItem("candy_corn", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(1).saturationMod(0.22f).build())));
	public static final RegistryObject<Item> CHILLI = registerItem("chilli", Chilli::new);
	public static final RegistryObject<Item> RAW_CHARGER_SHANK = registerItem("raw_charger_shank", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).meat().build())));
	public static final RegistryObject<Item> COOKED_CHARGER_SHANK = registerItem("cooked_charger_shank", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(7).saturationMod(0.3f).meat().build())));
	public static final RegistryObject<Item> RAW_CHIMERA_CHOP = registerItem("raw_chimera_chop", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).meat().build())));
	public static final RegistryObject<Item> COOKED_CHIMERA_CHOP = registerItem("cooked_chimera_chop", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(6).saturationMod(0.6f).meat().build())));
	public static final RegistryObject<Item> RAW_FURLION_CHOP = registerItem("raw_furlion_chop", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).meat().build())));
	public static final RegistryObject<Item> COOKED_FURLION_CHOP = registerItem("cooked_furlion_chop", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(6).saturationMod(0.6f).meat().build())));
	public static final RegistryObject<Item> RAW_HALYCON_BEEF = registerItem("raw_halycon_beef", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.3f).meat().effect(() -> new EffectBuilder(MobEffects.CONFUSION, 150).build(), 1f).effect(() -> new EffectBuilder(MobEffects.POISON, 40).build(), 1f).build())));
	public static final RegistryObject<Item> COOKED_HALYCON_BEEF = registerItem("cooked_halycon_beef", () -> new TooltipItem(1, new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(7).saturationMod(0.7f).meat().effect(() -> new EffectBuilder(MobEffects.CONFUSION, 150).build(), 1f).build())));
	...
	public static final RegistryObject<Item> GINGERBREAD_COOKIE = registerItem("gingerbread_cookie", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.25f).build())));
	public static final RegistryObject<Item> GINGERBREAD_WING = registerItem("gingerbread_wing", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2f).build())));
	...
	public static final RegistryObject<Item> LUNA_GLOBE = registerItem("luna_globe", () -> new TooltipItem(1, new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(0).saturationMod(0).alwaysEat().effect(new EffectBuilder(MobEffects.INVISIBILITY, 120).build(), 1).build())));
	public static final RegistryObject<Item> LUNALONS = registerItem("lunalons", () -> new TooltipItem(1, new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(0).saturationMod(0).alwaysEat().effect(new EffectBuilder(MobEffects.NIGHT_VISION, 40).level(2).build(), 1).build())));
	public static final RegistryObject<Item> MAGIC_MARANG = registerItem("magic_marang", MagicMarang::new);
	public static final RegistryObject<Item> MYSTIC_SHROOMS = registerItem("mystic_shrooms", () -> new ItemNameBlockItem(AoABlocks.MYSTIC_SHROOM_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(2).saturationMod(0.4f).alwaysEat().build())));
	public static final RegistryObject<Item> NATURE_MELON_SLICE = registerItem("nature_melon_slice", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(1).saturationMod(0.4f).build())));
	public static final RegistryObject<Item> PEPPERMINT_CANDY = registerItem("peppermint_candy", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(1).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> ROSIDONS = registerItem("rosidons", Rosidons::new);
	public static final RegistryObject<Item> SOUR_CANDY = registerItem("sour_candy", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(1).saturationMod(0.15f).build())));
	public static final RegistryObject<Item> SOUR_GUMMY = registerItem("sour_gummy", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(1).saturationMod(0.3f).build())));
	public static final RegistryObject<Item> SOUR_POP = registerItem("sour_pop", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(1).saturationMod(0.18f).build())));
	public static final RegistryObject<Item> SPEARMINT_CANDY = registerItem("spearmint_candy", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(1).saturationMod(0.25f).build())));
	...
	public static final RegistryObject<Item> COOKED_FISH = registerItem("cooked_fish", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(6).saturationMod(0.85F).effect(() -> new EffectBuilder(MobEffects.CONDUIT_POWER, 600).build(), 1f).build())));
	public static final RegistryObject<Item> CHUM = registerItem("chum", ChumItem::new);
	public static final RegistryObject<Item> CHUM_BURGER = registerItem("chum_burger", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(9).saturationMod(0.85F).effect(() -> new EffectBuilder(MobEffects.CONFUSION, 80).build(), 1f).build())));
	public static final RegistryObject<Item> CHUM_AND_SALAD_BURGER = registerItem("chum_and_salad_burger", () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.FOOD).food(new FoodProperties.Builder().nutrition(12).saturationMod(0.9F).effect(() -> new EffectBuilder(MobEffects.CONFUSION, 80).build(), 1f).build())));

	public static final RegistryObject<Item> BUBBLE_BERRY_SEEDS = registerItem("bubble_berry_seeds", () -> new ItemNameBlockItem(AoABlocks.BUBBLE_BERRY_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> CHILLI_SEEDS = registerItem("chilli_seeds", () -> new ItemNameBlockItem(AoABlocks.CHILLI_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> FLORACLE_SEEDS = registerItem("floracle_seeds", () -> new ItemNameBlockItem(AoABlocks.FLORACLES_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> GOLDICAP_SEEDS = registerItem("goldicap_seeds", () -> new ItemNameBlockItem(AoABlocks.GOLDICAPS_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> HEART_FRUIT_SEEDS = registerItem("heart_fruit_seeds", () -> new ItemNameBlockItem(AoABlocks.HEART_FRUIT_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> LUNACRIKE_SEEDS = registerItem("lunacrike_seeds", () -> new ItemNameBlockItem(AoABlocks.LUNACRIKE_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> LUNALON_SEEDS = registerItem("lunalon_seeds", () -> new ItemNameBlockItem(AoABlocks.LUNALON_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> LUNA_GLOBE_SEEDS = registerItem("luna_globe_seeds", () -> new ItemNameBlockItem(AoABlocks.LUNA_GLOBE_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> ROSIDON_SEEDS = registerItem("rosidon_seeds", () -> new ItemNameBlockItem(AoABlocks.ROSIDON_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> TEA_SEEDS = registerItem("tea_seeds", () -> new ItemNameBlockItem(AoABlocks.TEA_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> THORNY_PLANT_SEEDS = registerItem("thorny_plant_seeds", () -> new ItemNameBlockItem(AoABlocks.THORNY_PLANT_CROP.get(), new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> ENERGY_RUNE_BANNER_PATTERN = registerItem("energy_rune_banner_pattern", () -> new BannerPatternItem(AoABannerPatterns.ENERGY_RUNE.tag(), new Item.Properties().stacksTo(1).tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> FIRE_RUNE_BANNER_PATTERN = registerItem("fire_rune_banner_pattern", () -> new BannerPatternItem(AoABannerPatterns.FIRE_RUNE.tag(), new Item.Properties().stacksTo(1).tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> KINETIC_RUNE_BANNER_PATTERN = registerItem("kinetic_rune_banner_pattern", () -> new BannerPatternItem(AoABannerPatterns.KINETIC_RUNE.tag(), new Item.Properties().stacksTo(1).tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> LIFE_RUNE_BANNER_PATTERN = registerItem("life_rune_banner_pattern", () -> new BannerPatternItem(AoABannerPatterns.LIFE_RUNE.tag(), new Item.Properties().stacksTo(1).tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> LUNAR_RUNE_BANNER_PATTERN = registerItem("lunar_rune_banner_pattern", () -> new BannerPatternItem(AoABannerPatterns.LUNAR_RUNE.tag(), new Item.Properties().stacksTo(1).tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> POISON_RUNE_BANNER_PATTERN = registerItem("poison_rune_banner_pattern", () -> new BannerPatternItem(AoABannerPatterns.POISON_RUNE.tag(), new Item.Properties().stacksTo(1).tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> POWER_RUNE_BANNER_PATTERN = registerItem("power_rune_banner_pattern", () -> new BannerPatternItem(AoABannerPatterns.POWER_RUNE.tag(), new Item.Properties().stacksTo(1).tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> STORM_RUNE_BANNER_PATTERN = registerItem("storm_rune_banner_pattern", () -> new BannerPatternItem(AoABannerPatterns.STORM_RUNE.tag(), new Item.Properties().stacksTo(1).tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> STRIKE_RUNE_BANNER_PATTERN = registerItem("strike_rune_banner_pattern", () -> new BannerPatternItem(AoABannerPatterns.STRIKE_RUNE.tag(), new Item.Properties().stacksTo(1).tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> WATER_RUNE_BANNER_PATTERN = registerItem("water_rune_banner_pattern", () -> new BannerPatternItem(AoABannerPatterns.WATER_RUNE.tag(), new Item.Properties().stacksTo(1).tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> WIND_RUNE_BANNER_PATTERN = registerItem("wind_rune_banner_pattern", () -> new BannerPatternItem(AoABannerPatterns.WIND_RUNE.tag(), new Item.Properties().stacksTo(1).tab(AoACreativeModeTabs.MISC_ITEMS)));
	public static final RegistryObject<Item> WITHER_RUNE_BANNER_PATTERN = registerItem("wither_rune_banner_pattern", () -> new BannerPatternItem(AoABannerPatterns.WITHER_RUNE.tag(), new Item.Properties().stacksTo(1).tab(AoACreativeModeTabs.MISC_ITEMS)));
	...
	private static Supplier<Item> miscItem() {
		return () -> new Item(new Item.Properties().tab(AoACreativeModeTabs.MISC_ITEMS));
	}
