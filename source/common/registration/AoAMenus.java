...
public final class AoAMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<InfusedPressMenu>> INFUSED_PRESS = registerContainer("infused_press", (screenId, inventory, buffer) -> new InfusedPressMenu(screenId, inventory, ContainerLevelAccess.create(inventory.player.level(), buffer.readBlockPos())));
	public static final DeferredHolder<MenuType<?>, MenuType<TinkerersTableMenu>> TINKERERS_TABLE = registerContainer("tinkerers_table", (screenId, inventory, buffer) -> new TinkerersTableMenu(screenId, inventory, ContainerLevelAccess.create(inventory.player.level(), buffer.readBlockPos())));
	//public static final DeferredHolder<MenuType<?>, MenuType<ArtificeCreatingMenu>> ARTIFICE_CREATING = registerContainer("tinkerers_table", (screenId, inventory, buffer) -> new ArtificeCreatingMenu(screenId, inventory, ContainerLevelAccess.create(inventory.player.level(), buffer.readBlockPos())));
