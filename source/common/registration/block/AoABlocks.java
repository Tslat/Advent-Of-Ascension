...
public final class AoABlocks {
	...
	public static final DeferredBlock<Block> AMETHYST_LAMP = register("amethyst_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> AQUATIC_LAMP = register("aquatic_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> BARONYTE_LAMP = register("baronyte_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> BLAZIUM_LAMP = register("blazium_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> BLOODSTONE_LAMP = register("bloodstone_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> CRYSTALLITE_LAMP = register("crystallite_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> ELECANIUM_LAMP = register("elecanium_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> EMBERSTONE_LAMP = register("emberstone_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> FIRE_LAMP = register("fire_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> GHASTLY_LAMP = register("ghastly_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> GHOULISH_LAMP = register("ghoulish_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> IRO_LAMP = register("iro_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> IVORY_LAMP = register("ivory_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> IVORY_AMETHYST_LAMP = register("ivory_amethyst_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> IVORY_JADE_LAMP = register("ivory_jade_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> IVORY_LIMONITE_LAMP = register("ivory_limonite_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> IVORY_REDSTONE_LAMP = register("ivory_redstone_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> IVORY_LAPIS_LAMP = register("ivory_lapis_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> JADE_LAMP = register("jade_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> AQUA_STAINED_GLASS_LAMP = register("aqua_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> BLACK_STAINED_GLASS_LAMP = register("black_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> BLUE_STAINED_GLASS_LAMP = register("blue_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> BROWN_STAINED_GLASS_LAMP = register("brown_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> CYAN_STAINED_GLASS_LAMP = register("cyan_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> DARK_GREY_STAINED_GLASS_LAMP = register("dark_grey_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> GREEN_STAINED_GLASS_LAMP = register("green_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> GREY_STAINED_GLASS_LAMP = register("grey_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> LIME_STAINED_GLASS_LAMP = register("lime_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> MAGENTA_STAINED_GLASS_LAMP = register("magenta_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> ORANGE_STAINED_GLASS_LAMP = register("orange_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> PINK_STAINED_GLASS_LAMP = register("pink_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> PURPLE_STAINED_GLASS_LAMP = register("purple_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> RED_STAINED_GLASS_LAMP = register("red_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> WHITE_STAINED_GLASS_LAMP = register("white_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	public static final DeferredBlock<Block> YELLOW_STAINED_GLASS_LAMP = register("yellow_stained_glass_lamp", registrar -> registrar.factory(LampBlock::new).light(state -> state.getValue(RedstoneLampBlock.LIT) ? 15 : 0).stats(0.3f).sounds(SoundType.GLASS).decorationBlocksTab());
	...
	public static final DeferredBlock<Block> ARCHAIC_LADDER = register("archaic_ladder", registrar -> registrar.baseLadder().stats(1, 0.5f));
	public static final DeferredBlock<Block> RATCHETING_LADDER = register("ratcheting_ladder", registrar -> registrar.baseLadder());
	...
	public static final DeferredBlock<Block> KILLZONE = register("killzone", registrar -> registrar.noItem().stopsPistons().unbreakable().air().noOcclusion().noClip().factory(KillzoneBlock::new));
	...
	public static final DeferredBlock<Block> TINKERERS_TABLE = register("tinkerers_table", registrar -> registrar.factory(TinkerersTable::new).mapColour(MapColor.WOOD).sounds(SoundType.WOOD).stats(5f, 5f).utilityBlocksTab().noOcclusion().instrument(NoteBlockInstrument.BASS));
	...
	public static final DeferredBlock<Block> SAND_CATCHER = register("sand_catcher", registrar -> registrar.basePlant(state -> state.is(Tags.Blocks.SANDS), 12f, 12f).randomTicks().factory(SandCatcher::new));
	public static final DeferredBlock<Block> BARON_BRAMBLE = register("baron_bramble", registrar -> registrar.basePlant(state -> state.is(Tags.Blocks.STONES) || state.is(Tags.Blocks.SANDS), 14f, 14f));
	public static final DeferredBlock<Block> BARON_BLOOMS = register("baron_blooms", registrar -> registrar.basePlant(state -> state.is(Tags.Blocks.STONES) || state.is(Tags.Blocks.SANDS), 14f, 8f));
	public static final DeferredBlock<Block> BARON_SHRUB = register("baron_shrub", registrar -> registrar.basePlant(state -> state.is(Tags.Blocks.STONES) || state.is(Tags.Blocks.SANDS), 14f, 7f));
	public static final DeferredBlock<Block> BARON_TUFT = register("baron_tuft", registrar -> registrar.basePlant(state -> state.is(Tags.Blocks.STONES) || state.is(Tags.Blocks.SANDS), 14f, 11f));
	...
	public static final DeferredBlock<Block> ASHFERN_CROP = register("ashfern_crop", registrar -> registrar.baseCrop().light(state -> state.getValue(CropBlock.AGE) >= CropBlock.MAX_AGE ? 5 : 0).factory(properties -> new AshfernCropBlock(properties, AoAItems.ASHFERN_SEEDS)));
