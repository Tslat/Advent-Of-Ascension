...
public final class AoABlocks {
	...
	public static final DeferredBlock<Block> BARON_GROUND = register("baron_ground", registrar -> registrar.mapColour(MapColor.COLOR_RED).stats(1.5f, 10f).instrument(NoteBlockInstrument.FLUTE).sounds(SoundType.GRAVEL));
	...
	public static final DeferredBlock<Block> CRATE = register("crate", registrar -> registrar.mapColour(MapColor.WOOD).stats(1.5f, 10).flammable().decorationBlocksTab().instrument(NoteBlockInstrument.BASS).itemFactory(FuelBlockItem::new));
	...
	public static final DeferredBlock<Block> GIANT_PLANT_STEM = register("giant_plant_stem", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	public static final DeferredBlock<Block> BLACK_MUSHROOM_STEM = register("black_mushroom_stem", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	public static final DeferredBlock<Block> BLUE_MUSHROOM_STEM = register("blue_mushroom_stem", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	public static final DeferredBlock<Block> GREEN_MUSHROOM_STEM = register("green_mushroom_stem", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	public static final DeferredBlock<Block> ORANGE_MUSHROOM_STEM = register("orange_mushroom_stem", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	public static final DeferredBlock<Block> PURPLE_MUSHROOM_STEM = register("purple_mushroom_stem", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	public static final DeferredBlock<Block> YELLOW_MUSHROOM_STEM = register("yellow_mushroom_stem", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	public static final DeferredBlock<Block> BLACK_MUSHROOM_BLOCK = register("black_mushroom_block", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	public static final DeferredBlock<Block> BLUE_MUSHROOM_BLOCK = register("blue_mushroom_block", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	public static final DeferredBlock<Block> GREEN_MUSHROOM_BLOCK = register("green_mushroom_block", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	public static final DeferredBlock<Block> ORANGE_MUSHROOM_BLOCK = register("orange_mushroom_block", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	public static final DeferredBlock<Block> PURPLE_MUSHROOM_BLOCK = register("purple_mushroom_block", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	public static final DeferredBlock<Block> YELLOW_MUSHROOM_BLOCK = register("yellow_mushroom_block", registrar -> registrar.generationBlocksTab().sounds(SoundType.WOOD).flammable().stats(0.2f).mapColour(MapColor.PLANT).instrument(NoteBlockInstrument.BASS).factory(HugeMushroomBlock::new).compostable(0.85f));
	...
	public static final DeferredBlock<Block> VOX_LOG = register("vox_log", registrar -> registrar.baseLog(MapColor.COLOR_GREEN, MapColor.COLOR_GREEN, null).factory(VoxLog::new).itemFactory(FuelBlockItem::new));
	...
	public static final DeferredBlock<Block> DAMAGE_ENHANCER = register("damage_enhancer", registrar -> registrar.mapColour(MapColor.TERRACOTTA_GRAY).stats(10).utilityBlocksTab());
	public static final DeferredBlock<Block> DIVINE_ENHANCER = register("divine_enhancer", registrar -> registrar.mapColour(MapColor.TERRACOTTA_GRAY).stats(10).utilityBlocksTab());
	public static final DeferredBlock<Block> DURABILITY_ENHANCER = register("durability_enhancer", registrar -> registrar.mapColour(MapColor.TERRACOTTA_GRAY).stats(10).utilityBlocksTab());
	public static final DeferredBlock<Block> LUCK_ENHANCER = register("luck_enhancer", registrar -> registrar.mapColour(MapColor.TERRACOTTA_GRAY).stats(10).utilityBlocksTab());
	public static final DeferredBlock<Block> MAGIC_ENHANCER = register("magic_enhancer", registrar -> registrar.mapColour(MapColor.TERRACOTTA_GRAY).stats(10).utilityBlocksTab());
	public static final DeferredBlock<Block> RESISTANCE_ENHANCER = register("resistance_enhancer", registrar -> registrar.mapColour(MapColor.TERRACOTTA_GRAY).stats(10).utilityBlocksTab());
	public static final DeferredBlock<Block> SPEED_ENHANCER = register("speed_enhancer", registrar -> registrar.mapColour(MapColor.TERRACOTTA_GRAY).stats(10).utilityBlocksTab());
	public static final DeferredBlock<Block> WEIGHT_ENHANCER = register("weight_enhancer", registrar -> registrar.mapColour(MapColor.TERRACOTTA_GRAY).stats(10).utilityBlocksTab());
	...
	public static final DeferredBlock<Block> ABYSS_PORTAL =  register("abyss_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.ABYSS.key, ColourUtil.RGB(229, 0, 0))));
	public static final DeferredBlock<Block> BARATHOS_PORTAL = register("barathos_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.BARATHOS.key, ColourUtil.RGB(239, 137, 119))));
	public static final DeferredBlock<Block> CANDYLAND_PORTAL = register("candyland_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.CANDYLAND.key, ColourUtil.RGB(255, 232, 232))));
	public static final DeferredBlock<Block> CELEVE_PORTAL = register("celeve_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.CELEVE.key, ColourUtil.RGB(247, 239, 0))));
	public static final DeferredBlock<Block> CREEPONIA_PORTAL = register("creeponia_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.CREEPONIA.key, ColourUtil.RGB(132, 188, 124))));
	public static final DeferredBlock<Block> CRYSTEVIA_PORTAL = register("crystevia_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.CRYSTEVIA.key, ColourUtil.RGB(194, 73, 255))));
	public static final DeferredBlock<Block> DEEPLANDS_PORTAL = register("deeplands_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.DEEPLANDS.key, ColourUtil.RGB(181, 181, 181))));
	public static final DeferredBlock<Block> DUSTOPIA_PORTAL = register("dustopia_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.DUSTOPIA.key, ColourUtil.BLACK)));
	public static final DeferredBlock<Block> GARDENCIA_PORTAL = register("gardencia_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.GARDENCIA.key, ColourUtil.RGB(255, 0, 114))));
	public static final DeferredBlock<Block> GRECKON_PORTAL = register("greckon_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.GRECKON.key, ColourUtil.RGB(130, 178, 0))));
	public static final DeferredBlock<Block> HAVEN_PORTAL = register("haven_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.HAVEN.key, ColourUtil.RGB(0, 229, 237))));
	public static final DeferredBlock<Block> IROMINE_PORTAL = register("iromine_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.IROMINE.key, ColourUtil.RGB(232, 208, 0))));
	public static final DeferredBlock<Block> LBOREAN_PORTAL = register("lborean_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.LBOREAN.key, ColourUtil.RGB(0, 173, 216))));
	public static final DeferredBlock<Block> LELYETIA_PORTAL = register("lelyetia_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.LELYETIA.key, ColourUtil.RGB(221, 103, 0))));
	public static final DeferredBlock<Block> LUNALUS_PORTAL = register("lunalus_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.LUNALUS.key, ColourUtil.RGB(255, 226, 251))));
	public static final DeferredBlock<Block> MYSTERIUM_PORTAL = register("mysterium_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.MYSTERIUM.key, ColourUtil.RGB(107, 0, 82))));
	public static final DeferredBlock<Block> NETHER_PORTAL = register("nether_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, Level.NETHER, ColourUtil.RGB(193, 64, 215), () -> SoundEvents.PORTAL_AMBIENT)));
	...
	public static final DeferredBlock<Block> PRECASIA_PORTAL = register("precasia_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.PRECASIA.key, ColourUtil.RGB(207, 221, 0), AoASounds.BLOCK_PRECASIA_PORTAL_AMBIENT)));
	public static final DeferredBlock<Block> RUNANDOR_PORTAL = register("runandor_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.RUNANDOR.key, ColourUtil.RGB(124, 255, 255))));
	public static final DeferredBlock<Block> SHYRELANDS_PORTAL = register("shyrelands_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.SHYRELANDS.key, ColourUtil.YELLOW)));
	public static final DeferredBlock<Block> VOX_PONDS_PORTAL = register("vox_ponds_portal", registrar -> registrar.basePortal().factory(properties -> new PortalBlock(properties, AoADimensions.VOX_PONDS.key, ColourUtil.RGB(90, 104, 0))));
	...
	public static final DeferredBlock<Block> VOX_CRATE = register("vox_crate", registrar -> registrar.utilityBlocksTab().stats(5, 3).mapColour(MapColor.TERRACOTTA_GREEN).itemFactory(FuelBlockItem::new).factory(VoxCrate::new).flammable().sounds(SoundType.WOOD).instrument(NoteBlockInstrument.BASS));
	...
	public static final DeferredBlock<Block> VOX_STORE_CRATE = register("vox_store_crate", registrar -> registrar.utilityBlocksTab().stats(5, 3).mapColour(MapColor.TERRACOTTA_GREEN).itemFactory(FuelBlockItem::new).factory(VoxStoreCrate::new).flammable().sounds(SoundType.WOOD).instrument(NoteBlockInstrument.BASS));
	...
	public static final DeferredBlock<Block> BLOOD_PINE_STEM = register("blood_pine_stem", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setHatBlock(AoABlocks.BLOOD_PINE), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> BLOOD_PINE = register("blood_pine", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.BLOOD_PINE_STEM), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> BLOOD_SPIKES = register("blood_spikes", registrar -> registrar.basePlant().compostable(0.5f));//}, BloodSpikes::new, () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> BLOOD_STRANDS = register("blood_strands", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.COLOR_RED, Material.DIRT, Material.GRASS, Material.STONE, Material.VEGETABLE), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> BULB_STOCK = register("bulb_stock", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setHatBlock(AoABlocks.BULB_STOCK_CAP), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> BULB_STOCK_CAP = register("bulb_stock_cap", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.COLOR_RED, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.BULB_STOCK), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> CELEBULBS_STEM = register("celebulbs_stem", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setHatBlock(AoABlocks.YELLOW_CELEBULBS), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> GREEN_CELEBULBS = register("green_celebulbs", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.CELEBULBS_STEM), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> YELLOW_CELEBULBS = register("yellow_celebulbs", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.CELEBULBS_STEM), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> CORAL_CAGE = register("coral_cage", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackableWaterPlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT, Material.STONE), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> DAWNWOOD_BARS = register("dawnwood_bars", registrar -> registrar.basePlant().stats(1f, 0f).factory(DawnwoodBars::new).mapColour(MapColor.COLOR_BLACK).compostable(0.5f));//}, DawnwoodBars::new, () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> EYE_SHRUB_STEM = register("eye_shrub_stem", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setHatBlock(AoABlocks.EYE_SHRUB), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> EYE_SHRUB = register("eye_shrub", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.EYE_SHRUB_STEM), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> GARDEN_GRASS = register("garden_grass", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> BLUE_HAVENDALES_STEM = register("blue_havendales_stem", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setHatBlock(AoABlocks.BLUE_HAVENDALES), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> BLUE_HAVENDALES = register("blue_havendales", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.BLUE_HAVENDALES_STEM), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> PINK_HAVENDALES_STEM = register("pink_havendales_stem", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setHatBlock(AoABlocks.PINK_HAVENDALES), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> PINK_HAVENDALES = register("pink_havendales", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.PINK_HAVENDALES_STEM), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> YELLOW_HAVENDALES_STEM = register("yellow_havendales_stem", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setHatBlock(AoABlocks.YELLOW_HAVENDALES), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> YELLOW_HAVENDALES = register("yellow_havendales", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.YELLOW_HAVENDALES_STEM), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	...
	public static final DeferredBlock<Block> LELYETIAN_STEM_CAP = register("lelyetian_stem_cap", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.LELYETIAN_STEM), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> LELYETIAN_STEM_CAP_DOWN = register("lelyetian_stem_cap_down", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new UpsideDownStackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.LELYETIAN_STEM), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	...
	public static final DeferredBlock<Block> LELYETIAN_WIGGLER_BOTTOM = register("lelyetian_wiggler_bottom", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new UpsideDownStackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.LELYETIAN_WIGGLER), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> LELYETIAN_WIGGLER_TOP = register("lelyetian_wiggler_top", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.LELYETIAN_WIGGLER), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> GREEN_PEPPERMINT = register("green_peppermint", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(Material.GLASS, MaterialColor.PLANT, SoundType.GLASS, Material.GRASS, Material.DIRT), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> RED_PEPPERMINT = register("red_peppermint", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(Material.GLASS, MaterialColor.PLANT, SoundType.GLASS, Material.GRASS, Material.DIRT), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> PLASTIC_STICK = register("plastic_stick", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(Material.STONE, MaterialColor.PLANT, SoundType.STONE, Material.GRASS, Material.DIRT).setHatBlock(AoABlocks.CANDY_TUBE), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> CANDY_TUBE = register("candy_tube", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(Material.GLASS, MaterialColor.PLANT, SoundType.GLASS, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.PLASTIC_STICK), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> SHYRE_STOCK = register("shyre_stock", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new BidirectionalStackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setBottomHatBlock(AoABlocks.SHYRE_CAP_DOWN).setHatBlock(AoABlocks.SHYRE_CAP), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> SHYRE_CAP = register("shyre_cap", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new StackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.SHYRE_STOCK), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> SHYRE_CAP_DOWN = register("shyre_cap_down", registrar -> registrar.basePlant().compostable(0.5f));//}, () -> new UpsideDownStackablePlant(MaterialColor.PLANT, Material.GRASS, Material.DIRT).setStemBlock(AoABlocks.SHYRE_STOCK), () -> AoACreativeModeTabs.GENERATION_BLOCKS);
	public static final DeferredBlock<Block> VOX_FUNGI_STEM = register("vox_fungi_stem", registrar -> registrar.basePlant().compostable(0.5f));//}, registrar -> registrar.basePlant().factory(properties -> new StackablePlant(properties).setHatBlock(VOX_FUNGI)));
	public static final DeferredBlock<Block> VOX_FUNGI = register("vox_fungi", registrar -> registrar.basePlant().compostable(0.5f));//}, registrar -> registrar.basePlant().factory(properties -> new StackablePlant(properties).setStemBlock(VOX_FUNGI_STEM)));
	public static final DeferredBlock<StackablePlant> VOX_TENTACLES_STEM = register("vox_tentacles_stem", registrar -> registrar.basePlant().compostable(0.5f));//}, registrar -> registrar.basePlant(null));
	public static final DeferredBlock<Block> VOX_TENTACLES = register("vox_tentacles", registrar -> registrar.basePlant().compostable(0.5f));//}, registrar -> registrar.basePlant(VOX_TENTACLES_STEM));

	public static final DeferredBlock<Block> CREEP_VINES = register("creep_vines", registrar -> registrar.noClip().mapColour(MapColor.PLANT).replaceable().randomTicks().stats(0.2f).flammable().pistonBreaks().generationBlocksTab().factory(VinesBlock::new).compostable(0.5f));
