...
public final class AoAMobs {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AncientGolemEntity>> ANCIENT_GOLEM = registerMob("ancient_golem", AncientGolemEntity::new, 1 + 2 / 16f, 2 + 10 / 16f, 0x221D19, 0x211C18);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AttercopusEntity>> ATTERCOPUS = registerMob("attercopus", AttercopusEntity::new, 0.75f, 9 / 16f, 0x281F17, 0x433325);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<BombCarrierEntity>> BOMB_CARRIER = registerMob("bomb_carrier", BombCarrierEntity::new, 0.5f, 1.75f, 0x433128, 0x4C9949);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<BushBabyEntity>> BUSH_BABY = registerMob("bush_baby", BushBabyEntity::new, 0.85f, 0.9375f, 0x3BA14C, 0x83C15D);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<ChargerEntity>> CHARGER = registerMob("charger", ChargerEntity::new, 0.625f, 1.5f, 0xC35641, 0xC35641);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<ChomperEntity>> CHOMPER = registerMob("chomper", ChomperEntity::new, 0.8f, 0.85f, 0x1F3F31, 0x337056);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<CyclopsEntity>> CYCLOPS = registerMob("cyclops", CyclopsEntity::new, 0.6f, 34 / 16f, 0x664D3D, 0x7B6354);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<DunkleosteusEntity>> DUNKLEOSTEUS = registerMob("dunkleosteus", DunkleosteusEntity::new, 1.3125f, 1.59375f, 0x606F67, 0x5F5057);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<EmbrakeEntity>> EMBRAKE = registerMob("embrake", EmbrakeEntity::new, true, 0.875f, 1.125f, 0x261B18, 0xDD8701);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<FlamewalkerEntity>> FLAMEWALKER = registerMob("flamewalker", FlamewalkerEntity::new, true, 14 / 16f, 2 + 9 / 16f, 0xE48D12, 0x261815);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<GhostEntity>> GHOST = registerMob("ghost", GhostEntity::new, 9 / 16f, 1 + 10 / 16f, 0xB3D2CE, 0x4D5256);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<GoblinEntity>> GOBLIN = registerMob("goblin", GoblinEntity::new, 0.6f, 1.8f, 0x1B765E, 0x44AF5E);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<IceGiantEntity>> ICE_GIANT = registerMob("ice_giant", IceGiantEntity::new, 1.25f, 3.59375f, 0x8AB5C7, 0x54819A);
	public static final DeferredHolder<EntityType<?>, EntityType<InfernalEntity>> INFERNAL = registerMob("infernal", InfernalEntity::new, true, 1.25f, 3.75f, 0x1C1B1B, 0xE38700);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<KingChargerEntity>> KING_CHARGER = registerMob("king_charger", KingChargerEntity::new, 18 / 16f, 33 / 16f, 0xDF7858, 0x8D4347);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<LeafyGiantEntity>> LEAFY_GIANT = registerMob("leafy_giant", LeafyGiantEntity::new, 1.25f, 3.75f, 0x12680D, 0x392513);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<LittleBamEntity>> LITTLE_BAM = registerMob("little_bam", LittleBamEntity::new, true, 0.75f, 1 + 10.5f / 16f, 0x2F180E, 0xDB8702);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<MeganeuropsisEntity>> MEGANEUROPSIS = registerMob("meganeuropsis", MeganeuropsisEntity::new, 0.5f, 0.4375f, 0x715C0D, 0xE2E2E2);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<NethengeicBeastEntity>> NETHENGEIC_BEAST = registerMob("nethengeic_beast", NethengeicBeastEntity::new, true, 1.25f, 3.75f, 0x1A1513, 0xD43D10);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<SandGiantEntity>> SAND_GIANT = registerMob("sand_giant", SandGiantEntity::new, 1.5f, 3.46875f, 0xC5B996, 0xAC9974);
	public static final DeferredHolder<EntityType<?>, EntityType<SasquatchEntity>> SASQUATCH = registerMob("sasquatch", SasquatchEntity::new, 9 / 16f, 29 / 16f, 0x80605C, 0x45293E);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<SmilodonEntity>> SMILODON = registerMob("smilodon", SmilodonEntity::new, 0.7f, 1.375f, 0x86552C, 0x372516);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<SpinoledonEntity>> SPINOLEDON = registerMob("spinoledon", SpinoledonEntity::new, 0.75f, 1.9375f, 0x3E5234, 0x3B3A38);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<StoneGiantEntity>> STONE_GIANT = registerMob("stone_giant", StoneGiantEntity::new, 1.3125f, 5.0625f, 0x56473C, 0x43352B);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<TreeSpiritEntity>> TREE_SPIRIT = registerMob("tree_spirit", TreeSpiritEntity::new, 1f, 3f, 0x60502C, 0x9A8448);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<VeloraptorEntity>> VELORAPTOR = registerMob("veloraptor", VeloraptorEntity::new, 0.55f, 1.3125f, 0x514641, 0x8E8975);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<VoidWalkerEntity>> VOID_WALKER = registerMob("void_walker", VoidWalkerEntity::new, 14 / 16f, 22 / 16f, 0x171717, 0x332B31);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<WoodGiantEntity>> WOOD_GIANT = registerMob("wood_giant", WoodGiantEntity::new, 1.5f, 3.375f, 0x291E12, 0x3E311E);
	public static final DeferredHolder<EntityType<?>, EntityType<YetiEntity>> YETI = registerMob("yeti", YetiEntity::new, 11 / 16f, 2.25f, 0xE0E2E2, 0x393D3D);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<SkeletalAbominationEntity>> SKELETAL_ABOMINATION = registerMob("skeletal_abomination", SkeletalAbominationEntity::new, true, 0.7f, 1.3125f, 0xCFCCBE, 0xA69E8C);

	public static final DeferredHolder<EntityType<?>, EntityType<SmashEntity>> SMASH = registerMob("smash", SmashEntity::new, 22 / 16f, 54 / 16f, 0x644E31, 0x3C2E1E);
	public static final DeferredHolder<EntityType<?>, EntityType<EliteSmashEntity>> ELITE_SMASH = registerMob("elite_smash", EliteSmashEntity::new, 22 / 16f, 54 / 16f, 0x644E31, 0x3C2E1E);
	public static final DeferredHolder<EntityType<?>, EntityType<NethengeicWitherEntity>> NETHENGEIC_WITHER = registerMob("nethengeic_wither", NethengeicWitherEntity::new, true, 22 / 16f, 59 / 16f, 0x1D1816, 0xDE4D13);
	public static final DeferredHolder<EntityType<?>, EntityType<EliteNethengeicWitherEntity>> ELITE_NETHENGEIC_WITHER = registerMob("elite_nethengeic_wither", EliteNethengeicWitherEntity::new, true, 22 / 16f, 59 / 16f, 0x1D1816, 0xDE4D13);
	public static final DeferredHolder<EntityType<?>, EntityType<KingBamBamBamEntity>> KING_BAMBAMBAM = registerMob("king_bambambam", KingBamBamBamEntity::new, true, 18 / 16f, 44 / 16f, 0x211C1A, 0x4D352B);
	public static final DeferredHolder<EntityType<?>, EntityType<EliteKingBamBamBamEntity>> ELITE_KING_BAMBAMBAM = registerMob("elite_king_bambambam", EliteKingBamBamBamEntity::new, true, 18 / 16f, 44 / 16f, 0x211C1A, 0x4D352B);
	public static final DeferredHolder<EntityType<?>, EntityType<TyrosaurEntity>> TYROSAUR = registerMob("tyrosaur", TyrosaurEntity::new, 22 / 16f, 27 / 16f, 0x5A4536, 0x252323);
	public static final DeferredHolder<EntityType<?>, EntityType<EliteTyrosaurEntity>> ELITE_TYROSAUR = registerMob("elite_tyrosaur", EliteTyrosaurEntity::new, 27 / 16f, 54 / 16f, 0x5A4536, 0x252323);
	public static final DeferredHolder<EntityType<?>, EntityType<SkeletronEntity>> SKELETRON = registerMob("skeletron", SkeletronEntity::new, 22 / 16f, 27 / 16f, 0x5A4536, 0x252323);
	public static final DeferredHolder<EntityType<?>, EntityType<EliteSkeletronEntity>> ELITE_SKELETRON = registerMob("elite_skeletron", EliteSkeletronEntity::new, 22 / 16f, 27 / 16f, 0x5A4536, 0x252323);
	...
	private static <T extends Mob> DeferredHolder<EntityType<?>, EntityType<T>> registerMob(String registryName, EntityType.EntityFactory<T> factory, float width, float height, int primaryEggColour, int secondaryEggColour) {
		return registerMob(registryName, factory, false, width, height, primaryEggColour, secondaryEggColour);
	}

	private static <T extends Mob> DeferredHolder<EntityType<?>, EntityType<T>> registerMob(String registryName, EntityType.EntityFactory<T> factory, boolean fireImmune, float width, float height, int primaryEggColour, int secondaryEggColour) {
