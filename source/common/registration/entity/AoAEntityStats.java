...
public final class AoAEntityStats {
	...
	private static void registerStats(final EntityAttributeCreationEvent ev) {
		...
		AttributeBuilder.create(AoAAnimals.AMBIENT_PIXON.get()).health(15).moveSpeed(0.4).knockbackResist(1).followRange(16).extraAttributes(NeoForgeMod.ENTITY_GRAVITY.value(), Attributes.ATTACK_KNOCKBACK).build(ev);
		...
		AttributeBuilder.create(AoAAnimals.GLARING_PIXON.get()).health(15).moveSpeed(0.4).knockbackResist(1).followRange(16).extraAttributes(Attributes.ARMOR_TOUGHNESS, NeoForgeMod.SWIM_SPEED.value(), NeoForgeMod.NAMETAG_DISTANCE.value(), NeoForgeMod.ENTITY_GRAVITY.value(), Attributes.ATTACK_KNOCKBACK).build(ev);
		AttributeBuilder.create(AoAAnimals.GLEAMING_PIXON.get()).health(15).moveSpeed(0.4).knockbackResist(1).followRange(16).extraAttributes(Attributes.ARMOR_TOUGHNESS, NeoForgeMod.SWIM_SPEED.value(), NeoForgeMod.NAMETAG_DISTANCE.value(), NeoForgeMod.ENTITY_GRAVITY.value(), Attributes.ATTACK_KNOCKBACK).build(ev);
		AttributeBuilder.create(AoAAnimals.GLISTENING_PIXON.get()).health(15).moveSpeed(0.4).knockbackResist(1).followRange(16).extraAttributes(Attributes.ARMOR_TOUGHNESS, NeoForgeMod.SWIM_SPEED.value(), NeoForgeMod.NAMETAG_DISTANCE.value(), NeoForgeMod.ENTITY_GRAVITY.value(), Attributes.ATTACK_KNOCKBACK).build(ev);
		AttributeBuilder.create(AoAAnimals.GLOWING_PIXON.get()).health(15).moveSpeed(0.4).knockbackResist(1).followRange(16).extraAttributes(Attributes.ARMOR_TOUGHNESS, NeoForgeMod.SWIM_SPEED.value(), NeoForgeMod.NAMETAG_DISTANCE.value(), NeoForgeMod.ENTITY_GRAVITY.value(), Attributes.ATTACK_KNOCKBACK).build(ev);
		...
		AttributeBuilder.create(AoAAnimals.RADIANT_PIXON.get()).health(15).moveSpeed(0.4).knockbackResist(1).followRange(16).extraAttributes(Attributes.ARMOR_TOUGHNESS, NeoForgeMod.SWIM_SPEED.value(), NeoForgeMod.NAMETAG_DISTANCE.value(), NeoForgeMod.ENTITY_GRAVITY.value(), Attributes.ATTACK_KNOCKBACK).build(ev);
		...
		AttributeBuilder.create(AoAAnimals.SHINING_PIXON.get()).health(15).moveSpeed(0.4).knockbackResist(1).followRange(16).extraAttributes(Attributes.ARMOR_TOUGHNESS, NeoForgeMod.SWIM_SPEED.value(), NeoForgeMod.NAMETAG_DISTANCE.value(), NeoForgeMod.ENTITY_GRAVITY.value(), Attributes.ATTACK_KNOCKBACK).build(ev);
