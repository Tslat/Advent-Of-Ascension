...
public final class AoAEntityStats {
	...
	private static void doOverworldEntityStats(final EntityAttributeCreationEvent ev) {
		...
		AttributeBuilder.createMonster(AoAMobs.GOBLIN.get()).health(20).moveSpeed(0.29).meleeSpeed(4).followRange(12).aggroRange(8).build(ev);
	...
	private static void doBossEntityStats(final EntityAttributeCreationEvent ev) {
		AttributeBuilder.createMonster(AoAMobs.SMASH.get()).health(275).moveSpeed(0.31).meleeStrength(15).knockbackResist(0.9).followRange(60).aggroRange(40).armour(10, 10).knockback(1f).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.NETHENGEIC_WITHER.get()).health(420).moveSpeed(0.31).flyingSpeed(0.6).projectileDamage(6).knockbackResist(0.9).followRange(60).aggroRange(40).knockback(1f).build(ev);
		AttributeBuilder.createMonster(AoAMobs.ELITE_NETHENGEIC_WITHER.get()).health(600).moveSpeed(0.315).flyingSpeed(0.6).projectileDamage(30).knockbackResist(1).followRange(60).aggroRange(40).knockback(1f).build(ev);
	}
	...
	private static void registerStats(final EntityAttributeCreationEvent ev) {
		...
		AttributeBuilder.createMonster(AoAMobs.DIOCUS.get()).health(64).moveSpeed(0.28).meleeStrength(6).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.DYREHORN.get()).health(60).moveSpeed(0.329).meleeStrength(8.5).knockbackResist(0.1).followRange(16).build(ev);
		AttributeBuilder.createMonster(AoAMobs.ECHODAR.get()).health(50).flyingSpeed(0.1).meleeStrength(6.5).followRange(24).build(ev);
		AttributeBuilder.createMonster(AoAMobs.ELITE_SKELEMAN.get()).health(120).moveSpeed(0.207).projectileDamage(7).followRange(24).build(ev);
		AttributeBuilder.createMonster(AoAMobs.ELITE_SKELE_HOPPER.get()).health(64).moveSpeed(0.2875).meleeStrength(12).knockbackResist(0.1).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.FENIX.get()).health(1).moveSpeed(0.27).meleeStrength(15).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.HAG.get()).health(15).moveSpeed(0.23).projectileDamage(4).followRange(24).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.HIDING_FUNGI.get()).health(1).moveSpeed(0).meleeStrength(0).knockbackResist(1).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.IOSAUR.get()).health(78).moveSpeed(0.2875).meleeStrength(7.5).knockbackResist(0.15).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.KAIYU.get()).health(70).moveSpeed(0.23).projectileDamage(9).knockbackResist(0.1).followRange(24).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.OPTERYX.get()).health(75).moveSpeed(0.329).meleeStrength(8.5).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.PINCHER.get()).health(25).moveSpeed(0.29).meleeStrength(4).armour(4).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.PRIMITIVE_CARROTOP.get()).health(70).moveSpeed(0.3).meleeStrength(9.5).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.REAVER.get()).health(40).moveSpeed(0.2875).meleeStrength(12).armour(1).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.SHAVO.get()).health(125).moveSpeed(0.25).meleeStrength(8.5).knockbackResist(0.1).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.SKELEDON.get()).health(120).moveSpeed(0.2875).meleeStrength(11.5).knockbackResist(0.1).followRange(16).build(ev);
		AttributeBuilder.createMonster(AoAMobs.SKELEKYTE.get()).health(115).moveSpeed(0.2875).meleeStrength(11).followRange(16).build(ev);
		AttributeBuilder.createMonster(AoAMobs.SKELEMAN.get()).health(30).moveSpeed(0.207).projectileDamage(2).followRange(24).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.SKELE_ELDER.get()).health(60).moveSpeed(0.25).meleeStrength(3).knockbackResist(0.1).followRange(16).build(ev);
		AttributeBuilder.createMonster(AoAMobs.SKELE_HOPPER.get()).health(16).moveSpeed(0.2875).meleeStrength(5).knockbackResist(0.1).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.SPHINX.get()).health(20).moveSpeed(0.2875).meleeStrength(4).followRange(16).build(ev);
		AttributeBuilder.createMonster(AoAMobs.SPINOLEDON.get()).health(72).moveSpeed(0.2875).meleeStrength(7).knockbackResist(0.1).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.TERRADON.get()).health(105).moveSpeed(0.329).meleeStrength(10).knockbackResist(0.8).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.TORTIONE.get()).health(100).moveSpeed(0.25).meleeStrength(7.5).knockbackResist(0.9).armour(7).followRange(16).build(ev);
		...
		AttributeBuilder.createMonster(AoAMobs.URV.get()).health(75).moveSpeed(0.25).meleeStrength(14).knockbackResist(0.3).followRange(16).build(ev);
