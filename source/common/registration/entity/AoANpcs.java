...
public final class AoANpcs {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AoATrader>> LOTTOMAN = registerNPC("lottoman", LottomanEntity::new, 0.5625f, 2.0f, 0x6B2A25, 0x2E1F14);
	public static final DeferredHolder<EntityType<?>, EntityType<AoATrader>> UNDEAD_HERALD = registerNPC("undead_herald", UndeadHeraldEntity::new, 0.5625f, 2.0f, 0xA7A294, 0x212121);

	public static final DeferredHolder<EntityType<?>, EntityType<CorruptedTravellerEntity>> CORRUPTED_TRAVELLER = registerNPC("corrupted_traveller", CorruptedTravellerEntity::new, 0.5625f, 2.0f, 0x2D231A, 0x54A8B0);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<SkillMasterEntity>> SKILL_MASTER = registerNPC("skill_master", SkillMasterEntity::new, 0.5625f, 2.0f, 0x211F1D, 0xE3A602);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AoATrader>> TOKEN_COLLECTOR = registerNPC("token_collector", TokenCollectorEntity::new, 0.5625f, 2.0f, 0x675105, 0x1C1304);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<DryadSpriteEntity>> DRYAD_SPRITE = registerNPC("dryad_sprite", DryadSpriteEntity::new, 1f, 1f, 0x382E19, 0x4C4525);

	private static <T extends Mob> DeferredHolder<EntityType<?>, EntityType<T>> registerNPC(String registryName, EntityType.EntityFactory<T> factory, float width, float height, int primaryEggColour, int secondaryEggColour) {
		return registerNPC(registryName, factory, false, width, height, primaryEggColour, secondaryEggColour);
	}

	private static <T extends Mob> DeferredHolder<EntityType<?>, EntityType<T>> registerNPC(String registryName, EntityType.EntityFactory<T> factory, boolean fireImmune, float width, float height, int primaryEggColour, int secondaryEggColour) {
