...
public final class AoAItems {
	...
	public static final RegistryObject<Item> AMETHYST = registerItem("amethyst", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> BLOODSTONE = registerItem("bloodstone", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> CRYSTALLITE = registerItem("crystallite", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GEMENYTE = registerItem("gemenyte", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> JADE = registerItem("jade", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> JEWELYTE = registerItem("jewelyte", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> ORNAMYTE = registerItem("ornamyte", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SAPPHIRE = registerItem("sapphire", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SHYREGEM = registerItem("shyregem", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> RUNIUM_CHUNK = registerItem("runium_chunk", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> CHESTBONE_FRAGMENT = registerItem("chestbone_fragment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> FOOTBONE_FRAGMENT = registerItem("footbone_fragment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> LEGBONE_FRAGMENT = registerItem("legbone_fragment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SKULLBONE_FRAGMENT = registerItem("skullbone_fragment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> CHARGED_RUNIUM_CHUNK = registerItem("charged_runium_chunk", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> BLUE_CRYSTAL = registerItem("blue_crystal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GREEN_CRYSTAL = registerItem("green_crystal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> PURPLE_CRYSTAL = registerItem("purple_crystal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> RED_CRYSTAL = registerItem("red_crystal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> WHITE_CRYSTAL = registerItem("white_crystal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> YELLOW_CRYSTAL = registerItem("yellow_crystal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> BARONYTE_INGOT = registerItem("baronyte_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> BLAZIUM_INGOT = registerItem("blazium_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> ELECANIUM_INGOT = registerItem("elecanium_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> EMBERSTONE_INGOT = registerItem("emberstone_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GHASTLY_INGOT = registerItem("ghastly_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GHOULISH_INGOT = registerItem("ghoulish_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> LIMONITE_INGOT = registerItem("limonite_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> LUNAR_INGOT = registerItem("lunar_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> LYON_INGOT = registerItem("lyon_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> MYSTITE_INGOT = registerItem("mystite_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> ROSITE_INGOT = registerItem("rosite_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> RUSTED_IRON_INGOT = registerItem("rusted_iron_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SHYRESTONE_INGOT = registerItem("shyrestone_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SKELETAL_INGOT = registerItem("skeletal_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> VARSIUM_INGOT = registerItem("varsium_ingot", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));

	public static final RegistryObject<Item> BARONYTE_NUGGET = registerItem("baronyte_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> BLAZIUM_NUGGET = registerItem("blazium_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> ELECANIUM_NUGGET = registerItem("elecanium_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> EMBERSTONE_NUGGET = registerItem("emberstone_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GHASTLY_NUGGET = registerItem("ghastly_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GHOULISH_NUGGET = registerItem("ghoulish_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> LIMONITE_NUGGET = registerItem("limonite_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> LUNAR_NUGGET = registerItem("lunar_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> LYON_NUGGET = registerItem("lyon_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> MYSTITE_NUGGET = registerItem("mystite_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> ROSITE_NUGGET = registerItem("rosite_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SHYRESTONE_NUGGET = registerItem("shyrestone_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> VARSIUM_NUGGET = registerItem("varsium_nugget", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> ACTIVE_RUNE_STONE = registerItem("active_rune_stone", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> ALIEN_ORB = registerItem("alien_orb", () -> new ReservedItem("alien_orb"));
	public static final RegistryObject<Item> ARMOUR_PLATING = registerItem("armour_plating", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> CUP = registerItem("cup", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> DARK_BONES = registerItem("dark_bones", () -> new ReservedItem("alien_orb"));
	public static final RegistryObject<Item> DARKLY_POWDER = registerItem("darkly_powder", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> DENSE_ROCK = registerItem("dense_rock", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> DISTORTING_ARTIFACT = registerItem("distorting_artifact", DistortingArtifact::new);
	public static final RegistryObject<Item> BLUE_DRUSE = registerItem("blue_druse", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GREEN_DRUSE = registerItem("green_druse", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> PURPLE_DRUSE = registerItem("purple_druse", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> RAINBOW_DRUSE = registerItem("rainbow_druse", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> RED_DRUSE = registerItem("red_druse", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> WHITE_DRUSE = registerItem("white_druse", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> YELLOW_DRUSE = registerItem("yellow_druse", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> ENCHANTED_GUNPOWDER = registerItem("enchanted_gunpowder", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> FLAMMABLE_DUST = registerItem("flammable_dust", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)), 100);
	...
	public static final RegistryObject<Item> BLUE_GEMSTONES = registerItem("blue_gemstones", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GREEN_GEMSTONES = registerItem("green_gemstones", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> PURPLE_GEMSTONES = registerItem("purple_gemstones", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> RED_GEMSTONES = registerItem("red_gemstones", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> WHITE_GEMSTONES = registerItem("white_gemstones", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> YELLOW_GEMSTONES = registerItem("yellow_gemstones", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GHOSTLY_POWDER = registerItem("ghostly_powder", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GHOULASM = registerItem("ghoulasm", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GRAVITATOR = registerItem("gravitator", Gravitator::new);
	public static final RegistryObject<Item> HARDENED_CONFETTI_BALL = registerItem("hardened_confetti_ball", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)), 120);
	public static final RegistryObject<Item> HIVE_CHUNK = registerItem("hive_chunk", HiveChunk::new);
	public static final RegistryObject<Item> ICE_CRYSTAL = registerItem("ice_crystal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> IMPURE_GOLD = registerItem("impure_gold", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> IVORY = registerItem("ivory", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> JUNGLE_THORNS = registerItem("jungle_thorns", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> LIMONITE_ROD = registerItem("limonite_rod", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> LOTTO_TOTEM = registerItem("lotto_totem", LottoTotem::new);
	public static final RegistryObject<Item> LUNARADE_MUG = registerItem("lunarade_mug", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> METAL_TUB = registerItem("metal_tub", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> MAGNET_SHARD = registerItem("magnet_shard", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> MECHA_GEAR = registerItem("mecha_gear", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> BLUE_MEGA_RUNE_FRAGMENT = registerItem("blue_mega_rune_fragment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GREEN_MEGA_RUNE_FRAGMENT = registerItem("green_mega_rune_fragment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> RED_MEGA_RUNE_FRAGMENT = registerItem("red_mega_rune_fragment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> YELLOW_MEGA_RUNE_FRAGMENT = registerItem("yellow_mega_rune_fragment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> MUSHROOM_SPORES = registerItem("mushroom_spores", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> NIGHTMARE_FLAKES = registerItem("nightmare_flakes", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> OLD_BOOT = registerItem("old_boot", OldBoot::new);
	public static final RegistryObject<Item> ORANGE_SPORES = registerItem("orange_spores", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> ORBULON = registerItem("orbulon", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> PADDED_CLOTH = registerItem("padded_cloth", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)), 110);
	public static final RegistryObject<Item> PHANTASM = registerItem("phantasm", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> POWER_CORE = registerItem("power_core", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> PRIMED_GHOULASM = registerItem("primed_ghoulasm", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> PRIMORDIAL_SKULL = registerItem("primordial_skull", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> PURE_GOLD = registerItem("pure_gold", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> PURE_RAIN_STONE = registerItem("pure_rain_stone", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> REINFORCED_CLOTH = registerItem("reinforced_cloth", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)), 90);
	...
	public static final RegistryObject<Item> ROSID_ROOT = registerItem("rosid_root", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> RUNIC_ENERGY = registerItem("runic_energy", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> PROGRESS_TOKEN = registerItem("progress_token", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SCRAP_METAL = registerItem("scrap_metal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SCREAM_SHIELD = registerItem("scream_shield", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SHARP_CLAW = registerItem("sharp_claw", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SMALL_BLUE_PETAL = registerItem("small_blue_petal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SMALL_GREEN_PETAL = registerItem("small_green_petal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SMALL_ORANGE_PETAL = registerItem("small_orange_petal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SMALL_PURPLE_PETAL = registerItem("small_purple_petal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SMALL_RED_PETAL = registerItem("small_red_petal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> STICKY_SLIME = registerItem("sticky_slime", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> TEA_SHREDDINGS = registerItem("tea_shreddings", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> THORNY_PETALS = registerItem("thorny_petals", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> TORN_CLOTH = registerItem("torn_cloth", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> TOXIC_LUMP = registerItem("toxic_lump", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> UNCHARGED_STONE = registerItem("uncharged_stone", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> UNSTABLE_GUNPOWDER = registerItem("unstable_gunpowder", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> URKA_HIDE = registerItem("urka_hide", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> VOID_SCALES = registerItem("void_scales", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> BATTLE_VULCANE_AUGMENT = registerItem("battle_vulcane_augment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> EQUALITY_VULCANE_AUGMENT = registerItem("equality_vulcane_augment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> FIRE_VULCANE_AUGMENT = registerItem("fire_vulcane_augment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> IMPAIRMENT_VULCANE_AUGMENT = registerItem("impairment_vulcane_augment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> POISON_VULCANE_AUGMENT = registerItem("poison_vulcane_augment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> POWER_VULCANE_AUGMENT = registerItem("power_vulcane_augment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> WITHER_VULCANE_AUGMENT = registerItem("wither_vulcane_augment", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> WEAPON_PARTS = registerItem("weapon_parts", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> WHITEWASHING_SOLUTION = registerItem("whitewashing_solution", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> WORN_BOOK = registerItem("worn_book", WornBook::new);
	public static final RegistryObject<Item> YELLOW_SPORES = registerItem("yellow_spores", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> ZHINX_DUST = registerItem("zhinx_dust", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> BLASTER_FRAME = registerItem("blaster_frame", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> CROSSBOW_FRAME = registerItem("crossbow_frame", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> BOOTS_FRAME = registerItem("boots_frame", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> LEGGINGS_FRAME = registerItem("leggings_frame", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> CHESTPLATE_FRAME = registerItem("chestplate_frame", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> HELMET_FRAME = registerItem("helmet_frame", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> CANNON_FRAME = registerItem("cannon_frame", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GUN_FRAME = registerItem("gun_frame", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SHOTGUN_FRAME = registerItem("shotgun_frame", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SNIPER_FRAME = registerItem("sniper_frame", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));

	public static final RegistryObject<Item> AMPHIBIYTE_LUNG = registerItem("amphibiyte_lung", AmphibiyteLung::new);
	public static final RegistryObject<Item> ANCIENT_RING = registerItem("ancient_ring", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> BONE_HORN = registerItem("bone_horn", BoneHorn::new);
	public static final RegistryObject<Item> BOOK_OF_SHADOWS = registerItem("book_of_shadows", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> BOULDER_DASH = registerItem("boulder_dash", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> CALL_OF_THE_DRAKE = registerItem("call_of_the_drake", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> EXPLOSIVE_GEMS = registerItem("explosive_gems", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> EXPLOSIVE_IDOL = registerItem("explosive_idol", ExplosiveIdol::new);
	public static final RegistryObject<Item> GIANT_CRYSTAL = registerItem("giant_crystal", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GOLD_SPRING = registerItem("gold_spring", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GUARDIANS_EYE = registerItem("guardians_eye", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> SILVRO_COIN = registerItem("silvro_coin", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> INCOMPLETE_MECHA_BOW = registerItem("incomplete_mecha_bow", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> INCOMPLETE_MECHA_CANNON = registerItem("incomplete_mecha_cannon", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> INCOMPLETE_MECHA_CROSSBOW = registerItem("incomplete_mecha_crossbow", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> INCOMPLETE_MECHANICAL_ASSAULT_RIFLE = registerItem("incomplete_mechanical_assault_rifle", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> INCOMPLETE_MECHA_STAFF = registerItem("incomplete_mecha_staff", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> INCOMPLETE_MECHYRO = registerItem("incomplete_mechyro", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> AMBIENT_POWER_STONE = registerItem("ambient_power_stone", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> BLOOMING_POWER_STONE = registerItem("blooming_power_stone", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GLARING_POWER_STONE = registerItem("glaring_power_stone", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GLEAMING_POWER_STONE = registerItem("gleaming_power_stone", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GLISTENING_POWER_STONE = registerItem("glistening_power_stone", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GLOWING_POWER_STONE = registerItem("glowing_power_stone", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> RADIANT_POWER_STONE = registerItem("radiant_power_stone", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> SHINING_POWER_STONE = registerItem("shining_power_stone", () -> new Item(new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	...
	public static final RegistryObject<Item> COOKED_CANDLEFISH = registerItem("cooked_candlefish", () -> new HealingFood(7.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(6).saturationMod(0.7f).build())));
	public static final RegistryObject<Item> COOKED_CRIMSON_SKIPPER = registerItem("cooked_crimson_skipper", () -> new HealingFood(6.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(5).saturationMod(0.6f).build())));
	public static final RegistryObject<Item> COOKED_CRIMSON_STRIPEFISH = registerItem("cooked_crimson_stripefish", () -> new HealingFood(5.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(4).saturationMod(0.5f).build())));
	public static final RegistryObject<Item> COOKED_DARK_HATCHETFISH = registerItem("cooked_dark_hatchetfish", () -> new HealingFood(8.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(7).saturationMod(0.75f).build())));
	public static final RegistryObject<Item> COOKED_FINGERFISH = registerItem("cooked_fingerfish", () -> new HealingFood(1.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(1).saturationMod(0.2f).build())));
	public static final RegistryObject<Item> COOKED_GOLDEN_GULLFISH = registerItem("cooked_golden_gullfish", () -> new HealingFood(3.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(2).saturationMod(0.4f).build())));
	public static final RegistryObject<Item> COOKED_IRONBACK = registerItem("cooked_ironback", () -> new HealingFood(9.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(8).saturationMod(0.8f).build())));
	public static final RegistryObject<Item> COOKED_LIMEFISH = registerItem("cooked_limefish", () -> new HealingFood(2.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(1).saturationMod(0.35f).build())));
	public static final RegistryObject<Item> COOKED_PEARL_STRIPEFISH = registerItem("cooked_pearl_stripefish", () -> new HealingFood(1.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(1).saturationMod(0.35f).build())));
	...
	public static final RegistryObject<Item> COOKED_RAZORFISH = registerItem("cooked_razorfish", () -> new HealingFood(10.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(9).saturationMod(0.85f).build())));
	public static final RegistryObject<Item> COOKED_ROCKETFISH = registerItem("cooked_rocketfish", () -> new HealingFood(5.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(4).saturationMod(0.5f).build())));
	public static final RegistryObject<Item> COOKED_SAILBACK = registerItem("cooked_sailback", () -> new HealingFood(2.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(2).saturationMod(0.4f).build())));
	public static final RegistryObject<Item> COOKED_SAPPHIRE_STRIDER = registerItem("cooked_sapphire_strider", () -> new HealingFood(6.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(6).saturationMod(0.65f).build())));
	public static final RegistryObject<Item> COOKED_TURQUOISE_STRIPEFISH = registerItem("cooked_turquoise_stripefish", () -> new HealingFood(4.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(2).saturationMod(0.4f).build())));
	public static final RegistryObject<Item> COOKED_VIOLET_SKIPPER = registerItem("cooked_violet_skipper", () -> new HealingFood(4.0f, new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(3).saturationMod(0.5f).build())));
	...
	public static final RegistryObject<Item> CANDY_CORN = registerItem("candy_corn", () -> new Item(new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(1).saturationMod(0.22f).build())));
	public static final RegistryObject<Item> CHILLI = registerItem("chilli", Chilli::new);
	public static final RegistryObject<Item> RAW_CHARGER_SHANK = registerItem("raw_charger_shank", () -> new Item(new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(2).saturationMod(0.2f).meat().build())));
	public static final RegistryObject<Item> COOKED_CHARGER_SHANK = registerItem("cooked_charger_shank", () -> new Item(new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(7).saturationMod(0.3f).meat().build())));
	public static final RegistryObject<Item> RAW_CHIMERA_CHOP = registerItem("raw_chimera_chop", () -> new Item(new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(2).saturationMod(0.2f).meat().build())));
	...
	public static final RegistryObject<Item> GINGERBREAD_COOKIE = registerItem("gingerbread_cookie", () -> new Item(new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(2).saturationMod(0.25f).build())));
	public static final RegistryObject<Item> GINGERBREAD_WING = registerItem("gingerbread_wing", () -> new Item(new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(2).saturationMod(0.2f).build())));
	...
	public static final RegistryObject<Item> SOUR_CANDY = registerItem("sour_candy", () -> new Item(new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(1).saturationMod(0.15f).build())));
	public static final RegistryObject<Item> SOUR_GUMMY = registerItem("sour_gummy", () -> new Item(new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(1).saturationMod(0.3f).build())));
	public static final RegistryObject<Item> SOUR_POP = registerItem("sour_pop", () -> new Item(new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(1).saturationMod(0.18f).build())));
	public static final RegistryObject<Item> SPEARMINT_CANDY = registerItem("spearmint_candy", () -> new Item(new Item.Properties().tab(AoAItemGroups.FOOD).food(new Food.Builder().nutrition(1).saturationMod(0.25f).build())));
	...
	public static final RegistryObject<Item> FLORACLE_SEEDS = registerItem("floracle_seeds", () -> new BlockNamedItem(AoABlocks.FLORACLES_CROP.get(), new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> GOLDICAP_SEEDS = registerItem("goldicap_seeds", () -> new BlockNamedItem(AoABlocks.GOLDICAPS_CROP.get(), new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
	public static final RegistryObject<Item> HEART_FRUIT_SEEDS = registerItem("heart_fruit_seeds", () -> new BlockNamedItem(AoABlocks.HEART_FRUIT_CROP.get(), new Item.Properties().tab(AoAItemGroups.MISC_ITEMS)));
