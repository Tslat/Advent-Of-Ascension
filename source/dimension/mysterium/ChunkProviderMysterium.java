...
public class ChunkProviderMysterium implements IChunkProvider {
	private Random rand;
	...
	public ChunkProviderMysterium(final World par1World, final long par2) {
	...
	public void generate(final int i, final int j, final Block[] b) {
		final MysteriumChunkBuilder builder = new MysteriumChunkBuilder();
