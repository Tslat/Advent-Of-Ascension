...
public class ChunkGenDustopia implements IChunkGenerator {
	...
	private final Biome biome = DimensionRegister.biomeDustopia;
	...
	protected ChunkGenDustopia(World world) {
		this.world = world;
	...
	public void populate(int chunkX, int chunkZ) {
		...
		if (ConfigurationUtil.StructureConfig.dustopia.primordialShrineSpawnChance > 0 && rand.nextInt(ConfigurationUtil.StructureConfig.dustopia.primordialShrineSpawnChance) == 0) {
			...
			if (world.getBlockState(pos.setPos(x + 16, y - 1, z + 17)) == biome.topBlock)
				StructuresHandler.generateStructure("DustopianVillage", world, rand, pos.setPos(x, y, z));
		}
