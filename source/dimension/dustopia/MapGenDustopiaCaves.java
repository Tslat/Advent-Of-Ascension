...
public class MapGenDustopiaCaves extends MapGenBase {
	...
	protected void func_151541_a(long p_151541_1_, int p_151541_3_, int p_151541_4_, Block[] p_151541_5_, double p_151541_6_, double p_151541_8_, double p_151541_10_, float p_151541_12_, float p_151541_13_, float p_151541_14_, int p_151541_15_, int p_151541_16_, double p_151541_17_) {
		...
		for (boolean flag = random.nextInt(6) == 0; p_151541_15_ < p_151541_16_; ++p_151541_15_) {
			...
			if (!flag2 && p_151541_15_ == k1 && p_151541_12_ > 1.0F && p_151541_16_ > 0) {
				func_151541_a(random.nextLong(), p_151541_3_, p_151541_4_, p_151541_5_, p_151541_6_, p_151541_8_, p_151541_10_, random.nextFloat() * 0.5F + 0.5F, p_151541_13_ - ((float)Math.PI / 2F), p_151541_14_ / 3.0F, p_151541_15_, p_151541_16_, 1.0D);
				func_151541_a(random.nextLong(), p_151541_3_, p_151541_4_, p_151541_5_, p_151541_6_, p_151541_8_, p_151541_10_, random.nextFloat() * 0.5F + 0.5F, p_151541_13_ + ((float)Math.PI / 2F), p_151541_14_ / 3.0F, p_151541_15_, p_151541_16_, 1.0D);
				return;
			}
	...
	protected void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_) {
		...
		for (int j1 = 0; j1 < i1; ++j1) {
			double d0 = (double)(p_151538_2_ * 16 + rand.nextInt(16));
			double d1 = (double)rand.nextInt(rand.nextInt(120) + 8);
			double d2 = (double)(p_151538_3_ * 16 + rand.nextInt(16));
			int k1 = 1;

			if (rand.nextInt(4) == 0) {
				func_151542_a(rand.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, d0, d1, d2);
				k1 += rand.nextInt(4);
			}
			...
			for (int l1 = 0; l1 < k1; ++l1) {
				...
				func_151541_a(rand.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, d0, d1, d2, f2, f, f1, 0, 0, 1.0D);
			}
		}
	}
	...
	protected void digBlock(Block[] data, int index, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop) {
		BiomeGenBase biome = worldObj.getBiomeGenForCoords(x + chunkX * 16, z + chunkZ * 16);
		Block top = (isExceptionBiome(biome) ? Blockizer.GrassDustopia : biome.topBlock);
		Block filler = (isExceptionBiome(biome) ? Blockizer.StoneDustopia : biome.fillerBlock);
		Block block = data[index];

		if (block == Blockizer.StoneDustopia || block == filler || block == top) {
			if (y < 2) {
