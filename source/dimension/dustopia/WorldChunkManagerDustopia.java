...
public class WorldChunkManagerDustopia extends WorldChunkManager {
	private GenLayer genBiomes;
	private GenLayer biomeIndexLayer;
	private BiomeCache biomeCache;
	private List<BiomeGenBase> biomesToSpawnIn;

	public WorldChunkManagerDustopia() {
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<BiomeGenBase>();
		biomesToSpawnIn.addAll(allowedBiomes);
	}

	public WorldChunkManagerDustopia(long seed, WorldType worldType) {
		this();
		// i changed this to my GenLayerTutorial
		GenLayer[] agenlayer = GenLayerDustopia.makeTheWorld(seed, worldType);
		agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
		genBiomes = agenlayer[0];
		biomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerDustopia(World world) {
