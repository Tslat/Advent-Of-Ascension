...
public class WorldProviderAcv extends WorldProvider {
	public String getDimensionName() {
		return "DimensionAncientCavern";
	}

	public void registerWorldChunkManager() {
		worldChunkMgr = new WorldChunkManagerHell(DimensionOrganizer.AncientCavern, 1.0f);
		dimensionId = Dimensionizer.ancientcavernId;
		hasNoSky = true;
	}

	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderAncientCavern(worldObj, worldObj.getSeed());
	}
