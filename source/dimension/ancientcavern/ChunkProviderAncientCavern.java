...
import net.nevermine.structures.ancientcavern.*;

import java.util.List;
import java.util.Random;

public class ChunkProviderAncientCavern implements IChunkProvider {
	private Random rand;
	...
	public ChunkProviderAncientCavern(final World par1World, final long par2) {
	...
	public void populate(final IChunkProvider par1IChunkProvider, final int par2, final int par3) {
		...
		final int y = 15;
		if (par2 == 0 && par3 == 0) {
			new CavernP1().generate(worldObj, rand, x - 20, y, z - 20);
			new CavernP2().generate(worldObj, rand, x - 20, y, z - 20);
			new CavernP3().generate(worldObj, rand, x - 20, y, z - 20);
			new CavernP4().generate(worldObj, rand, x - 20, y, z - 20);
			new CavernP5().generate(worldObj, rand, x - 20, y, z - 20);
			new CavernP6().generate(worldObj, rand, x - 20, y, z - 20);
			new ConiferonRoom().generate(worldObj, rand, x - 75, y, z - 75);
			new HoronRoom().generate(worldObj, rand, x + 75, y, z - 75);
			new PenumbraRoom().generate(worldObj, rand, x - 75, y, z + 75);
			new GoldorthRoom().generate(worldObj, rand, x + 75, y, z + 75);
		}
	}
