...
public class TeleporterAncientCavern extends Teleporter {
	...
	public TeleporterAncientCavern(final WorldServer par1WorldServer) {
	...
	public boolean placeInExistingPortal(final Entity entity, final double notUsed_entityX, final double notUsed_entityY, final double notUsed_entityZ, final float notUsed_entityRotation) {
		if (entity instanceof EntityPlayer) {
			if (entity.dimension == ConfigurationHelper.ancientcavern) {
				entity.setLocationAndAngles(0.0, 18.0, 0.0, entity.rotationYaw, 0.0f);
			}
			else {
