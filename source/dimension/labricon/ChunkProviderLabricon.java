...
public class ChunkProviderLabricon implements IChunkProvider {
	private Random rand;
	...
	public ChunkProviderLabricon(final World par1World, final long par2) {
	...
	public void generate(final int i, final int j, final Block[] b) {
		final LabriconChunkBuilder builder = new LabriconChunkBuilder();
		LabriconChunkBuilder.toTerrainArray(builder.buildChunk(), b);
	}
