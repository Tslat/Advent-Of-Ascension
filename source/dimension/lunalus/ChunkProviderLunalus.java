...
public class ChunkProviderLunalus implements IChunkProvider {
	private Random rand;
	...
	public ChunkProviderLunalus(final World par1World, final long par2) {
	...
	public void generate(final int i, final int j, final Block[] b) {
		final LunalusChunkBuilder builder = new LunalusChunkBuilder();
		LunalusChunkBuilder.toTerrainArray(builder.buildChunk(), b);
	}
