...
public class WorldProviderLu extends WorldProvider {
	public String getDimensionName() {
		return "DimensionLunalus";
	}

	public void registerWorldChunkManager() {
		worldChunkMgr = new WorldChunkManagerHell(DimensionOrganizer.Lunalus, 1.0f);
		dimensionId = Dimensionizer.lunalusId;
		hasNoSky = true;
	}

	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderLunalus(worldObj, worldObj.getSeed());
	}
