...
public class ChunkProviderLelyetia implements IChunkProvider {
	private Random rand;
	...
	public ChunkProviderLelyetia(final World par1World, final long par2) {
	...
	public void generate(final int i, final int j, final Block[] b) {
		final LelyetiaChunkBuilder builder = new LelyetiaChunkBuilder();
