...
public class WorldProviderLl extends WorldProvider {
	public String getDimensionName() {
		return "DimensionLelyetia";
	}

	public void registerWorldChunkManager() {
		worldChunkMgr = new WorldChunkManagerHell(DimensionOrganizer.Lelyetia, 1.0f);
		dimensionId = Dimensionizer.lelyetiaId;
	}

	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderLelyetia(worldObj, worldObj.getSeed());
	}
