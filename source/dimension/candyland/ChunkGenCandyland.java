...
public class ChunkGenCandyland implements IChunkGenerator {
	...
	private final Biome biome = DimensionRegister.biomeCandyland;
	...
	protected ChunkGenCandyland(World world) {
		this.world = world;
	...
	public void populate(int chunkX, int chunkZ) {
		...
		if (ConfigurationUtil.spawnChanceCottonCandyTower > 0 && rand.nextInt(ConfigurationUtil.spawnChanceCottonCandyTower) == 0) {
			...
			if (world.getBlockState(pos.setPos(x + 6, y - 1, z + 6)) == biome.topBlock)
				StructuresHandler.generateStructure("InfestedCandyCane", world, rand, pos.setPos(x, y, z));
		}
