...
public class ChunkGenGardencia implements IChunkGenerator {
	...
	private final Biome biome = DimensionRegister.biomeGardencia;
	...
	protected ChunkGenGardencia(World world) {
		this.world = world;
		this.rand = new Random(world.getSeed());
		this.world.setSeaLevel(66);
	...
	public void populate(int chunkX, int chunkZ) {
		...
		if (ConfigurationUtil.StructureConfig.gardencia.kineticRuneShrineSpawnChance > 0 && rand.nextInt(ConfigurationUtil.StructureConfig.gardencia.kineticRuneShrineSpawnChance) == 0) {
			...
			StructuresHandler.generateStructure("KineticRuneShrine", world, rand, pos.setPos(x, y, z));
		}
