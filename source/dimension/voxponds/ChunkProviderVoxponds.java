...
public class ChunkProviderVoxponds implements IChunkProvider {
	private Random rand;
	...
	public ChunkProviderVoxponds(final World par1World, final long par2) {
	...
	public void generate(final int i, final int j, final Block[] b) {
		final VoxPondsChunkBuilder builder = new VoxPondsChunkBuilder();
		VoxPondsChunkBuilder.toTerrainArray(builder.buildChunk(), b);
	}
