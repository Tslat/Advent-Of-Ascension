...
public class WorldChunkManagerGreckon extends WorldChunkManager {
	...
	public WorldChunkManagerGreckon() {
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<BiomeGenBase>();
		biomesToSpawnIn.addAll(allowedBiomes);
	}

	public WorldChunkManagerGreckon(long seed, WorldType worldType) {
		this();
		// i changed this to my GenLayerTutorial
		GenLayer[] agenlayer = GenLayerGreckon.makeTheWorld(seed, worldType);
		agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
		genBiomes = agenlayer[0];
		biomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerGreckon(World world) {
