...
public class TeleporterCreeponia extends Teleporter {
	private final WorldServer worldServerInstance;
	private final Random random;
	private final LongHashMap destinationCoordinateCache;
	private final List destinationCoordinateKeys;

	public TeleporterCreeponia(final WorldServer par1WorldServer) {
	...
	public void placeInPortal(final Entity par1Entity, final double par2, final double par4, final double par6, final float par8) {
		if (par1Entity instanceof EntityPlayer) {
			if (worldServerInstance.provider.dimensionId == ConfigurationHelper.creeponia) {
	...
	public boolean placeInExistingPortal(final Entity par1Entity, final double par2, final double par4, final double par6, final float par8) {
			...
			for (int l2 = l - short1; l2 <= l + short1; ++l2) {
				...
				for (int l3 = i2 - short1; l3 <= i2 + short1; ++l3) {
					...
					for (int i3 = worldServerInstance.getActualHeight() - 1; i3 >= 0; --i3) {
						if (worldServerInstance.getBlock(l2, i3, l3) == Blockizer.creeponiaPortal) {
							while (worldServerInstance.getBlock(l2, i3 - 1, l3) == Blockizer.creeponiaPortal) {
								--i3;
							}
		...
		if (d3 >= 0.0) {
			...
			double d6 = k + 0.5;
			int i4 = -1;
			if (worldServerInstance.getBlock(i - 1, j, k) == Blockizer.creeponiaPortal) {
				i4 = 2;
			}
			if (worldServerInstance.getBlock(i + 1, j, k) == Blockizer.creeponiaPortal) {
				i4 = 0;
			}
			if (worldServerInstance.getBlock(i, j, k - 1) == Blockizer.creeponiaPortal) {
				i4 = 3;
			}
			if (worldServerInstance.getBlock(i, j, k + 1) == Blockizer.creeponiaPortal) {
				i4 = 1;
			...
			for (int i4 = -1; i4 <= 1; ++i4) {
				for (int j3 = 1; j3 < 3; ++j3) {
					for (int k4 = -1; k4 < 3; ++k4) {
						...
						worldServerInstance.setBlock(l3, i5, j4, flag ? Blocks.gravel : Blocks.air);
						worldServerInstance.setBlock(l3 + 1, i5, j4, flag ? Blocks.gravel : Blocks.air);
						worldServerInstance.setBlock(l3 - 1, i5, j4, flag ? Blocks.gravel : Blocks.air);
						worldServerInstance.setBlock(l3 + 2, i5, j4, flag ? Blocks.gravel : Blocks.air);
						worldServerInstance.setBlock(l3 - 2, i5, j4, flag ? Blocks.gravel : Blocks.air);
						worldServerInstance.setBlock(l3, i5, j4 + 1, flag ? Blocks.gravel : Blocks.air);
						worldServerInstance.setBlock(l3, i5, j4 - 1, flag ? Blocks.gravel : Blocks.air);
						worldServerInstance.setBlock(l3, i5, j4 + 2, flag ? Blocks.gravel : Blocks.air);
						worldServerInstance.setBlock(l3, i5, j4 - 2, flag ? Blocks.gravel : Blocks.air);
					}
				}
			}
		...
		for (int i4 = 0; i4 < 4; ++i4) {
			for (int j3 = 0; j3 < 4; ++j3) {
				for (int k4 = -1; k4 < 4; ++k4) {
					...
					worldServerInstance.setBlock(l3, i5, j4, flag ? Blocks.gravel : Blockizer.creeponiaPortal, 0, 2);
				}
			}
			for (int j3 = 0; j3 < 4; ++j3) {
				for (int k4 = -1; k4 < 4; ++k4) {
