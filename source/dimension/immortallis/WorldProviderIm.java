...
public class WorldProviderIm extends WorldProvider {
	public String getDimensionName() {
		return "DimensionImmortallis";
	}

	public void registerWorldChunkManager() {
		worldChunkMgr = new WorldChunkManagerHell(DimensionOrganizer.Immortallis, 1.0f);
		dimensionId = Dimensionizer.immortallisId;
		hasNoSky = true;
	}

	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderImmortallis(worldObj, worldObj.getSeed());
	}
