...
import net.nevermine.structures.immortallis.*;

import java.util.List;
import java.util.Random;

public class ChunkProviderImmortallis implements IChunkProvider {
	private Random rand;
	...
	public ChunkProviderImmortallis(final World par1World, final long par2) {
	...
	public void populate(final IChunkProvider par1IChunkProvider, final int par2, final int par3) {
		...
		final int y = 17;
		if (par2 == 0 && par3 == 0) {
			new ImmortalDungeonP1().generate(worldObj, rand, x - 15, y, z - 40);
			new ImmortalDungeonP2().generate(worldObj, rand, x - 15, y, z - 40);
			new ImmortalDungeonP3().generate(worldObj, rand, x - 15, y, z - 40);
			new ImmortalDungeonP4().generate(worldObj, rand, x - 15, y, z - 40);
			new ImmortalDungeonP5().generate(worldObj, rand, x - 15, y, z - 40);
			new ImmortalDungeonP6().generate(worldObj, rand, x - 15, y, z - 40);
			new ImmortalDungeonP7().generate(worldObj, rand, x - 15, y, z - 40);
			new ImmortalDungeonP8().generate(worldObj, rand, x - 15, y, z - 40);
			new ImmortalDungeonP9().generate(worldObj, rand, x - 15, y, z - 40);
		}
	}
