...
public class EntityCannonBall extends EntityThrowable implements HardProjectile {
	private float damage;
	float f4;
	private float gravity;
	private int knockbackStrength;

	public EntityCannonBall(final World par1World) {
		super(par1World);
	}

	public EntityCannonBall(final World par1World, final EntityPlayer par3EntityPlayer, final float dmg, final int knock, final float grav) {
	...
	public EntityCannonBall(final World par1World, final double par2, final double par4, final double par6) {
