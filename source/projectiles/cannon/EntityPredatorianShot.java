...
public class EntityPredatorianShot extends EntityThrowable implements HardProjectile {
	private float damage;
	float f4;
	private int knockbackStrength;

	public EntityPredatorianShot(final World par1World) {
		super(par1World);
	}

	public EntityPredatorianShot(final World par1World, final EntityPlayer par3EntityPlayer, final float dmg, final int knock) {
	...
	public EntityPredatorianShot(final World par1World, final double par2, final double par4, final double par6) {
	...
	public void onUpdate() {
		...
		if (worldObj.isRemote) {
			for (int var3 = 0; var3 < 8; ++var3) {
				final SkeletalTrail var4 = new SkeletalTrail(worldObj, posX, posY, posZ, 0.0, 0.0, 0.0, 8);
