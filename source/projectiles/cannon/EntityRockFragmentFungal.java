...
public class EntityRockFragmentFungal extends EntityThrowable implements HardProjectile {
	private float damage;
	private int age;

	public EntityRockFragmentFungal(final World par1World) {
		super(par1World);
		age = 0;
	}

	public EntityRockFragmentFungal(final World par1World, final EntityPlayer par3EntityPlayer, final float dmg) {
	...
	public EntityRockFragmentFungal(final World par1World, final double par2, final double par4, final double par6) {
