...
public class EntityShadowBall extends EntityThrowable implements HardProjectile {
	...
	public EntityShadowBall(final World par1World) {
		super(par1World);
		speed = 0.3f;
		shot1 = 0.0f;
		switch1 = 0;
	...
	public EntityShadowBall(final World par1World, final EntityPlayer par3EntityPlayer, final float dmg, final int knock) {
	...
	public EntityShadowBall(final World par1World, final double par2, final double par4, final double par6) {
