...
public class EntityFireBall extends EntityThrowable implements HardProjectile {
	...
	public EntityFireBall(final World par1World, final EntityPlayer par3EntityPlayer, final float dmg, final int knock) {
	...
	public EntityFireBall(final World par1World, final double par2, final double par4, final double par6) {
