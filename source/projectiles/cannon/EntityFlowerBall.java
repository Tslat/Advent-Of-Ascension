...
public class EntityFlowerBall extends EntityThrowable implements HardProjectile {
	private float damage;
	float f4;
	private int knockbackStrength;

	public EntityFlowerBall(final World par1World) {
		super(par1World);
	}

	public EntityFlowerBall(final World par1World, final EntityPlayer par3EntityPlayer, final float dmg, final int knock) {
	...
	public EntityFlowerBall(final World par1World, final double par2, final double par4, final double par6) {
