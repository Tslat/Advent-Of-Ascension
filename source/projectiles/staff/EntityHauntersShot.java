...
public class EntityHauntersShot extends EntityThrowable {
	...
	public EntityHauntersShot(final World par1World) {
		super(par1World);
		age = 0;
	}

	public EntityHauntersShot(final World par1World, final EntityPlayer par3EntityPlayer, final float dmg, final int knock, final float grav) {
	...
	public EntityHauntersShot(final World par1World, final double par2, final double par4, final double par6) {
