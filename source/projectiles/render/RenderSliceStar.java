...
public class RenderSliceStar extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderSliceStar() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderSliceStar.EntityTexture;
	}

	static {
		RenderSliceStar.EntityTexture = new ResourceLocation("nevermine:textures/items/sliceStar.png");
	}
}
