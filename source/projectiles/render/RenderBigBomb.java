...
public class RenderBigBomb extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderBigBomb() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderBigBomb.EntityTexture;
	}

	static {
		RenderBigBomb.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/bigBomb.png");
	}
}
