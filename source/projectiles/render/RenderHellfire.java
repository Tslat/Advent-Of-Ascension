...
public class RenderHellfire extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderHellfire() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderHellfire.EntityTexture;
	}

	static {
		RenderHellfire.EntityTexture = new ResourceLocation("nevermine:textures/items/hellFire.png");
	}
}
