...
public class RenderLaserShot extends Render {
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderLaserShot.EntityTexture;
	}

	static {
		RenderLaserShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/laserShot.png");
	}
}
