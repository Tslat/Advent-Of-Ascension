...
public class RenderSoundCannon3 extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderSoundCannon3() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderSoundCannon3.EntityTexture;
	}

	static {
		RenderSoundCannon3.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/musicRed.png");
	}
}
