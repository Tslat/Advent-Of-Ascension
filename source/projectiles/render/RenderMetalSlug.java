...
public class RenderMetalSlug extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderMetalSlug() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderMetalSlug.EntityTexture;
	}

	static {
		RenderMetalSlug.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/slug.png");
	}
}
