...
public class RenderRunicBomb extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderRunicBomb() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderRunicBomb.EntityTexture;
	}

	static {
		RenderRunicBomb.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/runicShot.png");
	}
}
