...
public class RenderDischargeShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderDischargeShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderDischargeShot.EntityTexture;
	}

	static {
		RenderDischargeShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/fireShot.png");
	}
}
