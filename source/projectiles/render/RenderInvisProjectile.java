...
public class RenderInvisProjectile extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderInvisProjectile() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderInvisProjectile.EntityTexture;
	}

	static {
		RenderInvisProjectile.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/invis.png");
	}
}
