...
public class RenderSoundCannon1 extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderSoundCannon1() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderSoundCannon1.EntityTexture;
	}

	static {
		RenderSoundCannon1.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/musicBlue.png");
	}
}
