...
public class RenderCannonShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderCannonShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderCannonShot.EntityTexture;
	}

	static {
		RenderCannonShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/cannonShot.png");
	}
}
