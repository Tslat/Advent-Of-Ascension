...
public class RenderIllusionShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderIllusionShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderIllusionShot.EntityTexture;
	}

	static {
		RenderIllusionShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/illusionShot.png");
	}
}
