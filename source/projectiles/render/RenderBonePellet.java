...
public class RenderBonePellet extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderBonePellet() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderBonePellet.EntityTexture;
	}

	static {
		RenderBonePellet.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/bonePellet.png");
	}
}
