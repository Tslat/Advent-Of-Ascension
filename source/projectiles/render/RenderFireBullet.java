...
public class RenderFireBullet extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderFireBullet() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderFireBullet.EntityTexture;
	}

	static {
		RenderFireBullet.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/fireShot.png");
	}
}
