...
public class RenderWartDart extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderWartDart() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderWartDart.EntityTexture;
	}

	static {
		RenderWartDart.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/wartDart.png");
	}
}
