...
public class RenderProtonShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderProtonShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderProtonShot.EntityTexture;
	}

	static {
		RenderProtonShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/protonShot.png");
	}
}
