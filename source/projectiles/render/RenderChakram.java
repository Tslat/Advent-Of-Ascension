...
public class RenderChakram extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderChakram() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderChakram.EntityTexture;
	}

	static {
		RenderChakram.EntityTexture = new ResourceLocation("nevermine:textures/items/chakram.png");
	}
}
