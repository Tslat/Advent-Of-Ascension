...
public class RenderHellBubbleShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderHellBubbleShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderHellBubbleShot.EntityTexture;
	}

	static {
		RenderHellBubbleShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/hellBubble.png");
	}
}
