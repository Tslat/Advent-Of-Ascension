...
public class RenderSoundCannon4 extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderSoundCannon4() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderSoundCannon4.EntityTexture;
	}

	static {
		RenderSoundCannon4.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/musicGreen.png");
	}
}
