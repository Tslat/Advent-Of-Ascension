...
public class RenderWrathShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderWrathShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderWrathShot.EntityTexture;
	}

	static {
		RenderWrathShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/wrathShot.png");
	}
}
