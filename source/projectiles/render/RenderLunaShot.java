...
public class RenderLunaShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderLunaShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderLunaShot.EntityTexture;
	}

	static {
		RenderLunaShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/lunaShot.png");
	}
}
