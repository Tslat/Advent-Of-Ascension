...
public class RenderBubbleShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderBubbleShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderBubbleShot.EntityTexture;
	}

	static {
		RenderBubbleShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/bubble.png");
	}
}
