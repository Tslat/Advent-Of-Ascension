...
public class RenderPopperShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderPopperShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderPopperShot.EntityTexture;
	}

	static {
		RenderPopperShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/popperShot.png");
	}
}
