...
public class RenderSkulloShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderSkulloShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderSkulloShot.EntityTexture;
	}

	static {
		RenderSkulloShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/skulloShot.png");
	}
}
