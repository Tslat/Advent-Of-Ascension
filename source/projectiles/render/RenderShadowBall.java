...
public class RenderShadowBall extends Render {
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderShadowBall.EntityTexture;
	}

	static {
		RenderShadowBall.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/shadowBall.png");
	}
}
