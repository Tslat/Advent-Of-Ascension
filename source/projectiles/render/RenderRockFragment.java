...
public class RenderRockFragment extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderRockFragment() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderRockFragment.EntityTexture;
	}

	static {
		RenderRockFragment.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/rockFragment.png");
	}
}
