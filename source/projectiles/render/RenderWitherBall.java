...
public class RenderWitherBall extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderWitherBall() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderWitherBall.EntityTexture;
	}

	static {
		RenderWitherBall.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/witherBall.png");
	}
}
