...
public class RenderFragmentShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderFragmentShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderFragmentShot.EntityTexture;
	}

	static {
		RenderFragmentShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/fragmentShot.png");
	}
}
