...
public class RenderNetherSlug extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderNetherSlug() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderNetherSlug.EntityTexture;
	}

	static {
		RenderNetherSlug.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/netherSlug.png");
	}
}
