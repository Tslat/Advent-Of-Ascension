...
public class RenderMetalPellet extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderMetalPellet() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderMetalPellet.EntityTexture;
	}

	static {
		RenderMetalPellet.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/metalPellet.png");
	}
}
