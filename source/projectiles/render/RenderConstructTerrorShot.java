...
public class RenderConstructTerrorShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderConstructTerrorShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderConstructTerrorShot.EntityTexture;
	}

	static {
		RenderConstructTerrorShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/constructShot.png");
	}
}
