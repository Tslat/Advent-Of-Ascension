...
public class RenderBlissfulBlast extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderBlissfulBlast() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderBlissfulBlast.EntityTexture;
	}

	static {
		RenderBlissfulBlast.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/smileBall.png");
	}
}
