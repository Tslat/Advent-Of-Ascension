...
public class RenderVulkram extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderVulkram() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderVulkram.EntityTexture;
	}

	static {
		RenderVulkram.EntityTexture = new ResourceLocation("nevermine:textures/items/vulkram.png");
	}
}
