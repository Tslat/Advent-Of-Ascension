...
public class RenderSoundCannon2 extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderSoundCannon2() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderSoundCannon2.EntityTexture;
	}

	static {
		RenderSoundCannon2.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/musicYellow.png");
	}
}
