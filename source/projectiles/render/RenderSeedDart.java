...
public class RenderSeedDart extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderSeedDart() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderSeedDart.EntityTexture;
	}

	static {
		RenderSeedDart.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/seedDart.png");
	}
}
