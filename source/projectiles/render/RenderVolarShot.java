...
public class RenderVolarShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderVolarShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderVolarShot.EntityTexture;
	}

	static {
		RenderVolarShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/voliantShot.png");
	}
}
