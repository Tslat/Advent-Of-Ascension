...
public class RenderGrenadeShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderGrenadeShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderGrenadeShot.EntityTexture;
	}

	static {
		RenderGrenadeShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/grenadeShot.png");
	}
}
