...
public class RenderPopShot extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderPopShot() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderPopShot.EntityTexture;
	}

	static {
		RenderPopShot.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/popShot.png");
	}
}
