...
public class RenderSoundCannon5 extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderSoundCannon5() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderSoundCannon5.EntityTexture;
	}

	static {
		RenderSoundCannon5.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/musicPurple.png");
	}
}
