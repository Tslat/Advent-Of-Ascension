...
public class RenderBalloonBomb extends Render {
	private static ResourceLocation EntityTexture;
	private float scale;

	public RenderBalloonBomb() {
		scale = 1.0f;
	}
	...
	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderBalloonBomb.EntityTexture;
	}

	static {
		RenderBalloonBomb.EntityTexture = new ResourceLocation("nevermine:textures/projectiles/balloonBomb.png");
	}
}
