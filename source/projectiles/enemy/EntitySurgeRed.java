...
public class EntitySurgeRed extends EntityThrowable {
	private float damage;
	private int clr;
	private int age;

	public EntitySurgeRed(final World par1World) {
		super(par1World);
		age = 0;
	}

	public EntitySurgeRed(final World par1World, final EntityMob entityGoblin, final float dmg, final int color) {
	...
	public EntitySurgeRed(final World par1World, final double par2, final double par4, final double par6) {
