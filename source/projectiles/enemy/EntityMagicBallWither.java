...
public class EntityMagicBallWither extends EntityThrowable {
	private float damage;
	private int clr;
	private int age;

	public EntityMagicBallWither(final World par1World) {
		super(par1World);
		age = 0;
	}

	public EntityMagicBallWither(final World par1World, final EntityMob entityGoblin, final float dmg, final int color) {
	...
	public EntityMagicBallWither(final World par1World, final double par2, final double par4, final double par6) {
