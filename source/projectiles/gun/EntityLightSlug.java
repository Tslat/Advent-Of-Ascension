...
public class EntityLightSlug extends EntityThrowable implements HardProjectile {
	private float damage;
	float f4;
	private int knockbackStrength;

	public EntityLightSlug(final World par1World) {
		super(par1World);
	}

	public EntityLightSlug(final World par1World, final EntityPlayer par3EntityPlayer, final float dmg, final int knock) {
	...
	public EntityLightSlug(final World par1World, final double par2, final double par4, final double par6) {
