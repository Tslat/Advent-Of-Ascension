...
public class EntityTagDamageBonusProjectile extends EntityTagDamageBonus {
	...
	public EntityTagDamageBonusProjectile(AoASkill.Instance skill, CompoundNBT data) {
		super(AoAAbilities.ENTITY_TAG_DAMAGE_BONUS_PROJECTILE.get(), skill, data);
	}

	@Override
	protected void updateDescription(TranslationTextComponent defaultDescription) {
		defaultDescription = new TranslationTextComponent(defaultDescription.getKey() + ".projectile", getScalingDescriptionComponent(4), new StringTextComponent(this.tag.getName().toString()));
