...
public class ScalingJumpBoost extends AoAAbility.Instance {
	...
	public ScalingJumpBoost(AoASkill.Instance skill, JsonObject data) {
		super(AoAAbilities.SCALING_JUMP_BOOST.get(), skill, data);
	...
	public ScalingJumpBoost(AoASkill.Instance skill, CompoundNBT data) {
		super(AoAAbilities.SCALING_JUMP_BOOST.get(), skill, data);
	...
	public TranslationTextComponent getDescription() {
		...
		else if (perLevelBoost != 0) {
			keySuffix = ".scaled";
		}

		if (sprintJumpBoost) {
			return new TranslationTextComponent(super.getDescription().getKey() + ".lateral" + keySuffix, NumberUtil.roundToNthDecimalPlace(baseBoost * 100, 2), NumberUtil.roundToNthDecimalPlace(perLevelBoost * 100, 2));
		}
		else {
			return new TranslationTextComponent(super.getDescription().getKey() + ".vertical" + keySuffix, NumberUtil.roundToNthDecimalPlace(baseBoost * 100, 2), NumberUtil.roundToNthDecimalPlace(perLevelBoost * 100, 2));
		}
	}
