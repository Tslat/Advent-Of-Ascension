...
public final class PlayerDataManager implements AoAPlayerEventListener {
	...
	public void updatePlayerInstance(ServerPlayerEntity player) {
		this.player = player;
	}
	...
	public void handlePlayerDataClone(final PlayerEvent.Clone ev) {
		PlayerDataManager sourceData = PlayerUtil.getAdventPlayer((ServerPlayerEntity)ev.getOriginal());
