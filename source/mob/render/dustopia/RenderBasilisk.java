...
public class RenderBasilisk extends RenderLiving {
	...
	public RenderBasilisk(final ModelBase par1ModelBase, final float par2) {
		super(par1ModelBase, par2);
		model = (modelBasilisk)mainModel;
	}
	...
	static {
		EntityTexture = new ResourceLocation("nevermine:textures/mobs/basilisk.png");
	}
}
