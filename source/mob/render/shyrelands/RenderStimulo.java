...
public class RenderStimulo extends RenderLiving {
	private static final ResourceLocation EntityTexture = new ResourceLocation("nevermine:textures/mobs/stimulo.png");
	protected modelStimulo model;

	public RenderStimulo(ModelBase par1ModelBase, float par2) {
		super(par1ModelBase, par2);
		this.model = ((modelStimulo)this.mainModel);
	}
