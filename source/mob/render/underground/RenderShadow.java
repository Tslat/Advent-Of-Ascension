...
public class RenderShadow extends RenderLiving {
	...
	protected modelShadow model;

	public RenderShadow(final ModelBase par1ModelBase, final float par2) {
		super(par1ModelBase, par2);
		model = (modelShadow)mainModel;
	}

	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderShadow.EntityTexture;
	}
