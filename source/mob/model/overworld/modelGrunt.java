...
public class modelGrunt extends ModelBase {
	...
	public modelGrunt() {
		textureWidth = 64;
		textureHeight = 32;
		(head = new ModelRenderer(this, 25, 0)).addBox(4.0f, -11.0f, -1.0f, 1, 4, 3);
		...
		(head2 = new ModelRenderer(this, 36, 4)).addBox(-1.0f, -4.0f, -7.0f, 2, 2, 2);
		head2.setRotationPoint(0.0f, 10.0f, 0.0f);
		head2.setTextureSize(64, 32);
		head2.mirror = true;
		setRotation(head2, 0.0f, 0.0f, 0.0f);
		(head3 = new ModelRenderer(this, 25, 0)).addBox(-5.0f, -11.0f, -1.0f, 1, 4, 3);
		head3.setRotationPoint(0.0f, 10.0f, 0.0f);
		head3.setTextureSize(64, 32);
		head3.mirror = true;
		setRotation(head3, 0.0f, 0.0f, 0.0f);
		(head4 = new ModelRenderer(this, 45, 0)).addBox(-2.0f, -6.0f, -5.0f, 4, 1, 1);
		...
		(head7 = new ModelRenderer(this, 45, 0)).addBox(-4.0f, -8.0f, -5.0f, 8, 2, 1);
