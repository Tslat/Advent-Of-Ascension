...
public class modelNightmareSpider extends ModelBase {
	...
	public modelNightmareSpider() {
		textureWidth = 128;
		textureHeight = 32;
		(Ear2 = new ModelRenderer(this, 92, 4)).addBox(2.0f, -10.0f, -7.0f, 2, 4, 2);
		Ear2.setRotationPoint(0.0f, 18.0f, -3.0f);
		...
		setRotation(RearEnd2, 0.6108652f, 0.0f, 0.0f);
		...
		(Leg1 = new ModelRenderer(this, 18, 0)).addBox(-15.0f, -4.0f, -1.0f, 16, 2, 2);
		Leg1.setRotationPoint(-4.0f, 18.0f, 2.0f);
		Leg1.setTextureSize(64, 32);
		Leg1.mirror = true;
		setRotation(Leg1, 0.0f, 0.5759587f, -0.1919862f);
		(RearEnd = new ModelRenderer(this, 0, 12)).addBox(-5.0f, -6.0f, -6.0f, 10, 8, 12);
		RearEnd.setRotationPoint(0.0f, 18.0f, 9.0f);
		RearEnd.setTextureSize(64, 32);
		RearEnd.mirror = true;
		setRotation(RearEnd, 0.0f, 0.0f, 0.0f);
		(RearEnd3 = new ModelRenderer(this, 68, 1)).addBox(-5.0f, -6.0f, -6.0f, 2, 4, 9);
		RearEnd3.setRotationPoint(2.0f, 14.0f, 11.0f);
