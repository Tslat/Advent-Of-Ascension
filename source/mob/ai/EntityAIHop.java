...
public class EntityAIHop extends EntityAIBase {
	...
	public EntityAIHop(final EntityLiving par1EntityLiving, final float par2) {
	...
	public void startExecuting() {
		...
		leaper.motionX += var1 / var3 * 0.4 * 0.200000011920929 + this.leaper.motionX * 0.10000000298023223;
		final EntityLivingBase leaper2 = this.leaper;
		leaper2.motionZ += var2 / var3 * 0.4 * 0.200000011920929 + this.leaper.motionZ * 0.10000000298023223;
