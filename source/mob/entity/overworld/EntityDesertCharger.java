...
public class EntityDesertCharger extends EntityMob {
	public EntityDesertCharger(final World par1World) {
		super(par1World);
		setSize(1.0f, 1.0f);
	}
	...
	public boolean attackEntityAsMob(final Entity par1) {
		if (super.attackEntityAsMob(par1)) {
			if (par1 instanceof EntityLivingBase) {
				((EntityLivingBase)par1).addPotionEffect(new PotionEffect(Potion.weakness.id, 150, 0));
			}
			return true;
		}
		return false;
