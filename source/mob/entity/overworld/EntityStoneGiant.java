...
public class EntityStoneGiant extends EntityMob {
	...
	public boolean getCanSpawnHere() {
		...
		return worldObj.difficultySetting != EnumDifficulty.PEACEFUL && BigDayEvent.isBig() && (b == Blocks.grass || b == Blocks.dirt || b == Blocks.stone) && worldObj.checkNoEntityCollision(boundingBox) && worldObj.getCollidingBoundingBoxes(this, boundingBox).isEmpty() && !worldObj.isAnyLiquid(boundingBox);
	}
