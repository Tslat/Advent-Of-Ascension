...
public class EntityHorndron extends EntityMob {
	public EntityHorndron(final World par1World) {
		super(par1World);
		setSize(2.15f, 2.3f);
	}

	protected String getLivingSound() {
		return "nevermine:HorndronLiving";
	}

	protected String getDeathSound() {
		return "nevermine:HorndronDeath";
	}

	protected String getHurtSound() {
		return "nevermine:HorndronHit";
	}
