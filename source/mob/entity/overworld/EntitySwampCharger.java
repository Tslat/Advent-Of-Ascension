...
public class EntitySwampCharger extends EntityMob {
	public EntitySwampCharger(final World par1World) {
		super(par1World);
		setSize(1.0f, 1.0f);
	}
	...
	public boolean attackEntityAsMob(final Entity par1) {
		if (super.attackEntityAsMob(par1)) {
			if (par1 instanceof EntityLivingBase) {
				((EntityLivingBase)par1).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 40, 0));
			}
			return true;
		}
		return false;
