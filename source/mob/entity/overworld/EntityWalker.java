...
public class EntityWalker extends EntityMob {
	public EntityWalker(final World par1World) {
		super(par1World);
		setSize(0.6f, 2.0f);
	}

	protected String getLivingSound() {
		return "nevermine:WalkerLiving";
	}

	protected String getDeathSound() {
		return "nevermine:WalkerDeath";
	}

	protected String getHurtSound() {
		return "nevermine:WalkerHit";
	}
	...
	public void onLivingUpdate() {
		...
		for (final EntityPlayer e : (List<EntityPlayer>)worldObj.getEntitiesWithinAABB(EntityPlayer.class, boundingBox.expand(5.0, 5.0, 5.0))) {
