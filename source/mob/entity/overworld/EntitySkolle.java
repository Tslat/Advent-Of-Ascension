...
public class EntitySkolle extends EntityMob {
	public EntitySkolle(final World par1World) {
		super(par1World);
		setSize(1.0f, 1.0f);
	}

	protected String getLivingSound() {
		return "nevermine:GruntLiving";
	}

	protected String getDeathSound() {
		return "nevermine:GruntDeath";
	}

	protected String getHurtSound() {
		return "nevermine:GruntHit";
	}
	...
	public void onLivingUpdate() {
		...
		if (!worldObj.isRemote && rand.nextInt(200) == 34 && canEntityBeSeen(var1)) {
