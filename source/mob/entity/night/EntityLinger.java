...
public class EntityLinger extends EntityMob implements IRangedAttackMob {
	private EntityAIArrowAttack aiArrowAttack;

	public EntityLinger(final World par1World) {
		super(par1World);
	...
	public boolean getCanSpawnHere() {
		return worldObj.difficultySetting != EnumDifficulty.PEACEFUL && BloodHuntEvent.isHunt() && worldObj.checkNoEntityCollision(boundingBox) && worldObj.getCollidingBoundingBoxes(this, boundingBox).isEmpty() && !worldObj.isAnyLiquid(boundingBox);
	}
	...
	protected String getLivingSound() {
		return "nevermine:LingerLiving";
	}

	protected String getDeathSound() {
		return "nevermine:LingerDeath";
	}

	protected String getHurtSound() {
		return "nevermine:LingerHit";
	}
	...
	public void attackEntityWithRangedAttack(final EntityLivingBase var1, final float f) {
		final EntityBloodball var2 = new EntityBloodball(worldObj, this, 4.0f, 1);
		...
		playSound("nevermine:LingerFire", 1.0f, 1.0f / (getRNG().nextFloat() * 0.4f + 0.8f));
