...
public class EntityGhostlyGoblin extends EntityMob implements IRangedAttackMob {
	private EntityAIArrowAttack aiArrowAttack;

	public EntityGhostlyGoblin(final World par1World) {
		super(par1World);
	...
	public void attackEntityWithRangedAttack(final EntityLivingBase var1, final float f) {
		final EntityMagicBall var2 = new EntityMagicBall(worldObj, this, 7.0f, 1);
