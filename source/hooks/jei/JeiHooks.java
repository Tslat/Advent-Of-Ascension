...
public class JeiHooks implements IModPlugin {
	...
	private void registerHiddenItems(IModRegistry registry) {
		...
		blacklist.addIngredientToBlacklist(new ItemStack(ItemRegister.DARK_BONES));
		...
		blacklist.addIngredientToBlacklist(new ItemStack(ItemRegister.ROCK_BONES));
		blacklist.addIngredientToBlacklist(new ItemStack(ItemRegister.SOULBONE));
