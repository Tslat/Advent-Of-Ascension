...
public class EntityAIAttackAdventBow<T extends EntityMob & IRangedAttackMob> extends EntityAIBase {
	...
	public EntityAIAttackAdventBow(T taskHost, double moveSpeed, int shootCooldown, float maxRange) {
		this.entity = taskHost;
		this.moveSpeedAmp = moveSpeed;
		this.attackCooldown = shootCooldown;
		this.maxAttackDistance = maxRange * maxRange;
		this.setMutexBits(3);
	}
