...
public class EntityAgilityTablet extends EntitySoulTablet {
	public EntityAgilityTablet(World world) {
		this(world, null);
	}

	public EntityAgilityTablet(World world, EntityPlayer placer) {
		super(world, placer);
	}
	...
	protected void doTickEffect() {
		for(EntityPlayer pl : getTargetsWithinRadius(EntityPlayer.class, player -> player != null && player.isEntityAlive())) {
			pl.addPotionEffect(new PotionEffect(MobEffects.SPEED, 10, 2, true, true));
		}
	}
