...
public class EntitySandGiant extends AoAMeleeMob {
	public static final float entityWidth = 1.125f;

	public EntitySandGiant(World world) {
	...
	protected void dropGuaranteedItems(int lootingMod, DamageSource source) {
		dropItem(Item.getItemFromBlock(Blocks.SAND), 32 + rand.nextInt(1 + lootingMod * 4));
	}
