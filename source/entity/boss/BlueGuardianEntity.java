...
public class BlueGuardianEntity extends AoARangedMob {
	...
	public BlueGuardianEntity(EntityType<? extends MonsterEntity> entityType, World world) {
	...
	protected void registerGoals() {
		...
		goalSelector.addGoal(2, new RangedAttackGoal(this, 1.0d, 25, 50, 32));
	...
	public void doProjectileImpactEffect(BaseMobProjectile projectile, Entity target) {
		EntityUtil.applyPotions(target, new PotionUtil.EffectBuilder(Effects.BLINDNESS, 40).level(3));
	}

	@Override
	protected BaseMobProjectile getNewProjectileInstance() {
		return new BlueGuardianShotEntity(this, BaseMobProjectile.Type.MAGIC);
	}
