...
public class EntityStrongSkeleHopper extends AoAMeleeMob {
	public static final float entityWidth = 0.8f;

	public EntityStrongSkeleHopper(World world, BlockPos armyBlockPos) {
		this(world);
	...
	public EntityStrongSkeleHopper(World world) {
