package net.tslat.aoa3.entity.boss.cindaxas;
...
public class EntityCindaxas extends AoAMeleeMob implements BossEntity {
	...
	public EntityCindaxas(World world) {
		super(world, entityWidth, 10f);
