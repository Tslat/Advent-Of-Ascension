...
public class GardenciaDimension extends Dimension {
	public GardenciaDimension(World world, DimensionType dimType) {
	...
	public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
		...
		BiomeProvider biomeProvider = biomeProviderType.create(biomeProviderType.createSettings(world.getWorldInfo()).setBiome(AoABiomes.GARDENCIA.get()));
		BlockState fillerBlock = AoABlocks.AROMATIC_STONE.get().getDefaultState();
		BlockState liquidBlock = Blocks.WATER.getDefaultState();
