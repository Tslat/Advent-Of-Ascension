...
public class HavenDimension extends Dimension {
	public HavenDimension(World world, DimensionType dimType) {
	...
	public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
		...
		BiomeProvider biomeProvider = biomeProviderType.create(biomeProviderType.createSettings(world.getWorldInfo()).setBiome(AoABiomes.HAVEN.get()));
		BlockState fillerBlock = AoABlocks.WEIGHTLESS_STONE.get().getDefaultState();
