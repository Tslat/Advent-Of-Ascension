...
public class ImmortallisDimension extends Dimension {
	public ImmortallisDimension(World world, DimensionType dimType) {
	...
	public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
		...
		BiomeProvider biomeProvider = biomeProviderType.create(biomeProviderType.createSettings(world.getWorldInfo()).setBiome(AoABiomes.IMMORTALLIS.get()));
		BlockState fillerBlock = Blocks.AIR.getDefaultState();
	...
	public boolean canMineBlock(PlayerEntity player, BlockPos pos) {
		...
		return bl == AoABlocks.IMMORTALLIS_PROGRESSOR.get() || bl == AoABlocks.GOLD_ACCUMULATOR.get() || bl == AoABlocks.PURE_GOLD_ACCUMULATOR.get();
	}
}
