...
public class GreckonDimension extends Dimension {
	public GreckonDimension(World world, DimensionType dimType) {
	...
	public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
		...
		BiomeProvider biomeProvider = biomeProviderType.create(biomeProviderType.createSettings(world.getWorldInfo()).setBiome(AoABiomes.GRECKON.get()));
		BlockState fillerBlock = AoABlocks.GRECKON_STONE.get().getDefaultState();
