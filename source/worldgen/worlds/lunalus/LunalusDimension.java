...
public class LunalusDimension extends Dimension {
	public LunalusDimension(World world, DimensionType dimType) {
	...
	public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
		...
		BiomeProvider biomeProvider = biomeProviderType.create(biomeProviderType.createSettings(world.getWorldInfo()).setBiome(AoABiomes.LUNALUS.get()));
