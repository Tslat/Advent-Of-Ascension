...
public class LelyetiaDimension extends Dimension {
	public LelyetiaDimension(World world, DimensionType dimType) {
	...
	public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
		...
		BiomeProvider biomeProvider = biomeProviderType.create(biomeProviderType.createSettings(world.getWorldInfo()).setBiome(AoABiomes.LELYETIA.get()));
		BlockState fillerBlock = AoABlocks.LELYETIAN_STONE.get().getDefaultState();
