...
public class VoxPondsDimension extends Dimension {
	public VoxPondsDimension(World world, DimensionType dimType) {
	...
	public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
		...
		BiomeProvider biomeProvider = biomeProviderType.create(biomeProviderType.createSettings(world.getWorldInfo()).setBiome(AoABiomes.VOX_PONDS.get()));
		BlockState fillerBlock = AoABlocks.POLLUTED_STONE.get().getDefaultState();
