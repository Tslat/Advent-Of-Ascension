...
public class ShyrelandsBiome extends AoABiome {
	...
	public void generateStructuredChunk(IWorld world, ChunkPrimer chunk, SharedSeedRandom rand, BiConsumer<BlockPos, BlockState> blockPlacer) {
		...
		setAllBlocksInRegion(blockPlacer, 0, 0, 0, 15, 29, 15, AoABlocks.BRIGHT_ROCK.get().getDefaultState());
		setAllBlocksInRegion(blockPlacer, 1, 30, 1, 14, 30, 14, AoABlocks.BRIGHT_GRASS.get().getDefaultState());

		setAllBlocksInRegion(blockPlacer, 0, 30, 0, 15, 30, 0, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 0, 30, 15, 15, 30, 15, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 0, 30, 1, 0, 30, 14, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 15, 30, 1, 15, 30, 14, whiteBricks);

		setAllBlocksInRegion(blockPlacer, 0, 46, 0, 0, 54, 0, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 0, 46, 15, 0, 54, 15, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 15, 46, 0, 15, 54, 0, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 15, 46, 15, 15, 54, 15, whiteBricks);

		setAllBlocksInRegion(blockPlacer, 0, 55, 0, 15, 55, 0, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 0, 55, 15, 15, 55, 15, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 0, 55, 1, 0, 55, 14, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 15, 55, 1, 15, 55, 14, whiteBricks);

		setAllBlocksInRegion(blockPlacer, 1, 46, 0, 14, 54, 0, glass);
		setAllBlocksInRegion(blockPlacer, 1, 46, 15, 14, 54, 15, glass);
		setAllBlocksInRegion(blockPlacer, 0, 46, 1, 0, 54, 14, glass);
		setAllBlocksInRegion(blockPlacer, 15, 46, 1, 15, 54, 14, glass);

		setAllBlocksInRegion(blockPlacer, 0, 45, 0, 15, 45, 0, yellowBricks);
		setAllBlocksInRegion(blockPlacer, 0, 45, 15, 15, 45, 15, yellowBricks);
		setAllBlocksInRegion(blockPlacer, 0, 45, 1, 0, 45, 14, yellowBricks);
		setAllBlocksInRegion(blockPlacer, 15, 45, 1, 15, 45, 14, yellowBricks);

		setAllBlocksInRegion(blockPlacer, 0, 31, 0, 3, 44, 0, yellowBricks);
		setAllBlocksInRegion(blockPlacer, 12, 31, 0, 14, 44, 0, yellowBricks);
		setAllBlocksInRegion(blockPlacer, 0, 31, 15, 3, 44, 15, yellowBricks);
		setAllBlocksInRegion(blockPlacer, 12, 31, 15, 15, 44, 15, yellowBricks);
		setAllBlocksInRegion(blockPlacer, 0, 31, 0, 0, 44, 3, yellowBricks);
		setAllBlocksInRegion(blockPlacer, 0, 31, 12, 0, 44, 14, yellowBricks);
		setAllBlocksInRegion(blockPlacer, 15, 31, 0, 15, 44, 3, yellowBricks);
		setAllBlocksInRegion(blockPlacer, 15, 31, 12, 15, 44, 14, yellowBricks);

		setAllBlocksInRegion(blockPlacer, 4, 31, 0, 4, 44, 0, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 11, 31, 0, 11, 44, 0, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 4, 31, 15, 4, 44, 15, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 11, 31, 15, 11, 44, 15, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 0, 31, 4, 0, 44, 4, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 0, 31, 11, 0, 44, 11, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 15, 31, 4, 15, 44, 4, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 15, 31, 11, 15, 44, 11, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 5, 44, 0, 10, 44, 0, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 5, 44, 15, 10, 44, 15, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 0, 44, 5, 0, 44, 10, whiteBricks);
		setAllBlocksInRegion(blockPlacer, 15, 44, 5, 15, 44, 10, whiteBricks);

		buildRandomDoor(Direction.NORTH, blockPlacer, random);
		buildRandomDoor(Direction.SOUTH, blockPlacer, random);
		buildRandomDoor(Direction.EAST, blockPlacer, random);
		buildRandomDoor(Direction.WEST, blockPlacer, random);
		...
		switch (side) {
			...
			case SOUTH:
				...
				switch (rand.randomNumberUpTo(5)) {
					case 0:
						blockPlacer.accept(pos.setPos(5, 43, z), glass);
						blockPlacer.accept(pos.setPos(6, 43, z), glass);
						blockPlacer.accept(pos.setPos(7, 43, z), whiteBricks);
						blockPlacer.accept(pos.setPos(8, 43, z), whiteBricks);
						blockPlacer.accept(pos.setPos(9, 43, z), glass);
						blockPlacer.accept(pos.setPos(10, 43, z), glass);
						blockPlacer.accept(pos.setPos(5, 42, z), glass);
						blockPlacer.accept(pos.setPos(6, 42, z), glass);
						blockPlacer.accept(pos.setPos(7, 42, z), whiteBricks);
						blockPlacer.accept(pos.setPos(8, 42, z), whiteBricks);
						blockPlacer.accept(pos.setPos(9, 42, z), glass);
						blockPlacer.accept(pos.setPos(10, 42, z), glass);
						blockPlacer.accept(pos.setPos(5, 41, z), glass);
						blockPlacer.accept(pos.setPos(6, 41, z), whiteBricks);
						blockPlacer.accept(pos.setPos(7, 41, z), whiteBricks);
						blockPlacer.accept(pos.setPos(8, 41, z), whiteBricks);
						blockPlacer.accept(pos.setPos(9, 41, z), whiteBricks);
						blockPlacer.accept(pos.setPos(10, 41, z), glass);
						blockPlacer.accept(pos.setPos(5, 40, z), whiteBricks);
						blockPlacer.accept(pos.setPos(6, 40, z), whiteBricks);
						blockPlacer.accept(pos.setPos(9, 40, z), whiteBricks);
						blockPlacer.accept(pos.setPos(10, 40, z), whiteBricks);
						break;
					case 1:
						blockPlacer.accept(pos.setPos(5, 43, z), glass);
						blockPlacer.accept(pos.setPos(6, 43, z), glass);
						...
						blockPlacer.accept(pos.setPos(9, 43, z), glass);
						blockPlacer.accept(pos.setPos(10, 43, z), glass);
						blockPlacer.accept(pos.setPos(5, 42, z), whiteBricks);
						blockPlacer.accept(pos.setPos(6, 42, z), whiteBricks);
						blockPlacer.accept(pos.setPos(7, 42, z), whiteBricks);
						blockPlacer.accept(pos.setPos(8, 42, z), whiteBricks);
						blockPlacer.accept(pos.setPos(9, 42, z), whiteBricks);
						blockPlacer.accept(pos.setPos(10, 42, z), whiteBricks);
						blockPlacer.accept(pos.setPos(5, 41, z), glass);
						blockPlacer.accept(pos.setPos(6, 41, z), whiteBricks);
						blockPlacer.accept(pos.setPos(9, 41, z), whiteBricks);
						blockPlacer.accept(pos.setPos(10, 41, z), glass);
					...
					case 2:
						blockPlacer.accept(pos.setPos(5, 43, z), glass);
						blockPlacer.accept(pos.setPos(6, 43, z), glass);
						blockPlacer.accept(pos.setPos(7, 43, z), glass);
						blockPlacer.accept(pos.setPos(8, 43, z), glass);
						blockPlacer.accept(pos.setPos(9, 43, z), glass);
						blockPlacer.accept(pos.setPos(10, 43, z), glass);
						blockPlacer.accept(pos.setPos(5, 42, z), glass);
						blockPlacer.accept(pos.setPos(6, 42, z), whiteBricks);
					...
					case 3:
						blockPlacer.accept(pos.setPos(5, 43, z), glass);
						blockPlacer.accept(pos.setPos(6, 43, z), whiteBricks);
						blockPlacer.accept(pos.setPos(9, 43, z), whiteBricks);
						blockPlacer.accept(pos.setPos(10, 43, z), glass);
						blockPlacer.accept(pos.setPos(5, 42, z), glass);
						blockPlacer.accept(pos.setPos(6, 42, z), whiteBricks);
						blockPlacer.accept(pos.setPos(9, 42, z), whiteBricks);
						blockPlacer.accept(pos.setPos(10, 42, z), glass);
						blockPlacer.accept(pos.setPos(5, 41, z), whiteBricks);
						blockPlacer.accept(pos.setPos(6, 41, z), whiteBricks);
						blockPlacer.accept(pos.setPos(9, 41, z), whiteBricks);
						blockPlacer.accept(pos.setPos(10, 41, z), whiteBricks);
						break;
					case 4:
						blockPlacer.accept(pos.setPos(5, 43, z), glass);
						blockPlacer.accept(pos.setPos(6, 43, z), whiteBricks);
			...
			case EAST:
				...
				switch (rand.randomNumberUpTo(5)) {
					case 0:
						blockPlacer.accept(pos.setPos(x, 43, 5), glass);
						blockPlacer.accept(pos.setPos(x, 43, 6), glass);
						blockPlacer.accept(pos.setPos(x, 43, 7), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 43, 8), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 43, 9), glass);
						blockPlacer.accept(pos.setPos(x, 43, 10), glass);
						blockPlacer.accept(pos.setPos(x, 42, 5), glass);
						blockPlacer.accept(pos.setPos(x, 42, 6), glass);
						blockPlacer.accept(pos.setPos(x, 42, 7), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 42, 8), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 42, 9), glass);
						blockPlacer.accept(pos.setPos(x, 42, 10), glass);
						blockPlacer.accept(pos.setPos(x, 41, 5), glass);
						blockPlacer.accept(pos.setPos(x, 41, 6), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 41, 7), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 41, 8), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 41, 9), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 41, 10), glass);
						blockPlacer.accept(pos.setPos(x, 40, 5), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 40, 6), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 40, 7), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 40, 8), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 40, 9), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 40, 10), whiteBricks);
						break;
					case 1:
						blockPlacer.accept(pos.setPos(x, 43, 5), glass);
						blockPlacer.accept(pos.setPos(x, 43, 6), glass);
						...
						blockPlacer.accept(pos.setPos(x, 43, 9), glass);
						blockPlacer.accept(pos.setPos(x, 43, 10), glass);
						blockPlacer.accept(pos.setPos(x, 42, 5), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 42, 6), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 42, 7), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 42, 8), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 42, 9), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 42, 10), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 41, 5), glass);
						blockPlacer.accept(pos.setPos(x, 41, 6), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 41, 9), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 41, 10), glass);
					...
					case 2:
						blockPlacer.accept(pos.setPos(x, 43, 5), glass);
						blockPlacer.accept(pos.setPos(x, 43, 6), glass);
						blockPlacer.accept(pos.setPos(x, 43, 7), glass);
						blockPlacer.accept(pos.setPos(x, 43, 8), glass);
						blockPlacer.accept(pos.setPos(x, 43, 9), glass);
						blockPlacer.accept(pos.setPos(x, 43, 10), glass);
						blockPlacer.accept(pos.setPos(x, 42, 5), glass);
						blockPlacer.accept(pos.setPos(x, 42, 6), whiteBricks);
					...
					case 3:
						blockPlacer.accept(pos.setPos(x, 43, 5), glass);
						blockPlacer.accept(pos.setPos(x, 43, 6), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 43, 9), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 43, 10), glass);
						blockPlacer.accept(pos.setPos(x, 42, 5), glass);
						blockPlacer.accept(pos.setPos(x, 42, 6), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 42, 9), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 42, 10), glass);
						blockPlacer.accept(pos.setPos(x, 41, 5), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 41, 6), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 41, 9), whiteBricks);
						blockPlacer.accept(pos.setPos(x, 41, 10), whiteBricks);
						break;
					case 4:
						blockPlacer.accept(pos.setPos(x, 43, 5), glass);
						blockPlacer.accept(pos.setPos(x, 43, 6), whiteBricks);
