...
public class ShyrelandsDimension extends Dimension {
	public ShyrelandsDimension(World world, DimensionType dimType) {
	...
	public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
		...
		BiomeProvider biomeProvider = biomeProviderType.create(biomeProviderType.createSettings(world.getWorldInfo()).setBiome(AoABiomes.SHYRELANDS.get()));
		BlockState fillerBlock = AoABlocks.BRIGHT_ROCK.get().getDefaultState();
