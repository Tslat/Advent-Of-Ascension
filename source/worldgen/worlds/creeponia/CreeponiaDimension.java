...
public class CreeponiaDimension extends Dimension {
	public CreeponiaDimension(World world, DimensionType dimType) {
	...
	public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
		...
		BiomeProvider biomeProvider = biomeProviderType.create(biomeProviderType.createSettings(world.getWorldInfo()).setBiome(AoABiomes.CREEPONIA.get()));
		BlockState fillerBlock = AoABlocks.CREEP_STONE.get().getDefaultState();
