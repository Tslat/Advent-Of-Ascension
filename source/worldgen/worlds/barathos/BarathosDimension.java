...
public class BarathosDimension extends Dimension {
	public BarathosDimension(World world, DimensionType dimType) {
	...
	public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
		...
		BiomeProvider biomeProvider = biomeProviderType.create(biomeProviderType.createSettings(world.getWorldInfo()).setBiome(AoABiomes.BARATHOS.get()));
		BlockState fillerBlock = AoABlocks.BARON_STONE.get().getDefaultState();
