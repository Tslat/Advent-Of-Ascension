...
import net.tslat.aoa3.entity.npc.lottoman.DustopianLottomanEntity;
...
public class LottoCage extends AoAStructure { //StructureSize: 5x9x5
	...
	protected void spawnEntities(IWorld world, Random rand, BlockPos basePos) {
		DustopianLottomanEntity lottoman = new DustopianLottomanEntity(AoAEntities.NPCs.DUSTOPIAN_LOTTOMAN.get(), world.getWorld());

		lottoman.setLocationAndAngles(basePos.getX() + 2, basePos.getY() + 5, basePos.getZ() + 2, rand.nextFloat() * 360, 0);
