...
public class CrusiliskCave extends AoAStructure { //StructureSize: 10x10x20
	...
	private static final BlockState crusiliskSpawner = Blocks.SPAWNER.getDefaultState();
	...
	protected void doPostBuildOps(IWorld world, Random rand, BlockPos basePos) {
		initSpawner(world, basePos.add(4, 5, 16), AoAEntities.Mobs.CRUSILISK.get());
		initSpawner(world, basePos.add(5, 5, 16), AoAEntities.Mobs.CRUSILISK.get());
	}
}
