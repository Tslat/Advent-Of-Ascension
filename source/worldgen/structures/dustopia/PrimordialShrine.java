...
public class PrimordialShrine extends AoAStructure { //StructureSize: 5x7x11
	private static final BlockState dustopianLamp = AoABlocks.DUSTOPIAN_LAMP.get().getDefaultState().with(DustopianLamp.LIT, false);
	...
	private static final BlockState primordialShrine = AoABlocks.PRIMORDIAL_SHRINE.get().getDefaultState();
