...
public class CreeponianLottoStand extends AoAStructure { //StructureSize: 8x10x8
	private static final BlockState creeponiaBricks = AoABlocks.CREEPONIA_BRICKS.get().getDefaultState();
	private static final BlockState stainedGlass = Blocks.GREEN_STAINED_GLASS.getDefaultState();
	...
	protected void spawnEntities(IWorld world, Random rand, BlockPos basePos) {
		CreeponiaLottomanEntity lottoman = new CreeponiaLottomanEntity(AoAEntities.NPCs.CREEPONIA_LOTTOMAN.get(), world.getWorld());
