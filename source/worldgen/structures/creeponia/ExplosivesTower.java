...
public class ExplosivesTower extends AoAStructure { //StructureSize: 8x29x8
	...
	protected void spawnEntities(IWorld world, Random rand, BlockPos basePos) {
		ExplosivesExpertEntity explosivesExpert = new ExplosivesExpertEntity(AoAEntities.NPCs.EXPLOSIVES_EXPERT.get(), world.getWorld());

		explosivesExpert.setLocationAndAngles(basePos.getX() + 3, basePos.getY() + 25, basePos.getZ() + 3, rand.nextFloat() * 360, 0);
		world.addEntity(explosivesExpert);
	}
}
