...
public class LunarGarden extends AoAStructure { //StructureSize: 17x15x17
	...
	private static final BlockState tilledDirt = Blocks.FARMLAND.getDefaultState();
	private static final BlockState twinklestone = AoABlocks.TWINKLESTONE.get().getDefaultState();
	...
	protected void build(IWorld world, Random rand, BlockPos basePos) {
		...
		switch (rand.nextInt(3)) {
			case 0:
				crop = AoABlocks.LUNALON_CROP.get().getDefaultState();
				break;
			case 1:
				crop = AoABlocks.LUNACRIKE_CROP.get().getDefaultState();
				break;
			case 2:
			default:
				crop = AoABlocks.LUNA_GLOBE_CROP.get().getDefaultState();
				break;
		}
