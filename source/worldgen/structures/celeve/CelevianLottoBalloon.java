...
import net.tslat.aoa3.entity.npc.lottoman.CelevianLottomanEntity;
...
public class CelevianLottoBalloon extends AoAStructure { //StructureSize: 9x18x9
	...
	protected void spawnEntities(IWorld world, Random rand, BlockPos basePos) {
		CelevianLottomanEntity lottoman = new CelevianLottomanEntity(AoAEntities.NPCs.CELEVIAN_LOTTOMAN.get(), world.getWorld());
