	...
	protected void build(IWorld world, Random rand, BlockPos basePos) {
		...
		while (y <= 2) {
			if (world.getBlockState(basePos.add(0, y, 0)).getBlock() == Blocks.AIR) {
				addBlock(world, basePos, 0, y, 0, AoABlocks.BLUE_HAVENDALES_STEM.get().getDefaultState());
				y++;
			}
			else {
				break;
		...
		addBlock(world, basePos, 0, y, 0, AoABlocks.BLUE_HAVENDALES.get().getDefaultState());
	}
}
