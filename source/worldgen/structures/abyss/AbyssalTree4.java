...
public class AbyssalTree4 extends AoAStructure { //StructureSize: 8x10x7
	private static final BlockState shadowbloodLeaves = AoABlocks.SHADOWBLOOD_LEAVES.get().getDefaultState();
	...
	private static final BlockState shadowLogBark = AoABlocks.SHADOW_WOOD.get().getDefaultState();
