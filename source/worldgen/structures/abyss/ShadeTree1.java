...
public class ShadeTree1 extends AoAStructure { //StructureSize: 7x30x7
	...
	protected void build(IWorld world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 1, 25, 3, shadowLog);
		addBlock(world, basePos, 2, 25, 2, shadowLeaves);
		addBlock(world, basePos, 2, 25, 3, shadowLog);
		addBlock(world, basePos, 2, 25, 4, shadowLeaves);
		addBlock(world, basePos, 3, 25, 1, shadowLog);
		addBlock(world, basePos, 3, 25, 2, shadowLog);
		addBlock(world, basePos, 3, 25, 3, shadowLog);
		addBlock(world, basePos, 3, 25, 4, shadowLog);
		addBlock(world, basePos, 3, 25, 5, shadowLog);
		addBlock(world, basePos, 4, 25, 2, shadowLeaves);
		addBlock(world, basePos, 4, 25, 3, shadowLog);
		addBlock(world, basePos, 4, 25, 4, shadowLeaves);
		addBlock(world, basePos, 5, 25, 3, shadowLog);
		...
		addBlock(world, basePos, 0, 27, 3, shadowLeaves);
		...
		addBlock(world, basePos, 3, 27, 0, shadowLeaves);
		...
		addBlock(world, basePos, 3, 27, 6, shadowLeaves);
		...
		addBlock(world, basePos, 6, 27, 3, shadowLeaves);
