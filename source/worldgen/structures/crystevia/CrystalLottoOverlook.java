...
import net.tslat.aoa3.entity.npc.lottoman.CrystalLottomanEntity;
...
public class CrystalLottoOverlook extends AoAStructure { //StructureSize: 9x7x9
	...
	protected void spawnEntities(IWorld world, Random rand, BlockPos basePos) {
		CrystalLottomanEntity lottoman = new CrystalLottomanEntity(AoAEntities.NPCs.CRYSTAL_LOTTOMAN.get(), world.getWorld());
