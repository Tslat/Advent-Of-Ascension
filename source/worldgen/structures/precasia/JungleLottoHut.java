...
import net.tslat.aoa3.entity.npc.lottoman.PrecasianLottomanEntity;
import net.tslat.aoa3.worldgen.structures.AoAStructure;

import java.util.Random;

public class JungleLottoHut extends AoAStructure { //StructureSize: 9x11x9
	private static final BlockState cycadeLeaves = AoABlocks.STRANGLEWOOD_LEAVES.get().getDefaultState();
	...
	protected void spawnEntities(IWorld world, Random rand, BlockPos basePos) {
		PrecasianLottomanEntity lottoman = new PrecasianLottomanEntity(AoAEntities.NPCs.PRECASIAN_LOTTOMAN.get(), world.getWorld());
