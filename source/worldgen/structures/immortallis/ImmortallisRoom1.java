...
import net.tslat.aoa3.entity.npc.trader.DungeonKeeperEntity;
import net.tslat.aoa3.entity.npc.trader.TokenCollectorEntity;
...
public class ImmortallisRoom1 extends WorldGenerator {
	...
	private static final BlockState archaicLight = AoABlocks.ARCHAIC_LIGHT.get().getDefaultState();
	...
	private static final BlockState archaicStreamHorizontal = AoABlocks.ARCHAIC_STREAM_HORIZONTAL.get().getDefaultState();
	...
	private static final BlockState portalBlock = AoABlocks.IMMORTALLIS_PORTAL.get().getDefaultState().with(BlockStateProperties.HORIZONTAL_AXIS, Direction.Axis.X);
	private static final BlockState progressor1 = AoABlocks.IMMORTALLIS_PROGRESSOR.get().getDefaultState().with(ImmortallisProgressor.STAGE, 1);
	...
	public boolean generate(IWorld world, Random rand, BlockPos pos) {
		...
		spawnEntity(world, new DungeonKeeperEntity(AoAEntities.NPCs.DUNGEON_KEEPER.get(), world.getWorld()), x + 14, y + 1, z + 42);
	...
	private boolean continueGen(IWorld world, Random rand, int x, int y, int z) {
		...
		spawnEntity(world, new TokenCollectorEntity(AoAEntities.NPCs.TOKEN_COLLECTOR.get(), world.getWorld()), x + 29, y + 1, z + 42);
