...
public class GingerbirdAviary extends AoAStructure { //StructureSize: 10x12x10
	...
	private static final BlockState gingerbirdSpawner = Blocks.SPAWNER.getDefaultState();
	...
	protected void doPostBuildOps(IWorld world, Random rand, BlockPos basePos) {
		initSpawner(world, basePos.add(4, 8, 4), AoAEntities.Mobs.GINGERBIRD.get());
		initSpawner(world, basePos.add(4, 8, 5), AoAEntities.Mobs.GINGERBIRD.get());
		initSpawner(world, basePos.add(5, 8, 4), AoAEntities.Mobs.GINGERBIRD.get());
		initSpawner(world, basePos.add(5, 8, 5), AoAEntities.Mobs.GINGERBIRD.get());
	}
}
