...
public class InfestedCandyCane extends AoAStructure { //StructureSize: 12x8x12
	...
	private static final BlockState caneBugSpawner = Blocks.SPAWNER.getDefaultState();
	...
	protected void doPostBuildOps(IWorld world, Random rand, BlockPos basePos) {
		initSpawner(world, basePos.add(5, 0, 5), AoAEntities.Mobs.CANE_BUG.get());
		initSpawner(world, basePos.add(5, 0, 6), AoAEntities.Mobs.CANE_BUG.get());
		initSpawner(world, basePos.add(6, 0, 5), AoAEntities.Mobs.CANE_BUG.get());
		initSpawner(world, basePos.add(6, 0, 6), AoAEntities.Mobs.CANE_BUG.get());
	}
}
