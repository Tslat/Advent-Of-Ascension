...
public class ChurryTree2 extends AoAStructure { //StructureSize: 9x52x9
	private static final BlockState churryLeaves = AoABlocks.CHURRY_LEAVES.get().getDefaultState();
	private static final BlockState churryLog = AoABlocks.CHURRY_LOG.get().getDefaultState();
	...
	protected void build(IWorld world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 0, 7, 4, churryLeaves);
		addBlock(world, basePos, 1, 7, 4, churryLeaves);
		...
		addBlock(world, basePos, 4, 7, 0, churryLeaves);
		addBlock(world, basePos, 4, 7, 1, churryLeaves);
		...
		addBlock(world, basePos, 4, 7, 7, churryLeaves);
		addBlock(world, basePos, 4, 7, 8, churryLeaves);
		...
		addBlock(world, basePos, 7, 7, 4, churryLeaves);
		addBlock(world, basePos, 8, 7, 4, churryLeaves);
		...
		addBlock(world, basePos, 3, 9, 3, churryLeaves);
		addBlock(world, basePos, 3, 9, 4, churryLeaves);
		addBlock(world, basePos, 3, 9, 5, churryLeaves);
		addBlock(world, basePos, 4, 9, 3, churryLeaves);
		addBlock(world, basePos, 4, 9, 4, churryLog);
		addBlock(world, basePos, 4, 9, 5, churryLeaves);
		addBlock(world, basePos, 5, 9, 3, churryLeaves);
		addBlock(world, basePos, 5, 9, 4, churryLeaves);
		addBlock(world, basePos, 5, 9, 5, churryLeaves);
		addBlock(world, basePos, 3, 10, 4, churryLeaves);
		addBlock(world, basePos, 4, 10, 3, churryLeaves);
		addBlock(world, basePos, 4, 10, 4, churryLog);
		addBlock(world, basePos, 4, 10, 5, churryLeaves);
		addBlock(world, basePos, 5, 10, 4, churryLeaves);
		...
		addBlock(world, basePos, 0, 16, 4, churryLeaves);
		addBlock(world, basePos, 1, 16, 4, churryLeaves);
		...
		addBlock(world, basePos, 4, 16, 0, churryLeaves);
		addBlock(world, basePos, 4, 16, 1, churryLeaves);
		...
		addBlock(world, basePos, 4, 16, 7, churryLeaves);
		addBlock(world, basePos, 4, 16, 8, churryLeaves);
		...
		addBlock(world, basePos, 7, 16, 4, churryLeaves);
		addBlock(world, basePos, 8, 16, 4, churryLeaves);
		...
		addBlock(world, basePos, 3, 18, 3, churryLeaves);
		addBlock(world, basePos, 3, 18, 4, churryLeaves);
		addBlock(world, basePos, 3, 18, 5, churryLeaves);
		...
		addBlock(world, basePos, 5, 18, 3, churryLeaves);
		addBlock(world, basePos, 5, 18, 4, churryLeaves);
		addBlock(world, basePos, 5, 18, 5, churryLeaves);
		addBlock(world, basePos, 3, 19, 4, churryLeaves);
		addBlock(world, basePos, 4, 19, 3, churryLeaves);
		addBlock(world, basePos, 4, 19, 4, churryLog);
		addBlock(world, basePos, 4, 19, 5, churryLeaves);
		addBlock(world, basePos, 5, 19, 4, churryLeaves);
		...
		addBlock(world, basePos, 0, 25, 4, churryLeaves);
		addBlock(world, basePos, 1, 25, 4, churryLeaves);
		...
		addBlock(world, basePos, 4, 25, 0, churryLeaves);
		addBlock(world, basePos, 4, 25, 1, churryLeaves);
		...
		addBlock(world, basePos, 4, 25, 7, churryLeaves);
		addBlock(world, basePos, 4, 25, 8, churryLeaves);
		...
		addBlock(world, basePos, 7, 25, 4, churryLeaves);
		addBlock(world, basePos, 8, 25, 4, churryLeaves);
		...
		addBlock(world, basePos, 3, 27, 3, churryLeaves);
		addBlock(world, basePos, 3, 27, 4, churryLeaves);
		addBlock(world, basePos, 3, 27, 5, churryLeaves);
		...
		addBlock(world, basePos, 5, 27, 3, churryLeaves);
		addBlock(world, basePos, 5, 27, 4, churryLeaves);
		addBlock(world, basePos, 5, 27, 5, churryLeaves);
		addBlock(world, basePos, 3, 28, 4, churryLeaves);
		addBlock(world, basePos, 4, 28, 3, churryLeaves);
		addBlock(world, basePos, 4, 28, 4, churryLog);
		addBlock(world, basePos, 4, 28, 5, churryLeaves);
		addBlock(world, basePos, 5, 28, 4, churryLeaves);
		...
		addBlock(world, basePos, 4, 40, 4, churryLog);
		addBlock(world, basePos, 4, 41, 4, churryLog);
		addBlock(world, basePos, 3, 42, 4, churryLeaves);
		addBlock(world, basePos, 4, 42, 3, churryLeaves);
		addBlock(world, basePos, 4, 42, 4, churryLog);
		addBlock(world, basePos, 4, 42, 5, churryLeaves);
		addBlock(world, basePos, 5, 42, 4, churryLeaves);
		addBlock(world, basePos, 0, 43, 4, churryLeaves);
		addBlock(world, basePos, 1, 43, 4, churryLeaves);
		addBlock(world, basePos, 2, 43, 3, churryLeaves);
		addBlock(world, basePos, 2, 43, 4, churryLeaves);
		addBlock(world, basePos, 2, 43, 5, churryLeaves);
		addBlock(world, basePos, 3, 43, 2, churryLeaves);
		addBlock(world, basePos, 3, 43, 3, churryLeaves);
		addBlock(world, basePos, 3, 43, 4, churryLeaves);
		addBlock(world, basePos, 3, 43, 5, churryLeaves);
		addBlock(world, basePos, 3, 43, 6, churryLeaves);
		addBlock(world, basePos, 4, 43, 0, churryLeaves);
		addBlock(world, basePos, 4, 43, 1, churryLeaves);
		addBlock(world, basePos, 4, 43, 2, churryLeaves);
		addBlock(world, basePos, 4, 43, 3, churryLeaves);
		addBlock(world, basePos, 4, 43, 4, churryLog);
		addBlock(world, basePos, 4, 43, 5, churryLeaves);
		addBlock(world, basePos, 4, 43, 6, churryLeaves);
		addBlock(world, basePos, 4, 43, 7, churryLeaves);
		addBlock(world, basePos, 4, 43, 8, churryLeaves);
		addBlock(world, basePos, 5, 43, 2, churryLeaves);
		addBlock(world, basePos, 5, 43, 3, churryLeaves);
		addBlock(world, basePos, 5, 43, 4, churryLeaves);
		addBlock(world, basePos, 5, 43, 5, churryLeaves);
		addBlock(world, basePos, 5, 43, 6, churryLeaves);
		addBlock(world, basePos, 6, 43, 3, churryLeaves);
		addBlock(world, basePos, 6, 43, 4, churryLeaves);
		addBlock(world, basePos, 6, 43, 5, churryLeaves);
		addBlock(world, basePos, 7, 43, 4, churryLeaves);
		addBlock(world, basePos, 8, 43, 4, churryLeaves);
		addBlock(world, basePos, 2, 44, 3, churryLeaves);
		addBlock(world, basePos, 2, 44, 4, churryLeaves);
		addBlock(world, basePos, 2, 44, 5, churryLeaves);
		addBlock(world, basePos, 3, 44, 2, churryLeaves);
		addBlock(world, basePos, 3, 44, 3, churryLeaves);
		addBlock(world, basePos, 3, 44, 4, churryLeaves);
		addBlock(world, basePos, 3, 44, 5, churryLeaves);
		addBlock(world, basePos, 3, 44, 6, churryLeaves);
		addBlock(world, basePos, 4, 44, 2, churryLeaves);
		addBlock(world, basePos, 4, 44, 3, churryLeaves);
		addBlock(world, basePos, 4, 44, 4, churryLog);
		addBlock(world, basePos, 4, 44, 5, churryLeaves);
		addBlock(world, basePos, 4, 44, 6, churryLeaves);
		addBlock(world, basePos, 5, 44, 2, churryLeaves);
		addBlock(world, basePos, 5, 44, 3, churryLeaves);
		addBlock(world, basePos, 5, 44, 4, churryLeaves);
		addBlock(world, basePos, 5, 44, 5, churryLeaves);
		addBlock(world, basePos, 5, 44, 6, churryLeaves);
		addBlock(world, basePos, 6, 44, 3, churryLeaves);
		addBlock(world, basePos, 6, 44, 4, churryLeaves);
		addBlock(world, basePos, 6, 44, 5, churryLeaves);
		addBlock(world, basePos, 3, 45, 3, churryLeaves);
		addBlock(world, basePos, 3, 45, 4, churryLeaves);
		addBlock(world, basePos, 3, 45, 5, churryLeaves);
		addBlock(world, basePos, 4, 45, 3, churryLeaves);
		addBlock(world, basePos, 4, 45, 4, churryLog);
		addBlock(world, basePos, 4, 45, 5, churryLeaves);
		addBlock(world, basePos, 5, 45, 3, churryLeaves);
		addBlock(world, basePos, 5, 45, 4, churryLeaves);
		addBlock(world, basePos, 5, 45, 5, churryLeaves);
		addBlock(world, basePos, 3, 46, 4, churryLeaves);
		addBlock(world, basePos, 4, 46, 3, churryLeaves);
		addBlock(world, basePos, 4, 46, 4, churryLog);
		addBlock(world, basePos, 4, 46, 5, churryLeaves);
		addBlock(world, basePos, 5, 46, 4, churryLeaves);
		addBlock(world, basePos, 4, 47, 4, churryLog);
		addBlock(world, basePos, 4, 48, 4, churryLog);
		addBlock(world, basePos, 3, 49, 3, lelyetianLeaves);
		addBlock(world, basePos, 3, 49, 4, lelyetianLeaves);
		addBlock(world, basePos, 3, 49, 5, lelyetianLeaves);
		addBlock(world, basePos, 4, 49, 3, lelyetianLeaves);
		addBlock(world, basePos, 4, 49, 4, lelyetianLeaves);
		addBlock(world, basePos, 4, 49, 5, lelyetianLeaves);
		addBlock(world, basePos, 5, 49, 3, lelyetianLeaves);
		addBlock(world, basePos, 5, 49, 4, lelyetianLeaves);
		addBlock(world, basePos, 5, 49, 5, lelyetianLeaves);
		addBlock(world, basePos, 3, 50, 3, lelyetianLeaves);
		addBlock(world, basePos, 3, 50, 4, lelyetianLeaves);
		addBlock(world, basePos, 3, 50, 5, lelyetianLeaves);
		addBlock(world, basePos, 4, 50, 3, lelyetianLeaves);
		addBlock(world, basePos, 4, 50, 4, lelyetianLeaves);
		addBlock(world, basePos, 4, 50, 5, lelyetianLeaves);
		addBlock(world, basePos, 5, 50, 3, lelyetianLeaves);
		addBlock(world, basePos, 5, 50, 4, lelyetianLeaves);
		addBlock(world, basePos, 5, 50, 5, lelyetianLeaves);
		addBlock(world, basePos, 3, 51, 3, lelyetianLeaves);
		addBlock(world, basePos, 3, 51, 4, lelyetianLeaves);
		addBlock(world, basePos, 3, 51, 5, lelyetianLeaves);
		addBlock(world, basePos, 4, 51, 3, lelyetianLeaves);
		addBlock(world, basePos, 4, 51, 4, lelyetianLeaves);
		addBlock(world, basePos, 4, 51, 5, lelyetianLeaves);
		addBlock(world, basePos, 5, 51, 3, lelyetianLeaves);
		addBlock(world, basePos, 5, 51, 4, lelyetianLeaves);
		addBlock(world, basePos, 5, 51, 5, lelyetianLeaves);
	}
}
