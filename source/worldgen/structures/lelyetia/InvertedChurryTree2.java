...
public class InvertedChurryTree2 extends AoAStructure { //StructureSize: 9x52x9
	...
	public InvertedChurryTree2() {
		super("InvertedChurryTree2");
	}
	...
	protected void build(IWorld world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 3, 41, 4, churryLeaves);
		addBlock(world, basePos, 4, 41, 3, churryLeaves);
		addBlock(world, basePos, 4, 41, 4, churryLog);
		addBlock(world, basePos, 4, 41, 5, churryLeaves);
		addBlock(world, basePos, 5, 41, 4, churryLeaves);
		addBlock(world, basePos, 3, 42, 3, churryLeaves);
		addBlock(world, basePos, 3, 42, 4, churryLeaves);
		addBlock(world, basePos, 3, 42, 5, churryLeaves);
		...
		addBlock(world, basePos, 5, 42, 3, churryLeaves);
		addBlock(world, basePos, 5, 42, 4, churryLeaves);
		addBlock(world, basePos, 5, 42, 5, churryLeaves);
		...
		addBlock(world, basePos, 0, 44, 4, churryLeaves);
		addBlock(world, basePos, 1, 44, 4, churryLeaves);
		...
		addBlock(world, basePos, 4, 44, 0, churryLeaves);
		addBlock(world, basePos, 4, 44, 1, churryLeaves);
		...
		addBlock(world, basePos, 4, 44, 7, churryLeaves);
		addBlock(world, basePos, 4, 44, 8, churryLeaves);
		...
		addBlock(world, basePos, 7, 44, 4, churryLeaves);
		addBlock(world, basePos, 8, 44, 4, churryLeaves);
		...
		addBlock(world, basePos, 4, 49, 4, churryLog);
		addBlock(world, basePos, 4, 50, 4, churryLog);
		addBlock(world, basePos, 4, 51, 4, churryLog);
	}
}
