...
import net.tslat.aoa3.entity.npc.lottoman.RockyLottomanEntity;
...
public class DeepLottoShelter extends AoAStructure { //StructureSize: 14x4x14
	...
	protected void spawnEntities(IWorld world, Random rand, BlockPos basePos) {
		RockyLottomanEntity lottoman = new RockyLottomanEntity(AoAEntities.NPCs.ROCKY_LOTTOMAN.get(), world.getWorld());
