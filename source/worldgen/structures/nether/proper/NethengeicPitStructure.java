...
public class NethengeicPitStructure extends ScatteredStructure<NoFeatureConfig> {
	public NethengeicPitStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactory) {
		super(configFactory);
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
			NethengeicPitPiece piece = new NethengeicPitPiece(rand, chunkX * 16, 0, chunkZ * 16);
