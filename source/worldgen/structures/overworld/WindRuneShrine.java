...
public class WindRuneShrine extends AoAStructure { //StructureSize: 7x4x7
	...
	private static final BlockState shrine = AoABlocks.RUNE_SHRINE.get().getDefaultState();
	private static final BlockState post = AoABlocks.WIND_RUNE_POST.get().getDefaultState();
	...
	protected void build(IWorld world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 3, 1, 3, shrine);
