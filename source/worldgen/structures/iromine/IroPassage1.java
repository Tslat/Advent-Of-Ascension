...
public class IroPassage1 extends AoAStructure { //StructureSize: 14x6x20
	...
	private static final BlockState enforcerSpanwer = Blocks.SPAWNER.getDefaultState();
	...
	protected void build(IWorld world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 6, 0, 5, dottedBrick);
		...
		addBlock(world, basePos, 7, 0, 2, dottedBrick);
		...
		addBlock(world, basePos, 8, 0, 3, dottedBrick);
		addBlock(world, basePos, 8, 0, 4, stripedBrick);
		addBlock(world, basePos, 8, 0, 5, dottedBrick);
	...
	protected void doPostBuildOps(IWorld world, Random rand, BlockPos basePos) {
		assignLootChests(world, rand, new ResourceLocation(AdventOfAscension.MOD_ID, "structures/iro_passage"), basePos.add(6, 2, 17), basePos.add(7, 2, 17));

		initSpawner(world, basePos.add(3, 2, 9), AoAEntities.Mobs.ENFORCER.get());
		initSpawner(world, basePos.add(10, 2, 16), AoAEntities.Mobs.MECHYON.get());
	}
}
