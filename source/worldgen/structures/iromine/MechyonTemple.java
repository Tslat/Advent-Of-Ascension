...
public class MechyonTemple extends AoAStructure { //StructureSize: 11x11x12
	...
	protected void build(IWorld world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 3, 0, 8, dottedBrick);
		...
		addBlock(world, basePos, 4, 0, 8, dottedBrick);
		...
		addBlock(world, basePos, 5, 0, 8, dottedBrick);
		...
		addBlock(world, basePos, 6, 0, 3, dottedBrick);
		...
		addBlock(world, basePos, 6, 0, 8, dottedBrick);
		...
		addBlock(world, basePos, 7, 0, 3, dottedBrick);
		addBlock(world, basePos, 7, 0, 4, dottedBrick);
		addBlock(world, basePos, 7, 0, 5, dottedBrick);
		addBlock(world, basePos, 7, 0, 6, dottedBrick);
	...
	protected void doPostBuildOps(IWorld world, Random rand, BlockPos basePos) {
		assignLootChests(world, rand, new ResourceLocation(AdventOfAscension.MOD_ID, "structures/iro_passage"), basePos.add(5, 1, 6));

		initSpawner(world, basePos.add(2, 3, 9), AoAEntities.Mobs.MECHYON.get());
		initSpawner(world, basePos.add(8, 3, 2), AoAEntities.Mobs.MECHYON.get());
	}
}
