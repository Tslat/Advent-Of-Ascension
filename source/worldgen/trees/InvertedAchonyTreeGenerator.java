...
public class InvertedAchonyTreeGenerator extends TreeGenerator {
	public InvertedAchonyTreeGenerator(@Nullable SaplingBlock sapling) {
		super(sapling);
	}
