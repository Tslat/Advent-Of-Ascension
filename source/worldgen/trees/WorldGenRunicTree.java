...
public class WorldGenRunicTree extends WorldGenTree {
	public WorldGenRunicTree(@Nullable SaplingBlock sapling) {
		super(sapling);
	}
	...
	private boolean generateTree1(World world, Random rand, BlockPos pos) {
		...
		IBlockState log = BlockRegister.RUNIC_LOG.getDefaultState();
		IBlockState leaves = BlockRegister.RUNIC_LEAVES.getDefaultState();
