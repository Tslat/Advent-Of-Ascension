...
public class StranglewoodTreeGenerator extends TreeGenerator {
	...
	public boolean generate(IWorld world, Random rand, BlockPos pos) {
		...
		BlockState log = AoABlocks.STRANGLEWOOD_LOG.get().getDefaultState();
		BlockState leaves = AoABlocks.STRANGLEWOOD_LEAVES.get().getDefaultState();
