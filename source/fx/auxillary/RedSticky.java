...
public class RedSticky extends EntityFX {
	public float portalParticleScale;
	public int last;

	public RedSticky(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12, final int age) {
		...
		particleGreen *= 0.0f;
		particleBlue *= 0.0f;
		particleScale = rand.nextFloat() * rand.nextFloat() * 6.0f + 9.0f;
		particleMaxAge = (int)(4.0 / (rand.nextFloat() * 0.8 + 0.2));
	}
