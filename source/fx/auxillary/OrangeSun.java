...
public class OrangeSun extends EntityFX {
	public float portalParticleScale;
	public int last;

	public OrangeSun(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12, final int age) {
		...
		particleGreen *= 0.6f;
		particleBlue *= 0.0f;
		particleScale = rand.nextFloat() * rand.nextFloat() * 6.0f + 15.0f;
