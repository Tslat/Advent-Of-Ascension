...
public class ThinCyanTrail extends EntityFX {
	public float portalParticleScale;
	public int last;

	public ThinCyanTrail(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12, final int age) {
