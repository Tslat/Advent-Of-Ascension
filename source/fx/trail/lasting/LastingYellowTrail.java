package net.nevermine.fx.trail.lasting;
...
public class LastingYellowTrail extends EntityFX {
	public float portalParticleScale;
	public int last;

	public LastingYellowTrail(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12, final int age) {
		...
		particleMaxAge = (int)(50.0 / (rand.nextFloat() * 0.8 + 0.2)) + 6;
	}
