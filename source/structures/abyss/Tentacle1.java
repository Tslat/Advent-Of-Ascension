...
public class Tentacle1 extends WorldGenerator {
	public boolean generate(final World world, final Random rand, final int i, final int j, final int k) {
		...
		world.setBlock(i + 0, j + 5, k + 1, Blockizer.TentacleEyeRed);
		world.setBlock(i + 0, j + 6, k + 1, Blockizer.TentacleBlock);
		world.setBlock(i + 1, j + 6, k + 1, Blockizer.TentacleBlock);
		world.setBlock(i + 1, j + 7, k + 1, Blockizer.TentacleBlock);
		world.setBlock(i + 1, j + 8, k + 1, Blockizer.TentacleEyeRed);
		world.setBlock(i + 1, j + 9, k + 1, Blockizer.TentacleBlock);
		return true;
	}
}
