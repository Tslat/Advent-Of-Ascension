...
public class EyeHang1 extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 0, j + 4, k + 1, Blockizer.BloodStrands);
		world.setBlock(i + 0, j + 5, k + 1, Blockizer.BloodStrands);
		world.setBlock(i + 0, j + 6, k + 1, Blockizer.WoodBlood);
		...
		world.setBlock(i + 1, j + 4, k + 0, Blockizer.BloodStrands);
		world.setBlock(i + 1, j + 4, k + 1, Blockizer.WoodBlood);
		world.setBlock(i + 1, j + 4, k + 2, Blockizer.BloodStrands);
		world.setBlock(i + 1, j + 5, k + 0, Blockizer.BloodStrands);
		world.setBlock(i + 1, j + 5, k + 1, Blockizer.WoodBlood);
		world.setBlock(i + 1, j + 5, k + 2, Blockizer.BloodStrands);
		world.setBlock(i + 1, j + 6, k + 0, Blockizer.WoodBlood);
		...
		world.setBlock(i + 2, j + 4, k + 1, Blockizer.BloodStrands);
		world.setBlock(i + 2, j + 5, k + 1, Blockizer.BloodStrands);
