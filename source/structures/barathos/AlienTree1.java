...
public class AlienTree1 extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 0, j + 11, k + 0, Blockizer.LeavesOpollo);
		world.setBlock(i + 0, j + 11, k + 1, Blockizer.LeavesOpollo);
		world.setBlock(i + 0, j + 11, k + 2, Blockizer.LeavesOpollo);
		...
		world.setBlock(i + 2, j + 11, k + 0, Blockizer.LeavesOpollo);
		world.setBlock(i + 2, j + 11, k + 1, Blockizer.LeavesOpollo);
		world.setBlock(i + 2, j + 11, k + 2, Blockizer.LeavesOpollo);
