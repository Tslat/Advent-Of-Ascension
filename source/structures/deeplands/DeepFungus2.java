...
public class DeepFungus2 extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		for (int m = 0; m < max; m++) {
			world.setBlock(i + 0, y + 5, k + 2, Blockizer.BlackMushroom);
			world.setBlock(i + 0, y + 6, k + 2, Blockizer.BlackMushroom);
			world.setBlock(i + 1, y + 4, k + 2, Blockizer.BlackMushroom);
			world.setBlock(i + 1, y + 5, k + 2, Blockizer.BlackMushroom);
			world.setBlock(i + 1, y + 6, k + 2, Blockizer.BlackMushroom);
			...
			world.setBlock(i + 2, y + 5, k + 0, Blockizer.BlackMushroom);
			world.setBlock(i + 2, y + 5, k + 1, Blockizer.BlackMushroom);
			world.setBlock(i + 2, y + 5, k + 2, Blockizer.BlackMushroomStem);
			world.setBlock(i + 2, y + 5, k + 3, Blockizer.BlackMushroom);
			world.setBlock(i + 2, y + 5, k + 4, Blockizer.BlackMushroom);
			world.setBlock(i + 2, y + 6, k + 0, Blockizer.BlackMushroom);
			world.setBlock(i + 2, y + 6, k + 1, Blockizer.BlackMushroom);
			world.setBlock(i + 2, y + 6, k + 2, Blockizer.BlackMushroomStem);
			world.setBlock(i + 2, y + 6, k + 3, Blockizer.BlackMushroom);
			world.setBlock(i + 2, y + 6, k + 4, Blockizer.BlackMushroom);
			...
			world.setBlock(i + 3, y + 5, k + 2, Blockizer.BlackMushroom);
			world.setBlock(i + 3, y + 6, k + 2, Blockizer.BlackMushroom);
			world.setBlock(i + 3, y + 7, k + 2, Blockizer.BlackMushroom);
			world.setBlock(i + 4, y + 5, k + 2, Blockizer.BlackMushroom);
			world.setBlock(i + 4, y + 6, k + 2, Blockizer.BlackMushroom);
			y += 8;
		}
