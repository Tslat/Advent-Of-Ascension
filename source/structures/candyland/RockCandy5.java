...
public class RockCandy5 extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 0, j + 0, k + 2, candy);
		world.setBlock(i + 0, j + 1, k + 1, candy);
		world.setBlock(i + 0, j + 3, k + 2, candy);
		world.setBlock(i + 0, j + 5, k + 2, candy);
		world.setBlock(i + 0, j + 7, k + 1, candy);
		world.setBlock(i + 1, j + 0, k + 1, candy);
		world.setBlock(i + 1, j + 0, k + 2, candy);
		world.setBlock(i + 1, j + 0, k + 3, candy);
		world.setBlock(i + 1, j + 1, k + 0, candy);
		...
		world.setBlock(i + 1, j + 3, k + 0, candy);
		world.setBlock(i + 1, j + 3, k + 1, candy);
		world.setBlock(i + 1, j + 3, k + 2, candy);
		world.setBlock(i + 1, j + 3, k + 3, candy);
		...
		world.setBlock(i + 1, j + 7, k + 0, candy);
		world.setBlock(i + 1, j + 7, k + 1, candy);
		world.setBlock(i + 1, j + 7, k + 2, candy);
		world.setBlock(i + 1, j + 7, k + 3, candy);
		world.setBlock(i + 2, j + 0, k + 0, candy);
		...
		world.setBlock(i + 2, j + 1, k + 3, candy);
		...
		world.setBlock(i + 2, j + 5, k + 3, candy);
		world.setBlock(i + 2, j + 6, k + 1, candy);
		world.setBlock(i + 2, j + 6, k + 2, candy);
		world.setBlock(i + 2, j + 7, k + 1, candy);
		world.setBlock(i + 2, j + 7, k + 2, candy);
		world.setBlock(i + 2, j + 8, k + 1, candy);
		world.setBlock(i + 3, j + 0, k + 1, candy);
		world.setBlock(i + 3, j + 2, k + 2, candy);
		world.setBlock(i + 3, j + 4, k + 1, candy);
		world.setBlock(i + 3, j + 6, k + 2, candy);
		world.setBlock(i + 3, j + 7, k + 1, candy);
