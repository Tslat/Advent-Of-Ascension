...
public class RockCandy2 extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 0, j + 4, k + 1, candy);
		...
		world.setBlock(i + 1, j + 1, k + 3, candy);
		...
		world.setBlock(i + 1, j + 4, k + 3, candy);
		...
		world.setBlock(i + 2, j + 3, k + 3, candy);
		...
		world.setBlock(i + 2, j + 6, k + 0, candy);
		world.setBlock(i + 2, j + 6, k + 1, candy);
		world.setBlock(i + 2, j + 6, k + 2, candy);
		world.setBlock(i + 2, j + 6, k + 3, candy);
