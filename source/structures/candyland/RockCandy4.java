...
public class RockCandy4 extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 0, j + 5, k + 1, candy);
		world.setBlock(i + 0, j + 6, k + 2, candy);
		world.setBlock(i + 1, j + 0, k + 0, candy);
		...
		world.setBlock(i + 1, j + 2, k + 3, candy);
		...
		world.setBlock(i + 2, j + 7, k + 3, candy);
		world.setBlock(i + 3, j + 1, k + 2, candy);
		world.setBlock(i + 3, j + 2, k + 1, candy);
