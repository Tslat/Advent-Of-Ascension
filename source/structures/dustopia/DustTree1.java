...
public class DustTree1 extends WorldGenerator {
	public boolean generate(final World world, final Random rand, final int i, final int j, final int k) {
		...
		world.setBlock(i + 0, j + 3, k + 1, Blockizer.LeavesDawn);
		world.setBlock(i + 0, j + 8, k + 1, Blockizer.LeavesDawn);
		world.setBlock(i + 0, j + 12, k + 1, Blockizer.LeavesDawn);
		world.setBlock(i + 0, j + 16, k + 1, Blockizer.LeavesDawn);
		world.setBlock(i + 1, j + 0, k + 1, Blockizer.WoodDawn);
		world.setBlock(i + 1, j + 1, k + 1, Blockizer.WoodDawn);
		world.setBlock(i + 1, j + 1, k + 2, Blockizer.LeavesDawn);
		world.setBlock(i + 1, j + 2, k + 1, Blockizer.WoodDawn);
		world.setBlock(i + 1, j + 3, k + 0, Blockizer.LeavesDawn);
		world.setBlock(i + 1, j + 3, k + 1, Blockizer.WoodDawn);
		world.setBlock(i + 1, j + 4, k + 1, Blockizer.WoodDawn);
		world.setBlock(i + 1, j + 4, k + 2, Blockizer.LeavesDawn);
		world.setBlock(i + 1, j + 5, k + 0, Blockizer.LeavesDawn);
		...
		world.setBlock(i + 1, j + 16, k + 0, Blockizer.LeavesDawn);
		...
		world.setBlock(i + 1, j + 18, k + 2, Blockizer.LeavesDawn);
		world.setBlock(i + 1, j + 19, k + 0, Blockizer.LeavesDawn);
		world.setBlock(i + 1, j + 19, k + 1, Blockizer.WoodDawn);
		world.setBlock(i + 1, j + 20, k + 1, Blockizer.LeavesDawn);
		world.setBlock(i + 2, j + 4, k + 1, Blockizer.LeavesDawn);
		world.setBlock(i + 2, j + 7, k + 1, Blockizer.LeavesDawn);
		world.setBlock(i + 2, j + 13, k + 1, Blockizer.LeavesDawn);
		world.setBlock(i + 2, j + 17, k + 1, Blockizer.LeavesDawn);
		return true;
	}
}
