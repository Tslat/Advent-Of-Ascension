...
public class DeadTree2 implements IVoxpondsStructure {
	...
	public void generate(final Block[][][] chunk, final int i, final int j, final int k) {
		...
		chunk[i + 3][j + 5][k + 0] = Blockizer.WoodToxic;
		chunk[i + 3][j + 5][k + 3] = Blockizer.WoodToxic;
		chunk[i + 3][j + 5][k + 6] = Blockizer.WoodToxic;
		chunk[i + 3][j + 6][k + 0] = Blockizer.WoodToxic;
		chunk[i + 3][j + 6][k + 1] = Blockizer.WoodToxic;
		chunk[i + 3][j + 6][k + 2] = Blockizer.WoodToxic;
		chunk[i + 3][j + 6][k + 3] = Blockizer.WoodToxic;
		chunk[i + 3][j + 6][k + 4] = Blockizer.WoodToxic;
		...
		chunk[i + 4][j + 6][k + 3] = Blockizer.WoodToxic;
		chunk[i + 5][j + 6][k + 3] = Blockizer.WoodToxic;
		chunk[i + 6][j + 5][k + 3] = Blockizer.WoodToxic;
