...
public class ShyreTree2 implements IVoxpondsStructure {
	public void generate(Block[][][] chunk, int i, int j, int k) {
		...
		chunk[(i + 0)][(j + 8)][(k + 1)] = Blockizer.ShyreLeaves;
		...
		chunk[(i + 1)][(j + 8)][(k + 0)] = Blockizer.ShyreLeaves;
		chunk[(i + 1)][(j + 8)][(k + 1)] = Blockizer.ShyreLeaves;
		chunk[(i + 1)][(j + 8)][(k + 2)] = Blockizer.ShyreLeaves;
		chunk[(i + 2)][(j + 5)][(k + 1)] = Blockizer.ShyreLeaves;
		chunk[(i + 2)][(j + 7)][(k + 1)] = Blockizer.ShyreLeaves;
		chunk[(i + 2)][(j + 8)][(k + 1)] = Blockizer.ShyreLeaves;
	}
}
