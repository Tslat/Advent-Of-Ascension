...
public class ShyreDoor2 implements IVoxpondsStructure {
	public void generate(Block[][][] chunk, int x, int y, int z) {
		...
		chunk[x][y + 10][z + 1] = Blockizer.ShyreWallWhite;
		chunk[x][y + 10][z + 2] = Blockizer.ShyreWallWhite;
		chunk[x][y + 10][z + 5] = Blockizer.ShyreWallWhite;
		chunk[x][y + 10][z + 6] = Blockizer.ShyreWallWhite;
		chunk[x][y + 10][z + 7] = Blockizer.ShyreWallWhite;
		chunk[x][y + 11][z] = Blockizer.ShyreWallWhite;
		chunk[x][y + 11][z + 1] = Blockizer.ShyreGlass;
		chunk[x][y + 11][z + 2] = Blockizer.ShyreWallWhite;
		chunk[x][y + 11][z + 3] = Blockizer.ShyreWallWhite;
		chunk[x][y + 11][z + 4] = Blockizer.ShyreWallWhite;
		chunk[x][y + 11][z + 5] = Blockizer.ShyreWallWhite;
		chunk[x][y + 11][z + 6] = Blockizer.ShyreGlass;
		chunk[x][y + 11][z + 7] = Blockizer.ShyreWallWhite;
		chunk[x][y + 12][z] = Blockizer.ShyreWallWhite;
		chunk[x][y + 12][z + 1] = Blockizer.ShyreGlass;
		chunk[x][y + 12][z + 2] = Blockizer.ShyreGlass;
		chunk[x][y + 12][z + 3] = Blockizer.ShyreWallWhite;
		chunk[x][y + 12][z + 4] = Blockizer.ShyreWallWhite;
		chunk[x][y + 12][z + 5] = Blockizer.ShyreGlass;
		...
		chunk[x][y + 13][z + 2] = Blockizer.ShyreGlass;
		chunk[x][y + 13][z + 3] = Blockizer.ShyreWallWhite;
		chunk[x][y + 13][z + 4] = Blockizer.ShyreWallWhite;
		chunk[x][y + 13][z + 5] = Blockizer.ShyreGlass;
