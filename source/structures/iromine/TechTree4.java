...
public class TechTree4 extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 0, j + 4, k + 0, Blockizer.WoodIromine);
		world.setBlock(i + 0, j + 4, k + 1, Blockizer.IroGlass);
		world.setBlock(i + 0, j + 4, k + 2, Blockizer.WoodIromine);
		world.setBlock(i + 0, j + 5, k + 0, Blockizer.IroBox);
		world.setBlock(i + 0, j + 5, k + 2, Blockizer.IroBox);
		world.setBlock(i + 0, j + 6, k + 0, Blockizer.WoodIromine);
		world.setBlock(i + 0, j + 6, k + 2, Blockizer.WoodIromine);
		...
		world.setBlock(i + 1, j + 4, k + 0, Blockizer.IroGlass);
		...
		world.setBlock(i + 2, j + 5, k + 2, Blockizer.IroBox);
		world.setBlock(i + 2, j + 6, k + 0, Blockizer.WoodIromine);
