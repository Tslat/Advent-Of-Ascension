...
public class Crystal5 extends WorldGenerator {
	public boolean generate(final World world, final Random rand, final int i, final int j, final int k) {
		...
		world.setBlock(i + 0, j + 0, k + 2, cBlock);
		world.setBlock(i + 0, j + 1, k + 0, cBlock);
		world.setBlock(i + 0, j + 1, k + 1, cBlock);
		world.setBlock(i + 0, j + 1, k + 2, cBlock);
		world.setBlock(i + 0, j + 2, k + 0, cBlock);
		world.setBlock(i + 0, j + 2, k + 1, cBlock);
		world.setBlock(i + 0, j + 2, k + 2, cBlock);
		world.setBlock(i + 0, j + 3, k + 0, cBlock);
		world.setBlock(i + 0, j + 3, k + 1, cBlock);
		world.setBlock(i + 0, j + 3, k + 2, cBlock);
		world.setBlock(i + 0, j + 4, k + 0, cBlock);
		world.setBlock(i + 0, j + 4, k + 1, cBlock);
		world.setBlock(i + 0, j + 4, k + 2, cBlock);
		world.setBlock(i + 0, j + 5, k + 0, cBlock);
		world.setBlock(i + 0, j + 5, k + 1, cBlock);
		world.setBlock(i + 0, j + 5, k + 2, cBlock);
		world.setBlock(i + 1, j + 0, k + 0, cBlock);
		world.setBlock(i + 1, j + 0, k + 1, cBlock);
		world.setBlock(i + 1, j + 0, k + 2, cBlock);
		world.setBlock(i + 1, j + 1, k + 0, cBlock);
		world.setBlock(i + 1, j + 1, k + 1, cBlock);
		world.setBlock(i + 1, j + 1, k + 2, cBlock);
		world.setBlock(i + 1, j + 2, k + 0, cBlock);
		world.setBlock(i + 1, j + 2, k + 1, cBlock);
		world.setBlock(i + 1, j + 2, k + 2, cBlock);
		world.setBlock(i + 1, j + 3, k + 0, cBlock);
		world.setBlock(i + 1, j + 3, k + 1, cBlock);
		world.setBlock(i + 1, j + 3, k + 2, cBlock);
		world.setBlock(i + 1, j + 4, k + 0, cBlock);
		world.setBlock(i + 1, j + 4, k + 1, cBlock);
		world.setBlock(i + 1, j + 4, k + 2, cBlock);
		world.setBlock(i + 1, j + 5, k + 0, cBlock);
		world.setBlock(i + 1, j + 5, k + 1, cBlock);
		world.setBlock(i + 1, j + 5, k + 2, cBlock);
		world.setBlock(i + 2, j + 0, k + 0, cBlock);
		world.setBlock(i + 2, j + 0, k + 1, cBlock);
		world.setBlock(i + 2, j + 0, k + 2, cBlock);
		world.setBlock(i + 2, j + 1, k + 0, cBlock);
		world.setBlock(i + 2, j + 1, k + 1, cBlock);
		world.setBlock(i + 2, j + 1, k + 2, cBlock);
		world.setBlock(i + 2, j + 2, k + 0, cBlock);
		world.setBlock(i + 2, j + 2, k + 1, cBlock);
		world.setBlock(i + 2, j + 2, k + 2, cBlock);
		world.setBlock(i + 2, j + 3, k + 0, cBlock);
		world.setBlock(i + 2, j + 3, k + 1, cBlock);
		world.setBlock(i + 2, j + 3, k + 2, cBlock);
		world.setBlock(i + 2, j + 4, k + 0, cBlock);
		world.setBlock(i + 2, j + 4, k + 1, cBlock);
		world.setBlock(i + 2, j + 4, k + 2, cBlock);
		world.setBlock(i + 2, j + 5, k + 0, cBlock);
		world.setBlock(i + 2, j + 5, k + 1, cBlock);
		world.setBlock(i + 2, j + 5, k + 2, cBlock);
		return true;
	}
}
