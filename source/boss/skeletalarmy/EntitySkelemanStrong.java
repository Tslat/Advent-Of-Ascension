...
public class EntitySkelemanStrong extends EntityMob implements IRangedAttackMob {
	public EntitySkelemanStrong(final World par1World) {
		super(par1World);
	...
	public void attackEntityWithRangedAttack(final EntityLivingBase var1, final float f) {
		final EntitySkelemanShot var2 = new EntitySkelemanShot(worldObj, this, 4.0f);
