...
public class modelSkelepig extends ModelBase {
	ModelRenderer head1;
	ModelRenderer body3;
	ModelRenderer leg1;
	ModelRenderer leg2;
	...
	public modelSkelepig() {
		...
		body3.setRotationPoint(-1.0f, 11.0f, 10.0f);
