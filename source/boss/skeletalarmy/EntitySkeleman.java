...
public class EntitySkeleman extends EntityMob implements IRangedAttackMob {
	public EntitySkeleman(final World par1World) {
		super(par1World);
	...
	public void attackEntityWithRangedAttack(final EntityLivingBase var1, final float f) {
		final EntitySkelemanShot var2 = new EntitySkelemanShot(worldObj, this, 2.0f);
