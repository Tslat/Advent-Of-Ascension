...
public class EntitySkeleHopperStrong extends EntityMob {
	public EntitySkeleHopperStrong(final World par1World) {
		super(par1World);
		setSize(0.7f, 1.2f);
	...
	public void applyEntityAttributes() {
		...
		getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(32.0);
	}
}
