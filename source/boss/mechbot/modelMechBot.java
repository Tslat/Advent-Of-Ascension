...
public class modelMechBot extends ModelBase {
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
		...
		rightarm.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f + 3.1415927f)) * 2.0f * par2 * 0.5f;
		rightarm.rotateAngleZ = 0.0f;
		rightarm2.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f + 3.1415927f)) * 2.0f * par2 * 0.5f;
		rightarm2.rotateAngleZ = 0.0f;
		leftarm.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f)) * 2.0f * par2 * 0.5f;
		leftarm.rotateAngleZ = 0.0f;
		leftarm2.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f)) * 2.0f * par2 * 0.5f;
		leftarm2.rotateAngleZ = 0.0f;
		rightleg.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f)) * 1.4f * par2;
		rightleg.rotateAngleY = 0.0f;
		rightleg2.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f)) * 1.4f * par2;
		rightleg2.rotateAngleY = 0.0f;
		rightleg3.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f)) * 1.4f * par2;
		rightleg3.rotateAngleY = 0.0f;
		leftleg.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f + 3.1415927f)) * 1.4f * par2;
		leftleg2.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f + 3.1415927f)) * 1.4f * par2;
		leftleg3.rotateAngleX = MathHelper.cos((float)(par1 * 0.6662f + 3.1415927f)) * 1.4f * par2;
	}
}
