...
public class UtilityBlockScreen extends ContainerScreen<UtilityBlockContainer> {
	private static final ResourceLocation textures = new ResourceLocation("aoa3", "textures/gui/containers/basic_block.png");

	public UtilityBlockScreen(UtilityBlockContainer container, PlayerInventory inv, ITextComponent guiTitle) {
