...
public class HelmOfTheTreasurerModel extends SkillHelmetModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(AdventOfAscension.id("helm_of_the_treasurer"), "main");

	public HelmOfTheTreasurerModel(ModelPart meshDefRoot) {
		super(meshDefRoot);
	}

	public static Function<EntityModelSet, HelmOfTheTreasurerModel> modelFactory() {
		return modelSet -> new HelmOfTheTreasurerModel(modelSet.bakeLayer(LAYER_LOCATION));
	}
	...
	public static LayerDefinition createLayerDefinition() {
		...
		PartDefinition root = partDefinition.addOrReplaceChild("root", CubeListBuilder.create().texOffs(16, 3).addBox(-1.5F, -8.75F, -5.5F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(17, 13).addBox(-1.0F, -8.25F, -5.75F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
