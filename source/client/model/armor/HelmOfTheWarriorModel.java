...
public class HelmOfTheWarriorModel extends SkillHelmetModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(AdventOfAscension.id("helm_of_the_warrior"), "main");

	public HelmOfTheWarriorModel(ModelPart meshDefRoot) {
		super(meshDefRoot);
	}

	public static Function<EntityModelSet, HelmOfTheWarriorModel> modelFactory() {
		return modelSet -> new HelmOfTheWarriorModel(modelSet.bakeLayer(LAYER_LOCATION));
	}
	...
	public static LayerDefinition createLayerDefinition() {
		...
		bone8.addOrReplaceChild("bone9", CubeListBuilder.create().texOffs(40, 8).addBox(4.0F, -8.5794F, -8.5204F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(40, 8).addBox(4.0F, -8.5794F, -8.5204F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(54, 9).addBox(4.4475F, -11.6403F, -9.4024F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0706F, 5.5F, 2.538F, -0.6109F, 0.0F, 0.0F));
		...
		bone13.addOrReplaceChild("bone14", CubeListBuilder.create().texOffs(40, 8).mirror().addBox(-5.0F, -8.5794F, -8.5204F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(40, 8).mirror().addBox(-5.0F, -8.5794F, -8.5204F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(54, 9).mirror().addBox(-5.4475F, -11.6403F, -9.4024F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.0706F, 5.5F, 2.538F, -0.6109F, 0.0F, 0.0F));
