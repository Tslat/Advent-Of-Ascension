...
public class HelmOfTheRitualistTrimModel extends SkillHelmetModel {
	...
	public static LayerDefinition createLayerDefinition() {
		...
		PartDefinition bone20 = root.addOrReplaceChild("bone20", CubeListBuilder.create().texOffs(16, 20).addBox(1.5F, -8.9127F, 2.625F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -0.15F, -1.3F, 0.4363F, 0.0F, 0.0F));
		...
		PartDefinition bone8 = root.addOrReplaceChild("bone8", CubeListBuilder.create().texOffs(27, 2).mirror().addBox(-3.0F, -3.0F, 0.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.25F, -5.45F, -0.85F, 0.3491F, -0.3927F, 0.0F));
