...
public class HelmOfTheDryadModel extends SkillHelmetModel {
	public HelmOfTheDryadModel() {
		super(AdventOfAscension.id("textures/models/armor/custom/helm_of_the_dryad.png"));
		...
		bone22.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.0F, 0.0F, 0.0F);
		cube_r1.texOffs(46, 42).addBox(2.0F, -11.5F, -2.75F, 1.0F, 3.0F, 1.0F, 0.1F, false);
		cube_r1.texOffs(38, 42).addBox(1.75F, -8.5F, -3.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);

		ModelRenderer bone23 = new ModelRenderer(this);
		bone23.setPos(-5.25F, -7.5F, 3.25F);
		horn1.addChild(bone23);
		setRotationAngle(bone23, -0.1128F, 0.4389F, 0.7285F);

		ModelRenderer cube_r2 = new ModelRenderer(this);
		cube_r2.setPos(3.6837F, -1.4382F, -3.0115F);
		bone23.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.0F, 0.0F, 0.0F);
		cube_r2.texOffs(46, 46).addBox(2.75F, -8.5F, -3.0F, 1.0F, 3.0F, 1.0F, 0.1F, false);
		...
		cube_r3.texOffs(46, 42).addBox(-3.5F, -11.5F, -2.75F, 1.0F, 3.0F, 1.0F, 0.1F, true);
		cube_r3.texOffs(38, 42).addBox(-3.75F, -8.5F, -3.0F, 2.0F, 3.0F, 2.0F, 0.0F, true);
		...
		cube_r4.setPos(-3.6837F, -1.4382F, -3.0115F);
		bone24.addChild(cube_r4);
		setRotationAngle(cube_r4, 0.0F, 0.0F, 0.0F);
		cube_r4.texOffs(46, 46).addBox(-3.75F, -8.5F, -3.0F, 1.0F, 3.0F, 1.0F, 0.1F, true);
		...
		cube_r5.setPos(3.9776F, 0.953F, -0.2262F);
		bone10.addChild(cube_r5);
		setRotationAngle(cube_r5, 0.0F, 0.0F, 0.0F);
		cube_r5.texOffs(29, 27).addBox(-4.5F, -9.0F, 4.2F, 2.0F, 2.0F, 2.0F, 0.0F, true);

		ModelRenderer cube_r6 = new ModelRenderer(this);
		cube_r6.setPos(-3.0224F, 0.203F, -0.2262F);
		bone10.addChild(cube_r6);
		setRotationAngle(cube_r6, 0.0F, 0.0F, 0.0F);
		cube_r6.texOffs(27, 22).addBox(2.5F, -10.25F, -3.8F, 2.0F, 2.0F, 10.0F, 0.0F, false);
		...
		cube_r7.setPos(3.0224F, 0.203F, -0.2262F);
		bone15.addChild(cube_r7);
		setRotationAngle(cube_r7, 0.0F, 0.0F, 0.0F);
		cube_r7.texOffs(29, 27).addBox(-4.5F, -8.25F, 4.2F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		cube_r7.texOffs(27, 22).addBox(-4.5F, -10.25F, -3.8F, 2.0F, 2.0F, 10.0F, 0.0F, true);
