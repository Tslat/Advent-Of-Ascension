...
public class HelmOfTheDextrousTrimModel extends SkillHelmetModel {
	public HelmOfTheDextrousTrimModel() {
		super(AdventOfAscension.id("textures/models/armor/custom/helm_of_the_dextrous_trim.png"));
		...
		ModelRenderer bone5 = new FullbrightModelRenderer(this);
		...
		ModelRenderer bone6 = new FullbrightModelRenderer(this);
		...
		ModelRenderer bone7 = new FullbrightModelRenderer(this);
		...
		ModelRenderer bone12 = new FullbrightModelRenderer(this);
		bone12.setPos(-8.8464F, 6.3178F, 8.2956F);
		bone9.addChild(bone12);
		setRotationAngle(bone12, 0.8456F, -0.266F, -0.0577F);
		bone12.texOffs(37, 20).addBox(4.3959F, -7.3154F, 0.8541F, 0.0F, 3.0F, 9.0F, 0.0F, true);

		ModelRenderer bone13 = new FullbrightModelRenderer(this);
		bone13.setPos(-8.5964F, 8.0678F, 7.0456F);
		bone9.addChild(bone13);
		setRotationAngle(bone13, 0.5838F, -0.266F, -0.0577F);
		bone13.texOffs(38, 24).addBox(4.6959F, -7.3998F, 1.3533F, 0.0F, 3.0F, 8.0F, 0.0F, true);

		ModelRenderer bone14 = new FullbrightModelRenderer(this);
		bone14.setPos(-8.0964F, 9.0678F, 5.0456F);
		bone9.addChild(bone14);
		setRotationAngle(bone14, 0.1911F, -0.266F, -0.0577F);
		bone14.texOffs(40, 29).addBox(4.8459F, -7.3774F, 1.3597F, 0.0F, 3.0F, 6.0F, 0.0F, true);
		...
		ModelRenderer bone17 = new FullbrightModelRenderer(this);
		bone17.setPos(0.0F, 0.2F, 0.0F);
		head.addChild(bone17);
		setRotationAngle(bone17, 0.0F, 0.0F, 0.7854F);
		bone17.texOffs(56, 28).addBox(-6.5255F, -6.5255F, -5.75F, 2.0F, 2.0F, 2.0F, -0.35F, false);

		ModelRenderer bone18 = new FullbrightModelRenderer(this);
		bone18.setPos(0.0F, 0.0F, 0.0F);
		head.addChild(bone18);
		bone18.texOffs(0, 19).addBox(0.0F, -14.0487F, -1.25F, 0.0F, 10.0F, 9.0F, 0.0F, false);
	}
