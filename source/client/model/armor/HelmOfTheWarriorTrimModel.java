...
public class HelmOfTheWarriorTrimModel extends SkillHelmetModel {
	public HelmOfTheWarriorTrimModel() {
		super(AdventOfAscension.id("textures/models/armor/custom/helm_of_the_warrior_trim.png"));
		texWidth = 64;
		texHeight = 32;
		...
		ModelRenderer GEM = new FullbrightModelRenderer(this);
		GEM.setPos(-6.511F, 0.0F, -1.0114F);
		bone4.addChild(GEM);
		GEM.texOffs(16, 12).addBox(-0.25F, -6.5F, -5.75F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		...
		ModelRenderer GLOW_1 = new FullbrightModelRenderer(this);
		GLOW_1.setPos(0.4532F, -3.6403F, -2.9024F);
		bone9.addChild(GLOW_1);
		GLOW_1.texOffs(58, 8).addBox(3.9943F, -10.25F, -6.5F, 1.0F, 5.0F, 2.0F, 0.0F, false);

		ModelRenderer GLOW_2 = new FullbrightModelRenderer(this);
		GLOW_2.setPos(0.3532F, -2.6403F, -4.4024F);
		bone9.addChild(GLOW_2);
		setRotationAngle(GLOW_2, -0.5236F, 0.0F, 0.0F);
		GLOW_2.texOffs(58, 8).addBox(3.9943F, -9.0F, -7.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);
		...
		ModelRenderer GLOW_4 = new FullbrightModelRenderer(this);
		GLOW_4.setPos(-0.4532F, -3.6403F, -2.9024F);
		bone14.addChild(GLOW_4);
		GLOW_4.texOffs(58, 8).addBox(-4.9943F, -10.25F, -6.5F, 1.0F, 5.0F, 2.0F, 0.0F, true);

		ModelRenderer GLOW_3 = new FullbrightModelRenderer(this);
		GLOW_3.setPos(-0.3532F, -2.6403F, -4.4024F);
		bone14.addChild(GLOW_3);
		setRotationAngle(GLOW_3, -0.5236F, 0.0F, 0.0F);
		GLOW_3.texOffs(58, 8).addBox(-4.9943F, -9.0F, -7.0F, 1.0F, 5.0F, 2.0F, 0.0F, true);
	}
