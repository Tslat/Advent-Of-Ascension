...
public class HelmOfTheTrawlerModel extends SkillHelmetModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(AdventOfAscension.id("helm_of_the_trawler"), "main");

	public HelmOfTheTrawlerModel(ModelPart meshDefRoot) {
		super(meshDefRoot);
	}

	public static Function<EntityModelSet, HelmOfTheTrawlerModel> modelFactory() {
		return modelSet -> new HelmOfTheTrawlerModel(modelSet.bakeLayer(LAYER_LOCATION));
	}
	...
	public static LayerDefinition createLayerDefinition() {
		...
		PartDefinition tail_end = bone7.addOrReplaceChild("tail_end", CubeListBuilder.create().texOffs(16, 12).addBox(-3.6F, -7.5F, -3.85F, 8.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.4F, 1.3162F, 6.586F));
		...
		root.addOrReplaceChild("top_fins", CubeListBuilder.create().texOffs(55, 0).addBox(-0.5F, -11.5F, -1.5601F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(55, 10).addBox(0.0F, -11.5F, -0.5601F, 0.0F, 5.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(53, 13).addBox(0.0F, -11.5F, 3.4399F, 0.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
				...
				.texOffs(54, 17).addBox(0.0F, -8.25F, 5.6899F, 0.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.75F, -4.0F, -0.5672F, 0.0F, 0.0F));

		PartDefinition right_fins = root.addOrReplaceChild("right_fins", CubeListBuilder.create(), PartPose.offset(2.3249F, -6.5F, -3.4479F));

		right_fins.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(0, 18).addBox(0.2614F, -0.5F, -1.1122F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(14, 15).addBox(0.0114F, -0.25F, -0.1122F, 5.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0555F, 0.5648F, 0.1034F));
		right_fins.addOrReplaceChild("bone4", CubeListBuilder.create().texOffs(0, 20).addBox(1.2614F, -0.5F, -1.1122F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(26, 17).addBox(2.2614F, 0.0F, -0.1122F, 4.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5F, 3.0F, 0.0507F, -0.394F, 0.0542F));
		...
		left_fins.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(0, 18).mirror().addBox(-5.2614F, -0.5F, -1.1122F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(14, 15).mirror().addBox(-5.0114F, -0.25F, -0.1122F, 5.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0555F, -0.5648F, -0.1034F));
		left_fins.addOrReplaceChild("bone8", CubeListBuilder.create().texOffs(0, 20).mirror().addBox(-7.2614F, -0.5F, -1.1122F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(26, 17).mirror().addBox(-6.2614F, 0.0F, -0.1122F, 4.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -0.5F, 3.0F, 0.0507F, 0.394F, -0.0542F));
		...
		root.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(43, 13).addBox(-0.9497F, -8.0F, -5.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
