...
public class HelmOfTheRitualistModel extends SkillHelmetModel {
	...
	public static LayerDefinition createLayerDefinition() {
		...
		root.addOrReplaceChild("bone20", CubeListBuilder.create().texOffs(16, 20).addBox(1.5F, -8.9127F, 2.625F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5F, -0.15F, -2.8F, 0.4363F, 0.0F, 0.0F));
		...
		root.addOrReplaceChild("bone10", CubeListBuilder.create().texOffs(27, 2).mirror().addBox(-3.0F, -3.0F, 0.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.75F, -5.45F, -2.35F, 0.3491F, -0.3927F, 0.0F));

		PartDefinition bone11 = root.addOrReplaceChild("bone11", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.75F, -5.45F, -2.35F, 0.3491F, -0.3927F, 0.0F));
