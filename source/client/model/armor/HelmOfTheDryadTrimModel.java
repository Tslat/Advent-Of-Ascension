...
public class HelmOfTheDryadTrimModel extends SkillHelmetModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(AdventOfAscension.id("helm_of_the_dryad_trim"), "main");

	public HelmOfTheDryadTrimModel(ModelPart meshDefRoot) {
		super(meshDefRoot);
	}

	public static Function<EntityModelSet, HelmOfTheDryadTrimModel> modelFactory() {
		return modelSet -> new HelmOfTheDryadTrimModel(modelSet.bakeLayer(LAYER_LOCATION));
	}
	...
	public static LayerDefinition createLayerDefinition() {
		...
		PartDefinition bone21 = horn2.addOrReplaceChild("bone21", FullbrightCubes.create(), PartPose.offsetAndRotation(0.0F, 0.5F, -1.75F, -0.4443F, -0.0873F, 0.4005F));

		bone21.addOrReplaceChild("cube_r1", FullbrightCubes.create().texOffs(46, 42).mirror().addGlowBox(-3.0F, -14.5F, -2.75F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.1F)).mirror(false)
				.texOffs(38, 42).addGlowBox(-3.75F, -10.5F, -3.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.6837F, -1.4382F, -3.0115F, 0.0F, 0.0F, 0.0F));

		PartDefinition bone26 = bone21.addOrReplaceChild("bone26", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.6837F, -1.4382F, -3.0115F, 0.0F, 0.0F, -0.8727F));

		bone26.addOrReplaceChild("cube_r2", FullbrightCubes.create().texOffs(46, 42).mirror().addGlowBox(-4.0F, -15.0F, -2.25F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.1F)).mirror(false), PartPose.offsetAndRotation(8.8186F, 2.3102F, -0.15F, 0.0F, 0.0F, 0.0F));

		PartDefinition bone24 = horn2.addOrReplaceChild("bone24", FullbrightCubes.create(), PartPose.offsetAndRotation(5.25F, -7.5F, 3.25F, -0.1128F, -0.4389F, -0.7285F));

		bone24.addOrReplaceChild("cube_r3", FullbrightCubes.create().texOffs(46, 42).mirror().addGlowBox(-3.75F, -9.5F, -3.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.1F)).mirror(false), PartPose.offsetAndRotation(-3.6837F, -1.4382F, -3.0115F, 0.0F, 0.0F, 0.0F));

		PartDefinition bone25 = bone24.addOrReplaceChild("bone25", FullbrightCubes.create(), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6545F));

		bone25.addOrReplaceChild("cube_r4", FullbrightCubes.create().texOffs(46, 42).mirror().addGlowBox(-3.75F, -8.5F, -3.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(-8.8465F, 1.2291F, -3.0115F, 0.0F, 0.0F, 0.0F));

		PartDefinition horn1 = root.addOrReplaceChild("horn1", FullbrightCubes.create().texOffs(38, 34).addGlowBox(1.0F, -10.5F, -5.0F, 3.0F, 5.0F, 3.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-3.0F, -4.0F, -1.25F, -0.3054F, 0.0F, 0.6981F));

		PartDefinition bone22 = horn1.addOrReplaceChild("bone22", FullbrightCubes.create(), PartPose.offsetAndRotation(0.0F, 0.5F, -1.75F, -0.4443F, 0.0873F, -0.4005F));

		bone22.addOrReplaceChild("cube_r5", FullbrightCubes.create().texOffs(46, 42).addGlowBox(2.0F, -14.5F, -2.75F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.1F))
				.texOffs(38, 42).mirror().addGlowBox(1.75F, -10.5F, -3.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.6837F, -1.4382F, -3.0115F, 0.0F, 0.0F, 0.0F));

		PartDefinition bone23 = bone22.addOrReplaceChild("bone23", FullbrightCubes.create(), PartPose.offsetAndRotation(3.6837F, -1.4382F, -3.0115F, 0.0F, 0.0F, 0.8727F));

		bone23.addOrReplaceChild("cube_r6", FullbrightCubes.create().texOffs(46, 42).addGlowBox(3.0F, -15.0F, -2.25F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-8.8186F, 2.3102F, -0.15F, 0.0F, 0.0F, 0.0F));

		PartDefinition bone27 = horn1.addOrReplaceChild("bone27", FullbrightCubes.create(), PartPose.offsetAndRotation(-5.25F, -7.5F, 3.25F, -0.1128F, 0.4389F, 0.7285F));

		bone27.addOrReplaceChild("cube_r7", FullbrightCubes.create().texOffs(46, 42).addGlowBox(2.75F, -9.5F, -3.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(3.6837F, -1.4382F, -3.0115F, 0.0F, 0.0F, 0.0F));

		PartDefinition bone28 = bone27.addOrReplaceChild("bone28", FullbrightCubes.create(), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6545F));

		bone28.addOrReplaceChild("cube_r8", FullbrightCubes.create().texOffs(46, 42).addGlowBox(2.75F, -8.5F, -3.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(8.8465F, 1.2291F, -3.0115F, 0.0F, 0.0F, 0.0F));
		...
		bone10.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(29, 27).mirror().addBox(-4.5F, -9.0F, 4.2F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.9776F, 0.953F, -0.2262F, 0.0F, 0.0F, 0.0F));
		bone10.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(27, 22).addBox(2.5F, -10.25F, -3.8F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0224F, 0.203F, -0.2262F, 0.0F, 0.0F, 0.0F));
		...
		bone15.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(29, 27).addBox(-4.5F, -8.25F, 4.2F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		...
		root.addOrReplaceChild("bone2", FullbrightCubes.create().texOffs(37, 14).addBox(-3.5F, -5.0F, -2.25F, 7.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(0, 17).addBox(-1.5F, -5.5962F, -2.4749F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(11, 0).addGlowBox(-1.0F, -6.0962F, -1.4749F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.25F, 0.25F, 0.7854F, 0.0F, 0.0F));
