...
public class HelmOfTheDextrousModel extends SkillHelmetModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(AdventOfAscension.id("helm_of_the_dextrous"), "main");

	public HelmOfTheDextrousModel(ModelPart meshDefRoot) {
		super(meshDefRoot);
	}

	public static Function<EntityModelSet, HelmOfTheDextrousModel> modelFactory() {
		return modelSet -> new HelmOfTheDextrousModel(modelSet.bakeLayer(LAYER_LOCATION));
	}
	...
	public static LayerDefinition createLayerDefinition() {
		...
		PartDefinition root = partDefinition.addOrReplaceChild("root", CubeListBuilder.create().texOffs(32, 0).addBox(-0.4006F, -10.5487F, -4.251F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
				...
				.texOffs(0, 19).addBox(0.0F, -14.0487F, -1.25F, 0.0F, 10.0F, 9.0F, new CubeDeformation(0.0F))
		...
		bone4.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(37, 20).addBox(-4.3959F, -7.3154F, 0.8541F, 0.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.8464F, 6.3178F, 8.2956F, 0.8456F, 0.266F, 0.0577F));
		bone4.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(38, 24).addBox(-4.6959F, -7.3998F, 1.3533F, 0.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.5964F, 8.0678F, 7.0456F, 0.5838F, 0.266F, 0.0577F));
		bone4.addOrReplaceChild("bone7", CubeListBuilder.create().texOffs(40, 29).addBox(-4.8459F, -7.3774F, 1.3597F, 0.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0964F, 9.0678F, 5.0456F, 0.1911F, 0.266F, 0.0577F));
		...
		bone9.addOrReplaceChild("bone12", CubeListBuilder.create().texOffs(39, 22).mirror().addBox(4.3959F, -7.3154F, 0.8541F, 0.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-8.8464F, 6.3178F, 8.2956F, 0.8456F, -0.266F, -0.0577F));
		bone9.addOrReplaceChild("bone13", CubeListBuilder.create().texOffs(39, 25).mirror().addBox(4.6959F, -7.3998F, 1.3533F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-8.5964F, 8.0678F, 7.0456F, 0.5838F, -0.266F, -0.0577F));
		bone9.addOrReplaceChild("bone14", CubeListBuilder.create().texOffs(41, 30).mirror().addBox(4.8459F, -7.3774F, 1.3597F, 0.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-8.0964F, 9.0678F, 5.0456F, 0.1911F, -0.266F, -0.0577F));
