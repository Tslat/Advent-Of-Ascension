...
public class ModelNightmareSpider extends ModelBase {
	...
	public ModelNightmareSpider() {
		...
		Leg3.cubeList.add(new ModelBox(Leg3, 18, 0, -0.0052F, -1.5226F, -1.0519F, 16, 2, 2, 0.0F, true));

		Leg4 = new ModelRenderer(this);
		Leg4.setRotationPoint(-2.0F, 0.0F, 0.5F);
		Body.addChild(Leg4);
		setRotation(Leg4, 0.0F, 0.2793F, 0.2443F);
		Leg4.cubeList.add(new ModelBox(Leg4, 18, 0, -15.9948F, -1.5226F, -1.0519F, 16, 2, 2, 0.0F, false));
		...
		RearEnd.cubeList.add(new ModelBox(RearEnd, 0, 12, -5.0F, -4.0F, -6.0F, 10, 8, 12, 0.0F, true));
		...
		RearEnd2.cubeList.add(new ModelBox(RearEnd2, 68, 1, -1.0F, -4.0F, -6.0F, 2, 4, 9, 0.0F, true));
		RearEnd2.cubeList.add(new ModelBox(RearEnd2, 68, 1, 3.0F, -4.0F, -6.0F, 2, 4, 9, 0.0F, true));

		Head = new ModelRenderer(this);
		Head.setRotationPoint(0.0F, 0.0F, -3.0F);
		Body.addChild(Head);
		Head.cubeList.add(new ModelBox(Head, 32, 4, -4.0F, -4.0F, -8.0F, 8, 8, 8, 0.0F, true));
		Head.cubeList.add(new ModelBox(Head, 92, 4, 2.0F, -8.0F, -7.0F, 2, 4, 2, 0.0F, true));
		Head.cubeList.add(new ModelBox(Head, 92, 4, -4.0F, -8.0F, -7.0F, 2, 4, 2, 0.0F, true));
	}
