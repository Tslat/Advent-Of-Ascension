...
public class ModelGravityTablet extends ModelBase {
	private final ModelRenderer base;
	private final ModelRenderer icon;

	public ModelGravityTablet() {
		textureWidth = 32;
		textureHeight = 32;
		...
		icon.cubeList.add(new ModelBox(icon, 12, 10, -1.0F, -1.249F, -2.0F, 2, 1, 3, 0.0F, false));
		icon.cubeList.add(new ModelBox(icon, 0, 14, 0.1213F, -1.249F, 0.2929F, 2, 1, 1, 0.0F, false));
		icon.cubeList.add(new ModelBox(icon, 0, 10, -2.1213F, -1.25F, 0.2929F, 2, 1, 1, 0.0F, false));

		ModelRenderer cube = new ModelRenderer(this);
		cube.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube, 0.0F, -0.7854F, 0.0F);
		icon.addChild(cube);
		cube.cubeList.add(new ModelBox(cube, 8, 10, -0.5858F, -1.251F, 1.4142F, 1, 1, 1, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 1, 12, 1.4142F, -1.25F, -0.5858F, 1, 1, 1, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 7, 10, 0.4142F, -1.251F, 0.4142F, 2, 1, 2, 0.0F, false));
	}
