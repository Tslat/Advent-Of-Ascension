...
public class ModelSatiationTablet extends ModelBase {
	private final ModelRenderer base;
	private final ModelRenderer icon;

	public ModelSatiationTablet() {
		textureWidth = 32;
		textureHeight = 32;
		...
		icon.cubeList.add(new ModelBox(icon, 16, 10, -2.4749F, -1.249F, -2.4142F, 1, 1, 1, 0.0F, false));
		icon.cubeList.add(new ModelBox(icon, 16, 10, 1.7678F, -1.249F, 1.8284F, 1, 1, 1, 0.0F, false));
		icon.cubeList.add(new ModelBox(icon, 16, 10, -2.7678F, -1.249F, -2.1213F, 1, 1, 1, 0.0F, false));
		icon.cubeList.add(new ModelBox(icon, 16, 10, 1.4749F, -1.249F, 2.1213F, 1, 1, 1, 0.0F, false));

		ModelRenderer cube = new ModelRenderer(this);
		cube.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube, 0.0F, -0.7854F, 0.0F);
		icon.addChild(cube);
		cube.cubeList.add(new ModelBox(cube, 11, 10, -2.75F, -1.249F, -0.25F, 6, 1, 1, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 0, 10, -1.75F, -1.25F, -1.25F, 4, 1, 3, 0.0F, false));
	}
