...
public class ModelResistanceTablet extends ModelBase {
	...
	public ModelResistanceTablet() {
		...
		icon.cubeList.add(new ModelBox(icon, 0, 10, -2.0F, -1.25F, -1.0F, 3, 1, 4, 0.0F, false));
		icon.cubeList.add(new ModelBox(icon, 6, 10, 0.9837F, -1.249F, -1.0F, 1, 1, 4, 0.0F, false));

		ModelRenderer cube = new ModelRenderer(this);
		cube.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube, 0.0F, 0.5236F, 0.0F);
		icon.addChild(cube);
		cube.cubeList.add(new ModelBox(cube, 12, 12, -1.2321F, -1.2495F, -1.866F, 2, 1, 1, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 0, 12, 0.0679F, -1.249F, -1.866F, 1, 1, 1, 0.0F, false));

		ModelRenderer cube4 = new ModelRenderer(this);
		cube4.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube4, 0.0F, -0.5236F, 0.0F);
		icon.addChild(cube4);
		cube4.cubeList.add(new ModelBox(cube4, 12, 10, -0.7821F, -1.249F, -1.8579F, 2, 1, 1, 0.0F, false));
		cube4.cubeList.add(new ModelBox(cube4, 0, 12, -1.0821F, -1.249F, -1.8579F, 1, 1, 1, 0.0F, false));
	}
