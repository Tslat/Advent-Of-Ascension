...
public class ModelStrengthTablet extends ModelBase {
	private final ModelRenderer base;
	private final ModelRenderer icon;

	public ModelStrengthTablet() {
		textureWidth = 32;
		textureHeight = 32;
		...
		icon.addChild(cube);
		cube.cubeList.add(new ModelBox(cube, 12, 10, -1.0F, -1.249F, -1.0F, 1, 1, 4, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 2, 10, -0.5F, -1.249F, -1.0F, 1, 1, 4, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 10, 10, -0.7366F, -1.249F, -3.2232F, 1, 1, 2, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 18, 12, -1.2366F, -1.25F, -1.9732F, 2, 1, 1, 0.0F, false));

		ModelRenderer cube4 = new ModelRenderer(this);
		cube4.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube4, 0.0F, -0.7854F, 0.0F);
		cube.addChild(cube4);
		cube4.cubeList.add(new ModelBox(cube4, 8, 10, 1.4142F, -1.25F, 1.8284F, 1, 1, 1, 0.0F, false));
		cube4.cubeList.add(new ModelBox(cube4, 0, 10, -3.05F, -1.25F, -2.7083F, 1, 1, 1, 0.0F, false));
		cube4.cubeList.add(new ModelBox(cube4, 18, 10, -0.8555F, -1.25F, -1.9351F, 1, 1, 1, 0.0F, false));
		cube4.cubeList.add(new ModelBox(cube4, 0, 10, -2.2697F, -1.251F, -0.5209F, 1, 1, 1, 0.0F, false));
		cube4.cubeList.add(new ModelBox(cube4, 8, 10, 1.4749F, -1.25F, 1.7678F, 1, 1, 1, 0.0F, false));
		cube4.cubeList.add(new ModelBox(cube4, 8, 10, 1.4749F, -1.25F, 1.8284F, 1, 1, 1, 0.0F, false));
	}
