...
public class ModelDistortionTablet extends ModelBase {
	private final ModelRenderer base;
	private final ModelRenderer icon;

	public ModelDistortionTablet() {
		textureWidth = 32;
		textureHeight = 32;
		...
		icon.cubeList.add(new ModelBox(icon, 6, 10, -1.0F, -1.251F, 2.0F, 2, 1, 1, 0.0F, false));
		icon.cubeList.add(new ModelBox(icon, 0, 15, -1.0F, -1.249F, -1.8284F, 2, 1, 1, 0.0F, false));
		icon.cubeList.add(new ModelBox(icon, 0, 15, 1.4142F, -1.249F, -0.4142F, 1, 1, 2, 0.0F, false));
		icon.cubeList.add(new ModelBox(icon, 0, 10, -1.7071F, -1.25F, -1.1213F, 1, 1, 1, 0.0F, false));
		icon.cubeList.add(new ModelBox(icon, 0, 10, -0.6464F, -1.25F, 0.4393F, 1, 1, 1, 0.0F, false));
		icon.cubeList.add(new ModelBox(icon, 0, 15, -0.1982F, -1.249F, -0.2337F, 1, 1, 1, 0.0F, false));
		icon.cubeList.add(new ModelBox(icon, 0, 10, -1.7071F, -1.25F, -0.6213F, 1, 1, 1, 0.0F, false));

		ModelRenderer cube = new ModelRenderer(this);
		cube.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube, 0.0F, -0.7854F, 0.0F);
		icon.addChild(cube);
		cube.cubeList.add(new ModelBox(cube, 6, 10, -0.5858F, -1.251F, 1.8284F, 2, 1, 1, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 0, 15, -0.5858F, -1.249F, -2.0F, 2, 1, 1, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 0, 10, 1.8284F, -1.25F, -0.5858F, 1, 1, 2, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 0, 10, -2.0F, -1.25F, -0.5858F, 1, 1, 1, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 0, 10, -0.9393F, -1.25F, 0.4749F, 1, 1, 1, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 0, 10, -0.4393F, -1.25F, 0.4749F, 1, 1, 1, 0.0F, false));
		cube.cubeList.add(new ModelBox(cube, 0, 15, 0.2678F, -1.249F, -0.2322F, 1, 1, 1, 0.0F, false));

		ModelRenderer cube4 = new ModelRenderer(this);
		cube4.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube4, 0.0F, 0.2618F, 0.0F);
		icon.addChild(cube4);
		cube4.cubeList.add(new ModelBox(cube4, 0, 15, -0.165F, -1.249F, -0.0182F, 1, 1, 1, 0.0F, false));
	}
