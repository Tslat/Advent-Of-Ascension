...
public class TreeSpiritModel extends EntityModel<MobEntity> {
	...
	public void setRotationAngles(MobEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		head26.rotateAngleY = netHeadYaw / 57.295776f;
		head26.rotateAngleX = headPitch / 54.11268f;
		head27.rotateAngleY = netHeadYaw / 57.295776f;
		head27.rotateAngleX = headPitch / 54.11268f;
		rightArmtop.rotateAngleX = MathHelper.cos(limbSwing * 0.6662f + 3.1415927f) * 2.0f * limbSwingAmount * 0.5f;
		rightArmtop.rotateAngleZ = 0.0f;
		rightArmbot.rotateAngleX = MathHelper.cos(limbSwing * 0.6662f + 3.1415927f) * 2.0f * limbSwingAmount * 0.5f;
		rightArmbot.rotateAngleZ = 0.0f;
		rightArmmid.rotateAngleX = MathHelper.cos(limbSwing * 0.6662f + 3.1415927f) * 2.0f * limbSwingAmount * 0.5f;
		rightArmmid.rotateAngleZ = 0.0f;
		leftArmtop.rotateAngleX = MathHelper.cos(limbSwing * 0.6662f) * 2.0f * limbSwingAmount * 0.5f;
		leftArmtop.rotateAngleZ = 0.0f;
		leftArmbot.rotateAngleX = MathHelper.cos(limbSwing * 0.6662f) * 2.0f * limbSwingAmount * 0.5f;
		leftArmbot.rotateAngleZ = 0.0f;
		leftArmmid.rotateAngleX = MathHelper.cos(limbSwing * 0.6662f) * 2.0f * limbSwingAmount * 0.5f;
		...
		rightLegbot.rotateAngleX = MathHelper.cos(limbSwing * 0.6662f) * 1.4f * limbSwingAmount;
		rightLegbot.rotateAngleY = 0.0f;
		leftLegbot.rotateAngleX = MathHelper.cos(limbSwing * 0.6662f + 3.1415927f) * 1.4f * limbSwingAmount;
