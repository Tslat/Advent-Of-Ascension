...
public class FlowerfaceModel extends EntityModel<MobEntity> {
	...
	public FlowerfaceModel() {
		texWidth = 128;
		texHeight = 32;
		(head = new ModelRenderer(this, 96, 0)).addBox(-3.0f, 3.0f, -3.0f, 6, 10, 3);
		...
		(head3 = new ModelRenderer(this, 18, 0)).addBox(-13.0f, -3.0f, -3.0f, 10, 6, 3);
		head3.setPos(0.0f, 0.0f, -1.0f);
		head3.setTexSize(128, 32);
		head3.mirror = true;
		setRotation(head3, 0.0f, 0.0f, 0.0f);
		(head4 = new ModelRenderer(this, 46, 0)).addBox(3.0f, -3.0f, -3.0f, 10, 6, 3);
		head4.setPos(0.0f, 0.0f, -1.0f);
		head4.setTexSize(128, 32);
		head4.mirror = true;
		setRotation(head4, 0.0f, 0.0f, 0.0f);
		(head5 = new ModelRenderer(this, 74, 0)).addBox(-3.0f, -13.0f, -3.0f, 6, 10, 3);
