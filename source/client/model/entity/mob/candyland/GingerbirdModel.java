...
public class GingerbirdModel extends EntityModel<MobEntity> {
	...
	public void setRotationAngles(MobEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		wingR1.rotateAngleZ = MathHelper.cos(ageInTicks * 0.5f) * 3.1415927f * 0.35f;
		wingL1.rotateAngleZ = -wingR1.rotateAngleZ;
		wingR2.rotateAngleZ = MathHelper.cos(ageInTicks * 0.5f) * 3.1415927f * 0.35f;
		wingL2.rotateAngleZ = -wingR2.rotateAngleZ;
		wingR3.rotateAngleZ = MathHelper.cos(ageInTicks * 0.5f) * 3.1415927f * 0.35f;
		wingL3.rotateAngleZ = -wingR3.rotateAngleZ;
		wingR4.rotateAngleZ = MathHelper.cos(ageInTicks * 0.5f) * 3.1415927f * 0.35f;
		wingL4.rotateAngleZ = -wingR4.rotateAngleZ;
		wingR5.rotateAngleZ = MathHelper.cos(ageInTicks * 0.5f) * 3.1415927f * 0.35f;
		wingL5.rotateAngleZ = -wingR5.rotateAngleZ;
		wingR6.rotateAngleZ = MathHelper.cos(ageInTicks * 0.5f) * 3.1415927f * 0.35f;
