...
public class ArocknidModel extends EntityModel<MobEntity> {
	...
	public ArocknidModel() {
		...
		Leg3.setTextureOffset(18, 0).addBox(-0.0052F, -1.5196F, -1.0519F, 16, 2, 2, 0.0F, true);

		Leg4 = new ModelRenderer(this);
		Leg4.setRotationPoint(-2.0F, 0.0F, 0.5F);
		Body.addChild(Leg4);
		setRotation(Leg4, 0.0F, 0.2793F, 0.2443F);
		Leg4.setTextureOffset(18, 0).addBox(-15.9948F, -1.5196F, -1.0519F, 16, 2, 2, 0.0F, false);
		...
		Head3.setTextureOffset(4, 33).addBox(2.0F, -11.0F, -9.0F, 1, 4, 9, 0.0F, true);
		Head3.setTextureOffset(4, 33).addBox(-3.0F, -11.0F, -9.0F, 1, 4, 9, 0.0F, true);

		Body3 = new ModelRenderer(this);
		Body3.setRotationPoint(-1.0F, -1.0F, 2.0F);
		Body.addChild(Body3);
		setRotation(Body3, 0.912F, 0.0F, 0.0F);
		Body3.setTextureOffset(31, 23).addBox(2.0F, -4.0F, -2.0F, 1, 6, 13, 0.0F, true);
		Body3.setTextureOffset(31, 23).addBox(-1.0F, -4.0F, -2.0F, 1, 6, 13, 0.0F, true);

		RearEnd = new ModelRenderer(this);
		RearEnd.setRotationPoint(0.0F, 3.0F, 3.0F);
		Body.addChild(RearEnd);
		RearEnd.setTextureOffset(0, 12).addBox(-5.0F, -4.0F, 0.0F, 3, 4, 12, 0.0F, true);
		RearEnd.setTextureOffset(0, 12).addBox(2.0F, -4.0F, 0.0F, 3, 4, 12, 0.0F, true);
	}
