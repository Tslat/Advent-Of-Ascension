...
public class CaveCreepModel extends EntityModel<MobEntity> {
	...
	public CaveCreepModel() {
		...
		body8.setRotationPoint(2.0f, 14.0f, 1.0f);
		...
		body9.setRotationPoint(0.0f, 14.0f, -7.5f);
		...
		body10.setRotationPoint(0.0f, 14.0f, 9.5f);
		...
		body11.setRotationPoint(0.0f, 14.0f, -7.5f);
		...
		body12.setRotationPoint(2.0f, 14.0f, 1.0f);
		...
		body13.setRotationPoint(-2.0f, 14.0f, 1.0f);
