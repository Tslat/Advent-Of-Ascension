...
public class RockCrawlerModel extends EntityModel<MobEntity> {
	...
	public RockCrawlerModel() {
		...
		RearEnd2.setPos(0.0f, 12.0f, 1.0f);
		...
		RearEnd3.setPos(4.0f, 8.0f, 4.0f);
