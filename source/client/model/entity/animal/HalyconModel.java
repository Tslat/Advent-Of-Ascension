...
public class HalyconModel extends EntityModel<MobEntity> {
	...
	public HalyconModel() {
		...
		Front_Back_Spike.setPos(0.0f, 3.0f, -5.0f);
		Front_Back_Spike.setTexSize(128, 64);
		...
		Last_Back_Spike.setPos(0.0f, 3.0f, 5.0f);
		Last_Back_Spike.setTexSize(128, 64);
		...
		Left_body_Plate.setPos(6.0f, 6.0f, 1.0f);
		Left_body_Plate.setTexSize(128, 64);
		...
		Right_body_Plate.setPos(-6.0f, 6.0f, 1.0f);
		Right_body_Plate.setTexSize(128, 64);
		...
		Left_Top_body_Plate.setPos(3.0f, 2.0f, -6.0f);
		Left_Top_body_Plate.setTexSize(128, 64);
		...
		Right_Top_body_Plate.setPos(-3.0f, 2.0f, -6.0f);
		Right_Top_body_Plate.setTexSize(128, 64);
		...
		udders.setPos(0.0f, 16.0f, 4.0f);
		udders.setTexSize(128, 64);
		udders.mirror = true;
