...
public class HydroliskModel extends EntityModel<HydroliskEntity> {
	...
	@Override
	public void setRotationAngles(HydroliskEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
