...
public class LelyetianNPCModel extends EntityModel<MobEntity> {
	...
	public LelyetianNPCModel() {
		textureWidth = 64;
		textureHeight = 32;
		(head = new ModelRenderer(this, 0, 0)).addBox(-4.0f, -8.0f, -4.0f, 8, 8, 8);
		head.setRotationPoint(5.0f, 0.0f, 0.0f);
		...
		(rightArm = new ModelRenderer(this, 40, 16)).addBox(-3.0f, -2.0f, -2.0f, 4, 9, 4);
		rightArm.setRotationPoint(-5.0f, 3.0f, 0.0f);
		rightArm.setTextureSize(64, 32);
		rightArm.mirror = true;
		setRotation(rightArm, 0.0f, 0.0f, 0.0f);
		(leftArm = new ModelRenderer(this, 40, 16)).addBox(-1.0f, -2.0f, -2.0f, 4, 9, 4);
		...
		head2.setRotationPoint(-5.0f, 0.0f, 0.0f);
