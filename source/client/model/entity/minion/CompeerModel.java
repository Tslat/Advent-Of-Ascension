...
public class CompeerModel extends EntityModel<MobEntity> {
	...
	public CompeerModel() {
		...
		Leg_Front_1.setPos(3.0f, 15.0f, -6.0f);
		Leg_Front_1.setTexSize(64, 32);
		...
		Leg_back.setPos(3.0f, 15.0f, 3.0f);
		Leg_back.setTexSize(64, 32);
		...
		Leg_back_2.setPos(-3.0f, 15.0f, 3.0f);
		Leg_back_2.setTexSize(64, 32);
		...
		Leg_Front_2.setPos(-3.0f, 15.0f, -6.0f);
		Leg_Front_2.setTexSize(64, 32);
		...
		Back_Bone.setPos(0.0f, 5.0f, -4.0f);
		Back_Bone.setTexSize(64, 32);
	...
	public void setupAnim(MobEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		Leg_Front_1.xRot = MathHelper.cos(limbSwing * 0.6662f) * 1.4f * limbSwingAmount;
		Leg_Front_1.yRot = 0.0f;
		Leg_back.xRot = MathHelper.cos(limbSwing * 0.6662f) * 1.4f * limbSwingAmount;
		Leg_back.yRot = 0.0f;
		Leg_back_2.xRot = MathHelper.cos(limbSwing * 0.6662f + 3.1415927f) * 1.4f * limbSwingAmount;
		Leg_Front_2.xRot = MathHelper.cos(limbSwing * 0.6662f + 3.1415927f) * 1.4f * limbSwingAmount;
	}
}
