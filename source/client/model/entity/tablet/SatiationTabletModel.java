...
public class SatiationTabletModel extends EntityModel<Entity> {
	...
	public SatiationTabletModel() {
		...
		icon.texOffs(16, 10).addBox(-2.4749F, -1.249F, -2.4142F, 1, 1, 1, 0.0F, false);
		icon.texOffs(16, 10).addBox(1.7678F, -1.249F, 1.8284F, 1, 1, 1, 0.0F, false);
		icon.texOffs(16, 10).addBox(-2.7678F, -1.249F, -2.1213F, 1, 1, 1, 0.0F, false);
		icon.texOffs(16, 10).addBox(1.4749F, -1.249F, 2.1213F, 1, 1, 1, 0.0F, false);

		ModelRenderer cube = new ModelRenderer(this);
		cube.setPos(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube, 0.0F, -0.7854F, 0.0F);
		icon.addChild(cube);
		cube.texOffs(11, 10).addBox(-2.75F, -1.249F, -0.25F, 6, 1, 1, 0.0F, false);
		cube.texOffs(0, 10).addBox(-1.75F, -1.25F, -1.25F, 4, 1, 3, 0.0F, false);
	}
