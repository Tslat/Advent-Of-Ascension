...
public class UntiringTabletModel extends EntityModel<Entity> {
	...
	public UntiringTabletModel() {
		...
		icon.setTextureOffset(17, 12).addBox(-1.2929F, -1.25F, 1.5213F, 2, 1, 1, 0.0F, false);
		icon.setTextureOffset(23, 11).addBox(1.1213F, -1.25F, -0.8929F, 1, 1, 2, 0.0F, false);
		icon.setTextureOffset(3, 12).addBox(0.6213F, -1.2F, 1.0071F, 1, 1, 1, 0.0F, true);

		ModelRenderer cube = new ModelRenderer(this);
		cube.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube, 0.0F, -0.7854F, 0.0F);
		icon.addChild(cube);
		cube.setTextureOffset(0, 12).addBox(-2.4672F, -1.2F, -0.2172F, 4, 1, 1, 0.0F, true);
		cube.setTextureOffset(10, 11).addBox(1.2828F, -1.251F, -0.7172F, 1, 1, 2, 0.0F, false);
	}
