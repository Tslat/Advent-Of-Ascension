...
public class GravityTabletModel extends EntityModel<Entity> {
	private final ModelRenderer base;
	private final ModelRenderer icon;

	public GravityTabletModel() {
		textureWidth = 32;
		textureHeight = 32;
		...
		icon.setTextureOffset(12, 10).addBox(-1.0F, -1.249F, -2.0F, 2, 1, 3, 0.0F, false);
		icon.setTextureOffset(0, 14).addBox(0.1213F, -1.249F, 0.2929F, 2, 1, 1, 0.0F, false);
		icon.setTextureOffset(0, 10).addBox(-2.1213F, -1.25F, 0.2929F, 2, 1, 1, 0.0F, false);

		ModelRenderer cube = new ModelRenderer(this);
		cube.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube, 0.0F, -0.7854F, 0.0F);
		icon.addChild(cube);
		cube.setTextureOffset(8, 10).addBox(-0.5858F, -1.251F, 1.4142F, 1, 1, 1, 0.0F, false);
		cube.setTextureOffset(1, 12).addBox(1.4142F, -1.25F, -0.5858F, 1, 1, 1, 0.0F, false);
		cube.setTextureOffset(7, 10).addBox(0.4142F, -1.251F, 0.4142F, 2, 1, 2, 0.0F, false);
	}
