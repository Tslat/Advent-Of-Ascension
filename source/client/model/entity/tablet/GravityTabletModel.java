...
public class GravityTabletModel extends EntityModel<Entity> {
	...
	public GravityTabletModel() {
		...
		icon.texOffs(12, 10).addBox(-1.0F, -1.249F, -2.0F, 2, 1, 3, 0.0F, false);
		icon.texOffs(0, 14).addBox(0.1213F, -1.249F, 0.2929F, 2, 1, 1, 0.0F, false);
		icon.texOffs(0, 10).addBox(-2.1213F, -1.25F, 0.2929F, 2, 1, 1, 0.0F, false);

		ModelRenderer cube = new ModelRenderer(this);
		cube.setPos(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube, 0.0F, -0.7854F, 0.0F);
		icon.addChild(cube);
		cube.texOffs(8, 10).addBox(-0.5858F, -1.251F, 1.4142F, 1, 1, 1, 0.0F, false);
		cube.texOffs(1, 12).addBox(1.4142F, -1.25F, -0.5858F, 1, 1, 1, 0.0F, false);
		cube.texOffs(7, 10).addBox(0.4142F, -1.251F, 0.4142F, 2, 1, 2, 0.0F, false);
	}
