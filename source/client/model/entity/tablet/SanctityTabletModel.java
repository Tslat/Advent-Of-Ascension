...
public class SanctityTabletModel extends EntityModel<Entity> {
	...
	public SanctityTabletModel() {
		...
		icon.texOffs(0, 10).addBox(-1.0F, -1.25F, -2.0F, 2, 1, 3, 0.0F, false);
		icon.texOffs(14, 10).addBox(-0.2929F, -1.249F, -1.2929F, 2, 1, 2, 0.0F, false);

		ModelRenderer cube = new ModelRenderer(this);
		cube.setPos(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube, 0.0F, -0.7854F, 0.0F);
		icon.addChild(cube);
		cube.texOffs(14, 10).addBox(-0.7071F, -1.249F, -2.1213F, 1, 1, 1, 0.0F, false);
		cube.texOffs(8, 10).addBox(1.221F, -1.251F, 1.1509F, 1, 1, 1, 0.0F, false);
		cube.texOffs(8, 10).addBox(-0.5892F, -1.251F, 0.5785F, 1, 1, 1, 0.0F, false);
		cube.texOffs(0, 10).addBox(-0.2929F, -1.25F, -0.7071F, 2, 1, 2, 0.0F, false);
		cube.texOffs(8, 10).addBox(-2.1213F, -1.251F, -0.7071F, 1, 1, 1, 0.0F, false);

		ModelRenderer cube4 = new ModelRenderer(this);
		cube4.setPos(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube4, 0.0F, 0.0873F, 0.0F);
		icon.addChild(cube4);
		cube4.texOffs(8, 10).addBox(-1.5879F, -1.251F, -1.4368F, 1, 1, 2, 0.0F, false);

		ModelRenderer cube5 = new ModelRenderer(this);
		cube5.setPos(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube5, 0.0F, -0.2618F, 0.0F);
		icon.addChild(cube5);
		cube5.texOffs(0, 14).addBox(-0.018F, -1.251F, 0.4732F, 1, 1, 2, 0.0F, false);
	}
