...
public class AwarenessTabletModel extends EntityModel<Entity> {
	...
	public AwarenessTabletModel() {
		...
		icon.texOffs(8, 10).addBox(-0.75F, -1.25F, -0.5F, 1, 1, 3, 0.0F, false);
		icon.texOffs(8, 10).addBox(-0.25F, -1.25F, -0.5F, 1, 1, 3, 0.0F, false);
		icon.texOffs(0, 10).addBox(-1.0115F, -1.251F, 2.4886F, 1, 1, 1, 0.0F, false);
		icon.texOffs(0, 10).addBox(-0.9885F, -1.251F, 2.4886F, 2, 1, 1, 0.0F, false);
		icon.texOffs(1, 15).addBox(-0.25F, -1.25F, -2.25F, 1, 1, 1, 0.0F, false);
		icon.texOffs(0, 10).addBox(-0.75F, -1.251F, -2.25F, 1, 1, 1, 0.0F, false);
		icon.texOffs(18, 12).addBox(-0.25F, -1.249F, -2.75F, 1, 1, 1, 0.0F, false);
		icon.texOffs(1, 15).addBox(-0.75F, -1.25F, -2.75F, 1, 1, 1, 0.0F, false);

		ModelRenderer cube = new ModelRenderer(this);
		cube.setPos(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube, 0.0F, 0.0873F, 0.0F);
		icon.addChild(cube);
		cube.texOffs(16, 10).addBox(-0.2093F, -1.249F, -0.4327F, 1, 1, 3, 0.0F, false);

		ModelRenderer cube4 = new ModelRenderer(this);
		cube4.setPos(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube4, 0.0F, -0.0873F, 0.0F);
		icon.addChild(cube4);
		cube4.texOffs(0, 10).addBox(-0.7907F, -1.251F, -0.4327F, 1, 1, 3, 0.0F, false);
	}
