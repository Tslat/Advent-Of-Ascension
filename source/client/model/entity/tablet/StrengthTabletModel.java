...
public class StrengthTabletModel extends EntityModel<Entity> {
	...
	public StrengthTabletModel() {
		...
		cube.setPos(0.25F, 0.0F, 0.5F);
		setRotationAngle(cube, 0.0F, 0.5236F, 0.0F);
		icon.addChild(cube);
		cube.texOffs(12, 10).addBox(-1.0F, -1.249F, -1.0F, 1, 1, 4, 0.0F, false);
		cube.texOffs(2, 10).addBox(-0.5F, -1.249F, -1.0F, 1, 1, 4, 0.0F, false);
		cube.texOffs(10, 10).addBox(-0.7366F, -1.249F, -3.2232F, 1, 1, 2, 0.0F, false);
		cube.texOffs(18, 12).addBox(-1.2366F, -1.25F, -1.9732F, 2, 1, 1, 0.0F, false);

		ModelRenderer cube4 = new ModelRenderer(this);
		cube4.setPos(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube4, 0.0F, -0.7854F, 0.0F);
		cube.addChild(cube4);
		cube4.texOffs(8, 10).addBox(1.4142F, -1.25F, 1.8284F, 1, 1, 1, 0.0F, false);
		cube4.texOffs(0, 10).addBox(-3.05F, -1.25F, -2.7083F, 1, 1, 1, 0.0F, false);
		cube4.texOffs(18, 10).addBox(-0.8555F, -1.25F, -1.9351F, 1, 1, 1, 0.0F, false);
		cube4.texOffs(0, 10).addBox(-2.2697F, -1.251F, -0.5209F, 1, 1, 1, 0.0F, false);
		cube4.texOffs(8, 10).addBox(1.4749F, -1.25F, 1.7678F, 1, 1, 1, 0.0F, false);
		cube4.texOffs(8, 10).addBox(1.4749F, -1.25F, 1.8284F, 1, 1, 1, 0.0F, false);
	}
