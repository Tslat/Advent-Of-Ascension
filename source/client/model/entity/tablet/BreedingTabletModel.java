...
public class BreedingTabletModel extends EntityModel<Entity> {
	...
	public BreedingTabletModel() {
		...
		icon.setTextureOffset(0, 10).addBox(-2.1213F, -1.251F, 0.7071F, 1, 1, 1, 0.0F, false);
		icon.setTextureOffset(0, 10).addBox(-1.4142F, -1.2501F, 1.4142F, 1, 1, 1, 0.0F, false);
		icon.setTextureOffset(0, 10).addBox(0.4142F, -1.251F, 1.4142F, 1, 1, 1, 0.0F, false);
		icon.setTextureOffset(16, 11).addBox(1.1213F, -1.25F, 0.7071F, 1, 1, 1, 0.0F, false);

		ModelRenderer cube = new ModelRenderer(this);
		cube.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube, 0.0F, -0.7854F, 0.0F);
		icon.addChild(cube);
		cube.setTextureOffset(8, 10).addBox(-1.0F, -1.25F, -1.0F, 2, 1, 2, 0.0F, false);
		cube.setTextureOffset(0, 10).addBox(-1.0F, -1.25F, 0.0F, 1, 1, 2, 0.0F, false);
		cube.setTextureOffset(12, 13).addBox(-0.2929F, -1.251F, 0.7071F, 1, 1, 2, 0.0F, false);
		cube.setTextureOffset(0, 13).addBox(0.7071F, -1.2511F, -0.2929F, 2, 1, 1, 0.0F, false);
		cube.setTextureOffset(8, 13).addBox(0.0F, -1.251F, 0.4142F, 2, 1, 1, 0.0F, false);
		cube.setTextureOffset(1, 13).addBox(0.4142F, -1.25F, 1.0F, 1, 1, 1, 0.0F, false);
		cube.setTextureOffset(16, 11).addBox(0.0F, -1.25F, -1.0F, 2, 1, 1, 0.0F, false);
	}
