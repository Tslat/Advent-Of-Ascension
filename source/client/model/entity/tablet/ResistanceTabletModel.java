...
public class ResistanceTabletModel extends EntityModel<Entity> {
	...
	public ResistanceTabletModel() {
		...
		icon.texOffs(0, 10).addBox(-2.0F, -1.25F, -1.0F, 3, 1, 4, 0.0F, false);
		icon.texOffs(6, 10).addBox(0.9837F, -1.249F, -1.0F, 1, 1, 4, 0.0F, false);

		ModelRenderer cube = new ModelRenderer(this);
		cube.setPos(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube, 0.0F, 0.5236F, 0.0F);
		icon.addChild(cube);
		cube.texOffs(12, 12).addBox(-1.2321F, -1.2495F, -1.866F, 2, 1, 1, 0.0F, false);
		cube.texOffs(0, 12).addBox(0.0679F, -1.249F, -1.866F, 1, 1, 1, 0.0F, false);

		ModelRenderer cube4 = new ModelRenderer(this);
		cube4.setPos(0.0F, 0.0F, 0.0F);
		setRotationAngle(cube4, 0.0F, -0.5236F, 0.0F);
		icon.addChild(cube4);
		cube4.texOffs(12, 10).addBox(-0.7821F, -1.249F, -1.8579F, 2, 1, 1, 0.0F, false);
		cube4.texOffs(0, 12).addBox(-1.0821F, -1.249F, -1.8579F, 1, 1, 1, 0.0F, false);
	}
