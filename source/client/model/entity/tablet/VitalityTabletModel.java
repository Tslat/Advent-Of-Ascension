...
public class VitalityTabletModel extends EntityModel<Entity> {
	private final ModelRenderer base;
	private final ModelRenderer icon;

	public VitalityTabletModel() {
		textureWidth = 32;
		textureHeight = 32;
		...
		icon.setTextureOffset(9, 10).addBox(-1.0F, -1.25F, -2.0F, 2, 1, 5, 0.0F, false);
		icon.setTextureOffset(0, 10).addBox(-2.5F, -1.25F, -0.5F, 5, 1, 2, 0.0F, false);
	}
