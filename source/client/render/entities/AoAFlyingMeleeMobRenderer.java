...
public class AoAFlyingMeleeMobRenderer extends RenderLiving<AoAFlyingMeleeMob> {
	...
	@Override
	protected void preRenderCallback(AoAFlyingMeleeMob mob, float partialTickTime) {
		GlStateManager.scale(scale, scale, scale);
	}

	@Override
	protected void renderModel(AoAFlyingMeleeMob entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(AoAFlyingMeleeMob mob) {
