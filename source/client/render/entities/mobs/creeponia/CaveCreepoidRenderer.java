...
public class CaveCreepoidRenderer extends RenderLiving<EntityCaveCreepoid> {
	private final ResourceLocation texture;

	public CaveCreepoidRenderer(RenderManager renderManager, ResourceLocation textureResource) {
		super(renderManager, new ModelCaveCreepoid(), EntityCaveCreepoid.entityWidth / 3);
	...
	@Override
	protected void preRenderCallback(EntityCaveCreepoid boneCreeper, float partialTickTime) {
	...
	@Override
	protected int getColorMultiplier(EntityCaveCreepoid boneCreeper, float lightBrightness, float partialTickTime) {
		float flashIntensity = boneCreeper.getCreeperFlashIntensity(partialTickTime);
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityCaveCreepoid entity) {
		return texture;
	}
}
