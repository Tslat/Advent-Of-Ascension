...
import net.tslat.aoa3.client.model.entities.boss.gyro.ModelGyrocopter;
import org.apache.logging.log4j.Level;

import javax.annotation.Nullable;

@SideOnly(Side.CLIENT)
public class GyrocopterRenderer extends RenderEntity {
	private final ResourceLocation texture;
	private final ModelBase model = new ModelGyrocopter();

	public GyrocopterRenderer(RenderManager renderManager, final ResourceLocation resource) {
		super(renderManager);
	...
	public void doRender(Entity entity, double x, double y, double z, float entityYaw, float partialTicks) {
		try {
			...
			renderModel(entity, entity.ticksExisted + 1 * partialTicks, 0, rotation, entity.rotationYaw, entity.rotationPitch, 0.0625f);
			...
			AdventOfAscension.logMessage(Level.ERROR, "Failed Gyrocopter Render", ex);
			ex.printStackTrace();
		}
