...
import net.tslat.aoa3.client.model.entities.misc.ModelHeartStone;
import org.apache.logging.log4j.Level;

import javax.annotation.Nullable;

@SideOnly(Side.CLIENT)
public class HeartStoneRenderer extends RenderEntity {
	private final ResourceLocation texture;
	private final ModelBase model = new ModelHeartStone();

	public HeartStoneRenderer(RenderManager renderManager, final ResourceLocation resource) {
		super(renderManager);
	...
	public void doRender(Entity entity, double x, double y, double z, float entityYaw, float partialTicks) {
		try {
			...
			AdventOfAscension.logMessage(Level.ERROR, "Failed Heart Stone Render", ex);
			ex.printStackTrace();
		}
