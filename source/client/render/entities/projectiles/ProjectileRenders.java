...
public class ProjectileRenders {
	...
	public static void registerEntityRenders(final ModelRegistryEvent ev) {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityBearShot.class, renderManager -> new BearShotRenderer(renderManager, null));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityGreenBall.class, renderManager -> new GreenBallRenderer(renderManager, new ResourceLocation("aoa3", "textures/entities/projectiles/cannonshots/green_ball.png")));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityHeavyRedBullet.class, renderManager -> new RedBulletRenderer(renderManager, new ResourceLocation("aoa3", "textures/entities/projectiles/bullets/limonite_bullet.png")));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityRedBullet.class, renderManager -> new RedBulletRenderer(renderManager, new ResourceLocation("aoa3", "textures/entities/projectiles/bullets/limonite_bullet.png")));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntitySoundCannonBlue.class, renderManager -> new SoundCannonRenderer(renderManager, new ResourceLocation("aoa3", "textures/entities/projectiles/bullets/sound_cannon_shot_blue.png")));
		RenderingRegistry.registerEntityRenderingHandler(EntitySoundCannonGreen.class, renderManager -> new SoundCannonRenderer(renderManager, new ResourceLocation("aoa3", "textures/entities/projectiles/bullets/sound_cannon_shot_green.png")));
		RenderingRegistry.registerEntityRenderingHandler(EntitySoundCannonOrange.class, renderManager -> new SoundCannonRenderer(renderManager, new ResourceLocation("aoa3", "textures/entities/projectiles/bullets/sound_cannon_shot_orange.png")));
		RenderingRegistry.registerEntityRenderingHandler(EntitySoundCannonPurple.class, renderManager -> new SoundCannonRenderer(renderManager, new ResourceLocation("aoa3", "textures/entities/projectiles/bullets/sound_cannon_shot_purple.png")));
		RenderingRegistry.registerEntityRenderingHandler(EntitySoundCannonRed.class, renderManager -> new SoundCannonRenderer(renderManager, new ResourceLocation("aoa3", "textures/entities/projectiles/bullets/sound_cannon_shot_red.png")));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityYellowBullet.class, renderManager -> new YellowBulletRenderer(renderManager, new ResourceLocation("aoa3", "textures/entities/projectiles/bullets/limonite_bullet.png")));
