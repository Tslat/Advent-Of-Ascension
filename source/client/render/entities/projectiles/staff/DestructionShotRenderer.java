...
public class DestructionShotRenderer extends Render<EntityDestructionShot> {
	private final ResourceLocation texture;

	public DestructionShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityDestructionShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityDestructionShot entity) {
		return texture;
	}
}
