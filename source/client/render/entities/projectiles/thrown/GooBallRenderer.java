...
public class GooBallRenderer extends Render<EntityGooBall> {
	private final ResourceLocation texture;

	public GooBallRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityGooBall entity, double x, double y, double z, float entityYaw, float partialTicks) {
