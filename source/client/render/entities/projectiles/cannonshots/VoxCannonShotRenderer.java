...
public class VoxCannonShotRenderer extends Render<EntityVoxCannon> {
	private final ResourceLocation texture;

	public VoxCannonShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityVoxCannon entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityVoxCannon entity) {
		return texture;
	}
}
