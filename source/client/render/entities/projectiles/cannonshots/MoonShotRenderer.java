...
public class MoonShotRenderer extends Render<EntityMoonShot> {
	...
	public void doRender(EntityMoonShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
		for (int i = 0; i < 3; i++) {
			...
			entity.world.spawnParticle(ParticleRegister.FLICKERING_FLUFFY, entity.posX, entity.posY + entity.yOffset1, entity.posZ, 0, 0, 0, Enums.RGBIntegers.PINK, 100, 3, 7);
