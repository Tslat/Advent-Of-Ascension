...
public class WaterBalloonBombRenderer extends Render<EntityWaterBalloonBomb> {
	private final ResourceLocation texture;

	public WaterBalloonBombRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityWaterBalloonBomb entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityWaterBalloonBomb entity) {
		return texture;
	}
}
