...
public class SmileyCannonballRenderer extends Render<EntitySmileyCannonball> {
	private final ResourceLocation texture;

	public SmileyCannonballRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntitySmileyCannonball entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntitySmileyCannonball entity) {
		return texture;
	}
}
