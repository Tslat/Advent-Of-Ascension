...
public class CannonballRenderer extends Render<EntityCannonball> {
	private final ResourceLocation texture;

	public CannonballRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
