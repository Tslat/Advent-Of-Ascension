...
public class MultiplyingGrenadeRenderer extends Render<EntityMultiplyingGrenade> {
	private final ResourceLocation texture;

	public MultiplyingGrenadeRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityMultiplyingGrenade entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityMultiplyingGrenade entity) {
		return texture;
	}
}
