...
public class VolatileCannonballRenderer extends Render<EntityCannonball> {
	private final ResourceLocation texture;

	public VolatileCannonballRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
