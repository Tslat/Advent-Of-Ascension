...
public class BalloonBombRenderer extends Render<EntityBalloonBomb> {
	private final ResourceLocation texture;

	public BalloonBombRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityBalloonBomb entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityBalloonBomb entity) {
		return texture;
	}
}
