...
public class GoldenCannonballRenderer extends Render<EntityGoldenCannonball> {
	private final ResourceLocation texture;

	public GoldenCannonballRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityGoldenCannonball entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityGoldenCannonball entity) {
		return texture;
	}
}
