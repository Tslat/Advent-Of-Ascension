...
public class BulletShotRenderer extends Render<EntityBulletShot> {
	private final ResourceLocation texture;

	public BulletShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityBulletShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityBulletShot entity) {
		return texture;
	}
}
