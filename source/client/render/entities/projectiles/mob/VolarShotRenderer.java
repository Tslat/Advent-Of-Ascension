...
public class VolarShotRenderer extends Render<EntityVolarShot> {
	private final ResourceLocation texture;

	public VolarShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityVolarShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityVolarShot entity) {
		return texture;
	}
}
