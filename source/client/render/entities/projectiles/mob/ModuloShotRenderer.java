...
public class ModuloShotRenderer extends Render<EntityModuloShot> {
	private final ResourceLocation texture;

	public ModuloShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityModuloShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityModuloShot entity) {
		return texture;
	}
}
