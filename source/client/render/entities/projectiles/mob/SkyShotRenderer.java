...
public class SkyShotRenderer extends Render<EntitySkyShot> {
	private final ResourceLocation texture;

	public SkyShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntitySkyShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntitySkyShot entity) {
		return texture;
	}
}
