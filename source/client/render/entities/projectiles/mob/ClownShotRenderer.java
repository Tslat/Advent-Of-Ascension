...
public class ClownShotRenderer extends Render<EntityClownShot> {
	...
	public void doRender(EntityClownShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		new FXFluffyTrail(entity.world, entity.posX, entity.posY - 0.25, entity.posZ, 0, 0, 0, Enums.RGBIntegers.GREEN, 5).create();
		new FXFluffyTrail(entity.world, entity.posX, entity.posY + 0.25, entity.posZ, 0, 0, 0, Enums.RGBIntegers.RED, 5).create();
	}
