...
public class CherryShotRenderer extends Render<EntityCherryShot> {
	...
	public void doRender(EntityCherryShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
		new FXSwirlyTrail(entity.world, entity.posX, entity.posY + 0.2, entity.posZ, 0, 0, 0, Enums.RGBIntegers.RED, 5, 1).create();
		new FXSwirlyTrail(entity.world, entity.posX, entity.posY - 0.2, entity.posZ, 0, 0, 0, Enums.RGBIntegers.GREEN, 5, 1).create();
	}
