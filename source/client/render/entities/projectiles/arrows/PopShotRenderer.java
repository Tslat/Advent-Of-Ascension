...
public class PopShotRenderer extends Render<EntityPopShot> {
	private final ResourceLocation texture;

	public PopShotRenderer(RenderManager renderManagerIn, final ResourceLocation textureResource) {
		super(renderManagerIn);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityPopShot entity, double x, double y, double z, float entityYaw, float partialTicks){
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityPopShot entity) {
		return texture;
	}
}
