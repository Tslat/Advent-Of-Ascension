...
public class LunaShotRenderer extends Render<EntityLunaShot> {
	private final ResourceLocation texture;

	public LunaShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityLunaShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityLunaShot entity) {
		return texture;
	}
}
