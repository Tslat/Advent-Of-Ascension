...
public class BubbleShotRenderer extends Render<EntityBubbleShot> {
	private final ResourceLocation texture;

	public BubbleShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityBubbleShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityBubbleShot entity) {
		return texture;
	}
}
