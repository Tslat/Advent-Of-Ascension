...
public class IllusionShotRenderer extends Render<EntityIllusionShot> {
	private final ResourceLocation texture;

	public IllusionShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityIllusionShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityIllusionShot entity) {
		return texture;
	}
}
