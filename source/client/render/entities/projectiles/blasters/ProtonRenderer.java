...
public class ProtonRenderer extends Render<EntityProton> {
	private final ResourceLocation texture;

	public ProtonRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityProton entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityProton entity) {
		return texture;
	}
}
