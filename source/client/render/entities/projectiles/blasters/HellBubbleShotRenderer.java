...
public class HellBubbleShotRenderer extends Render<EntityHellBubbleShot> {
	private final ResourceLocation texture;

	public HellBubbleShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityHellBubbleShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityHellBubbleShot entity) {
		return texture;
	}
}
