...
public class PartyPopperRenderer extends Render<EntityPartyPopper> {
	...
	public PartyPopperRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityPartyPopper entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityPartyPopper entity) {
		return texture;
	}
}
