...
public class LightBlasterShotRenderer extends Render<EntityLightBlasterShot> {
	...
	public void doRender(EntityLightBlasterShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
		for (int i = 0; i < 3; i++) {
			...
			for (int j = 0; j < 3; j++) {
				entity.world.spawnParticle(ParticleRegister.FLICKERING_FLUFFY, true, entity.posX, entity.posY + entity.yOffset1, entity.posZ, 0, 0, 0, Enums.RGBIntegers.GREEN, 100, 3, 7);
