...
public class FragmentShotRenderer extends Render<EntityFragmentShot> {
	private final ResourceLocation texture;

	public FragmentShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityFragmentShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityFragmentShot entity) {
		return texture;
	}
}
