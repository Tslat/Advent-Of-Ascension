...
public class BonePelletRenderer extends Render<EntityBonePellet> {
	private final ResourceLocation texture;

	public BonePelletRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityBonePellet entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityBonePellet entity) {
		return texture;
	}
}
