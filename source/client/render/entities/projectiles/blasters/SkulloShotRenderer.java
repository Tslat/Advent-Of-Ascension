...
public class SkulloShotRenderer extends Render<EntitySkulloShot> {
	private final ResourceLocation texture;

	public SkulloShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntitySkulloShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntitySkulloShot entity) {
		return texture;
	}
}
