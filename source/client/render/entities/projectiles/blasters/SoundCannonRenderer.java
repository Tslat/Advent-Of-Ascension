...
public class SoundCannonRenderer extends Render<BaseEnergyShot> {
	private final ResourceLocation texture;

	public SoundCannonRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(BaseEnergyShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(BaseEnergyShot entity) {
		return texture;
	}
}
