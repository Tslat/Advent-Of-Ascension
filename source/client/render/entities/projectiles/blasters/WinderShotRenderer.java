...
public class WinderShotRenderer extends Render<EntityWinderShot> {
	private final ResourceLocation texture;

	public WinderShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
	...
	public void doRender(EntityWinderShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
		if (AdventOfAscension.rand.nextBoolean()) {
			...
			for (int i = 0; i < 3; i++) {
				new FXFluffyTrail(entity.world, entity.posX, entity.posY, entity.posZ, 0, 0, 0, Enums.RGBIntegers.YELLOW, 3, 1).create();
			}
		}
	}
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityWinderShot entity) {
		return texture;
	}
}
