...
public class ChilliShotRenderer extends Render<EntityChilliShot> {
	private final ResourceLocation texture;

	public ChilliShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityChilliShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityChilliShot entity) {
		return texture;
	}
}
