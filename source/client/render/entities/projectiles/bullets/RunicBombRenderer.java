...
public class RunicBombRenderer extends Render<EntityRunicBomb> {
	private final ResourceLocation texture;

	public RunicBombRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityRunicBomb entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityRunicBomb entity) {
		return texture;
	}
}
