...
public class SeedDartRenderer extends Render<EntitySeedDart> {
	private final ResourceLocation texture;

	public SeedDartRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntitySeedDart entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntitySeedDart entity) {
		return texture;
	}
}
