...
public class ShroomBulletRenderer extends Render<EntityShroomBullet> {
	private final ResourceLocation texture;

	public ShroomBulletRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityShroomBullet entity, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		for (int i = 0; i < 8; i++) {
			switch (AdventOfAscension.rand.nextInt(4)) {
				case 0:
					entity.world.spawnParticle(ParticleRegister.FLUFFY, entity.posX, entity.posY, entity.posZ, 0, 0, 0, Enums.RGBIntegers.GREEN, 100, 3, 5);
					break;
				case 1:
				...
				case 2:
					...
					break;
				case 3:
					entity.world.spawnParticle(ParticleRegister.FLUFFY, entity.posX, entity.posY, entity.posZ, 0, 0, 0, Enums.RGBIntegers.PURPLE, 100, 3, 5);
					break;
			}
		}
	}
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityShroomBullet entity) {
		return texture;
	}
}
