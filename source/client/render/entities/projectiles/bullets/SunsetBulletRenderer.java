...
public class SunsetBulletRenderer extends Render<EntitySunsetBullet> {
	...
	public SunsetBulletRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntitySunsetBullet entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntitySunsetBullet entity) {
		return texture;
	}
}
