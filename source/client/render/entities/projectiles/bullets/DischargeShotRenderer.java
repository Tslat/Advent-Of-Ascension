...
public class DischargeShotRenderer extends Render<EntityDischargeShot> {
	private final ResourceLocation texture;

	public DischargeShotRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityDischargeShot entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityDischargeShot entity) {
		return texture;
	}
}
