...
public class BlueBulletRenderer extends Render<EntityBlueBullet> {
	private final ResourceLocation texture;

	public BlueBulletRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityBlueBullet entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityBlueBullet entity) {
		return texture;
	}
}
