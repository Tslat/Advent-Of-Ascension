...
public class ColouredTexturedProjectileRenderer extends Render<Entity> {
	private final ResourceLocation texture;
	private final int colour;

	public ColouredTexturedProjectileRenderer(final RenderManager manager, final int colour, final ResourceLocation textureResource) {
		super(manager);
