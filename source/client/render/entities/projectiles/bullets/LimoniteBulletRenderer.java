...
public class LimoniteBulletRenderer extends Render<EntityLimoniteBullet> {
	private final ResourceLocation texture;

	public LimoniteBulletRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityLimoniteBullet entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityLimoniteBullet entity) {
		return texture;
	}
}
