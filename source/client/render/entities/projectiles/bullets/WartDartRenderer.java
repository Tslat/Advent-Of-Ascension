...
public class WartDartRenderer extends Render<EntityWartDart> {
	private final ResourceLocation texture;

	public WartDartRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityWartDart entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityWartDart entity) {
		return texture;
	}
}
