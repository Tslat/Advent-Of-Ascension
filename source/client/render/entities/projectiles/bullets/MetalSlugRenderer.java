...
public class MetalSlugRenderer extends Render<EntityMetalSlug> {
	private final ResourceLocation texture;

	public MetalSlugRenderer(final RenderManager manager, final ResourceLocation textureResource) {
		super(manager);
		texture = textureResource;
	}

	@Override
	public void doRender(EntityMetalSlug entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityMetalSlug entity) {
		return texture;
	}
}
