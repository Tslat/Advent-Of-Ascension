...
public class RunicornRiderRenderer extends AoAMobRenderer {
	public RunicornRiderRenderer(EntityRendererProvider.Context renderManager) {
		super(renderManager, new RunicornRiderModel(), AoAMobs.RUNICORN_RIDER.get().getWidth() / 3f, 1f, new ResourceLocation("aoa3", "textures/entity/mob/runandor/runicorn_rider.png"));
