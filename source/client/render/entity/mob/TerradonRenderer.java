...
public class TerradonRenderer extends AoAMobRenderer {
	...
	public TerradonRenderer(EntityRendererManager renderManager) {
		super(renderManager, new TerradonModel(), AoAEntities.Mobs.TERRADON.get().getWidth() / 3f, 1.0f, new ResourceLocation("aoa3", "textures/entity/mob/precasia/terradon.png"));
	}
