...
public class LyonicShotRenderer extends ParticleProjectileRenderer<NonPhysicalWeaponProjectile> {
	...
	protected void addParticles(NonPhysicalWeaponProjectile entity, float partialTicks) {
		ParticleBuilder.forPositions(AoAParticleTypes.GENERIC_DUST.get(), entity.position())
				.colourTint(RandomUtil.selection(ColourUtil.RGB(30, 29, 22), ColourUtil.RGB(204, 172, 0)))
