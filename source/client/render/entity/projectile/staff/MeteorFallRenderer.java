...
public class MeteorFallRenderer extends ParticleProjectileRenderer<MeteorFallEntity> {
	...
	protected void addParticles(MeteorFallEntity entity, float partialTicks) {
		for (int i = 0; i < 3; i++) {
			...
			entity.level.addParticle(new CustomisableParticleType.Data(AoAParticleTypes.SPARKLER.get(), 1, 3, NumberUtil.RGB(223, 153, 0)), entity.getX(), entity.getY() - 0.3D , entity.getZ(), 0, 0, 0);
			entity.level.addParticle(new CustomisableParticleType.Data(AoAParticleTypes.SPARKLER.get(), 1, 3, NumberUtil.RGB(255, 255, 0)), entity.getX(), entity.getY() - 0.6D , entity.getZ(), 0, 0, 0);
		}
	}
}
