...
public class AquaticShotRenderer extends ParticleProjectileRenderer<NonPhysicalWeaponProjectile> {
	public AquaticShotRenderer(final EntityRendererProvider.Context manager) {
		super(manager);
	}
