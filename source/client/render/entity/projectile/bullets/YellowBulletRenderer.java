...
import net.tslat.aoa3.entity.projectile.gun.YellowBulletEntity;
import net.tslat.aoa3.library.misc.CustomisableParticleType;
import net.tslat.aoa3.util.NumberUtil;

public class YellowBulletRenderer extends TexturedProjectileRenderer<YellowBulletEntity> {
	public YellowBulletRenderer(final EntityRendererManager manager, final ResourceLocation textureResource) {
		super(manager, textureResource);
	}

	@Override
	public void render(YellowBulletEntity entity, float entityYaw, float partialTicks, MatrixStack matrix, IRenderTypeBuffer buffer, int packedLight) {
