...
import net.tslat.aoa3.object.entity.projectile.gun.ShroomBulletEntity;
import net.tslat.aoa3.util.ColourUtil;
import net.tslat.aoa3.util.RandomUtil;

public class ShroomBulletRenderer extends TexturedProjectileRenderer<ShroomBulletEntity> {
	public ShroomBulletRenderer(final EntityRendererManager manager, final ResourceLocation textureResource) {
		super(manager, textureResource);
	}

	@Override
	public void render(ShroomBulletEntity entity, float entityYaw, float partialTicks, MatrixStack matrix, IRenderTypeBuffer buffer, int packedLight) {
