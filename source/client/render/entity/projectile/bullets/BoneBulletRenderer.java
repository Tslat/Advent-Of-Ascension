...
public class BoneBulletRenderer extends TexturedProjectileRenderer<BoneBulletEntity> {
	public BoneBulletRenderer(final EntityRendererProvider.Context manager, final ResourceLocation textureResource) {
		super(manager, textureResource);
	}

	@Override
	public void render(BoneBulletEntity entity, float entityYaw, float partialTicks, PoseStack matrix, MultiBufferSource buffer, int packedLight) {
