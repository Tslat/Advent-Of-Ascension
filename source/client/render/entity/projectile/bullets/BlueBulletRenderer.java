...
public class BlueBulletRenderer extends TexturedProjectileRenderer<BlueBulletEntity> {
	public BlueBulletRenderer(final EntityRendererProvider.Context manager, final ResourceLocation textureResource) {
		super(manager, textureResource);
	}

	@Override
	public void render(BlueBulletEntity entity, float entityYaw, float partialTicks, PoseStack matrix, MultiBufferSource buffer, int packedLight) {
