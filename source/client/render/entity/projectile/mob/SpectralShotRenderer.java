...
public class SpectralShotRenderer extends ParticleProjectileRenderer<SpectralShotEntity> {
	...
	protected void addParticles(SpectralShotEntity entity, float partialTicks) {
		entity.level.addParticle(new CustomisableParticleType.Data(AoAParticleTypes.SPARKLER.get(), 1, 3, NumberUtil.RGB(255, 255, 255)), entity.getX(), entity.getY(), entity.getZ() - 0.25, 0, 0, 0);
