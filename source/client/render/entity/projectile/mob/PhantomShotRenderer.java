...
public class PhantomShotRenderer extends ParticleProjectileRenderer<PhantomShotEntity> {
	...
	protected void addParticles(PhantomShotEntity entity, float partialTicks) {
		entity.world.addParticle(new CustomisableParticleType.Data(AoAParticleTypes.FLICKERING_SPARKLER.get(), 1, 3, NumberUtil.RGB(193, 64, 215) | (128 << 24)), entity.getPosX(), entity.getPosY(), entity.getPosZ(), 0, 0, 0);
	}
}
