...
public class ClownShotRenderer extends ParticleProjectileRenderer<ClownShotEntity> {
	...
	protected void addParticles(ClownShotEntity entity, float partialTicks) {
		...
		entity.world.addParticle(new CustomisableParticleType.Data(AoAParticleTypes.SPARKLER.get(), 1, 3, NumberUtil.RGB(0, 255, 0)), entity.getPosX(), entity.getPosY() - 0.25f, entity.getPosZ(), 0, 0, 0);
		entity.world.addParticle(new CustomisableParticleType.Data(AoAParticleTypes.SPARKLER.get(), 1, 3, NumberUtil.RGB(255, 0, 0)), entity.getPosX(), entity.getPosY() + 0.25f, entity.getPosZ(), 0, 0, 0);
	}
}
