...
public class CottonCandorShotRenderer extends ParticleProjectileRenderer<CottonCandorShotEntity> {
	...
	protected void addParticles(CottonCandorShotEntity entity, float partialTicks) {
		...
		entity.world.addParticle(new CustomisableParticleType.Data(AoAParticleTypes.FLICKERING_SPARKLER.get(), 1, 3, NumberUtil.RGB(255, 105, 180)), entity.getPosX(), entity.getPosY(), entity.getPosZ(), 0, 0, 0);
	}
}
