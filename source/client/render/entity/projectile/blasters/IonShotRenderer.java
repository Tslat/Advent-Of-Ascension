...
public class IonShotRenderer extends ParticleProjectileRenderer<IonShotEntity> {
	...
	protected void addParticles(IonShotEntity entity, float partialTicks) {
		for (int i = 0; i < 3; i++) {
			entity.level.addParticle(new CustomisableParticleType.Data(AoAParticleTypes.SPARKLER.get(), 1, 3, NumberUtil.RGB(0, 255, 255)), entity.getX(), entity.getY() + 2, entity.getZ(), 0, 0, 0);
