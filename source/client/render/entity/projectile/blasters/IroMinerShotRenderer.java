...
public class IroMinerShotRenderer extends ParticleProjectileRenderer<IroMinerShotEntity> {
	...
	protected void addParticles(IroMinerShotEntity entity, float partialTicks) {
		for (int i = 0; i < 3; i++) {
			entity.level.addParticle(new CustomisableParticleType.Data(AoAParticleTypes.SPARKLER.get(), 1, 3, NumberUtil.RGB(204, 172, 0)), entity.getX(), entity.getY(), entity.getZ(), 0, 0, 0);
		}
	}
}
