...
public class DeathRayRenderer extends ParticleProjectileRenderer<NonPhysicalWeaponProjectile> {
	public DeathRayRenderer(final EntityRendererProvider.Context manager) {
		super(manager);
	}
