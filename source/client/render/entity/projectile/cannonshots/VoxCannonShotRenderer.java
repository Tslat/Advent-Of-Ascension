...
import net.tslat.aoa3.object.entity.projectile.cannon.VoxCannonEntity;
import net.tslat.aoa3.util.ColourUtil;

public class VoxCannonShotRenderer extends TexturedProjectileRenderer<VoxCannonEntity> {
	public VoxCannonShotRenderer(final EntityRendererManager manager, final ResourceLocation textureResource) {
		super(manager, textureResource);
	}

	@Override
	public void render(VoxCannonEntity entity, float entityYaw, float partialTicks, MatrixStack matrix, IRenderTypeBuffer buffer, int packedLight) {
