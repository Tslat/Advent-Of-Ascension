...
public class RPGRenderer extends TexturedProjectileRenderer<RPGEntity> {
	...
	public void render(RPGEntity entity, float entityYaw, float partialTicks, MatrixStack matrix, IRenderTypeBuffer buffer, int packedLight) {
		...
		for (int i = 0; i < 8; i++) {
			...
			entity.world.addParticle(new CustomisableParticleType.Data(AoAParticleTypes.FLICKERING_SPARKLER.get(), 1, 3, NumberUtil.RGB(255, 255, 255)), entity.getPosX(), entity.getPosY() - 0.3, entity.getPosZ(), 0, 0, 0);
		}
	}
}
