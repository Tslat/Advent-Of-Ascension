...
public class CorallusRenderer extends MobRenderer<CorallusEntity, EntityModel<CorallusEntity>> {
	private static final ResourceLocation TEXTURE = new ResourceLocation("aoa3", "textures/entities/boss/corallus/corallus.png");
	private static final ResourceLocation ENRAGED_TEXTURE = new ResourceLocation("aoa3", "textures/entities/boss/corallus/corallus_enraged.png");
