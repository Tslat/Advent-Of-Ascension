...
public class AoAFlyingRangedMobRenderer extends RenderLiving<AoAFlyingRangedMob> {
	...
	@Override
	protected void renderModel(AoAFlyingRangedMob entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(AoAFlyingRangedMob mob) {
