...
public class TarRenderProperties implements IClientFluidTypeExtensions {
	public static final ResourceLocation OVERLAY = new ResourceLocation(AdventOfAscension.MOD_ID, "block/tar_overlay");
	public static final ResourceLocation UNDERWATER = new ResourceLocation(AdventOfAscension.MOD_ID, "textures/block/tar_overlay.png");
	public static final ResourceLocation FLOWING = new ResourceLocation(AdventOfAscension.MOD_ID, "block/tar_flow");
	public static final ResourceLocation STILL = new ResourceLocation(AdventOfAscension.MOD_ID, "block/tar_still");

	@Override
	public int getTintColor() {
		return ColourUtil.RGBA(35, 35, 35, 255);
	}
