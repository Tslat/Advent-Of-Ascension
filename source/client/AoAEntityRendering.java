...
public final class AoAEntityRendering {
	...
	//public static final EntityRendererPackage<?> AROCKNID = new GeckoLibRendererPackage<>(AoAMonsters.AROCKNID).path("mob/deeplands/arocknid");
	public static final EntityRendererPackage<?> ATTERCOPUS = new GeckoLibRendererPackage<>(AoAMonsters.ATTERCOPUS).renderer(AttercopusRenderer::new);
	public static final EntityRendererPackage<?> BOMB_CARRIER = new GeckoLibRendererPackage<>(AoAMonsters.BOMB_CARRIER).path("mob/overworld/bomb_carrier");
	public static final EntityRendererPackage<?> BUSH_BABY = new GeckoLibRendererPackage<>(AoAMonsters.BUSH_BABY).path("mob/overworld/bush_baby");
	//public static final EntityRendererPackage<?> CASE_CONSTRUCT = new GeckoLibRendererPackage<>(AoAMonsters.CASE_CONSTRUCT).path("mob/deeplands/case_construct");
	//public static final EntityRendererPackage<?> CAVE_CREEP = new GeckoLibRendererPackage<>(AoAMonsters.CAVE_CREEP).path("mob/deeplands/cave_creep");
	public static final EntityRendererPackage<?> CHARGER = new GeckoLibRendererPackage<>(AoAMonsters.CHARGER).model(new ChargerModel());
	...
	public static final EntityRendererPackage<?> GOBLIN = new GeckoLibRendererPackage<>(AoAMonsters.GOBLIN).path("mob/overworld/goblin");
	public static final EntityRendererPackage<?> ICE_GIANT = new GeckoLibRendererPackage<>(AoAMonsters.ICE_GIANT).path("mob/overworld/ice_giant");
	public static final EntityRendererPackage<?> INFERNAL = new GeckoLibRendererPackage<>(AoAMonsters.INFERNAL).path("mob/nether/infernal").emissive();
	public static final EntityRendererPackage<?> KING_CHARGER = new GeckoLibRendererPackage<>(AoAMonsters.KING_CHARGER).path("mob/overworld/king_charger");
	...
	//public static final EntityRendererPackage<?> NIPPER = new GeckoLibRendererPackage<>(AoAMonsters.NIPPER).path("mob/deeplands/nipper");
	//public static final EntityRendererPackage<?> OMNILIGHT = new GeckoLibRendererPackage<>(AoAMonsters.OMNILIGHT).path("mob/shyrelands/omnilight");
	//public static final EntityRendererPackage<?> ROCK_CRAWLER = new GeckoLibRendererPackage<>(AoAMonsters.ROCK_CRAWLER).path("mob/deeplands/rock_crawler");
	//public static final EntityRendererPackage<?> ROCK_CRITTER = new GeckoLibRendererPackage<>(AoAMonsters.ROCK_CRITTER).path("mob/deeplands/rock_critter");
	//public static final EntityRendererPackage<?> ROCKBITER = new GeckoLibRendererPackage<>(AoAMonsters.ROCKBITER).path("mob/deeplands/rockbiter");
	public static final EntityRendererPackage<?> SAND_GIANT = new GeckoLibRendererPackage<>(AoAMonsters.SAND_GIANT).path("mob/overworld/sand_giant");
	...
	public static final EntityRendererPackage<?> NETHENGEIC_WITHER = new GeckoLibRendererPackage<>(AoAMonsters.NETHENGEIC_WITHER).path("boss/nethengeic_wither/nethengeic_wither").emissive();
	public static final EntityRendererPackage<?> ELITE_NETHENGEIC_WITHER = new GeckoLibRendererPackage<>(AoAMonsters.ELITE_NETHENGEIC_WITHER).path("boss/nethengeic_wither/elite_nethengeic_wither").emissive();
	...
	//public static final EntityRendererPackage<?> AIRHEAD = new EntityRendererPackage<>(AoAMonsters.AIRHEAD).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> ALARMO = new EntityRendererPackage<>(AoAMonsters.ALARMO).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> AMPHIBIOR = new EntityRendererPackage<>(AoAMonsters.AMPHIBIOR).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> AMPHIBIYTE = new EntityRendererPackage<>(AoAMonsters.AMPHIBIYTE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> ANEMIA = new EntityRendererPackage<>(AoAMonsters.ANEMIA).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> APPARITION = new EntityRendererPackage<>(AoAMonsters.APPARITION).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> ARC_FLOWER = new EntityRendererPackage<>(AoAMonsters.ARC_FLOWER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> ARC_WIZARD = new EntityRendererPackage<>(AoAMonsters.ARC_WIZARD).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> ARCHVINE = new EntityRendererPackage<>(AoAMonsters.ARCHVINE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> ARCWORM = new EntityRendererPackage<>(AoAMonsters.ARCWORM).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> ARIEL = new EntityRendererPackage<>(AoAMonsters.ARIEL).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> ARKBACK = new EntityRendererPackage<>(AoAMonsters.ARKBACK).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> ARKZYNE = new EntityRendererPackage<>(AoAMonsters.ARKZYNE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> AXIOLIGHT = new EntityRendererPackage<>(AoAMonsters.AXIOLIGHT).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> BANSHEE = new EntityRendererPackage<>(AoAMonsters.BANSHEE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> BASILISK = new EntityRendererPackage<>(AoAMonsters.BASILISK).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> BAUMBA = new EntityRendererPackage<>(AoAMonsters.BAUMBA).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> BLOODSUCKER = new EntityRendererPackage<>(AoAMonsters.BLOODSUCKER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> BOBO = new EntityRendererPackage<>(AoAMonsters.BOBO).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> BONE_CREEPER = new EntityRendererPackage<>(AoAMonsters.BONE_CREEPER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> BOUNCER = new EntityRendererPackage<>(AoAMonsters.BOUNCER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> BROCCOHEAD = new EntityRendererPackage<>(AoAMonsters.BROCCOHEAD).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CANDY_CORNY = new EntityRendererPackage<>(AoAMonsters.CANDY_CORNY).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CANE_BUG = new EntityRendererPackage<>(AoAMonsters.CANE_BUG).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CARROTOP = new EntityRendererPackage<>(AoAMonsters.CARROTOP).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CAVE_CREEPOID = new EntityRendererPackage<>(AoAMonsters.CAVE_CREEPOID).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CENTINEL = new EntityRendererPackage<>(AoAMonsters.CENTINEL).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CHERRY_BLASTER = new EntityRendererPackage<>(AoAMonsters.CHERRY_BLASTER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CHOCKO = new EntityRendererPackage<>(AoAMonsters.CHOCKO).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CONSTRUCT_OF_FLIGHT = new EntityRendererPackage<>(AoAMonsters.CONSTRUCT_OF_FLIGHT).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CONSTRUCT_OF_MIND = new EntityRendererPackage<>(AoAMonsters.CONSTRUCT_OF_MIND).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CONSTRUCT_OF_RANGE = new EntityRendererPackage<>(AoAMonsters.CONSTRUCT_OF_RANGE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CONSTRUCT_OF_RESISTANCE = new EntityRendererPackage<>(AoAMonsters.CONSTRUCT_OF_RESISTANCE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CONSTRUCT_OF_SPEED = new EntityRendererPackage<>(AoAMonsters.CONSTRUCT_OF_SPEED).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CONSTRUCT_OF_STRENGTH = new EntityRendererPackage<>(AoAMonsters.CONSTRUCT_OF_STRENGTH).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CONSTRUCT_OF_TERROR = new EntityRendererPackage<>(AoAMonsters.CONSTRUCT_OF_TERROR).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CORNY = new EntityRendererPackage<>(AoAMonsters.CORNY).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CREEPERLOCK = new EntityRendererPackage<>(AoAMonsters.CREEPERLOCK).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CREEPIRD = new EntityRendererPackage<>(AoAMonsters.CREEPIRD).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CREEPUPLE = new EntityRendererPackage<>(AoAMonsters.CREEPUPLE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CRUSILISK = new EntityRendererPackage<>(AoAMonsters.CRUSILISK).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> CRYPTID = new EntityRendererPackage<>(AoAMonsters.CRYPTID).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> DAYSEE = new EntityRendererPackage<>(AoAMonsters.DAYSEE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> DESTRUCTOR = new EntityRendererPackage<>(AoAMonsters.DESTRUCTOR).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> DEVOURER = new EntityRendererPackage<>(AoAMonsters.DEVOURER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> DISTORTER = new EntityRendererPackage<>(AoAMonsters.DISTORTER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	...
	//public static final EntityRendererPackage<?> DUST_STRIDER = new EntityRendererPackage<>(AoAMonsters.DUST_STRIDER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> DUSTEIVA = new EntityRendererPackage<>(AoAMonsters.DUSTEIVA).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	...
	//public static final EntityRendererPackage<?> FACELESS_FLOATER = new EntityRendererPackage<>(AoAMonsters.FACELESS_FLOATER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> FAKE_ZORP = new EntityRendererPackage<>(AoAMonsters.FAKE_ZORP).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> FIEND = new EntityRendererPackage<>(AoAMonsters.FIEND).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> FISCHER = new EntityRendererPackage<>(AoAMonsters.FISCHER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> FLESH_EATER = new EntityRendererPackage<>(AoAMonsters.FLESH_EATER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> FLOWERFACE = new EntityRendererPackage<>(AoAMonsters.FLOWERFACE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> FUNGAT = new EntityRendererPackage<>(AoAMonsters.FUNGAT).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> FUNGBACK = new EntityRendererPackage<>(AoAMonsters.FUNGBACK).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> FUNGIK = new EntityRendererPackage<>(AoAMonsters.FUNGIK).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> FUNGOCK = new EntityRendererPackage<>(AoAMonsters.FUNGOCK).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> FUNGUNG = new EntityRendererPackage<>(AoAMonsters.FUNGUNG).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> GADGETOID = new EntityRendererPackage<>(AoAMonsters.GADGETOID).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> GINGERBIRD = new EntityRendererPackage<>(AoAMonsters.GINGERBIRD).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> GINGERBREAD_MAN = new EntityRendererPackage<>(AoAMonsters.GINGERBREAD_MAN).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> GRILLFACE = new EntityRendererPackage<>(AoAMonsters.GRILLFACE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> GROBBLER = new EntityRendererPackage<>(AoAMonsters.GROBBLER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> HAPPY = new EntityRendererPackage<>(AoAMonsters.HAPPY).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> HOST = new EntityRendererPackage<>(AoAMonsters.HOST).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> HUNTER = new EntityRendererPackage<>(AoAMonsters.HUNTER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> INMATE_X = new EntityRendererPackage<>(AoAMonsters.INMATE_X).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> INMATE_Y = new EntityRendererPackage<>(AoAMonsters.INMATE_Y).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> JAWE = new EntityRendererPackage<>(AoAMonsters.JAWE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> JUMBO = new EntityRendererPackage<>(AoAMonsters.JUMBO).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> KEELER = new EntityRendererPackage<>(AoAMonsters.KEELER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> KING_CREEPER = new EntityRendererPackage<>(AoAMonsters.KING_CREEPER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> KOKO = new EntityRendererPackage<>(AoAMonsters.KOKO).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> KRANKY = new EntityRendererPackage<>(AoAMonsters.KRANKY).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> LELYETIAN_CASTER = new EntityRendererPackage<>(AoAMonsters.LELYETIAN_CASTER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> LELYETIAN_WARRIOR = new EntityRendererPackage<>(AoAMonsters.LELYETIAN_WARRIOR).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> LIGHTWALKER = new EntityRendererPackage<>(AoAMonsters.LIGHTWALKER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> LOLLYPOPPER = new EntityRendererPackage<>(AoAMonsters.LOLLYPOPPER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> LOST_SOUL = new EntityRendererPackage<>(AoAMonsters.LOST_SOUL).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> LUNARCHER = new EntityRendererPackage<>(AoAMonsters.LUNARCHER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> LURKER = new EntityRendererPackage<>(AoAMonsters.LURKER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> LUXOCRON = new EntityRendererPackage<>(AoAMonsters.LUXOCRON).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> MAGICAL_CREEPER = new EntityRendererPackage<>(AoAMonsters.MAGICAL_CREEPER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> MECHACHRON = new EntityRendererPackage<>(AoAMonsters.MECHACHRON).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> MECHAMATON = new EntityRendererPackage<>(AoAMonsters.MECHAMATON).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> MECHYON = new EntityRendererPackage<>(AoAMonsters.MECHYON).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> MERKYRE = new EntityRendererPackage<>(AoAMonsters.MERKYRE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> MERMAGE = new EntityRendererPackage<>(AoAMonsters.MERMAGE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> MODULO = new EntityRendererPackage<>(AoAMonsters.MODULO).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> MUSHROOM_SPIDER = new EntityRendererPackage<>(AoAMonsters.MUSHROOM_SPIDER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> NIGHTMARE_SPIDER = new EntityRendererPackage<>(AoAMonsters.NIGHTMARE_SPIDER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> NIGHTWING = new EntityRendererPackage<>(AoAMonsters.NIGHTWING).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> NOSPIKE = new EntityRendererPackage<>(AoAMonsters.NOSPIKE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> OCCULENT = new EntityRendererPackage<>(AoAMonsters.OCCULENT).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> PALADIN = new EntityRendererPackage<>(AoAMonsters.PALADIN).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> PARASECT = new EntityRendererPackage<>(AoAMonsters.PARASECT).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> PARAVITE = new EntityRendererPackage<>(AoAMonsters.PARAVITE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> POD_PLANT = new EntityRendererPackage<>(AoAMonsters.POD_PLANT).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> POLYTOM = new EntityRendererPackage<>(AoAMonsters.POLYTOM).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> RAMRADON = new EntityRendererPackage<>(AoAMonsters.RAMRADON).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> RAWBONE = new EntityRendererPackage<>(AoAMonsters.RAWBONE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> REFLUCT = new EntityRendererPackage<>(AoAMonsters.REFLUCT).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> RUNIC_GOLEM = new EntityRendererPackage<>(AoAMonsters.RUNIC_GOLEM).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> RUNIC_GUARDIAN = new EntityRendererPackage<>(AoAMonsters.RUNIC_GUARDIAN).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> RUNICORN = new EntityRendererPackage<>(AoAMonsters.RUNICORN).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> RUNICORN_RIDER = new EntityRendererPackage<>(AoAMonsters.RUNICORN_RIDER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SHIFTER = new EntityRendererPackage<>(AoAMonsters.SHIFTER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SHYRE_KNIGHT = new EntityRendererPackage<>(AoAMonsters.SHYRE_KNIGHT).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SILENCER = new EntityRendererPackage<>(AoAMonsters.SILENCER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SKULL_CREATURE = new EntityRendererPackage<>(AoAMonsters.SKULL_CREATURE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SLIMER = new EntityRendererPackage<>(AoAMonsters.SLIMER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SNAPPY = new EntityRendererPackage<>(AoAMonsters.SNAPPY).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SOULSCORNE = new EntityRendererPackage<>(AoAMonsters.SOULSCORNE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SOULVYRE = new EntityRendererPackage<>(AoAMonsters.SOULVYRE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SPECTRAL_WIZARD = new EntityRendererPackage<>(AoAMonsters.SPECTRAL_WIZARD).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SPIRIT_GUARDIAN = new EntityRendererPackage<>(AoAMonsters.SPIRIT_GUARDIAN).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SPIRIT_PROTECTOR = new EntityRendererPackage<>(AoAMonsters.SPIRIT_PROTECTOR).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SQUASHER = new EntityRendererPackage<>(AoAMonsters.SQUASHER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SQUIGGLER = new EntityRendererPackage<>(AoAMonsters.SQUIGGLER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> STALKER = new EntityRendererPackage<>(AoAMonsters.STALKER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> STICKY = new EntityRendererPackage<>(AoAMonsters.STICKY).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> STIMULO = new EntityRendererPackage<>(AoAMonsters.STIMULO).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> STIMULOSUS = new EntityRendererPackage<>(AoAMonsters.STIMULOSUS).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> STITCHES = new EntityRendererPackage<>(AoAMonsters.STITCHES).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SUGARFACE = new EntityRendererPackage<>(AoAMonsters.SUGARFACE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> SUNNY = new EntityRendererPackage<>(AoAMonsters.SUNNY).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> TERRESTRIAL = new EntityRendererPackage<>(AoAMonsters.TERRESTRIAL).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> THARAFLY = new EntityRendererPackage<>(AoAMonsters.THARAFLY).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> TIPSY = new EntityRendererPackage<>(AoAMonsters.TIPSY).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> TOXXULOUS = new EntityRendererPackage<>(AoAMonsters.TOXXULOUS).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> VALKYRIE = new EntityRendererPackage<>(AoAMonsters.VALKYRIE).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> VINE_WIZARD = new EntityRendererPackage<>(AoAMonsters.VINE_WIZARD).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> VOLTRON = new EntityRendererPackage<>(AoAMonsters.VOLTRON).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> WEB_REAPER = new EntityRendererPackage<>(AoAMonsters.WEB_REAPER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> WINGED_CREEPER = new EntityRendererPackage<>(AoAMonsters.WINGED_CREEPER).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> ZARG = new EntityRendererPackage<>(AoAMonsters.ZARG).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> ZHINX = new EntityRendererPackage<>(AoAMonsters.ZHINX).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
	//public static final EntityRendererPackage<?> ZORP = new EntityRendererPackage<>(AoAMonsters.ZORP).provider(JankyJankTempRendererToPreventCrashesWhileInDev::new);
//
