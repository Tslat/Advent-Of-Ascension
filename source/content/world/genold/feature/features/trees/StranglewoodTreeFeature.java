...
public class StranglewoodTreeFeature extends AoATreeFeature {
	public StranglewoodTreeFeature(Codec<BlockStatePlacementConfig> codec, Supplier<AoASaplingBlock> saplingBlock) {
	...
	private void buildTallCrown(WorldGenLevel reader, BlockPos trunkTopPos, RandomSource rand) {
		BlockState log = AoABlocks.STRANGLEWOOD_LOG.get().defaultBlockState();
	...
	private void buildTallNorthSouthLeaves(WorldGenLevel reader, BlockPos centralPos, RandomSource rand) {
		BlockState leaves = AoABlocks.STRANGLEWOOD_LEAVES.get().defaultBlockState();
	...
	private void buildTallEastWestLeaves(WorldGenLevel reader, BlockPos centralPos, RandomSource rand) {
		BlockState leaves = AoABlocks.STRANGLEWOOD_LEAVES.get().defaultBlockState();
	...
	private void buildShortCrown(WorldGenLevel reader, BlockPos trunkTopPos, RandomSource rand) {
		BlockState log = AoABlocks.STRANGLEWOOD_LOG.get().defaultBlockState();
		BlockState leaves = AoABlocks.STRANGLEWOOD_LEAVES.get().defaultBlockState();
