...
public class DawnwoodTreeFeature extends AoATreeFeature {
	public DawnwoodTreeFeature(Codec<BlockStatePlacementConfig> codec, Supplier<? extends AoASaplingBlock> saplingBlock) {
	...
	protected boolean generateTree(WorldGenLevel reader, RandomSource rand, BlockPos pos, boolean isWorldGen) {
		...
		BlockState log = AoABlocks.DAWN_LOG.log().defaultBlockState();
