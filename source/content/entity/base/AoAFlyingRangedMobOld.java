...
public abstract class AoAFlyingRangedMobOld extends FlyingMob implements Enemy, RangedAttackMob, AoARangedAttacker, GeoEntity {
	private static final EntityDataAccessor<Integer> SHOOT_STATE = SynchedEntityData.defineId(AoAFlyingRangedMobOld.class, EntityDataSerializers.INT);
	protected static final EntityDataAccessor<Boolean> INVULNERABLE = SynchedEntityData.defineId(AoAFlyingRangedMobOld.class, EntityDataSerializers.BOOLEAN);
	...
	protected AoAFlyingRangedMobOld(EntityType<? extends FlyingMob> entityType, Level world) {
