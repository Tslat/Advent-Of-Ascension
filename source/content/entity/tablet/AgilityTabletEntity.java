...
public class AgilityTabletEntity extends SoulTabletEntity {
	...
	protected void doTickEffect() {
		EntityUtil.applyPotions(getTargetsWithinRadius(PlayerEntity.class, player -> player != null && player.isAlive()), new EffectBuilder(Effects.MOVEMENT_SPEED, 10).level(3).isAmbient());
	}
