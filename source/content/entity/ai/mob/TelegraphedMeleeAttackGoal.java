...
public class TelegraphedMeleeAttackGoal<T extends Mob> extends Goal {
	...
	public TelegraphedMeleeAttackGoal(T entity) {
		this.entity = entity;
	...
	public TelegraphedMeleeAttackGoal<T> speedModifier(double modifier) {
	...
	public TelegraphedMeleeAttackGoal<T> attackReach(double reach) {
		this.attackReach = reach;

		return this;
	}

	public TelegraphedMeleeAttackGoal<T> attackInterval(int ticks) {
		this.attackInterval = ticks;

		return this;
	}

	public TelegraphedMeleeAttackGoal<T> preAttackTime(int ticks) {
