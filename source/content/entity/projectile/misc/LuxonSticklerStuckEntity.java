...
public class LuxonSticklerStuckEntity extends ThrowableEntity {
	...
	public void tick() {
		...
		if (level.getGameTime() % 40 == 0)
			EntityUtil.applyPotions(level.getEntitiesOfClass(LivingEntity.class, target.getBoundingBox().inflate(7), EntityUtil.Predicates.HOSTILE_MOB), new EffectBuilder(Effects.GLOWING, 45));
	}
