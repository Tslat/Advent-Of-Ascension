...
public class GreenFlowerEntity extends AoAMeleeMob<GreenFlowerEntity> {
	public GreenFlowerEntity(VinocorneEntity vinocorne) {
		this(AoAMobs.GREEN_FLOWER.get(), vinocorne.level);

		moveTo(vinocorne.getX(), vinocorne.getY(), vinocorne.getZ(), random.nextFloat() * 360, 0);
	}

	public GreenFlowerEntity(EntityType<? extends GreenFlowerEntity> entityType, Level world) {
