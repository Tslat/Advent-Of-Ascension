...
public class WitherVulcane extends AoAVulcane {
	public WitherVulcane(Item.Properties properties) {
		super(properties);
	}

	@Override
	protected void onDamageEntity(Level level, LivingEntity user, LivingEntity hitEntity, ItemStack vulcane, float damage) {
		EntityUtil.applyPotions(hitEntity, user, new EffectBuilder(MobEffects.WITHER, 70).level(2));
	}
