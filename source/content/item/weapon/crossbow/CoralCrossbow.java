...
public class CoralCrossbow extends AoACrossbow {
	...
	public void onEntityImpact(Projectile projectile, @Nullable Entity shooter, EntityHitResult hitResult, ItemStack stack, float velocity) {
		EntityUtil.applyPotions(hitResult.getEntity(), shooter, new EffectBuilder(MobEffects.MOVEMENT_SLOWDOWN, 40).level(3));
	}
