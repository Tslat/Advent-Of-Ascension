...
public class DestructionRifle extends AoAGun {
	...
	protected void explode(Level level, Vec3 position, @Nullable Entity shooter, @Nullable Entity projectile) {
		if (level instanceof ServerLevel serverLevel)
			AoAExplosionBuilder.at(serverLevel, position, AoAExplosions.DESTRUCTION_RIFLE, StandardExplosion::new).explodingEntity(projectile).explode();
	}
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		...
		for (MutableComponent component : LocaleUtil.getExplosionInfoLocale(AoAExplosions.DESTRUCTION_RIFLE, true, flag.isAdvanced(), false)) {
