...
public class Iominator extends AoAGun {
	public Iominator(Item.Properties properties) {
		super(properties);
	}

	@Override
	public WeaponProjectile createProjectileEntity(Level level, WeaponFiringContext context) {
		return new PhysicalWeaponProjectile(AoAProjectiles.TOXIC_BULLET.get(), level, context);
	}
}