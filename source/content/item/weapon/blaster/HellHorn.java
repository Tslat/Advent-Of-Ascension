...
public class HellHorn extends AoABlaster<WeaponProjectile> {
	public HellHorn(Item.Properties properties) {
		super(properties);
	}
	...
	void fireBlaster(ServerLevel level, WeaponFiringContext context) {
		fireBlasterProjectile(level, context, HellBubbleShotEntity::new);
	}
