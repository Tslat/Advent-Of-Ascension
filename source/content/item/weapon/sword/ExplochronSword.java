...
public class ExplochronSword extends AoASword {
	...
	protected void doMeleeEffect(ItemStack stack, LivingEntity target, LivingEntity attacker, float attackCooldown) {
		if (attackCooldown > 0.75f && attacker.level() instanceof ServerLevel level) {
			...
			AoAExplosionBuilder.at(level, target.position().add(offsetX, offsetY, offsetZ), AoAExplosions.EXPLOCHRON_SWORD, StandardExplosion::new).explodingEntity(attacker).explode();
		}
	}
