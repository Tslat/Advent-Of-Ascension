...
public class Amplifier extends AoAShotgun {
	public Amplifier(Item.Properties properties) {
		super(properties);
	}
	...
	protected void explode(Level level, Vec3 position, @Nullable Entity shooter, Entity pellet) {
		if (level instanceof ServerLevel serverLevel)
			AoAExplosionBuilder.at(serverLevel, position, AoAExplosions.AMPLIFIER, StandardExplosion::new).explodingEntity(pellet).explode();
	}
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		...
		for (MutableComponent component : LocaleUtil.getExplosionInfoLocale(AoAExplosions.AMPLIFIER, true, flag.isAdvanced(), false)) {
