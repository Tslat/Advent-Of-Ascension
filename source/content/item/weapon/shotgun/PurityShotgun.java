...
public class PurityShotgun extends AoAShotgun {
	...
	public WeaponFiringContext.Builder createFiringContext(ItemStack stack, @Nullable Entity shooter, InteractionHand hand) {
		return super.createFiringContext(stack, shooter, hand).multiplyDamage((1 / (float)getPelletCount(stack)) * (RandomUtil.oneInNChance(4) ? 1.5f : 1));
	}
