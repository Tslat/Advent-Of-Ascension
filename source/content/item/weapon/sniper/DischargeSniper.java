...
public class DischargeSniper extends AoASniper {
	...
	public WeaponProjectile createProjectileEntity(Level level, WeaponFiringContext context) {
		return new DischargeSlugEntity(level, context);
	}
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		...
		for (MutableComponent component : LocaleUtil.getExplosionInfoLocale(AoAExplosions.DISCHARGE_SLUG, true, flag.isAdvanced(), false)) {
