...
public class EvermightStaff extends AoAStaff<Float> {
	...
	public void cast(ServerLevel level, LivingEntity caster, ItemStack staff, InteractionHand hand, Float args) {
		EntityUtil.applyPotions(caster, caster, new EffectBuilder(MobEffects.DAMAGE_BOOST, (int)(1200f * (1 - args))).level(args < 0.1 ? 3 : args < 0.5 ? 2 : 1));
	}
