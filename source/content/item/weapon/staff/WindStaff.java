...
public class WindStaff extends AoAStaff<Object> {
	public WindStaff(Item.Properties properties) {
		super(properties);
	}
	...
	protected void onDamageEntity(ServerLevel level, @Nullable WeaponProjectile projectile, @Nullable WeaponFiringContext context, @Nullable RayTrace<?> rayTrace, Entity hitEntity, float damage) {
		if (EntityUtil.getPartOrPartOwner(hitEntity) instanceof LivingEntity target)
			DamageUtil.doScaledKnockback(target, projectile.getLivingShooter(), 1.3f, 1, 1, 1);
	}
