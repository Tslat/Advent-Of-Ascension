...
public class MoonCannon extends AoACannon {
	...
	public WeaponProjectile createProjectileEntity(Level level, WeaponFiringContext context) {
		return new PhysicalWeaponProjectile(AoAProjectiles.MOON_SHOT.get(), level, context);
	}
	...
	protected void onDamageEntity(Level level, WeaponProjectile projectile, RayTrace<?> rayTrace, Entity hitEntity, float damage) {
		...
		DamageUtil.doEnergyProjectileAttack(projectile.getShooter(), projectile.asEntity(), hitEntity, damageSource -> damage / 2f);
	}
