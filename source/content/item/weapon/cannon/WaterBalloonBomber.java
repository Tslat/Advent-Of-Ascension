...
public class WaterBalloonBomber extends AoACannon {
	...
	public WeaponProjectile createProjectileEntity(Level level, WeaponFiringContext context) {
		return new WaterBalloonBombEntity(level, context);
	}
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		...
		for (MutableComponent component : LocaleUtil.getExplosionInfoLocale(AoAExplosions.waterBalloonBomb(entity -> 1), true, flag.isAdvanced(), false)) {
