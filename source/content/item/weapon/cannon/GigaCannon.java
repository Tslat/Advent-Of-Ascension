...
public class GigaCannon extends AoACannon {
	...
	public WeaponProjectile createProjectileEntity(Level level, WeaponFiringContext context) {
		return new PhysicalWeaponProjectile(AoAProjectiles.GIGA_GREEN_BALL.get(), level, context);
	}
