...
public class AchelosHelmet extends AdventArmour {
	...
	public void onArmourTick(LivingEntity entity, EnumSet<Piece> equippedPieces) {
		EntityUtil.applyPotions(entity, entity, new EffectBuilder(MobEffects.CONDUIT_POWER, 2).level(2).isAmbient(), new EffectBuilder(MobEffects.DOLPHINS_GRACE, 2).isAmbient());
	}
