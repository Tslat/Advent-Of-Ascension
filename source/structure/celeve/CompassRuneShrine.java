...
public class CompassRuneShrine extends AoAStructure { //StructureSize: 7x4x7
	...
	private static final IBlockState post = BlockRegister.RUNE_POST_COMPASS.getDefaultState();

	public CompassRuneShrine() {
		super("CompassRuneShrine");
	}
