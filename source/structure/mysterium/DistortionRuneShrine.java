...
public class DistortionRuneShrine extends AoAStructure { //StructureSize: 7x4x7
	...
	private static final IBlockState post = BlockRegister.RUNE_POST_DISTORTION.getDefaultState();

	public DistortionRuneShrine() {
		super("DistortionRuneShrine");
	}
