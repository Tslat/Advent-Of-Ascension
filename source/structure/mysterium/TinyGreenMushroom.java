...
public class TinyGreenMushroom extends AoAStructure {
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		if (rand.nextInt(3) == 0) {
			...
			world.setBlockState(basePos.up(2), BlockRegister.shroomGreen.getDefaultState());
		}
		else if (rand.nextBoolean()){
			world.setBlockState(basePos, BlockRegister.shroomStem.getDefaultState());
			world.setBlockState(basePos.up(), BlockRegister.shroomGreen.getDefaultState());
		}
		else {
			world.setBlockState(basePos, BlockRegister.shroomGreen.getDefaultState());
		}
	}
}
