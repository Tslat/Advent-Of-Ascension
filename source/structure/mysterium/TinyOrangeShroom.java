...
public class TinyOrangeShroom extends AoAStructure {
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		if (rand.nextInt(3) == 0) {
			...
			world.setBlockState(basePos.up(2), BlockRegister.ORANGE_SHROOM.getDefaultState());
		}
		else if (rand.nextBoolean()){
			world.setBlockState(basePos, BlockRegister.SHROOM_STEM.getDefaultState());
			world.setBlockState(basePos.up(), BlockRegister.ORANGE_SHROOM.getDefaultState());
		}
		else {
			world.setBlockState(basePos, BlockRegister.ORANGE_SHROOM.getDefaultState());
		}
	}
}
