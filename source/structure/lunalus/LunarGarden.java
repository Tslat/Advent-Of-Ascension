...
public class LunarGarden extends AoAStructure { //StructureSize: 17x15x17
	...
	private static final IBlockState lunalons = BlockRegister.cropLunalons.getDefaultState();
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 1, 7, 1, tilledDirt);
		...
		addBlock(world, basePos, 1, 7, 15, tilledDirt);
		...
		addBlock(world, basePos, 3, 7, 9, lunarBricks);
		addBlock(world, basePos, 3, 7, 10, lunarBricks);
		addBlock(world, basePos, 3, 7, 11, lunarBricks);
		addBlock(world, basePos, 3, 7, 12, lunarBricks);
		addBlock(world, basePos, 3, 7, 13, lunarBricks);
		...
		addBlock(world, basePos, 4, 7, 13, lunarBricks);
		...
		addBlock(world, basePos, 5, 7, 13, lunarBricks);
		...
		addBlock(world, basePos, 6, 7, 13, lunarBricks);
		...
		addBlock(world, basePos, 7, 7, 13, lunarBricks);
		...
		addBlock(world, basePos, 9, 7, 13, lunarBricks);
		...
		addBlock(world, basePos, 10, 7, 13, lunarBricks);
		...
		addBlock(world, basePos, 11, 7, 13, lunarBricks);
		...
		addBlock(world, basePos, 12, 7, 3, lunarBricks);
		addBlock(world, basePos, 12, 7, 8, lunarBricks);
		addBlock(world, basePos, 12, 7, 13, lunarBricks);
		...
		addBlock(world, basePos, 13, 7, 3, lunarBricks);
		addBlock(world, basePos, 13, 7, 4, lunarBricks);
		addBlock(world, basePos, 13, 7, 5, lunarBricks);
		addBlock(world, basePos, 13, 7, 6, lunarBricks);
		addBlock(world, basePos, 13, 7, 7, lunarBricks);
		addBlock(world, basePos, 13, 7, 8, lunarBricks);
		addBlock(world, basePos, 13, 7, 9, lunarBricks);
		addBlock(world, basePos, 13, 7, 10, lunarBricks);
		addBlock(world, basePos, 13, 7, 11, lunarBricks);
		addBlock(world, basePos, 13, 7, 12, lunarBricks);
		addBlock(world, basePos, 13, 7, 13, lunarBricks);
		...
		addBlock(world, basePos, 15, 7, 1, tilledDirt);
		...
		addBlock(world, basePos, 15, 7, 15, tilledDirt);
		...
		addBlock(world, basePos, 1, 8, 1, lunalons);
		addBlock(world, basePos, 1, 8, 2, lunalons);
		addBlock(world, basePos, 1, 8, 3, lunalons);
		addBlock(world, basePos, 1, 8, 4, lunalons);
		addBlock(world, basePos, 1, 8, 5, lunalons);
		addBlock(world, basePos, 1, 8, 6, lunalons);
		addBlock(world, basePos, 1, 8, 7, lunalons);
		addBlock(world, basePos, 1, 8, 8, lunalons);
		addBlock(world, basePos, 1, 8, 9, lunalons);
		addBlock(world, basePos, 1, 8, 10, lunalons);
		addBlock(world, basePos, 1, 8, 11, lunalons);
		addBlock(world, basePos, 1, 8, 12, lunalons);
		addBlock(world, basePos, 1, 8, 13, lunalons);
		addBlock(world, basePos, 1, 8, 14, lunalons);
		addBlock(world, basePos, 1, 8, 15, lunalons);
		addBlock(world, basePos, 2, 8, 1, lunalons);
		addBlock(world, basePos, 2, 8, 15, lunalons);
		addBlock(world, basePos, 3, 8, 1, lunalons);
		addBlock(world, basePos, 3, 8, 15, lunalons);
		addBlock(world, basePos, 4, 8, 1, lunalons);
		addBlock(world, basePos, 4, 8, 15, lunalons);
		addBlock(world, basePos, 5, 8, 1, lunalons);
		addBlock(world, basePos, 5, 8, 15, lunalons);
		addBlock(world, basePos, 6, 8, 1, lunalons);
		addBlock(world, basePos, 6, 8, 15, lunalons);
		addBlock(world, basePos, 7, 8, 1, lunalons);
		addBlock(world, basePos, 7, 8, 15, lunalons);
		addBlock(world, basePos, 8, 8, 1, lunalons);
		addBlock(world, basePos, 8, 8, 8, whitewashBricks);
		addBlock(world, basePos, 8, 8, 15, lunalons);
		addBlock(world, basePos, 9, 8, 1, lunalons);
		addBlock(world, basePos, 9, 8, 15, lunalons);
		addBlock(world, basePos, 10, 8, 1, lunalons);
		addBlock(world, basePos, 10, 8, 15, lunalons);
		addBlock(world, basePos, 11, 8, 1, lunalons);
		addBlock(world, basePos, 11, 8, 15, lunalons);
		addBlock(world, basePos, 12, 8, 1, lunalons);
		addBlock(world, basePos, 12, 8, 15, lunalons);
		addBlock(world, basePos, 13, 8, 1, lunalons);
		addBlock(world, basePos, 13, 8, 15, lunalons);
		addBlock(world, basePos, 14, 8, 1, lunalons);
		addBlock(world, basePos, 14, 8, 15, lunalons);
		addBlock(world, basePos, 15, 8, 1, lunalons);
		addBlock(world, basePos, 15, 8, 2, lunalons);
		addBlock(world, basePos, 15, 8, 3, lunalons);
		addBlock(world, basePos, 15, 8, 4, lunalons);
		addBlock(world, basePos, 15, 8, 5, lunalons);
		addBlock(world, basePos, 15, 8, 6, lunalons);
		addBlock(world, basePos, 15, 8, 7, lunalons);
		addBlock(world, basePos, 15, 8, 8, lunalons);
		addBlock(world, basePos, 15, 8, 9, lunalons);
		addBlock(world, basePos, 15, 8, 10, lunalons);
		addBlock(world, basePos, 15, 8, 11, lunalons);
		addBlock(world, basePos, 15, 8, 12, lunalons);
		addBlock(world, basePos, 15, 8, 13, lunalons);
		addBlock(world, basePos, 15, 8, 14, lunalons);
		addBlock(world, basePos, 15, 8, 15, lunalons);
