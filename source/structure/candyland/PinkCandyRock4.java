...
public class PinkCandyRock4 extends AoAStructure { //StructureSize: 4x9x4
	private static final IBlockState pinkRockCandy = BlockRegister.rockCandyPink.getDefaultState();

	public PinkCandyRock4() {
		super("PinkCandyRock4");
	}
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 2, 0, 3, pinkRockCandy);
		...
		addBlock(world, basePos, 1, 2, 3, pinkRockCandy);
		...
		addBlock(world, basePos, 3, 2, 1, pinkRockCandy);
		...
		addBlock(world, basePos, 0, 5, 1, pinkRockCandy);
		...
		addBlock(world, basePos, 2, 7, 3, pinkRockCandy);
		addBlock(world, basePos, 3, 7, 1, pinkRockCandy);
		addBlock(world, basePos, 1, 8, 2, pinkRockCandy);
	}
}
