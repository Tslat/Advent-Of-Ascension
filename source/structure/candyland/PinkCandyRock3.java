...
public class PinkCandyRock3 extends AoAStructure { //StructureSize: 4x8x4
	private static final IBlockState pinkRockCandy = BlockRegister.rockCandyPink.getDefaultState();

	public PinkCandyRock3() {
		super("PinkCandyRock3");
	}
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 3, 0, 2, pinkRockCandy);
		...
		addBlock(world, basePos, 3, 1, 1, pinkRockCandy);
		...
		addBlock(world, basePos, 2, 3, 0, pinkRockCandy);
		addBlock(world, basePos, 2, 3, 1, pinkRockCandy);
		addBlock(world, basePos, 2, 3, 2, pinkRockCandy);
		addBlock(world, basePos, 3, 3, 2, pinkRockCandy);
		...
		addBlock(world, basePos, 3, 5, 1, pinkRockCandy);
