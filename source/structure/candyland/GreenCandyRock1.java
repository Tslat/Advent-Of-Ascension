...
public class GreenCandyRock1 extends AoAStructure { //StructureSize: 4x8x4
	private static final IBlockState greenRockCandy = BlockRegister.rockCandyGreen.getDefaultState();

	public GreenCandyRock1() {
		super("GreenCandyRock1");
	}
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 2, 1, 0, greenRockCandy);
		addBlock(world, basePos, 2, 1, 1, greenRockCandy);
		addBlock(world, basePos, 2, 1, 2, greenRockCandy);
		addBlock(world, basePos, 3, 1, 2, greenRockCandy);
		addBlock(world, basePos, 0, 2, 2, greenRockCandy);
		addBlock(world, basePos, 1, 2, 0, greenRockCandy);
		...
		addBlock(world, basePos, 0, 3, 1, greenRockCandy);
		...
		addBlock(world, basePos, 3, 3, 1, greenRockCandy);
		addBlock(world, basePos, 0, 4, 2, greenRockCandy);
		...
		addBlock(world, basePos, 2, 4, 3, greenRockCandy);
		addBlock(world, basePos, 1, 5, 1, greenRockCandy);
		addBlock(world, basePos, 1, 5, 2, greenRockCandy);
		addBlock(world, basePos, 1, 5, 3, greenRockCandy);
		...
		addBlock(world, basePos, 3, 5, 2, greenRockCandy);
		addBlock(world, basePos, 0, 6, 1, greenRockCandy);
