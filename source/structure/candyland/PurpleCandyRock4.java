...
public class PurpleCandyRock4 extends AoAStructure { //StructureSize: 4x9x4
	private static final IBlockState purpleRockCandy = BlockRegister.rockCandyPurple.getDefaultState();

	public PurpleCandyRock4() {
		super("PurpleCandyRock4");
	}

	@Override
	protected void build(World world, Random rand, BlockPos basePos) {
		addBlock(world, basePos, 0, 0, 2, purpleRockCandy);
		addBlock(world, basePos, 1, 0, 0, purpleRockCandy);
		...
		addBlock(world, basePos, 2, 0, 3, purpleRockCandy);
		...
		addBlock(world, basePos, 1, 2, 3, purpleRockCandy);
		addBlock(world, basePos, 2, 2, 0, purpleRockCandy);
		addBlock(world, basePos, 2, 2, 1, purpleRockCandy);
		addBlock(world, basePos, 2, 2, 2, purpleRockCandy);
		addBlock(world, basePos, 3, 2, 1, purpleRockCandy);
		...
		addBlock(world, basePos, 0, 6, 2, purpleRockCandy);
		...
		addBlock(world, basePos, 2, 7, 3, purpleRockCandy);
		addBlock(world, basePos, 3, 7, 1, purpleRockCandy);
		addBlock(world, basePos, 1, 8, 2, purpleRockCandy);
	}
}
