...
public class PinkCandyRock5 extends AoAStructure { //StructureSize: 4x9x4
	private static final IBlockState pinkRockCandy = BlockRegister.rockCandyPink.getDefaultState();

	public PinkCandyRock5() {
		super("PinkCandyRock5");
	}

	@Override
	protected void build(World world, Random rand, BlockPos basePos) {
		addBlock(world, basePos, 0, 0, 2, pinkRockCandy);
		...
		addBlock(world, basePos, 2, 0, 0, pinkRockCandy);
		...
		addBlock(world, basePos, 0, 1, 1, pinkRockCandy);
		addBlock(world, basePos, 1, 1, 0, pinkRockCandy);
		...
		addBlock(world, basePos, 2, 1, 3, pinkRockCandy);
		...
		addBlock(world, basePos, 0, 3, 2, pinkRockCandy);
		addBlock(world, basePos, 1, 3, 0, pinkRockCandy);
		addBlock(world, basePos, 1, 3, 1, pinkRockCandy);
		addBlock(world, basePos, 1, 3, 2, pinkRockCandy);
		addBlock(world, basePos, 1, 3, 3, pinkRockCandy);
		...
		addBlock(world, basePos, 0, 5, 2, pinkRockCandy);
		...
		addBlock(world, basePos, 2, 5, 3, pinkRockCandy);
		...
		addBlock(world, basePos, 0, 7, 1, pinkRockCandy);
		addBlock(world, basePos, 1, 7, 0, pinkRockCandy);
		addBlock(world, basePos, 1, 7, 1, pinkRockCandy);
		addBlock(world, basePos, 1, 7, 2, pinkRockCandy);
		addBlock(world, basePos, 1, 7, 3, pinkRockCandy);
		addBlock(world, basePos, 2, 7, 1, pinkRockCandy);
		addBlock(world, basePos, 2, 7, 2, pinkRockCandy);
		addBlock(world, basePos, 3, 7, 1, pinkRockCandy);
		addBlock(world, basePos, 2, 8, 1, pinkRockCandy);
	}
}
