...
public class BlueCandyRock3 extends AoAStructure { //StructureSize: 4x8x4
	private static final IBlockState blueRockCandy = BlockRegister.rockCandyBlue.getDefaultState();

	public BlueCandyRock3() {
		super("BlueCandyRock3");
	}
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 3, 0, 2, blueRockCandy);
		...
		addBlock(world, basePos, 3, 1, 1, blueRockCandy);
		...
		addBlock(world, basePos, 2, 3, 0, blueRockCandy);
		addBlock(world, basePos, 2, 3, 1, blueRockCandy);
		addBlock(world, basePos, 2, 3, 2, blueRockCandy);
		addBlock(world, basePos, 3, 3, 2, blueRockCandy);
		...
		addBlock(world, basePos, 1, 4, 3, blueRockCandy);
