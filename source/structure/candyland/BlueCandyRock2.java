...
public class BlueCandyRock2 extends AoAStructure { //StructureSize: 4x8x4
	private static final IBlockState blueRockCandy = BlockRegister.rockCandyBlue.getDefaultState();

	public BlueCandyRock2() {
		super("BlueCandyRock2");
	}
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 1, 1, 3, blueRockCandy);
		...
		addBlock(world, basePos, 2, 3, 3, blueRockCandy);
		addBlock(world, basePos, 0, 4, 1, blueRockCandy);
