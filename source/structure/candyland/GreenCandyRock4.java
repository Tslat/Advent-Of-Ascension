...
public class GreenCandyRock4 extends AoAStructure { //StructureSize: 4x9x4
	private static final IBlockState greenRockCandy = BlockRegister.rockCandyGreen.getDefaultState();

	public GreenCandyRock4() {
		super("GreenCandyRock4");
	}
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 2, 0, 3, greenRockCandy);
		...
		addBlock(world, basePos, 1, 2, 3, greenRockCandy);
		...
		addBlock(world, basePos, 3, 2, 1, greenRockCandy);
		...
		addBlock(world, basePos, 2, 7, 3, greenRockCandy);
		addBlock(world, basePos, 3, 7, 1, greenRockCandy);
		addBlock(world, basePos, 1, 8, 2, greenRockCandy);
	}
}
