...
public class SwirlPop1 extends AoAStructure { //StructureSize: 9x13x1
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 7, 6, 0, redCandy);
		...
		addBlock(world, basePos, 8, 7, 0, redCandy);
		...
		addBlock(world, basePos, 7, 8, 0, redCandy);
		addBlock(world, basePos, 8, 8, 0, redCandy);
		addBlock(world, basePos, 0, 9, 0, redCandy);
		addBlock(world, basePos, 1, 9, 0, whiteCandy);
		addBlock(world, basePos, 2, 9, 0, redCandy);
		addBlock(world, basePos, 3, 9, 0, whiteCandy);
		addBlock(world, basePos, 4, 9, 0, redCandy);
		addBlock(world, basePos, 5, 9, 0, redCandy);
		addBlock(world, basePos, 6, 9, 0, redCandy);
		addBlock(world, basePos, 7, 9, 0, whiteCandy);
		addBlock(world, basePos, 8, 9, 0, redCandy);
		addBlock(world, basePos, 0, 10, 0, redCandy);
		addBlock(world, basePos, 1, 10, 0, whiteCandy);
		addBlock(world, basePos, 2, 10, 0, redCandy);
		addBlock(world, basePos, 3, 10, 0, redCandy);
		addBlock(world, basePos, 4, 10, 0, redCandy);
		addBlock(world, basePos, 5, 10, 0, redCandy);
		addBlock(world, basePos, 6, 10, 0, redCandy);
		addBlock(world, basePos, 7, 10, 0, whiteCandy);
		addBlock(world, basePos, 8, 10, 0, redCandy);
		...
		addBlock(world, basePos, 2, 12, 0, redCandy);
		addBlock(world, basePos, 3, 12, 0, redCandy);
		addBlock(world, basePos, 4, 12, 0, redCandy);
		addBlock(world, basePos, 5, 12, 0, redCandy);
		addBlock(world, basePos, 6, 12, 0, redCandy);
	}
}
