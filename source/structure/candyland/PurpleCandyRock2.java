...
public class PurpleCandyRock2 extends AoAStructure { //StructureSize: 4x8x4
	private static final IBlockState purpleRockCandy = BlockRegister.rockCandyPurple.getDefaultState();

	public PurpleCandyRock2() {
		super("PurpleCandyRock2");
	}
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 1, 1, 3, purpleRockCandy);
		...
		addBlock(world, basePos, 2, 3, 3, purpleRockCandy);
		addBlock(world, basePos, 0, 4, 1, purpleRockCandy);
