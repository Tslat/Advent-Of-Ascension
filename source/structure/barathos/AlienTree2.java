...
public class AlienTree2 extends AoAStructure { //StructureSize: 3x12x3
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		addBlock(world, basePos, 0, 9, 1, opolloLeaves);
		addBlock(world, basePos, 1, 9, 0, opolloLeaves);
		addBlock(world, basePos, 1, 9, 1, opolloLeaves);
		addBlock(world, basePos, 1, 9, 2, opolloLeaves);
		addBlock(world, basePos, 2, 9, 1, opolloLeaves);
		addBlock(world, basePos, 0, 10, 0, opolloLeaves);
		addBlock(world, basePos, 0, 10, 1, opolloLeaves);
		addBlock(world, basePos, 0, 10, 2, opolloLeaves);
		...
		addBlock(world, basePos, 2, 10, 0, opolloLeaves);
		addBlock(world, basePos, 2, 10, 1, opolloLeaves);
		addBlock(world, basePos, 2, 10, 2, opolloLeaves);
