...
public class PowerRuneShrine extends AoAStructure { //StructureSize: 7x4x7
	...
	private static final IBlockState post = BlockRegister.RUNE_POST_POWER.getDefaultState();

	public PowerRuneShrine() {
		super("PowerRuneShrine");
	}
