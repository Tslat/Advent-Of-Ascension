...
public class WaterRuneShrine extends AoAStructure { //StructureSize: 7x4x7
	...
	private static final IBlockState post = BlockRegister.RUNE_POST_WATER.getDefaultState();

	public WaterRuneShrine() {
		super("WaterRuneShrine");
	}
