...
public class BlueGardenFungi extends AoAStructure { //StructureSize: 7x16x7
	...
	private static final IBlockState stem = BlockRegister.mushroomStemBlue.getDefaultState();

	public BlueGardenFungi() {
		super("BlueGardenFungi");
	}
