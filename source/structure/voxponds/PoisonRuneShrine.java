...
public class PoisonRuneShrine extends AoAStructure { //StructureSize: 7x4x7
	...
	private static final IBlockState post = BlockRegister.RUNE_POST_POISON.getDefaultState();

	public PoisonRuneShrine() {
		super("PoisonRuneShrine");
	}
