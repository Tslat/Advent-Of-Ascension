...
public class WhiteCrystalTransferHut extends AoAStructure { //StructureSize: 11x11x11
	...
	private static final IBlockState whiteCrystalPlant = BlockRegister.plantCrystalWhite.getDefaultState();
	private static final IBlockState whiteCrystalCreator = BlockRegister.crystalCreatorWhite.getDefaultState();

	public WhiteCrystalTransferHut() {
		super("WhiteCrystalTransferHut");
	}
	...
	protected void build(World world, Random rand, BlockPos basePos) {
		...
		while (world.getBlockState(basePos.add(5, y, 5)).getBlock() == Blocks.AIR) {
			addBlock(world, basePos, 5, y, 5, whiteCrystal);
			y--;
		}
		...
		addBlock(world, basePos, 3, 1, 4, whiteCrystalPlant);
		addBlock(world, basePos, 3, 1, 6, whiteCrystalPlant);
		addBlock(world, basePos, 3, 1, 10, crystevianBricks);
		addBlock(world, basePos, 4, 1, 3, whiteCrystalPlant);
		addBlock(world, basePos, 4, 1, 7, whiteCrystalPlant);
		addBlock(world, basePos, 5, 1, 5, whiteCrystalCreator);
		addBlock(world, basePos, 6, 1, 3, whiteCrystalPlant);
		addBlock(world, basePos, 6, 1, 7, whiteCrystalPlant);
		addBlock(world, basePos, 7, 1, 0, crystevianBricks);
		addBlock(world, basePos, 7, 1, 4, whiteCrystalPlant);
		addBlock(world, basePos, 7, 1, 6, whiteCrystalPlant);
		...
		addBlock(world, basePos, 0, 2, 8, whiteCrystal);
		addBlock(world, basePos, 0, 2, 9, whiteCrystal);
		addBlock(world, basePos, 0, 2, 10, crystevianBricks);
		addBlock(world, basePos, 1, 2, 0, whiteCrystal);
		addBlock(world, basePos, 1, 2, 10, whiteCrystal);
		addBlock(world, basePos, 2, 2, 0, whiteCrystal);
		addBlock(world, basePos, 2, 2, 10, whiteCrystal);
		...
		addBlock(world, basePos, 8, 2, 0, whiteCrystal);
		addBlock(world, basePos, 8, 2, 10, whiteCrystal);
		addBlock(world, basePos, 9, 2, 0, whiteCrystal);
		addBlock(world, basePos, 9, 2, 10, whiteCrystal);
		addBlock(world, basePos, 10, 2, 0, crystevianBricks);
		addBlock(world, basePos, 10, 2, 1, whiteCrystal);
		addBlock(world, basePos, 10, 2, 2, whiteCrystal);
		addBlock(world, basePos, 10, 2, 3, crystevianBricks);
		addBlock(world, basePos, 10, 2, 7, crystevianBricks);
		addBlock(world, basePos, 10, 2, 8, whiteCrystal);
		addBlock(world, basePos, 10, 2, 9, whiteCrystal);
		...
		addBlock(world, basePos, 0, 3, 8, whiteCrystal);
		addBlock(world, basePos, 0, 3, 9, whiteCrystal);
		addBlock(world, basePos, 0, 3, 10, crystevianBricks);
		addBlock(world, basePos, 1, 3, 0, whiteCrystal);
		addBlock(world, basePos, 1, 3, 10, whiteCrystal);
		addBlock(world, basePos, 2, 3, 0, whiteCrystal);
		addBlock(world, basePos, 2, 3, 10, whiteCrystal);
		...
		addBlock(world, basePos, 8, 3, 0, whiteCrystal);
		addBlock(world, basePos, 8, 3, 10, whiteCrystal);
		addBlock(world, basePos, 9, 3, 0, whiteCrystal);
		addBlock(world, basePos, 9, 3, 10, whiteCrystal);
		addBlock(world, basePos, 10, 3, 0, crystevianBricks);
		addBlock(world, basePos, 10, 3, 1, whiteCrystal);
		addBlock(world, basePos, 10, 3, 2, whiteCrystal);
		addBlock(world, basePos, 10, 3, 3, crystevianBricks);
		addBlock(world, basePos, 10, 3, 7, crystevianBricks);
		addBlock(world, basePos, 10, 3, 8, whiteCrystal);
		addBlock(world, basePos, 10, 3, 9, whiteCrystal);
		...
		addBlock(world, basePos, 0, 5, 4, whiteCrystal);
		addBlock(world, basePos, 0, 5, 5, crystevianBricks);
		addBlock(world, basePos, 0, 5, 6, whiteCrystal);
		addBlock(world, basePos, 0, 5, 7, crystevianBricks);
		addBlock(world, basePos, 0, 5, 8, whiteCrystal);
		...
		addBlock(world, basePos, 2, 5, 10, whiteCrystal);
		addBlock(world, basePos, 3, 5, 0, crystevianBricks);
		addBlock(world, basePos, 3, 5, 10, crystevianBricks);
		addBlock(world, basePos, 4, 5, 0, whiteCrystal);
		addBlock(world, basePos, 4, 5, 10, whiteCrystal);
		addBlock(world, basePos, 5, 5, 0, crystevianBricks);
		addBlock(world, basePos, 5, 5, 10, crystevianBricks);
		addBlock(world, basePos, 6, 5, 0, whiteCrystal);
		addBlock(world, basePos, 6, 5, 10, whiteCrystal);
		addBlock(world, basePos, 7, 5, 0, crystevianBricks);
		addBlock(world, basePos, 7, 5, 10, crystevianBricks);
		addBlock(world, basePos, 8, 5, 0, whiteCrystal);
		addBlock(world, basePos, 8, 5, 10, whiteCrystal);
		...
		addBlock(world, basePos, 10, 5, 2, whiteCrystal);
		addBlock(world, basePos, 10, 5, 3, crystevianBricks);
		addBlock(world, basePos, 10, 5, 4, whiteCrystal);
		addBlock(world, basePos, 10, 5, 5, crystevianBricks);
		addBlock(world, basePos, 10, 5, 6, whiteCrystal);
		addBlock(world, basePos, 10, 5, 7, crystevianBricks);
		addBlock(world, basePos, 10, 5, 8, whiteCrystal);
		...
		addBlock(world, basePos, 0, 6, 4, whiteCrystal);
		addBlock(world, basePos, 0, 6, 5, crystevianBricks);
		addBlock(world, basePos, 0, 6, 6, whiteCrystal);
		...
		addBlock(world, basePos, 4, 6, 0, whiteCrystal);
		addBlock(world, basePos, 4, 6, 10, whiteCrystal);
		addBlock(world, basePos, 5, 6, 0, crystevianBricks);
		addBlock(world, basePos, 5, 6, 10, crystevianBricks);
		addBlock(world, basePos, 6, 6, 0, whiteCrystal);
		addBlock(world, basePos, 6, 6, 10, whiteCrystal);
		...
		addBlock(world, basePos, 10, 6, 4, whiteCrystal);
		addBlock(world, basePos, 10, 6, 5, crystevianBricks);
		addBlock(world, basePos, 10, 6, 6, whiteCrystal);
		...
		addBlock(world, basePos, 2, 8, 5, whiteCrystal);
		...
		addBlock(world, basePos, 3, 8, 3, whiteCrystal);
		addBlock(world, basePos, 3, 8, 4, whiteCrystal);
		addBlock(world, basePos, 3, 8, 5, whiteCrystal);
		addBlock(world, basePos, 3, 8, 6, whiteCrystal);
		addBlock(world, basePos, 3, 8, 7, whiteCrystal);
		...
		addBlock(world, basePos, 4, 8, 3, whiteCrystal);
		addBlock(world, basePos, 4, 8, 4, crystevianBricks);
		addBlock(world, basePos, 4, 8, 5, whiteCrystal);
		addBlock(world, basePos, 4, 8, 6, crystevianBricks);
		addBlock(world, basePos, 4, 8, 7, whiteCrystal);
		...
		addBlock(world, basePos, 5, 8, 2, whiteCrystal);
		addBlock(world, basePos, 5, 8, 3, whiteCrystal);
		addBlock(world, basePos, 5, 8, 4, whiteCrystal);
		addBlock(world, basePos, 5, 8, 5, whiteCrystal);
		addBlock(world, basePos, 5, 8, 6, whiteCrystal);
		addBlock(world, basePos, 5, 8, 7, whiteCrystal);
		addBlock(world, basePos, 5, 8, 8, whiteCrystal);
		...
		addBlock(world, basePos, 6, 8, 3, whiteCrystal);
		addBlock(world, basePos, 6, 8, 4, crystevianBricks);
		addBlock(world, basePos, 6, 8, 5, whiteCrystal);
		addBlock(world, basePos, 6, 8, 6, crystevianBricks);
		addBlock(world, basePos, 6, 8, 7, whiteCrystal);
		...
		addBlock(world, basePos, 7, 8, 3, whiteCrystal);
		addBlock(world, basePos, 7, 8, 4, whiteCrystal);
		addBlock(world, basePos, 7, 8, 5, whiteCrystal);
		addBlock(world, basePos, 7, 8, 6, whiteCrystal);
		addBlock(world, basePos, 7, 8, 7, whiteCrystal);
		...
		addBlock(world, basePos, 8, 8, 5, whiteCrystal);
		...
		addBlock(world, basePos, 1, 9, 4, crystevianBricks);
		addBlock(world, basePos, 1, 9, 5, whiteCrystal);
		addBlock(world, basePos, 1, 9, 6, crystevianBricks);
		addBlock(world, basePos, 4, 9, 1, crystevianBricks);
		addBlock(world, basePos, 4, 9, 9, crystevianBricks);
		addBlock(world, basePos, 5, 9, 1, whiteCrystal);
		addBlock(world, basePos, 5, 9, 9, whiteCrystal);
		addBlock(world, basePos, 6, 9, 1, crystevianBricks);
		addBlock(world, basePos, 6, 9, 9, crystevianBricks);
		addBlock(world, basePos, 9, 9, 4, crystevianBricks);
		addBlock(world, basePos, 9, 9, 5, whiteCrystal);
		addBlock(world, basePos, 9, 9, 6, crystevianBricks);
		addBlock(world, basePos, 1, 10, 4, crystevianBricks);
		addBlock(world, basePos, 1, 10, 5, crystevianBricks);
		addBlock(world, basePos, 1, 10, 6, crystevianBricks);
		addBlock(world, basePos, 4, 10, 1, crystevianBricks);
		addBlock(world, basePos, 4, 10, 9, crystevianBricks);
		addBlock(world, basePos, 5, 10, 1, crystevianBricks);
		addBlock(world, basePos, 5, 10, 9, crystevianBricks);
		addBlock(world, basePos, 6, 10, 1, crystevianBricks);
		addBlock(world, basePos, 6, 10, 9, crystevianBricks);
		addBlock(world, basePos, 9, 10, 4, crystevianBricks);
		addBlock(world, basePos, 9, 10, 5, crystevianBricks);
		addBlock(world, basePos, 9, 10, 6, crystevianBricks);
	}
}
