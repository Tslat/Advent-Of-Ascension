...
public class EntityIdolCreepoidGreatblade extends EntityCreature {
	public EntityIdolCreepoidGreatblade(final World par1World) {
		super(par1World);
		setSize(1.0f, 1.0f);
	}
	...
	protected void dropFewItems(final boolean par1, final int par2) {
		if (rand.nextInt(22) == 16) {
			dropItem(Weaponizer.CreepoidGreatblade, 1);
			...
			dropItem(Itemizer.CoinsCreeponia, 1);
		}
	}
}
