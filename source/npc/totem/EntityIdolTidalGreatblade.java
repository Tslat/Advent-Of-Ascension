...
public class EntityIdolTidalGreatblade extends EntityCreature {
	public EntityIdolTidalGreatblade(final World par1World) {
		super(par1World);
		setSize(1.0f, 1.0f);
	}
	...
	protected void dropFewItems(final boolean par1, final int par2) {
		if (rand.nextInt(22) == 16) {
			dropItem(Weaponizer.TidalGreatblade, 1);
			...
			dropItem(Itemizer.CoinsLborean, 1);
		}
	}
}
