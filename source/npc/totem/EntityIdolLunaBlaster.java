...
public class EntityIdolLunaBlaster extends EntityCreature {
	public EntityIdolLunaBlaster(final World par1World) {
		super(par1World);
		setSize(1.0f, 1.0f);
	}
	...
	protected void dropFewItems(final boolean par1, final int par2) {
		if (rand.nextInt(22) == 16) {
			dropItem(Weaponizer.LunaBlaster, 1);
			...
			dropItem(Itemizer.CoinsLunalus, 1);
		}
	}
}
