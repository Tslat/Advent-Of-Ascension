...
public class EntityIdolGoofyGreatblade extends EntityCreature {
	public EntityIdolGoofyGreatblade(final World par1World) {
		super(par1World);
		setSize(1.0f, 1.0f);
	}
	...
	protected void dropFewItems(final boolean par1, final int par2) {
		if (rand.nextInt(22) == 16) {
			dropItem(Weaponizer.GoofyGreatblade, 1);
			...
			dropItem(Itemizer.CoinsCeleve, 1);
		}
	}
}
