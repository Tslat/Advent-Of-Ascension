...
public class EntityIdolExplochronSword extends EntityCreature {
	public EntityIdolExplochronSword(final World par1World) {
		super(par1World);
		setSize(1.0f, 1.0f);
	}
	...
	protected void dropFewItems(final boolean par1, final int par2) {
		if (rand.nextInt(22) == 16) {
			dropItem(Weaponizer.ExplochronSword, 1);
