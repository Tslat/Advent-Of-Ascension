...
public class EntityLelyetianBanker extends EntityNevermineVillager {
	private static ArrayList<RestockedRecipe> trades = new ArrayList<RestockedRecipe>();

	public EntityLelyetianBanker(final World var1) {
		super(var1);
	}
	...
	public void interaction(final EntityPlayer p) {
		p.addChatMessage(StringUtil.getLocale("message.dialogue.lelyetianBanker." + rand.nextInt(5)));
	}
