...
public class EntityZalChild extends EntityVillager implements INpc, IMerchant {
	...
	public EntityZalChild(final World var1) {
		super(var1);
		randomTickDivider = 0;
		isMating = false;
		isPlaying = false;
		...
		tasks.addTask(1, new EntityAIAvoidEntity(this, EntityZombie.class, 16.0f, 0.30000001192092896, 0.3499999940395355));
		...
		tasks.addTask(10, new EntityAIWander(this, 0.6000000238418579));
	...
	public boolean interact(final EntityPlayer var1) {
		if (isEntityAlive() && !isTrading() && !isChild()) {
			if (!worldObj.isRemote) {
				...
				var1.addChatMessage(StringUtil.getLocale("message.dialogue.zalChild." + rand.nextInt(5)));
			}
			return true;
		}
