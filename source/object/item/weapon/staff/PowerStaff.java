...
import net.tslat.aoa3.object.entity.projectile.staff.PowerShotEntity;
...
public class PowerStaff extends BaseStaff<Object> {
	...
	public boolean doEntityImpact(BaseEnergyShot shot, Entity target, LivingEntity shooter) {
		if (DamageUtil.dealMagicDamage(shot, shooter, target, getDmg(), false)) {
			EntityUtil.applyPotions(target, new PotionUtil.EffectBuilder(Effects.WEAKNESS, 100).level(2));
