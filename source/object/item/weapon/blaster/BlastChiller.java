...
import net.tslat.aoa3.object.entity.projectile.blaster.IceShotEntity;
...
public class BlastChiller extends BaseBlaster {
	...
	protected void doImpactEffect(BaseEnergyShot shot, Entity target, LivingEntity shooter) {
		if (target instanceof LivingEntity)
			EntityUtil.applyPotions(target, new PotionUtil.EffectBuilder(Effects.MOVEMENT_SLOWDOWN, 10).level(5));
	}
