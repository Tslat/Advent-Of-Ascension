package net.tslat.aoa3.object.loottable.modifier;
...
import net.tslat.aoa3.object.block.functional.misc.FertilisedFarmland;
...
public class FertilisedFarmlandLootModifier extends LootModifier {
	...
	protected List<ItemStack> doApply(List<ItemStack> generatedLoot, LootContext context) {
		...
		if (state != null && pos != null && state.getBlock() instanceof CropsBlock) {
