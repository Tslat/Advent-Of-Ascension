...
public class RenderPenguin extends RenderLiving {
	...
	public RenderPenguin(final ModelBase par1ModelBase, final float par2) {
		super(par1ModelBase, par2);
		model = (modelPenguin)mainModel;
	}

	protected ResourceLocation getEntityTexture(final Entity entity) {
		return RenderPenguin.EntityTexture;
	}

	static {
		EntityTexture = new ResourceLocation("nevermine:textures/mobs/penguin.png");
	}
}
