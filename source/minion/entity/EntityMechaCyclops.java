...
public class EntityMechaCyclops extends EntityTameable {
	public EntityMechaCyclops(final World par1World) {
		super(par1World);
		setSize(1.0f, 2.25f);
	...
	public EntityMechaCyclops(final World par1World, final EntityPlayer p) {
		this(par1World);
