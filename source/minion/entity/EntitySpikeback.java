...
public class EntitySpikeback extends EntityTameable {
	public EntitySpikeback(final World par1World) {
		super(par1World);
		setSize(1.0f, 1.0f);
	...
	public boolean attackEntityAsMob(final Entity par1Entity) {
		return par1Entity.attackEntityFrom(DamageSource.causeMobDamage(this), 23.0f);
	}
	...
	public EntitySpikeback(final World par1World, final EntityPlayer p) {
		this(par1World);
