...
public class EntitySpraggy extends EntityTameable {
	public EntitySpraggy(final World par1World) {
		super(par1World);
		setSize(1.0f, 0.7f);
	...
	public boolean attackEntityAsMob(final Entity par1Entity) {
		if (par1Entity instanceof EntityMob) {
			((EntityMob)par1Entity).addPotionEffect(new PotionEffect(Potion.poison.id, 80, 1));
		}
	...
	public EntitySpraggy(final World par1World, final EntityPlayer p) {
		this(par1World);
