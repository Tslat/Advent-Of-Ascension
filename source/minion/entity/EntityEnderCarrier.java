...
public class EntityEnderCarrier extends EntityTameable {
	public EntityEnderCarrier(final World par1World) {
		super(par1World);
		setSize(1.2f, 1.3f);
	...
	public boolean attackEntityAsMob(final Entity par1Entity) {
		return par1Entity.attackEntityFrom(DamageSource.causeMobDamage(this), 7.0f);
	}
	...
	public EntityEnderCarrier(final World par1World, final EntityPlayer p) {
		this(par1World);
	...
	protected void applyEntityAttributes() {
		...
		getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.5799999833106995);
	...
	public boolean interact(final EntityPlayer par1EntityPlayer) {
		...
		if (isTamed()) {
			par1EntityPlayer.displayGUIChest(par1EntityPlayer.getInventoryEnderChest());
			if (var2 != null) {
			}
		}
		else {
