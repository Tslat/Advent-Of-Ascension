...
public class EntityPlateosaur extends EntityTameable {
	public EntityPlateosaur(final World par1World) {
		super(par1World);
		setSize(1.0f, 1.0f);
	...
	public EntityPlateosaur(final World par1World, final EntityPlayer p) {
		this(par1World);
