...
public class EntityShaddy extends EntityTameable {
	public EntityShaddy(final World par1World) {
		super(par1World);
		setSize(1.0f, 0.7f);
	...
	public boolean attackEntityAsMob(final Entity par1Entity) {
		if (par1Entity instanceof EntityMob) {
			((EntityMob)par1Entity).addPotionEffect(new PotionEffect(Potion.wither.id, 80, 2));
		}
	...
	public EntityShaddy(final World par1World, final EntityPlayer p) {
		this(par1World);
