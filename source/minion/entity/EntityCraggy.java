...
public class EntityCraggy extends EntityTameable {
	public EntityCraggy(final World par1World) {
		super(par1World);
		setSize(1.0f, 0.7f);
	...
	public EntityCraggy(final World par1World, final EntityPlayer p) {
		this(par1World);
