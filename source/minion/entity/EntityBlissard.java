...
public class EntityBlissard extends EntityTameable {
	public EntityBlissard(final World par1World) {
		super(par1World);
		setSize(1.0f, 1.0f);
	...
	public EntityBlissard(final World par1World, final EntityPlayer p) {
		this(par1World);
