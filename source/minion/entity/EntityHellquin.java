...
public class EntityHellquin extends EntityTameable {
	public EntityHellquin(final World par1World) {
		super(par1World);
		setSize(1.0f, 1.0f);
	...
	public EntityHellquin(final World par1World, final EntityPlayer p) {
		this(par1World);
	...
	public boolean attackEntityAsMob(final Entity par1Entity) {
		if (par1Entity instanceof EntityMob) {
			par1Entity.setFire(7);
		}
		return par1Entity.attackEntityFrom(DamageSource.causeMobDamage(this), 10.0f);
	}

	protected String getLivingSound() {
		return "nevermine:PenguinLiving";
	}

	protected String getHurtSound() {
		return "nevermine:PenguinHit";
	}

	protected String getDeathSound() {
		return "nevermine:PenguinDeath";
	}
}
