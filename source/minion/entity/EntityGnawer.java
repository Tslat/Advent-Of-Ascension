...
public class EntityGnawer extends EntityTameable {
	public EntityGnawer(final World par1World) {
		super(par1World);
		setSize(1.0f, 2.5f);
	...
	public boolean attackEntityAsMob(final Entity par1Entity) {
		return par1Entity.attackEntityFrom(DamageSource.causeMobDamage(this), 9.0f);
	}
	...
	public EntityGnawer(final World par1World, final EntityPlayer p) {
		this(par1World);
	...
	protected void applyEntityAttributes() {
		...
		getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(430.0);
	}
	...
	public boolean interact(final EntityPlayer par1EntityPlayer) {
		...
		if (isTamed()) {
			if (var2 != null && var2.getItem() == Items.fish) {
				par1EntityPlayer.heal(10.0f);
				par1EntityPlayer.inventory.consumeInventoryItem(Items.fish);
