...
public class EntityDraggy extends EntityTameable {
	public EntityDraggy(final World par1World) {
		super(par1World);
		setSize(1.0f, 0.7f);
	...
	public EntityDraggy(final World par1World, final EntityPlayer p) {
		this(par1World);
