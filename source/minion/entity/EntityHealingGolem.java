...
public class EntityHealingGolem extends EntityTameable {
	public EntityHealingGolem(final World par1World) {
		super(par1World);
		setSize(2.0f, 2.0f);
	...
	public EntityHealingGolem(final World par1World, final EntityPlayer p) {
		this(par1World);
	...
	public void onUpdate() {
		super.onUpdate();
		if (getOwner() != null && getOwner().getHealth() < 19.75f && getOwner().getHealth() > 0.0f) {
			getOwner().heal(0.015f);
		}
	}
