...
public class FishCase extends Item {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity player, Hand hand) {
		...
		if (player instanceof ServerPlayerEntity) {
			...
			ItemUtil.givePlayerMultipleItems(pl, LootUtil.generateLoot((ServerWorld)pl.world, new ResourceLocation(AdventOfAscension.MOD_ID, "items/fish_case"), LootUtil.getGiftContext((ServerWorld)pl.world, pl.getPosition(), pl)));
