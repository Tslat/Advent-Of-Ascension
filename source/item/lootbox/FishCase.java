...
public class FishCase extends Item {
	...
	public ActionResult<ItemStack> use(World worldIn, PlayerEntity player, Hand hand) {
		...
		if (player instanceof ServerPlayerEntity) {
			...
			ItemUtil.givePlayerMultipleItems(pl, LootUtil.generateLoot((ServerWorld)pl.level, new ResourceLocation(AdventOfAscension.MOD_ID, "items/fish_case"), LootUtil.getGiftContext((ServerWorld)pl.level, pl.position(), pl)));
