...
public class ForagingArmour extends AdventArmour implements SkillItem {
	public ForagingArmour(EquipmentSlotType slot) {
		super(ItemUtil.customArmourMaterial("aoa3:foraging", 65, new int[] {6, 7, 9, 4}, 10, SoundEvents.ARMOR_EQUIP_GENERIC, 7), slot, Rarity.RARE);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(LocaleUtil.getFormattedItemDescriptionText(LocaleUtil.Constants.XP_BONUS, LocaleUtil.ItemDescriptionType.BENEFICIAL, new StringTextComponent("30"), LocaleUtil.getLocaleMessage(LocaleUtil.Constants.FORAGING)));
