...
import static net.tslat.aoa3.common.registration.MaterialsRegister.ARMOUR_WITHER;

public class WitherArmour extends AdventArmour {
	public WitherArmour(String name, String registryName, EntityEquipmentSlot slot) {
		super(ARMOUR_WITHER, name, registryName, slot);
	}
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		...
		tooltip.add(ItemUtil.getFormattedDescriptionText("item.WitherArmour.desc.1", Enums.ItemDescriptionType.POSITIVE));
		tooltip.add(setEffectHeader());
		tooltip.add(ItemUtil.getFormattedDescriptionText("item.WitherArmour.desc.2", Enums.ItemDescriptionType.POSITIVE));
	}
}
