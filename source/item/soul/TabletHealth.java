...
public class TabletHealth extends BaseTablet {
	public TabletHealth(final int price, final int req) {
		super(price, req);
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		list.add(StringUtil.getLocaleString("item.TabletHealth.desc.1"));
