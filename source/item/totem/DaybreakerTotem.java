...
public class DaybreakerTotem extends TotemItem {
	public DaybreakerTotem() {
		super("DaybreakerTotem", "daybreaker_totem");
	}

	@Override
	protected void summonTotemEntity(World world, EntityPlayer player, BlockPos pos) {
		EntityLottoIdol idolEntity = new EntityLottoIdol(world, new ItemStack(WeaponRegister.bowDaybreaker), new ItemStack(ItemRegister.tokensDustopia));
