...
public class SoulfireBowTotem extends TotemItem {
	public SoulfireBowTotem() {
		super("SoulfireBowTotem", "soulfire_bow_totem");
	}

	@Override
	protected void summonTotemEntity(World world, EntityPlayer player, BlockPos pos) {
		EntityLottoIdol idolEntity = new EntityLottoIdol(world, new ItemStack(WeaponRegister.bowSoulfire), new ItemStack(ItemRegister.tokensAbyss));
