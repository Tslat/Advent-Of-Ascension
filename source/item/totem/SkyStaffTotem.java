...
public class SkyStaffTotem extends TotemItem {
	public SkyStaffTotem() {
		super("SkyStaffTotem", "sky_staff_totem");
	}

	@Override
	protected void summonTotemEntity(World world, EntityPlayer player, BlockPos pos) {
		EntityLottoIdol idolEntity = new EntityLottoIdol(world, new ItemStack(WeaponRegister.staffSky), new ItemStack(ItemRegister.tokensShyrelands));
