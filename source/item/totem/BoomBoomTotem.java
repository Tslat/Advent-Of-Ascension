...
public class BoomBoomTotem extends TotemItem {
	public BoomBoomTotem() {
		super("BoomBoomTotem", "boom_boom_totem");
	}

	@Override
	protected void summonTotemEntity(World world, EntityPlayer player, BlockPos pos) {
		EntityLottoIdol idolEntity = new EntityLottoIdol(world, new ItemStack(WeaponRegister.cannonBoomBoom), new ItemStack(ItemRegister.tokensCreeponia));
