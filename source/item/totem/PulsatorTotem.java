...
public class PulsatorTotem extends TotemItem {
	public PulsatorTotem() {
		super("PulsatorTotem", "pulsator_totem");
	}

	@Override
	protected void summonTotemEntity(World world, EntityPlayer player, BlockPos pos) {
		EntityLottoIdol idolEntity = new EntityLottoIdol(world, new ItemStack(WeaponRegister.gunPulsator), new ItemStack(ItemRegister.tokensLunar));
