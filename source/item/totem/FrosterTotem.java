...
public class FrosterTotem extends TotemItem {
	public FrosterTotem() {
		super("FrosterTotem", "froster_totem");
	}

	@Override
	protected void summonTotemEntity(World world, EntityPlayer player, BlockPos pos) {
		EntityLottoIdol idolEntity = new EntityLottoIdol(world, new ItemStack(WeaponRegister.blasterFroster), new ItemStack(ItemRegister.tokensCandyland));
