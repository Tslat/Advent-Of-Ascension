...
public class Viper1Totem extends TotemItem {
	public Viper1Totem() {
		super("Viper1Totem", "viper1_totem");
	}

	@Override
	protected void summonTotemEntity(World world, EntityPlayer player, BlockPos pos) {
		EntityLottoIdol idolEntity = new EntityLottoIdol(world, new ItemStack(WeaponRegister.sniperViper1), new ItemStack(ItemRegister.tokensGreckon));
