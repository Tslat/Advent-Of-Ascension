...
public class AncientBowTotem extends TotemItem {
	public AncientBowTotem() {
		super("AncientBowTotem", "ancient_bow_totem");
	}

	@Override
	protected void summonTotemEntity(World world, EntityPlayer player, BlockPos pos) {
		EntityLottoIdol idolEntity = new EntityLottoIdol(world, new ItemStack(WeaponRegister.bowAncient), new ItemStack(ItemRegister.tokensPrecasian));
