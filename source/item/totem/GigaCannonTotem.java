...
public class GigaCannonTotem extends TotemItem {
	public GigaCannonTotem() {
		super("GigaCannonTotem", "giga_cannon_totem");
	}

	@Override
	protected void summonTotemEntity(World world, EntityPlayer player, BlockPos pos) {
		EntityLottoIdol idolEntity = new EntityLottoIdol(world, new ItemStack(WeaponRegister.cannonGigaCannon), new ItemStack(ItemRegister.tokensHaven));
