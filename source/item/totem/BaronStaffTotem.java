...
public class BaronStaffTotem extends TotemItem {
	public BaronStaffTotem() {
		super("BaronStaffTotem", "baron_staff_totem");
	}

	@Override
	protected void summonTotemEntity(World world, EntityPlayer player, BlockPos pos) {
		EntityLottoIdol idolEntity = new EntityLottoIdol(world, new ItemStack(WeaponRegister.staffBaron), new ItemStack(ItemRegister.tokensBaron));
