...
public class TerminatorTotem extends TotemItem {
	public TerminatorTotem() {
		super("TerminatorTotem", "terminator_totem");
	}

	@Override
	protected void summonTotemEntity(World world, EntityPlayer player, BlockPos pos) {
		EntityLottoIdol idolEntity = new EntityLottoIdol(world, new ItemStack(WeaponRegister.sniperTerminator), new ItemStack(ItemRegister.tokensDustopia));
