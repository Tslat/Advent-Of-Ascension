...
public class SkeletalPickaxe extends ItemPickaxe {
	public SkeletalPickaxe(ToolMaterial material) {
		super(material);
		setUnlocalizedName("SkeletalPickaxe");
		setRegistryName("aoa3:skeletal_pickaxe");
