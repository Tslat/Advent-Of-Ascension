...
public class GoofyAxe extends BaseAxe {
	public GoofyAxe() {
		super("GoofyAxe", "goofy_axe", MaterialsRegister.TOOL_GOOFY);
	}
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(ItemUtil.getFormattedDescriptionText("item.GoofyAxe.desc.1", Enums.ItemDescriptionType.POSITIVE));
		tooltip.add(ItemUtil.getFormattedDescriptionText("item.GoofyAxe.desc.2", Enums.ItemDescriptionType.NEGATIVE));
	}
