...
public class SkeletalShovel extends ItemSpade {
	public SkeletalShovel(ToolMaterial material) {
		super(material);
		setUnlocalizedName("SkeletalShovel");
		setRegistryName("aoa3:skeletal_shovel");
