...
public class EnergisticShovel extends BaseShovel {
	public EnergisticShovel() {
		super("EnergisticShovel", "energistic_shovel", MaterialsRegister.TOOL_ENERGISTIC);
	}
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(ItemUtil.getFormattedDescriptionText("item.EnergisticShovel.desc.1", Enums.ItemDescriptionType.POSITIVE));
		tooltip.add(ItemUtil.getFormattedDescriptionText("item.EnergisticShovel.desc.2", Enums.ItemDescriptionType.POSITIVE));
