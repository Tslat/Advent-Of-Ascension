...
public class OccultShovel extends ItemSpade implements SkillItem, SpecialHarvestTool {
	public OccultShovel(ToolMaterial material) {
		super(material);
		setUnlocalizedName("OccultShovel");
		setRegistryName("aoa3:occult_shovel");
		setCreativeTab(CreativeTabsRegister.toolsTab);
	}

	public void doHarvestEffect(BlockEvent.HarvestDropsEvent e) {
		if (ToolRegister.shovelOccult.getDestroySpeed(e.getHarvester().getHeldItem(EnumHand.MAIN_HAND), e.getState()) > 1 && AdventOfAscension.rand.nextInt(10) == 0)
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(StringUtil.getColourLocaleString("item.OccultShovel.desc.1", TextFormatting.DARK_GREEN));
