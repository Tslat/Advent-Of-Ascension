...
public class CoralstormSword extends ItemSword implements SwordInterface {
	public CoralstormSword(final Item.ToolMaterial p_i45356_1_) {
		super(p_i45356_1_);
	...
	public boolean hitEntity(final ItemStack stack, final EntityLivingBase live, final EntityLivingBase live2) {
		live.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 60, 2));
