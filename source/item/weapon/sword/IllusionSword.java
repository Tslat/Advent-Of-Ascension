...
public class IllusionSword extends BaseSword implements AdventWeapon {
	public IllusionSword(final ToolMaterial material, Float dmg, Double speed) {
		super(material, dmg, speed);
		setUnlocalizedName("IllusionSword");
	...
	public boolean onLeftClickEntity(final ItemStack stack, final EntityPlayer player, final Entity target) {
		...
		((EntityLivingBase)target).addPotionEffect(new PotionEffect(MobEffects.WEAKNESS, (int)(45 * player.getCooledAttackStrength(0.0f)), 0));
		return false;
	}
