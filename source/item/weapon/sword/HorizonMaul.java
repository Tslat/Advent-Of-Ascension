...
public class HorizonMaul extends ItemSword implements SwordInterface {
	public HorizonMaul(final Item.ToolMaterial p_i45356_1_) {
		super(p_i45356_1_);
	...
	public boolean hitEntity(final ItemStack stack, final EntityLivingBase livingBase1, final EntityLivingBase livingBase2) {
		...
		livingBase1.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 100, 2));
		return true;
	}
