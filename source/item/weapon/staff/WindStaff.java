...
public class WindStaff extends BaseStaff {
	...
	public WindStaff(SoundEvent sound, int durability) {
		super(sound, durability);
		setUnlocalizedName("WindStaff");
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(StringUtil.getColourLocaleString("item.WindStaff.desc.1", TextFormatting.DARK_GREEN));
