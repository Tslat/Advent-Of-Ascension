...
public class CrystonStaff extends BaseStaff {
	...
	public CrystonStaff(SoundEvent sound, int durability) {
		super(sound, durability);
		setUnlocalizedName("CrystonStaff");
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(StringUtil.getColourLocaleString("item.CrystonStaff.desc.1", TextFormatting.DARK_GREEN));
