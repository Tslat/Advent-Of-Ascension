...
public class FireflyStaff extends BaseStaff {
	...
	public FireflyStaff(SoundEvent sound, int durability) {
		super(sound, durability);
		setUnlocalizedName("FireflyStaff");
	...
	public void cast(World world, ItemStack staff, EntityLivingBase caster, Object args) {
		world.spawnEntity(new EntityFireflyShot(caster, this, 60, 1, 0, 1));
		world.spawnEntity(new EntityFireflyShot(caster, this, 60, -1, 0, 1));
		world.spawnEntity(new EntityFireflyShot(caster, this, 60, 1, 0, -1));
		world.spawnEntity(new EntityFireflyShot(caster, this, 60, -1, 0, -1));
	}
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(StringUtil.getColourLocaleString("item.FireflyStaff.desc.1", TextFormatting.DARK_GREEN));
