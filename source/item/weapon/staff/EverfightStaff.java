...
public class EverfightStaff extends BaseStaff {
	...
	public EverfightStaff(SoundEvent sound, int durability) {
		super(sound, durability);
		setUnlocalizedName("EverfightStaff");
	...
	public void cast(World world, ItemStack staff, EntityLivingBase caster, Object args) {
		caster.addPotionEffect(new PotionEffect(MobEffects.RESISTANCE, Math.min((Integer)args * 100, 1200), Math.min(3, (Integer)args) - 1));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(StringUtil.getColourLocaleString("item.EverfightStaff.desc.1", TextFormatting.DARK_GREEN));
