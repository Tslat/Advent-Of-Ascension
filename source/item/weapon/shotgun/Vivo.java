...
public class Vivo extends BaseShotgun implements AdventWeapon {
	public Vivo(final double dmg, final int pellets, final SoundEvent sound, final int durability, final int fireDelayTicks, final float recoil) {
		super(dmg, pellets, sound, durability, fireDelayTicks, recoil);
		setUnlocalizedName("Vivo");
