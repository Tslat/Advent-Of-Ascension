...
public class GingerBlaster extends BaseGun {
	private final float dmg = 8.0f;

	public GingerBlaster(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		...
		list.add(StringUtil.getColourLocaleString("item.GingerBlaster.desc.1", EnumChatFormatting.DARK_GREEN));
