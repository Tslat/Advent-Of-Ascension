...
public class NethengeicSlugger extends BaseGun {
	...
	public NethengeicSlugger(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
	...
	public void fireGun(final World world, final ItemStack stack, final EntityPlayer player, final float multi, boolean consume) {
		player.worldObj.spawnEntityInWorld(new EntityNetherSlug(player.worldObj, player, dmg * multi, 2, 0));
	}
