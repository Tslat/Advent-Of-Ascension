...
public class BlastBarrel extends BaseGun {
	private final float dmg = 14.0f;

	public BlastBarrel(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		...
		list.add(StringUtil.getColourLocaleString("item.BlastBarrel.desc.1", EnumChatFormatting.DARK_GREEN));
