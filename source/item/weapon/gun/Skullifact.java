...
public class Skullifact extends BaseGun implements AdventWeapon {
	public Skullifact(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("Skullifact");
