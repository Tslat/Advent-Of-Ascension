...
public class RockerRifle extends BaseGun {
	...
	public RockerRifle(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		...
		list.add(StringUtil.getColourLocaleString("item.RockerRifle.desc.1", EnumChatFormatting.DARK_GREEN));
