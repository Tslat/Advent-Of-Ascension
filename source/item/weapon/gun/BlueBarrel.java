...
public class BlueBarrel extends BaseGun {
	private final float dmg = 13.0f;

	public BlueBarrel(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
