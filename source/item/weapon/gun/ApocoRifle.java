...
public class ApocoRifle extends BaseGun implements AdventWeapon {
	...
	public ApocoRifle(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		this.firingDelay = firingDelayTicks;
		setUnlocalizedName("ApocoRifle");
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(StringUtil.getColourLocaleString("item.ApocoRifle.desc.1", TextFormatting.DARK_GREEN));
