...
public class PrecasianSlugger extends BaseGun implements AdventWeapon {
	...
	public PrecasianSlugger(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		this.dmg = dmg;
		this.firingDelay = firingDelayTicks;
		setUnlocalizedName("PrecasianSlugger");
		setRegistryName("aoa3:precasian_slugger");
	}
