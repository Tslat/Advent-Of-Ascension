...
public class CoreRifle extends BaseGun implements AdventWeapon {
	public CoreRifle(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("CoreRifle");
