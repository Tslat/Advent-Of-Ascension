...
public class Minigun extends BaseGun implements AdventWeapon {
	public Minigun(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
