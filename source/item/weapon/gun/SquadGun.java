...
public class SquadGun extends BaseGun implements AdventWeapon {
	public SquadGun(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("SquadGun");
