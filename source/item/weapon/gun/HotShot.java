...
public class HotShot extends BaseGun implements AdventWeapon {
	private final int firingDelay;
	private final double dmg;

	public HotShot(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		this.dmg = dmg;
		this.firingDelay = firingDelayTicks;
		setUnlocalizedName("HotShot");
		setRegistryName("aoa3:hot_shot");
	}
