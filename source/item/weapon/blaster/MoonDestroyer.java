...
public class MoonDestroyer extends BaseBlaster {
	public MoonDestroyer(double dmg, SoundEvent sound, int durability, int fireDelayTicks, float energyCost) {
		super(dmg, sound, durability, fireDelayTicks, energyCost);
		setUnlocalizedName("MoonDestroyer");
		setRegistryName("aoa3:moon_destroyer");
	}

	@Override
	public void fire(ItemStack blaster, EntityLivingBase shooter) {
		shooter.world.spawnEntity(new EntityMoonDestroyerShot(shooter, this, 60));
	}
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(StringUtil.getColourLocaleString("item.MoonDestroyer.desc.1", TextFormatting.DARK_GREEN));
