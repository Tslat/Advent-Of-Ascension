...
public class Seaocron extends BaseBlaster {
	public Seaocron(double dmg, SoundEvent sound, int durability, int fireDelayTicks, float energyCost) {
		super(dmg, sound, durability, fireDelayTicks, energyCost);
		setUnlocalizedName("Seaocron");
		setRegistryName("aoa3:seaocron");
	}

	@Override
	public void fire(ItemStack blaster, EntityLivingBase shooter) {
		shooter.world.spawnEntity(new EntitySeaocron(shooter, this, 60));
	}
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(StringUtil.getColourLocaleString("item.Seaocron.desc.1", TextFormatting.DARK_GREEN));
