...
public class StepSoundCannon extends BaseBlaster {
	public StepSoundCannon(double dmg, SoundEvent sound, int durability, int fireDelayTicks, float energyCost) {
		super(dmg, sound, durability, fireDelayTicks, energyCost);
		setUnlocalizedName("StepSoundCannon");
		setRegistryName("aoa3:step_sound_cannon");
	}
