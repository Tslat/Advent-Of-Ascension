...
public class BeatSoundCannon extends BaseBlaster {
	public BeatSoundCannon(double dmg, SoundEvent sound, int durability, int fireDelayTicks, float energyCost) {
		super(dmg, sound, durability, fireDelayTicks, energyCost);
		setUnlocalizedName("BeatSoundCannon");
		setRegistryName("aoa3:beat_sound_cannon");
	}
