...
public class FireVulcane extends BaseVulcane {
	...
	public FireVulcane(final String effect, final int uses, final float dmg, final int need) {
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		...
		list.add(StringUtil.getColourLocaleStringWithArguments("items.description.skillRequirement", EnumChatFormatting.RED, Integer.toString(10), StringUtil.getLocaleString("skills.vulcanism.name")));
	}
}
