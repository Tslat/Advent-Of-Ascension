...
public class WitherVulcane extends BaseVulcane {
	...
	public WitherVulcane(final String effect, final int uses, final float dmg, final int need) {
	...
	public void fireGun(final World world, final ItemStack stack, final EntityPlayer player, final float multi, final EntityMob mob) {
		mob.addPotionEffect(new PotionEffect(Potion.wither.id, 100, 0));
	}
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		...
		list.add(StringUtil.getColourLocaleStringWithArguments("items.description.skillRequirement", EnumChatFormatting.RED, Integer.toString(50), StringUtil.getLocaleString("skills.vulcanism.name")));
	}
}
