...
public class MechaArchergun extends BaseGun {
	private final float dmg = 16.0f;

	public MechaArchergun(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
