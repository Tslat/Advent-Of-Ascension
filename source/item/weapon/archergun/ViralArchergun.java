...
public class ViralArchergun extends BaseGun {
	private final float dmg = 17.0f;

	public ViralArchergun(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
	...
	public void fireGun(final World world, final ItemStack stack, final EntityPlayer player, final float multi, boolean consume) {
		final EntityElementalArrow var5 = new EntityElementalArrow(world, player, 3.3f * multi, 4, true);
