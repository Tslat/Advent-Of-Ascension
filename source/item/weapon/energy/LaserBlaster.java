...
public class LaserBlaster extends BaseEnergyRapid {
	private final float dmg = 2.0f;

	public LaserBlaster(final int consumeChance, final String effect, final int uses, final int fireRate, final int cost) {
	...
	public void fireAncient(final World world, final ItemStack stack, final EntityPlayer player) {
		player.worldObj.spawnEntityInWorld(new EntityLaser(player.worldObj, player, dmg, 0));
	}
