...
public class LightBlaster extends BaseEnergy {
	private final float dmg = 63.0f;

	public LightBlaster(final int consumeChance, final String effect, final int uses, final int fireRate, final int cost) {
	...
	public void fireAncient(final World world, final ItemStack stack, final EntityPlayer player) {
		player.worldObj.spawnEntityInWorld(new EntityLightBlaster(player.worldObj, player, dmg));
	}
