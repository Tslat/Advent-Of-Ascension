...
public class IllusionSMG extends BaseEnergy {
	private final float dmg = 8.0f;

	public IllusionSMG(final int consumeChance, final String effect, final int uses, final int fireRate, final int cost) {
