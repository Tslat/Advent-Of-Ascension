...
public class BoneBlaster extends BaseEnergy {
	private final float dmg = 15.0f;

	public BoneBlaster(final int consumeChance, final String effect, final int uses, final int fireRate, final int cost) {
	...
	public void fireAncient(final World world, final ItemStack stack, final EntityPlayer player) {
		player.worldObj.spawnEntityInWorld(new EntityBonePellet(player.worldObj, player, dmg));
	}
