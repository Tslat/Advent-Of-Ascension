...
public class ToxicTerrorizer extends BaseEnergy {
	private final float dmg = 9.0f;

	public ToxicTerrorizer(final int consumeChance, final String effect, final int uses, final int fireRate, final int cost) {
	...
	public void fireAncient(final World world, final ItemStack stack, final EntityPlayer player) {
		player.worldObj.spawnEntityInWorld(new EntityToxicShot(player.worldObj, player, dmg, 4));
	}
