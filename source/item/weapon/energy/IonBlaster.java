...
public class IonBlaster extends BaseEnergy {
	private final float dmg = 20.0f;

	public IonBlaster(final int consumeChance, final String effect, final int uses, final int fireRate, final int cost) {
	...
	public void fireAncient(final World world, final ItemStack stack, final EntityPlayer player) {
		player.worldObj.spawnEntityInWorld(new EntityIonShot(player.worldObj, player, dmg, 1));
	}
