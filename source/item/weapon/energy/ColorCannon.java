...
public class ColorCannon extends BaseEnergy {
	private final float dmg = 60.0f;

	public ColorCannon(final int consumeChance, final String effect, final int uses, final int fireRate, final int cost) {
	...
	public void fireAncient(final World world, final ItemStack stack, final EntityPlayer player) {
		player.worldObj.spawnEntityInWorld(new EntityColorShot(player.worldObj, player, dmg));
	}
