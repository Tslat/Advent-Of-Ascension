...
public class WithersWrath extends BaseEnergy {
	private final float dmg = 11.0f;

	public WithersWrath(final int consumeChance, final String effect, final int uses, final int fireRate, final int cost) {
	...
	public void fireAncient(final World world, final ItemStack stack, final EntityPlayer player) {
		player.worldObj.spawnEntityInWorld(new EntityWrathShot(player.worldObj, player, dmg));
	}
