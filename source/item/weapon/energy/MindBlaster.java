...
public class MindBlaster extends BaseEnergy {
	private final float dmg = 55.0f;

	public MindBlaster(final int consumeChance, final String effect, final int uses, final int fireRate, final int cost) {
	...
	public void fireAncient(final World world, final ItemStack stack, final EntityPlayer player) {
		player.worldObj.spawnEntityInWorld(new EntityMindShot(player.worldObj, player, dmg));
	}
