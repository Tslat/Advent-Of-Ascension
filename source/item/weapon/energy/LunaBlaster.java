...
public class LunaBlaster extends BaseEnergy {
	private final float dmg = 6.0f;

	public LunaBlaster(final int consumeChance, final String effect, final int uses, final int fireRate, final int cost) {
	...
	public void fireAncient(final World world, final ItemStack stack, final EntityPlayer player) {
		player.worldObj.spawnEntityInWorld(new EntityLunaShot(player.worldObj, player, dmg));
	}
