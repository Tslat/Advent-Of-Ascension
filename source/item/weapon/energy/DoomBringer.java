...
public class DoomBringer extends BaseEnergy {
	private Random rand;
	private int canShootTick;

	public DoomBringer(final int consumeChance, final String effect, final int uses, final int fireRate, final int cost) {
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		list.add(StringUtil.getColourLocaleString("item.DoomBringer.desc.1", EnumChatFormatting.DARK_GREEN));
