...
public class DarklyGuster extends BaseEnergy {
	private final float dmg = 8.0f;

	public DarklyGuster(final int consumeChance, final String effect, final int uses, final int fireRate, final int cost) {
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		...
		list.add(StringUtil.getColourLocaleString("item.DarklyGuster.desc.1", EnumChatFormatting.DARK_GREEN));
