...
public class GhastBlaster extends BaseGun {
	private final float dmg = 11.0f;

	public GhastBlaster(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
