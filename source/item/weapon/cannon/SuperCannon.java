...
public class SuperCannon extends BaseGun {
	private final float dmg = 10.0f;

	public SuperCannon(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
