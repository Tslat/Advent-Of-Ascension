...
public class GolderBomber extends BaseCannon implements AdventWeapon {
	public GolderBomber(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("GolderBomber");
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(StringUtil.getColourLocaleString("item.GolderBomber.desc.1", TextFormatting.DARK_GREEN));
