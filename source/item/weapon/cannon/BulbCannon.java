...
public class BulbCannon extends BaseCannon implements AdventWeapon {
	public BulbCannon(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("BulbCannon");
		setRegistryName("aoa3:bulb_cannon");
	}
