...
public class UltraCannon extends BaseGun {
	private final float dmg = 14.0f;

	public UltraCannon(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
