...
public class CoralCannon extends BaseCannon implements AdventWeapon {
	public CoralCannon(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("CoralCannon");
		setRegistryName("aoa3:coral_cannon");
	}
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(StringUtil.getColourLocaleString("item.CoralCannon.desc.1", TextFormatting.DARK_GREEN));
