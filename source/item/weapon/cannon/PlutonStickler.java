...
public class PlutonStickler extends BaseCannon implements AdventWeapon {
	...
	public PlutonStickler(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("PlutonStickler");
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		...
		tooltip.add(StringUtil.getColourLocaleString("item.PlutonStickler.desc.1", TextFormatting.DARK_GREEN));
		tooltip.add(StringUtil.getColourLocaleString("item.PlutonStickler.desc.2", TextFormatting.DARK_GREEN));
