...
public class BoomCannon extends BaseCannon implements AdventWeapon {
	private double dmg;
	private int firingDelay;

	public BoomCannon(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("BoomCannon");
