...
public class ShadowBlaster extends BaseGun {
	private final float dmg = 16.0f;

	public ShadowBlaster(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
