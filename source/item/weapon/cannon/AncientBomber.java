...
public class AncientBomber extends BaseGun {
	private final float dmg = 12.0f;

	public AncientBomber(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
	...
	public void fireGun(final World world, final ItemStack stack, final EntityPlayer player, final float multi, boolean consume) {
		player.worldObj.spawnEntityInWorld(new EntityBoomCannonGrenade(player.worldObj, player, dmg * multi, 1));
	}
