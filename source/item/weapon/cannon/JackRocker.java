...
public class JackRocker extends BaseGun {
	private final float dmg = 15.0f;

	public JackRocker(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
	...
	public void fireGun(final World world, final ItemStack stack, final EntityPlayer player, final float multi, boolean consume) {
		player.worldObj.spawnEntityInWorld(new EntityRockFragment(player.worldObj, player, dmg * multi));
	}
