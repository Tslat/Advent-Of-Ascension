...
public class BigBlast extends BaseGun {
	private final float dmg = 35.0f;

	public BigBlast(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
	...
	public void fireGun(final World world, final ItemStack stack, final EntityPlayer player, final float multi, boolean consume) {
		player.worldObj.spawnEntityInWorld(new EntityCannonBall(player.worldObj, player, dmg * multi, 5, 0.0f));
	}
