...
public class SmileBlaster extends BaseCannon implements AdventWeapon {
	public SmileBlaster(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("SmileBlaster");
		setRegistryName("aoa3:smile_blaster");
	}
	...
	public BaseBullet findAndConsumeAmmo(EntityPlayer player, BaseGun gun, EnumHand hand) {
		...
		if (ammo != null)
			return new EntitySmileBlaster(player, gun, hand, 120, 0);
