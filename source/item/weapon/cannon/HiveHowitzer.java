...
public class HiveHowitzer extends BaseGun {
	private final float dmg = 25.0f;

	public HiveHowitzer(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
	...
	public void fireGun(final World world, final ItemStack stack, final EntityPlayer player, final float multi, boolean consume) {
		player.worldObj.spawnEntityInWorld(new EntityHiveBall(player.worldObj, player, dmg * multi, 1));
	}
