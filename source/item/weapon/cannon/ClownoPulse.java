...
public class ClownoPulse extends BaseCannon implements AdventWeapon {
	...
	public ClownoPulse(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		this.dmg = dmg;
		this.firingDelay = firingDelayTicks;
		setUnlocalizedName("ClownoPulse");
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(StringUtil.getColourLocaleString("item.ClownoPulse.desc.1", TextFormatting.DARK_GREEN));
