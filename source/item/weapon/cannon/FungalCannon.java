...
public class FungalCannon extends BaseCannon implements AdventWeapon {
	public FungalCannon(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("FungalCannon");
		setRegistryName("aoa3:fungal_cannon");
	}
	...
	public BaseBullet findAndConsumeAmmo(EntityPlayer player, BaseGun gun, EnumHand hand) {
		...
		if (ammo != null)
			return new EntityFungalBall(player, gun, hand, 120, 0);
