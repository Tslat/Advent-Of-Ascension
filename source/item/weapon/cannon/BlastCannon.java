...
public class BlastCannon extends BaseCannon implements AdventWeapon {
	...
	public BlastCannon(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("BlastCannon");
		setRegistryName("aoa3:blast_cannon");
		this.dmg = dmg;
	...
	public BaseBullet findAndConsumeAmmo(EntityPlayer player, BaseGun gun, EnumHand hand) {
		...
		if (ammo != null)
			return new EntityStickyCoolBomb(player, gun, hand, 120, 0);
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		...
		tooltip.add(StringUtil.getColourLocaleString("item.BlastCannon.desc.1", TextFormatting.DARK_GREEN));
		tooltip.add(StringUtil.getColourLocaleString("item.BlastCannon.desc.2", TextFormatting.DARK_GREEN));
