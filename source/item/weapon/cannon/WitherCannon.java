...
public class WitherCannon extends BaseGun {
	private final float dmg = 25.0f;

	public WitherCannon(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
