...
public class WitherCannon extends BaseCannon implements AdventWeapon {
	public WitherCannon(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("WitherCannon");
		setRegistryName("aoa3:wither_cannon");
	}
