...
public class GhoulCannon extends BaseCannon implements AdventWeapon {
	public GhoulCannon(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("GhoulCannon");
	...
	public BaseBullet findAndConsumeAmmo(EntityPlayer player, BaseGun gun, EnumHand hand) {
		...
		if (ammo != null)
			return new EntityGhoulBall(player, gun, hand, 120, 0);
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		tooltip.add(StringUtil.getColourLocaleString("item.GhoulCannon.desc.1", TextFormatting.DARK_GREEN));
