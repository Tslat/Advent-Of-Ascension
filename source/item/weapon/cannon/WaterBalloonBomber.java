...
public class WaterBalloonBomber extends BaseCannon implements AdventWeapon {
	double dmg;
	int firingDelay;

	public WaterBalloonBomber(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		this.dmg = dmg;
		this.firingDelay = firingDelayTicks;
		setUnlocalizedName("WaterBalloonBomber");
		setRegistryName("aoa3:water_balloon_bomber");
	}
	...
	public BaseBullet findAndConsumeAmmo(EntityPlayer player, BaseGun gun, EnumHand hand) {
		...
		if (ammo != null)
			return new EntityWaterBalloonBomb(player, gun, hand, 120, 0);
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		...
		tooltip.add(StringUtil.getColourLocaleString("item.WaterBalloonBomber.desc.1", TextFormatting.DARK_GREEN));
