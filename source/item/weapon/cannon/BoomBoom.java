...
public class BoomBoom extends BaseCannon implements AdventWeapon {
	double dmg;
	int firingDelay;

	public BoomBoom(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		this.dmg = dmg;
		this.firingDelay = firingDelayTicks;
		setUnlocalizedName("BoomBoom");
		setRegistryName("aoa3:boom_boom");
	}
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		...
		tooltip.add(StringUtil.getColourLocaleString("item.BoomBoom.desc.1", TextFormatting.DARK_GREEN));
