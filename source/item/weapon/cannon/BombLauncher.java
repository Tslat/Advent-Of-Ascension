...
public class BombLauncher extends BaseCannon implements AdventWeapon {
	...
	public BombLauncher(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("BombLauncher");
		setRegistryName("aoa3:bomb_launcher");
		this.dmg = dmg;
	...
	public BaseBullet findAndConsumeAmmo(EntityPlayer player, BaseGun gun, EnumHand hand) {
		...
		if (ammo != null)
			return new EntityStickyRedBomb(player, gun, hand, 120, 0);
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		...
		tooltip.add(StringUtil.getColourLocaleString("item.BombLauncher.desc.1", TextFormatting.DARK_GREEN));
		tooltip.add(StringUtil.getColourLocaleString("item.BombLauncher.desc.2", TextFormatting.DARK_GREEN));
