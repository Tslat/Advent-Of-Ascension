...
public class Mineral extends BaseGun implements SniperInstance {
	private final float dmg = 77.0f;
	private float multiplier;

	public Mineral(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		...
		list.add(StringUtil.getLocaleString("items.description.speed.ultraInsanelySlow"));
