...
public class BoltRifle extends BaseGun implements SniperInstance {
	private final float dmg = 50.0f;
	private float multiplier;

	public BoltRifle(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
