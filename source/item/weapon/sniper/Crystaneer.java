...
public class Crystaneer extends BaseGun implements SniperInstance {
	private final float dmg = 32.0f;
	private float multiplier;

	public Crystaneer(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
