...
public class Monster extends BaseGun implements SniperInstance {
	private final float dmg = 75.0f;
	private float multiplier;

	public Monster(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
