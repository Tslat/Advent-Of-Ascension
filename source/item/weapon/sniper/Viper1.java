...
public class Viper1 extends BaseGun implements SniperInstance {
	private final float dmg = 50.0f;
	private float multiplier;

	public Viper1(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
