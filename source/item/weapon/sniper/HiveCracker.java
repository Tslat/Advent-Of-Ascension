...
public class HiveCracker extends BaseGun implements SniperInstance {
	private final float dmg = 25.0f;
	private float multiplier;

	public HiveCracker(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
