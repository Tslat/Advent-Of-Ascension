...
public class HeadHunter extends BaseGun implements SniperInstance {
	private final float dmg = 45.0f;
	private float multiplier;

	public HeadHunter(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
