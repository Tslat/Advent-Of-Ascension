...
public class Decimator extends BaseGun implements SniperInstance {
	private final float dmg = 40.0f;
	private float multiplier;

	public Decimator(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
