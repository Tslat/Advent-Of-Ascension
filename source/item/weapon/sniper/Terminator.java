...
public class Terminator extends BaseGun implements SniperInstance {
	private final float dmg = 70.0f;
	private float multiplier;

	public Terminator(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		...
		list.add(StringUtil.getColourLocaleString("items.description.speed.ultraInsanelySlow", EnumChatFormatting.DARK_GREEN));
