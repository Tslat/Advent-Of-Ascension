...
public class MarkMaker extends BaseGun implements SniperInstance {
	private final float dmg = 60.0f;
	private float multiplier;

	public MarkMaker(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		...
		list.add(StringUtil.getColourLocaleString("item.MarkMaker.desc.1", EnumChatFormatting.DARK_GREEN));
