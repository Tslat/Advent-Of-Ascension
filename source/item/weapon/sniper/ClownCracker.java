...
public class ClownCracker extends BaseGun implements SniperInstance {
	private final float dmg = 20.0f;
	private float multiplier;

	public ClownCracker(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
