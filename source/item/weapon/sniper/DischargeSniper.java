...
public class DischargeSniper extends BaseSniper implements AdventWeapon {
	...
	public DischargeSniper(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		this.dmg = dmg;
		this.firingDelay = firingDelayTicks;
		setUnlocalizedName("DischargeSniper");
	...
	public void doImpactDamage(Entity target, EntityLivingBase shooter, BaseBullet bullet, float bulletDmgMultiplier) {
		...
		target.world.createExplosion(shooter, target.posX, target.posY + target.height + 0.5f, target.posZ, 2.5f, false);
	}
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
		...
		tooltip.add(StringUtil.getColourLocaleString("item.DischargeSniper.desc.1", TextFormatting.DARK_GREEN));
