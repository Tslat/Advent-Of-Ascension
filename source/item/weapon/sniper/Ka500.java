...
public class Ka500 extends BaseSniper implements AdventWeapon {
	public Ka500(double dmg, SoundEvent sound, int durability, int firingDelayTicks, float recoil) {
		super(dmg, sound, durability, firingDelayTicks, recoil);
		setUnlocalizedName("Ka500");
		setRegistryName("aoa3:ka500");
	}

	@Override
	public BaseBullet findAndConsumeAmmo(EntityPlayer player, BaseGun gun, EnumHand hand) {
		Item ammo = ItemUtil.findAndConsumeSpecialBullet(player, gun, itemRand.nextBoolean(), ItemRegister.metalSlug, player.getHeldItem(hand));
