...
public class CamoRifle extends BaseGun implements SniperInstance {
	private final float dmg = 60.0f;
	private float multiplier;

	public CamoRifle(final int consumeChance, final String effect, final int uses, final int fireRate, final Item item) {
