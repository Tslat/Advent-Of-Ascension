...
public class ShyregemBow extends ItemBow {
	...
	public ShyregemBow(int uses, int damage, Item arrow) {
		this(uses, damage, 72000, arrow);
		setFull3D();
	}

	public ShyregemBow(int uses, int damage, int maxUseDuraction, Item arrow) {
		setMaxDamage(uses);
		this.arrow = arrow;
		this.damage = damage;
	...
	public void registerIcons(IIconRegister icon) {
		String prefix = "nevermine:animateditem/bowShyregem";
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean bool) {
		...
		list.add(StringUtil.getLocaleString("items.description.speed.veryRapid"));
