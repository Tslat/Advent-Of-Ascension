...
public class InfernalArmor extends ItemArmor {
	public InfernalArmor(final ItemArmor.ArmorMaterial p_i45325_1_, final int p_i45325_2_, final int p_i45325_3_) {
		super(p_i45325_1_, p_i45325_2_, p_i45325_3_);
	}

	public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String type) {
		if (stack.getItem() == Armorizer.InfernalHelmet || stack.getItem() == Armorizer.InfernalChestplate || stack.getItem() == Armorizer.InfernalBoots) {
			return "nevermine:textures/models/armor/infernalarmor_1.png";
		}
		if (stack.getItem() == Armorizer.InfernalLeggings) {
