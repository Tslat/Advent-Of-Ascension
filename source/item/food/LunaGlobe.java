...
public class LunaGlobe extends ItemFood {
	public LunaGlobe() {
		super(0, true);
	...
	public ItemStack onEaten(final ItemStack item, final World world, final EntityPlayer player) {
		...
		if (!world.isRemote) {
			player.addPotionEffect(new PotionEffect(Potion.invisibility.id, 120));
		}
	...
	public void addInformation(final ItemStack stack, final EntityPlayer player, final List list, final boolean bool) {
		list.add(StringUtil.getLocaleString("item.LunaGlobe.desc.1"));
	}
}
